 ...
 * LogonMsg50SP2.java
 *
 * $Id: LogonMsg50SP2.java,v 1.3 2011-04-14 23:44:28 vrotaru Exp $
 */
 ...
 */
public class LogonMsg50SP2 extends LogonMsgFIXT11 {
    ...
    protected static final Set<Integer> MSG_TYPE_GROUP_TAGS = new MsgTypeGroup50SP2().getFragmentAllTags();
    ...
    public LogonMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }
    
    public LogonMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public LogonMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoMsgTypes(Integer noMsgTypes) {
        ...
        if (noMsgTypes != null) {
            ...
            for (int i = 0; i < msgTypeGroups.length; i++) {
                msgTypeGroups[i] = new MsgTypeGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public MsgTypeGroup addMsgTypeGroup() {
        MsgTypeGroup group = new MsgTypeGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (MSG_TYPE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noMsgTypes != null && noMsgTypes.intValue() > 0) {
                ...
                for (int i = 0; i < msgTypeGroups.length; i++) {
                    MsgTypeGroup group = new MsgTypeGroup50SP2(context);
