...
/*
 * MultilegModificationRequestMsg50SP2.java
 *
 * $Id: MultilegModificationRequestMsg50SP2.java,v 1.1 2011-09-10 05:39:46 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.LegOrdGroup50SP2;
import net.hades.fix.message.group.impl.v50sp2.PreAllocMLegGroup50SP2;
...
/**
 * FIX version 5.0SP2 MultilegModificationRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/04/2009, 9:32:41 AM
 */
@XmlRootElement(name="MlegOrdCxlRplc")
...
public class MultilegModificationRequestMsg50SP2 extends MultilegModificationRequestMsg {
    ...
    protected static final Set<Integer> ALLOC_GROUP_TAGS = new PreAllocMLegGroup50SP2().getFragmentAllTags();
    ...
    protected static final Set<Integer> LEG_ORD_GROUP_TAGS = new LegOrdGroup50SP2().getFragmentAllTags();
    ...
    public MultilegModificationRequestMsg50SP2() {
        super();
    }

    public MultilegModificationRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MultilegModificationRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public MultilegModificationRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MultilegModificationRequestMsg50SP2 fixml = (MultilegModificationRequestMsg50SP2) fragment;
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocGroups.length; i++) {
                allocGroups[i] = new PreAllocMLegGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public PreAllocMLegGroup addAllocGroup() {
        PreAllocMLegGroup group = new PreAllocMLegGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public void setNoTradingSessions(Integer noTradingSessions) {
        ...
        if (noTradingSessions != null) {
            ...
            for (int i = 0; i < tradingSessionGroups.length; i++) {
                tradingSessionGroups[i] = new TradingSessionGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public TradingSessionGroup addTradingSessionGroup() {
        TradingSessionGroup group = new TradingSessionGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public UnderlyingInstrument addUnderlyingInstrument() {
        UnderlyingInstrument group = new UnderlyingInstrument50SP2(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legOrdGroups.length; i++) {
                legOrdGroups[i] = new LegOrdGroup50SP2(context);
            }
        }
    }
    ...
    public LegOrdGroup addLegOrdGroup() {
        LegOrdGroup group = new LegOrdGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
        ...
        if (ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAllocs != null && noAllocs.intValue() > 0) {
                ...
                for (int i = 0; i < noAllocs.intValue(); i++) {
                    PreAllocMLegGroup group = new PreAllocMLegGroup50SP2(context);
        ...
        if (LEG_ORD_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    LegOrdGroup group = new LegOrdGroup50SP2(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MultilegModificationRequestMsg] message version [5.0SP2].";
    }
