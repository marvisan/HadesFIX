...
/*
 * TradingSessionStatusRequestMsg50.java
 *
 * $Id: TradingSessionStatusRequestMsg50.java,v 1.1 2011-04-22 01:59:23 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 TradingSessionStatusRequestMsg implementation.
 *
...
public class TradingSessionStatusRequestMsg50 extends TradingSessionStatusRequestMsg {
    ...
    public TradingSessionStatusRequestMsg50() {
        super();
    }

    public TradingSessionStatusRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradingSessionStatusRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradingSessionStatusRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradingSessionStatusRequestMsg50 fixml = (TradingSessionStatusRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradingSessionStatusRequestMsg] message version [5.0].";
    }
