...
/**
 * FIX 5.0 implementation of TrdCollGroup group.
 *
...
public class TrdCollGroup50 extends TrdCollGroup {
    ...
    public TrdCollGroup50() {
    }
    
    public TrdCollGroup50(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TrdCollGroup] group version [5.0].";
    }
