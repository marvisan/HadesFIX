 ...
 *
 * $Id: NestedParties250.java,v 1.2 2011-04-14 23:44:50 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.Nested2PartyGroup50;
 ...
 */
@XmlTransient
public class NestedParties250 extends NestedParties2 {
    ...
    protected static final Set<Integer> NESTED2_PARTY_GROUP_TAGS = new Nested2PartyGroup50().getFragmentAllTags();
    ...
    public NestedParties250() {
        super();
    }

    public NestedParties250(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoNested2PartyIDs(Integer noNested2PartyIDs) {
        ...
        if (noNested2PartyIDs != null) {
            ...
            for (int i = 0; i < nested2PartyGroups.length; i++) {
                nested2PartyGroups[i] = new Nested2PartyGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public Nested2PartyGroup addNested2PartyGroup() {
        Nested2PartyGroup group = new Nested2PartyGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NESTED2_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNested2PartyIDs != null && noNested2PartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < nested2PartyGroups.length; i++) {
                    Nested2PartyGroup group = new Nested2PartyGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NestedParties2] component version [5.0].";
    }
