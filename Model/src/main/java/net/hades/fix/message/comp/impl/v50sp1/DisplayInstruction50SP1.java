...
/*
 * DisplayInstruction50SP1.java
 *
 * $Id: DisplayInstruction50SP1.java,v 1.1 2010-12-05 08:13:28 vrotaru Exp $
 */
...
public class DisplayInstruction50SP1 extends DisplayInstruction {
    ...
    public DisplayInstruction50SP1() {
        super();
    }

    public DisplayInstruction50SP1(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DisplayInstruction] component version [5.0SP1].";
    }
