...
/*
 * TradeCaptureReportRequestAckMsg50.java
 *
...
/**
 * FIX version 5.0 TradeCaptureReportRequestAckMsg implementation.
 *
...
public class TradeCaptureReportRequestAckMsg50 extends TradeCaptureReportRequestAckMsg {
    ...
    public TradeCaptureReportRequestAckMsg50() {
        super();
    }

    public TradeCaptureReportRequestAckMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradeCaptureReportRequestAckMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradeCaptureReportRequestAckMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradeCaptureReportRequestAckMsg50 fixml = (TradeCaptureReportRequestAckMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradeCaptureReportRequestAckMsg] message version [5.0].";
    }
