...
/*
 * NewOrderListMsg50SP1.java
 *
 * $Id: NewOrderListMsg50SP1.java,v 1.3 2011-04-14 23:44:55 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.OrderListGroup50SP1;
...
/**
 * FIX version 5.0SP1 NewOrderListMsg implementation.
 *
...
public class NewOrderListMsg50SP1 extends NewOrderListMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> ORDER_LIST_GROUP_TAGS = new OrderListGroup50SP1().getFragmentAllTags();
    ...
    public NewOrderListMsg50SP1() {
        super();
    }

    public NewOrderListMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderListMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderListMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewOrderListMsg50SP1 fixml = (NewOrderListMsg50SP1) fragment;
    ...
    public void setNoOrders(Integer noOrders) {
        ...
        if (noOrders != null) {
            ...
            for (int i = 0; i < orderListGroups.length; i++) {
                orderListGroups[i] = new OrderListGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public OrderListGroup addOrderListGroup() {
        OrderListGroup group = new OrderListGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (ORDER_LIST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noOrders != null && noOrders.intValue() > 0) {
                ...
                for (int i = 0; i < noOrders.intValue(); i++) {
                    OrderListGroup group = new OrderListGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderListMsg] message version [5.0SP1].";
    }
