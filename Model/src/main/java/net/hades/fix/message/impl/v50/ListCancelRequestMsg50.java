...
/*
 * ListCancelRequestMsg50.java
 *
 * $Id: ListCancelRequestMsg50.java,v 1.2 2011-04-14 23:44:41 vrotaru Exp $
 */
...
public class ListCancelRequestMsg50 extends ListCancelRequestMsg {
    ...
    public ListCancelRequestMsg50() {
        super();
    }

    public ListCancelRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ListCancelRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ListCancelRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ListCancelRequestMsg50 fixml = (ListCancelRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListCancelRequestMsg] message version [5.0].";
    }
