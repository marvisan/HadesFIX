...
/*
 * SettlementInstructionsMsg42.java
 *
 * $Id: SettlementInstructionsMsg42.java,v 1.2 2011-03-26 03:24:27 vrotaru Exp $
 */
...
/**
 * FIX version 4.2 SettlementInstructionsMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class SettlementInstructionsMsg42 extends SettlementInstructionsMsg {
    ...
    protected static final Set<Integer> START_DATA_TAGS_V42 = null;
    ...
    public SettlementInstructionsMsg42() {
        super();
    }

    public SettlementInstructionsMsg42(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SettlementInstructionsMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SettlementInstructionsMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SettlementInstructionsMsg] message version [4.2].";
    }
