...
/*
 * OrderStatusRequestMsg50SP1.java
 *
 * $Id: OrderStatusRequestMsg50SP1.java,v 1.3 2011-04-14 23:44:58 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 OrderStatusRequestMsg implementation.
 *
...
public class OrderStatusRequestMsg50SP1 extends OrderStatusRequestMsg {
    ...
    public OrderStatusRequestMsg50SP1() {
        super();
    }

    public OrderStatusRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderStatusRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderStatusRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderStatusRequestMsg50SP1 fixml = (OrderStatusRequestMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderStatusRequestMsg] message version [5.0SP1].";
    }
