...
/*
 * CollateralInquiryAckMsg50.java
 *
 * $Id: AllocationInstructionMsg50.java,v 1.3 2011-04-14 23:50:38 vrotaru Exp $
 */
package net.hades.fix.message.impl.v50;

import net.hades.fix.message.group.impl.v50.CollInqQualGroup50;
...
/**
 * FIX version 5.0 CollateralInquiryAckMsg implementation.
 *
...
public class CollateralInquiryAckMsg50 extends CollateralInquiryAckMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> COLL_INQ_QUAL_GROUP_TAGS = new CollInqQualGroup50().getFragmentAllTags();
    ...
    public CollateralInquiryAckMsg50() {
        super();
    }

    public CollateralInquiryAckMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralInquiryAckMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralInquiryAckMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralInquiryAckMsg50 fixml = (CollateralInquiryAckMsg50) fragment;
    ...
    public void setNoCollInquiryQualifier(Integer noCollInquiryQualifier) {
        ...
        if (noCollInquiryQualifier != null) {
            ...
            for (int i = 0; i < collInqQualGroups.length; i++) {
                collInqQualGroups[i] = new CollInqQualGroup50(context);
            }
        }
    }
    ...
    public CollInqQualGroup addCollInqQualGroup() {
        CollInqQualGroup group = new CollInqQualGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (COLL_INQ_QUAL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noCollInquiryQualifier != null && noCollInquiryQualifier.intValue() > 0) {
                ...
                for (int i = 0; i < noCollInquiryQualifier.intValue(); i++) {
                    CollInqQualGroup component = new CollInqQualGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralInquiryAckMsg] message version [5.0].";
    }
