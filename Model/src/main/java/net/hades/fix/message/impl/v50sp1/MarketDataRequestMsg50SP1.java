...
/*
 * MarketDataRequestMsg50SP1.java
 *
 * $Id: MarketDataRequestMsg50SP1.java,v 1.9 2011-04-14 23:44:58 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.MDEntryTypeGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.MDReqGroup50SP1;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MDUpdateType;
import net.hades.fix.message.xml.codec.jaxb.adapter.FixBooleanAdapter;

/**
 * FIX version 5.0SP1 MarketDataRequestMsg implementation.
 *
...
public class MarketDataRequestMsg50SP1 extends MarketDataRequestMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -8919407431722680572L;
    
    protected static final Set<Integer> START_COMP_TAGS;
    
    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> MD_ENTRY_TYPE_GROUP_TAGS = new MDEntryTypeGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> PARTIES_COMP_TAGS = new Parties50SP1().getFragmentAllTags();
    protected static final Set<Integer> MD_REQ_GROUP_TAGS = new MDReqGroup50SP1().getFragmentAllTags();
    ...
    public MarketDataRequestMsg50SP1() {
        super();
    }
    
    public MarketDataRequestMsg50SP1(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MarketDataRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MarketDataRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MarketDataRequestMsg50SP1 fixml = (MarketDataRequestMsg50SP1) fragment;
    ...
    public void setNoMDEntryTypes(Integer noMDEntryTypes) {
        ...
        if (noMDEntryTypes != null) {
            ...
            for (int i = 0; i < mdEntryTypeGroups.length; i++) {
                mdEntryTypeGroups[i] = new MDEntryTypeGroup50SP1(context);
            }
        }
    }
    ...
    public MDEntryTypeGroup addMdEntryTypeGroup() {
        MDEntryTypeGroup group = new MDEntryTypeGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoRelatedSym(Integer noRelatedSym) {
        ...
        if (noRelatedSym != null) {
            ...
            for (int i = 0; i < mdReqGroups.length; i++) {
                mdReqGroups[i] = new MDReqGroup50SP1(context);
            }
        }
    }
    ...
    public MDReqGroup addMdReqGroup() {
        MDReqGroup group = new MDReqGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (MD_ENTRY_TYPE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noMDEntryTypes != null && noMDEntryTypes.intValue() > 0) {
                ...
                for (int i = 0; i < noMDEntryTypes.intValue(); i++) {
                    MDEntryTypeGroup group = new MDEntryTypeGroup50SP1(context);
        ...
        if (MD_REQ_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRelatedSym != null && noRelatedSym.intValue() > 0) {
                ...
                for (int i = 0; i < noRelatedSym.intValue(); i++) {
                    MDReqGroup group = new MDReqGroup50SP1(context);
                    group.decode(message);
                    mdReqGroups[i] = group;
                }
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MarketDataRequestMsg] message version [5.0SP1].";
    }
