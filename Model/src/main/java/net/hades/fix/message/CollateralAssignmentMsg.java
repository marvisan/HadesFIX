 ...
 * Used to assign collateral to cover a trading position. This message can be sent unsolicited or in reply to a
 * Collateral Request message.
 * The Collateral Assignment message can be used to perform the following:
 * <ul>
 *      <li>Assign initial collateral</li>
 *      <li>Replace collateral</li>
 * </ul>
 *
...
public abstract class CollateralAssignmentMsg extends FIXMsg {
    ...
    /**
     * TagNum = 894 REQUIRED. Starting with 4.4 version.
     */
    ...
    /**
     * TagNum = 895 REQUIRED. Starting with 4.4 version.
     */
    protected CollAsgnReason collAsgnReason;
   
    /**
     * TagNum = 903 REQUIRED. Starting with 4.4 version.
     */
    protected CollAsgnTransType collAsgnTransType;

    /**
     * TagNum = 907. Starting with 4.4 version.
     */
    protected String collAsgnRefID;
    ...
    public CollateralAssignmentMsg() {
        super();
    }

    public CollateralAssignmentMsg(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralAssignmentMsg(BeginString beginString) throws InvalidMsgException {
        super(MsgType.CollateralAssignment.getValue(), beginString);
    }

    public CollateralAssignmentMsg(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
        super(MsgType.CollateralAssignment.getValue(), beginString, applVerID);
    }
    ...
    @TagNumRef(tagNum=TagNum.CollAsgnID, required=true)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnReason, required=true)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnTransType, required=true)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnRefID)
    public String getCollAsgnRefID() {
        return collAsgnRefID;
    }

    /**
     * Message field setter.
     * @param collAsgnRefID field value
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnRefID)
    public void setCollAsgnRefID(String collAsgnRefID) {
        this.collAsgnRefID = collAsgnRefID;
    }
   ...
   /**
    ...
    protected void validateRequiredTags() throws TagNotPresentException {
        ...
        if (collAsgnTransType == null) {
            errorMsg.append(" [CollAsgnTransType]");
            hasMissingTag = true;
        }
    ...
    protected byte[] encodeFragmentAll() throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            TagEncoder.encode(bao, TagNum.CollAsgnRefID, collAsgnRefID);
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {    
            ...
            case CollAsgnRefID:
                collAsgnRefID = new String(tag.value, sessionCharset);
                break;
           ...
           case SettlSessSubID:
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [CollateralAssignmentMsg] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("{CollateralAssignmentMsg=");
        ...
        printTagValue(b, TagNum.CollAsgnRefID, collAsgnRefID);
