...
/*
 * CollateralInquiryMsg50SP1.java
 *
...
/**
 * FIX version 5.0SP1 CollateralInquiryMsg implementation.
 *
...
public class CollateralInquiryMsg50SP1 extends CollateralInquiryMsg {
    ...
    public CollateralInquiryMsg50SP1() {
        super();
    }

    public CollateralInquiryMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralInquiryMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralInquiryMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralInquiryMsg50SP1 fixml = (CollateralInquiryMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralInquiryMsg] message version [5.0SP1].";
    }
