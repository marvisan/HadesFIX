...
public class ConfirmationAckMsg50SP2 extends ConfirmationAckMsg {
    ...
    public ConfirmationAckMsg50SP2() {
        super();
    }

    public ConfirmationAckMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ConfirmationAckMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ConfirmationAckMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ConfirmationAckMsg50SP2 fixml = (ConfirmationAckMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ConfirmationAckMsg] message version [5.0SP2].";
    }
