...
/*
 * ListCancelRequestMsg50SP2.java
 *
 * $Id: ListCancelRequestMsg50SP2.java,v 1.2 2011-04-14 23:44:29 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 ListCancelRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 21/04/2009, 9:32:41 AM
 */
@XmlRootElement(name="ListCxlReq")
@XmlType(propOrder = {"header", "partyIDGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class ListCancelRequestMsg50SP2 extends ListCancelRequestMsg {
    ...
    public ListCancelRequestMsg50SP2() {
        super();
    }

    public ListCancelRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ListCancelRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ListCancelRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ListCancelRequestMsg50SP2 fixml = (ListCancelRequestMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListCancelRequestMsg] message version [5.0SP2].";
    }
