...
/*
 * LegStipulations50.java
 *
 * $Id: LegStipulations50.java,v 1.8 2011-04-14 23:44:50 vrotaru Exp $
 */
package net.hades.fix.message.comp.impl.v50;

import net.hades.fix.message.group.impl.v50.LegStipulationsGroup50;
...
/**
 * FIX version 5.0 implementation of LegStipulations component.
 *
 ...
 */
@XmlTransient
public class LegStipulations50 extends LegStipulations {
    ...
    protected static final Set<Integer> LEG_STIPS_GROUP_TAGS = new LegStipulationsGroup50().getFragmentAllTags();
    ...
    public LegStipulations50() {
        super();
    }

    public LegStipulations50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoLegStipulations(Integer noLegStipulations) {
        ...
        if (noLegStipulations != null) {
            ...
            for (int i = 0; i < legStipulationsGroups.length; i++) {
                legStipulationsGroups[i] = new LegStipulationsGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public LegStipulationsGroup addLegStipulationsGroup() {
        ...
        LegStipulationsGroup group = new LegStipulationsGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noLegStipulations != null && noLegStipulations.intValue() > 0) {
            if (LEG_STIPS_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noLegStipulations.intValue(); i++) {
                    LegStipulationsGroup group = new LegStipulationsGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [LegStipulations] component version [5.0].";
    }
