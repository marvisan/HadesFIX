...
/*
 * SecurityTypeRequestMsg50SP1.java
 *
 * $Id: SecurityTypeRequestMsg50SP1.java,v 1.1 2011-04-26 02:16:03 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 SecurityTypeRequestMsg implementation.
 *
...
public class SecurityTypeRequestMsg50SP1 extends SecurityTypeRequestMsg {
    ...
    public SecurityTypeRequestMsg50SP1() {
        super();
    }

    public SecurityTypeRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityTypeRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityTypeRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityTypeRequestMsg50SP1 fixml = (SecurityTypeRequestMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityTypeRequestMsg] message version [5.0SP1].";
    }
