...
/*
 * QuoteResponseMsg44.java
 *
 * $Id: QuoteResponseMsg44.java,v 1.13 2011-04-14 23:44:37 vrotaru Exp $
 */
...
/**
 * FIX version 4.4 QuoteResponseMsg implementation.
 *
...
public class QuoteResponseMsg44 extends QuoteResponseMsg {
    ...
    protected static final Set<Integer> LEG_QUOTE_GROUP_TAGS = new LegQuoteGroup44().getFragmentAllTags();
    ...
    public QuoteResponseMsg44() {
        super();
    }
    
    public QuoteResponseMsg44(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteResponseMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    ...
    public QuoteResponseMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteResponseMsg44 fixml = (QuoteResponseMsg44) fragment;
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteGroups.length; i++) {
                legQuoteGroups[i] = new LegQuoteGroup44(context);
            }
        }
    }
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (quoteRespType != null && MsgUtil.isTagInList(TagNum.QuoteRespType, SECURED_TAGS, secured)) {
                ...
                if (legQuoteGroups != null && legQuoteGroups.length == noLegs.intValue()) {
                    for (int i = 0; i < noLegs.intValue(); i++) {
                        if (legQuoteGroups[i] != null) {
                            bao.write(legQuoteGroups[i].encode(getMsgSecureTypeForFlag(secured)));
                        }
                    }
                } else {
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (LEG_QUOTE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                message.reset();
                legQuoteGroups = new LegQuoteGroup44[noLegs.intValue()];
                for (int i = 0; i < legQuoteGroups.length; i++) {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteResponseMsg] message version [4.4].";
    }
