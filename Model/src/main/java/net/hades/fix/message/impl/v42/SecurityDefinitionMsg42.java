...
/*
 * SecurityDefinitionMsg42.java
 *
 * $Id: SecurityDefinitionMsg42.java,v 1.2 2011-04-29 03:11:02 vrotaru Exp $
 */
...
/**
 * FIX version 4.2 SecurityDefinitionMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class SecurityDefinitionMsg42 extends SecurityDefinitionMsg {
    ...
    public SecurityDefinitionMsg42() {
        super();
    }

    public SecurityDefinitionMsg42(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityDefinitionMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityDefinitionMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityDefinitionMsg] message version [4.2].";
    }
