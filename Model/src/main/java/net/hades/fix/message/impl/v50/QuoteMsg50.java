 ...
 * QuoteMsg50.java
 *
 * $Id: QuoteMsg50.java,v 1.10 2011-04-14 23:44:42 vrotaru Exp $
 */
...
public class QuoteMsg50 extends QuoteMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -1918697970794019142L;
    ...
    protected static final Set<Integer> LEG_QUOTE_SYMBOL_GROUP_TAGS = new LegQuoteGroup50().getFragmentAllTags();
    ...
    public QuoteMsg50(Header header, ByteBuffer rawMsg)
    ...
    public QuoteMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        instrument = new Instrument50(context);
    }

    public QuoteMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteMsg50 fixml = (QuoteMsg50) fragment;
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteSymbolGroups.length; i++) {
                legQuoteSymbolGroups[i] = new LegQuoteGroup50(context);
            }
        }
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (LEG_QUOTE_SYMBOL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                message.reset();
                legQuoteSymbolGroups = new LegQuoteGroup50[noLegs.intValue()];
                for (int i = 0; i < legQuoteSymbolGroups.length; i++) {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteMsg] message version [5.0].";
    }
