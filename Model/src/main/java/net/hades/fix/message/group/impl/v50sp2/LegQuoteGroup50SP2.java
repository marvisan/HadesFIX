...
/*
 * LegQuoteGroup50SP2.java
 *
 * $Id: LegQuoteGroup50SP2.java,v 1.8 2011-04-14 23:44:29 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP2 implementation of LegQuoteGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.8 $
 * @created 17/06/2009, 6:46:57 PM
 */
...
public class LegQuoteGroup50SP2 extends LegQuoteGroup {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -5689309451421848537L;
    ...
    protected static final Set<Integer> LEG_BENCHMARK_CURVE_COMP_TAGS = new LegBenchmarkCurveData50SP2().getFragmentAllTags();
    ...
    public LegQuoteGroup50SP2() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public LegQuoteGroup50SP2(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    public void setInstrumentLeg() {
        instrumentLeg = new InstrumentLeg50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setLegStipulations() {
        this.legStipulations = new LegStipulations50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setNestedParties() {
        this.nestedParties = new NestedParties50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setLegBenchmarkCurveData() {
        this.legBenchmarkCurveData = new LegBenchmarkCurveData50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (LEG_STIPULATIONS_COMP_TAGS.contains(tag.tagNum)) {
            if (legStipulations == null) {
                legStipulations = new LegStipulations50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
            legStipulations.decode(tag, message);
        }
        if (NESTED_PARTIES_COMP_TAGS.contains(tag.tagNum)) {
            if (nestedParties == null) {
                nestedParties = new NestedParties50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
            nestedParties.decode(tag, message);
        }
        if (LEG_BENCHMARK_CURVE_COMP_TAGS.contains(tag.tagNum)) {
            if (legBenchmarkCurveData == null) {
                legBenchmarkCurveData = new LegBenchmarkCurveData50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [LegQuoteSymbolGroup] group version [5.0SP2].";
    }
