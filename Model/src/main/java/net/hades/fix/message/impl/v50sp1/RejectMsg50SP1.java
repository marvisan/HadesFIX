 ...
 * RejectMsg50SP1.java
 *
 * $Id: RejectMsg50SP1.java,v 1.2 2010-11-14 08:53:00 vrotaru Exp $
 */
...
/**
 * FIXT 5.0SP1 implementation of RejectMsg.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 18/12/2008, 8:26:23 PM
 */
public class RejectMsg50SP1 extends RejectMsgFIXT11 {
    ...
    public RejectMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RejectMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public RejectMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RejectMsg] message version [5.0SP1].";
    }
