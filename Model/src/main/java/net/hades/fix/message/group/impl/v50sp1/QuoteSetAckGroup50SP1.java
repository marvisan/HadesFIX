...
/*
 * QuoteSetAckGroup50SP1.java
 *
 * $Id: QuoteSetAckGroup50SP1.java,v 1.8 2011-04-14 23:44:51 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of QuoteSetGroup group.
 *
...
public class QuoteSetAckGroup50SP1 extends QuoteSetAckGroup {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -5490627537827172783L;
    
    protected static final Set<Integer> START_COMP_TAGS;

    protected static final Set<Integer> ALL_TAGS;
    
    protected static final Set<Integer> QUOTE_ENTRY_ACK_GROUP_TAGS = new QuoteEntryAckGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> UND_INSTR_COMP_TAGS = new UnderlyingInstrument50SP1().getFragmentAllTags();
    ...
    public QuoteSetAckGroup50SP1() {
    }
    
    public QuoteSetAckGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setUnderlyingInstrument() {
        this.underlyingInstrument = new UnderlyingInstrument50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setNoQuoteEntries(Integer noQuoteEntries) {
        ...
        if (noQuoteEntries != null) {
            ...
            for (int i = 0; i < quoteEntryAckGroups.length; i++) {
                quoteEntryAckGroups[i] = new QuoteEntryAckGroup50SP1(context);
            }
        }
    }
    ...
    public QuoteEntryAckGroup addQuoteEntryAckGroup() {
        QuoteEntryAckGroup group = new QuoteEntryAckGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (QUOTE_ENTRY_ACK_GROUP_TAGS.contains(tag.tagNum)) {
            if (noQuoteEntries != null && noQuoteEntries.intValue() > 0) {
                ...
                for (int i = 0; i < quoteEntryAckGroups.length; i++) {
                    QuoteEntryAckGroup group = new QuoteEntryAckGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteSetAckGroup] group version [5.0SP1].";
    }
