...
/*
 * OrderCancelRejectMsg40.java
 *
 * $Id: OrderCancelRejectMsg40.java,v 1.1 2011-01-23 10:02:05 vrotaru Exp $
 */
...
/**
 * FIX version 4.0 OrderCancelRejectMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class OrderCancelRejectMsg40 extends OrderCancelRejectMsg {
    ...
    public OrderCancelRejectMsg40() {
        super();
    }

    public OrderCancelRejectMsg40(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRejectMsg40(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRejectMsg40(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderCancelRejectMsg] message version [4.0].";
    }
