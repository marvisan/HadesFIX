...
/*
 * QuoteStatusReportMsg50.java
 *
 * $Id: QuoteStatusReportMsg50.java,v 1.11 2011-04-14 23:44:41 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.LegQuoteGroup50;
import net.hades.fix.message.group.impl.v50.LegQuoteStatusGroup50;
import net.hades.fix.message.group.impl.v50.QuoteQualifierGroup50;
...
/**
 * FIX version 5.0 QuoteStatusReportMsg implementation.
 *
...
public class QuoteStatusReportMsg50 extends QuoteStatusReportMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -795069731150413464L;
    ...
    protected static final Set<Integer> LEG_QUOTE_STATUS_GROUP_TAGS = new LegQuoteGroup50().getFragmentAllTags();
    ...
    public QuoteStatusReportMsg50() {
        super();
        instrument = new Instrument50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    
    public QuoteStatusReportMsg50(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public QuoteStatusReportMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        instrument = new Instrument50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    
    public QuoteStatusReportMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteStatusReportMsg50 fixml = (QuoteStatusReportMsg50) fragment;
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteStatusGroups.length; i++) {
                legQuoteStatusGroups[i] = new LegQuoteStatusGroup50(context);
            }
        }
    }
    ...
    public LegQuoteStatusGroup addLegQuoteStatusGroup() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        LegQuoteStatusGroup group = new LegQuoteStatusGroup50(context);
        ...
        if (LEG_QUOTE_STATUS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    LegQuoteStatusGroup component = new LegQuoteStatusGroup50(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteStatusReportMsg] message version [5.0].";
    }
