...
/*
 * Instrument50SP1.java
 *
 * $Id: Instrument50SP1.java,v 1.10 2011-04-14 23:44:46 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.EventGroup50SP1;
...
import net.hades.fix.message.group.impl.v50sp1.SecurityAltIDGroup50SP1;
...
@XmlType(propOrder = {"securityAltIDGroups", "securityXML", "events", "instrumentPartyGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class Instrument50SP1 extends Instrument {
    ...
    protected static final Set<Integer> SEC_ALT_ID_GROUP_TAGS = new SecurityAltIDGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> SECURITY_XML_COMP_TAGS = new SecurityXML50SP1().getFragmentAllTags();
    protected static final Set<Integer> EVENT_GROUP_TAGS = new EventGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> INSTRUMENT_PARTIES_COMP_TAGS = new InstrumentParties50SP1().getFragmentAllTags();
    ...
    public Instrument50SP1(FragmentContext context) {
        super(context);
        if (messageEncoding == null) {
            messageEncoding = Charset.forName(FIXMsg.DEFAULT_CHARACTER_SET);
        }
    ...
    public void setNoSecurityAltID(Integer noSecurityAltID) {
        ...
        if (noSecurityAltID != null) {
            ...
            for (int i = 0; i < securityAltIDGroups.length; i++) {
                securityAltIDGroups[i] = new SecurityAltIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public SecurityAltIDGroup addSecurityAltIDGroup() {       
        SecurityAltIDGroup group = new SecurityAltIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setSecurityXML() {
        ...
        securityXML = new SecurityXML50SP1(context);
    }
    ...
    public void setNoEvents(Integer noEvents) {
        ...
        if (noEvents != null) {
            ...
            for (int i = 0; i < events.length; i++) {
                events[i] = new EventGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public EventGroup addEvent() {
        ...
        EventGroup group = new EventGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setInstrumentParties() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        instrumentParties = new InstrumentParties50SP1(context);
    }
    ...
    public void setInstrumentPartyGroups(InstrumentPartyGroup[] instrumentPartyGroups) {
        if (instrumentPartyGroups != null) {
            ...
            ((InstrumentParties50SP1) instrumentParties).setInstrumentPartyGroups(instrumentPartyGroups);
        }
    }
        ...
        if (noSecurityAltID != null && noSecurityAltID.intValue() > 0) {
            if (SEC_ALT_ID_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noSecurityAltID.intValue(); i++) {
                    SecurityAltIDGroup group = new SecurityAltIDGroup50SP1(context);
        ...
        if (noEvents != null && noEvents.intValue() > 0) {
            if (EVENT_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noEvents.intValue(); i++) {
                    EventGroup group = new EventGroup50SP1(context);
                    group.decode(message);
                    events[i] = group;
                }
            }
