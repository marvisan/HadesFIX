...
/*
 * NewOrderCrossMsg44.java
 *
 * $Id: NewOrderCrossMsg44.java,v 1.2 2011-05-17 09:28:21 vrotaru Exp $
 */
...
/**
 * FIX version 4.4 NewOrderCrossMsg implementation.
 *
...
public class NewOrderCrossMsg44 extends NewOrderCrossMsg {
    ...
    public NewOrderCrossMsg44() {
        super();
    }

    public NewOrderCrossMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderCrossMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderCrossMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewOrderCrossMsg44 fixml = (NewOrderCrossMsg44) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderCrossMsg] message version [4.4].";
    }
