...
/*
 * SecurityDefinitionRequestMsg50.java
 *
 * $Id: SecurityDefinitionRequestMsg50.java,v 1.1 2011-04-16 07:38:24 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 SecurityDefinitionRequestMsg implementation.
 *
...
public class SecurityDefinitionRequestMsg50 extends SecurityDefinitionRequestMsg {
    ...
    public SecurityDefinitionRequestMsg50() {
        super();
    }

    public SecurityDefinitionRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityDefinitionRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityDefinitionRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityDefinitionRequestMsg50 fixml = (SecurityDefinitionRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityDefinitionRequestMsg] message version [5.0].";
    }
