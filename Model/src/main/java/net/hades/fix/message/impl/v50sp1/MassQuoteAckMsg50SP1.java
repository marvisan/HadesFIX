...
/*
 * MassQuoteAckMsg50SP1.java
 *
 * $Id: MassQuoteAckMsg50SP1.java,v 1.10 2011-04-14 23:44:58 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 MassQuoteMsg implementation.
 *
...
public class MassQuoteAckMsg50SP1 extends MassQuoteAckMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -6621028285015177090L;
    
    protected static final Set<Integer> START_COMP_TAGS;
    
    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> QUOTE_SET_ACK_GROUP_TAGS = new QuoteSetAckGroup50SP1().getFragmentAllTags();
    ...
    public MassQuoteAckMsg50SP1() {
        super();
    }
    
    public MassQuoteAckMsg50SP1(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MassQuoteAckMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MassQuoteAckMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MassQuoteAckMsg50SP1 fixml = (MassQuoteAckMsg50SP1) fragment;
    ...
    public void setNoQuoteSets(Integer noQuoteSets) {
        ...
        if (noQuoteSets != null) {
            ...
            for (int i = 0; i < quoteSetAckGroups.length; i++) {
                quoteSetAckGroups[i] = new QuoteSetAckGroup50SP1(context);
            }
        }
    }
    ...
    public QuoteSetAckGroup addQuoteSetAckGroup() {
        QuoteSetAckGroup group = new QuoteSetAckGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (QUOTE_SET_ACK_GROUP_TAGS.contains(tag.tagNum)) {
            if (noQuoteSets != null && noQuoteSets.intValue() > 0) {
                ...
                for (int i = 0; i < noQuoteSets.intValue(); i++) {
                    QuoteSetAckGroup component = new QuoteSetAckGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MassQuoteAckMsg] message version [5.0SP1].";
    }
