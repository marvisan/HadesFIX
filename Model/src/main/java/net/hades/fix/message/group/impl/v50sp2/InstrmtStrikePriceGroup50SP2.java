...
/*
 * InstrmtStrikePriceGroup50SP2.java
 *
 * $Id: InstrmtStrikePriceGroup50SP2.java,v 1.1 2011-04-15 04:37:43 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP2 implementation of InstrmtStrikePriceGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 05/04/2009, 11:39:24 AM
 */
@XmlRootElement(name="StrkPX")
@XmlType(propOrder = {"instrument", "underlyingInstruments"})
@XmlAccessorType(XmlAccessType.NONE)
public class InstrmtStrikePriceGroup50SP2 extends InstrmtStrikePriceGroup {
    ...
    public InstrmtStrikePriceGroup50SP2() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public InstrmtStrikePriceGroup50SP2(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrmtStrikePriceGroup] group version [5.0SP2].";
    }
