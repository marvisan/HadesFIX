...
/*
 * PositionMaintenanceRequestMsg50SP1.java
 *
 * $Id: AllocationInstructionMsg40.java,v 1.3 2011-04-14 23:44:38 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.PositionQtyGroup50SP1;
...
/**
 * FIX version 5.0SP1 PositionMaintenanceRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 05/12/2011, 9:32:41 AM
 */
...
public class PositionMaintenanceRequestMsg50SP1 extends PositionMaintenanceRequestMsg {
    ...
    protected static final Set<Integer> POSITION_QTY_GROUP_TAGS = new PositionQtyGroup50SP1().getFragmentAllTags();
    ...
    public PositionMaintenanceRequestMsg50SP1() {
        super();
    }

    public PositionMaintenanceRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public PositionMaintenanceRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public PositionMaintenanceRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        PositionMaintenanceRequestMsg50SP1 fixml = (PositionMaintenanceRequestMsg50SP1) fragment;
    ...
    public void setNoPositions(Integer noPositions) {
        ...
        if (noPositions != null) {
            ...
            for (int i = 0; i < positionQtyGroups.length; i++) {
                positionQtyGroups[i] = new PositionQtyGroup50SP1(context);
            }
        }
    }
    ...
    public PositionQtyGroup addPositionQtyGroup() {
        PositionQtyGroup group = new PositionQtyGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (POSITION_QTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noPositions != null && noPositions.intValue() > 0) {
                ...
                for (int i = 0; i < noPositions.intValue(); i++) {
                    PositionQtyGroup group = new PositionQtyGroup50SP1(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PositionMaintenanceRequestMsg] message version [5.0SP1].";
    }
