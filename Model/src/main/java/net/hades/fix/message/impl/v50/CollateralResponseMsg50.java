...
import net.hades.fix.message.group.impl.v50.ExecCollGroup50;
import net.hades.fix.message.group.impl.v50.MiscFeeGroup50;
...
import net.hades.fix.message.group.impl.v50.TrdCollGroup50;
import net.hades.fix.message.group.impl.v50.TrdRegTimestampsGroup50;
import net.hades.fix.message.group.impl.v50.UndInstrmtCollGroup50;
...
/**
 * FIX version 5.0 CollateralResponseMsg implementation.
 *
...
public class CollateralResponseMsg50 extends CollateralResponseMsg {
    ...
    protected static final Set<Integer> EXEC_COLL_GROUP_TAGS = new ExecCollGroup50().getFragmentAllTags();
    protected static final Set<Integer> TRD_COLL_GROUP_TAGS = new TrdCollGroup50().getFragmentAllTags();
    ...
    protected static final Set<Integer> UND_INSTRMT_COLL_GROUP_TAGS = new UndInstrmtCollGroup50().getFragmentAllTags();
    ...
    public CollateralResponseMsg50() {
        super();
    }

    public CollateralResponseMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralResponseMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralResponseMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralResponseMsg50 fixml = (CollateralResponseMsg50) fragment;
        ...
        if (fixml.getCollApplType() != null) {
            collApplType = fixml.getCollApplType();
        }
    ...
    public void setNoExecs(Integer noExecs) {
        ...
        if (noExecs != null) {
            ...
            for (int i = 0; i < execCollGroups.length; i++) {
                execCollGroups[i] = new ExecCollGroup50(context);
            }
        }
    }
    ...
    public ExecCollGroup addExecCollGroup() {
        ExecCollGroup group = new ExecCollGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoTrades(Integer noContAmts) {
        ...
        if (noContAmts != null) {
            ...
            for (int i = 0; i < trdCollGroups.length; i++) {
                trdCollGroups[i] = new TrdCollGroup50(context);
            }
        }
    }
    ...
    public TrdCollGroup addTrdCollGroup() {
        TrdCollGroup group = new TrdCollGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoUnderlyings(Integer noUnderlyings) {
        ...
        if (noUnderlyings != null) {
            ...
            for (int i = 0; i < undInstrmtCollGroups.length; i++) {
                undInstrmtCollGroups[i] = new UndInstrmtCollGroup50(context);
            }
        }
    }
    ...
    public UndInstrmtCollGroup addUndInstrmtCollGroup() {
        UndInstrmtCollGroup group = new UndInstrmtCollGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (EXEC_COLL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noExecs != null && noExecs.intValue() > 0) {
                ...
                for (int i = 0; i < noExecs.intValue(); i++) {
                    ExecCollGroup component = new ExecCollGroup50(context);
        ...
        if (TRD_COLL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noTrades != null && noTrades.intValue() > 0) {
                ...
                for (int i = 0; i < noTrades.intValue(); i++) {
                    TrdCollGroup component = new TrdCollGroup50(context);
                    component.decode(message);
        ...
        if (UND_INSTRMT_COLL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noUnderlyings != null && noUnderlyings.intValue() > 0) {
                ...
                for (int i = 0; i < noUnderlyings.intValue(); i++) {
                    UndInstrmtCollGroup component = new UndInstrmtCollGroup50(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralRequestMsg] message version [5.0].";
    }
