...
/*
 * ListStatusMsg50SP1.java
 *
 * $Id: ListStatusMsg50SP1.java,v 1.2 2011-04-14 23:44:54 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.OrderStatusGroup50SP1;
...
public class ListStatusMsg50SP1 extends ListStatusMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> ORDER_STATUS_GROUP_TAGS = new OrderStatusGroup50SP1().getFragmentAllTags();
    ...
    public ListStatusMsg50SP1() {
        super();
    }

    public ListStatusMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListStatusMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListStatusMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ListStatusMsg50SP1 fixml = (ListStatusMsg50SP1) fragment;
    ...
    public void setNoOrders(Integer noOrders) {
        ...
        if (noOrders != null) {
            ...
            for (int i = 0; i < orderStatusGroups.length; i++) {
                orderStatusGroups[i] = new OrderStatusGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public OrderStatusGroup addOrderStatusGroup() {
        OrderStatusGroup group = new OrderStatusGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (ORDER_STATUS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noOrders != null && noOrders.intValue() > 0) {
                ...
                for (int i = 0; i < noOrders.intValue(); i++) {
                    OrderStatusGroup group = new OrderStatusGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListStatusMsg] message version [5.0SP1].";
    }
