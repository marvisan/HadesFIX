...
/*
 * TradeAllocGroup50SP2.java
 *
 * $Id: TradeAllocGroup50SP2.java,v 1.1 2011-10-21 10:31:03 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP2 implementation of TradeAllocGroup group.
 *
...
public class TradeAllocGroup50SP2 extends TradeAllocGroup {
    ...
    public TradeAllocGroup50SP2() {
    }

    public TradeAllocGroup50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNestedParties2() {
        ...
        this.nestedParties2 = new NestedParties250SP2(context);
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (NESTED_PARTIES2_COMP_TAGS.contains(tag.tagNum)) {
            if (nestedParties2 == null) {
                nestedParties2 = new NestedParties250SP2(context);
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradeAllocGroup] group version [5.0SP2].";
    }
