...
/*
 * QuoteCancelGroup44.java
 *
 * $Id: QuoteCancelGroup44.java,v 1.9 2011-04-14 23:44:46 vrotaru Exp $
 */
...
/**
 * FIX 4.4 implementation of QuoteCancelGroup group.
 *
...
public class QuoteCancelGroup44 extends QuoteCancelGroup {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -6184707260221451872L;
    ...
    public QuoteCancelGroup44() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired);
        instrument = new Instrument44(context);
    }
    
    public QuoteCancelGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        instrument = new Instrument44(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteCancelGroup] group version [4.4].";
    }
