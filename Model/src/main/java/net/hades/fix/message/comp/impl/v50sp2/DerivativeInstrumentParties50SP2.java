...
/*
 * DerivativeInstrumentParties50SP2.java
 *
 * $Id: DerivativeInstrumentParties50SP2.java,v 1.1 2011-09-19 08:15:45 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.DerivativeInstrumentPartyGroup50SP2;
...
/**
 * FIX 5.0SP2 implementation of DerivativeInstrumentParties component.
 * 
 ...
 */
@XmlTransient
public class DerivativeInstrumentParties50SP2 extends DerivativeInstrumentParties {
    ...
    protected static final Set<Integer> INSTRUMENT_PARTY_GROUP_TAGS = new DerivativeInstrumentPartyGroup50SP2().getFragmentAllTags();
    ...
    public DerivativeInstrumentParties50SP2() {
        super();
    }

    public DerivativeInstrumentParties50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoDerivativeInstrumentParties(Integer noDerivativeInstrumentParties) {
        ...
        if (noDerivativeInstrumentParties != null) {
            ...
            for (int i = 0; i < derivativeInstrumentPartyGroups.length; i++) {
                derivativeInstrumentPartyGroups[i] = new DerivativeInstrumentPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public DerivativeInstrumentPartyGroup addDerivativeInstrumentPartyGroup() {
        ...
        DerivativeInstrumentPartyGroup group = new DerivativeInstrumentPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noDerivativeInstrumentParties != null && noDerivativeInstrumentParties.intValue() > 0) {
            if (INSTRUMENT_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noDerivativeInstrumentParties.intValue(); i++) {
                    DerivativeInstrumentPartyGroup group = new DerivativeInstrumentPartyGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in DerivativeInstrumentParties component release [5.0SP2].";
    }
