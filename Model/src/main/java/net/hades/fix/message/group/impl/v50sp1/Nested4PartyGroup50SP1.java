...
/*
 * Nested4PartyGroup50SP1.java
 *
 * $Id: Nested4PartyGroup50SP1.java,v 1.2 2011-04-14 23:44:52 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of Nested4PartyGroup group.
 *
...
public class Nested4PartyGroup50SP1 extends Nested4PartyGroup {
    ...
    protected static final Set<Integer> NSTD4_PARTY_SUB_GROUP_TAGS = new Nested4PartySubGroup50SP1().getFragmentAllTags();
    ...
    public Nested4PartyGroup50SP1() {
    }

    public Nested4PartyGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoNested4PartySubIDs(Integer noNested4PartySubIDs) {
        ...
        if (noNested4PartySubIDs != null) {
            ...
            for (int i = 0; i < nstd4PtysSubGroups.length; i++) {
                nstd4PtysSubGroups[i] = new Nested4PartySubGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public Nested4PartySubGroup addNstd4PtysSubGroup() {
        Nested4PartySubGroup group = new Nested4PartySubGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NSTD4_PARTY_SUB_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNested4PartySubIDs != null && noNested4PartySubIDs.intValue() > 0) {
                ...
                for (int i = 0; i < nstd4PtysSubGroups.length; i++) {
                    Nested4PartySubGroup group = new Nested4PartySubGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [Nested4PartyGroup] group version [5.0SP1].";
    }
