...
/*
 * AllocationInstructionMsg40.java
 *
 * $Id: AllocationInstructionMsg40.java,v 1.4 2011-10-21 10:31:05 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v40.AllocGroup40;
...
/**
 * FIX version 4.0 AllocationInstructionMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class AllocationInstructionMsg40 extends AllocationInstructionMsg {
    ...
    protected static final Set<Integer> ALLOC_GROUP_TAGS = new AllocGroup40().getFragmentAllTags();
    ...
    public AllocationInstructionMsg40() {
        super();
    }

    public AllocationInstructionMsg40(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public AllocationInstructionMsg40(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public AllocationInstructionMsg40(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocGroups.length; i++) {
                allocGroups[i] = new AllocGroup40(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public AllocGroup addAllocGroup() {
        AllocGroup group = new AllocGroup40(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAllocs != null && noAllocs.intValue() > 0) {
                ...
                allocGroups = new AllocGroup[noAllocs.intValue()];
                for (int i = 0; i < noAllocs.intValue(); i++) {
                    AllocGroup group = new AllocGroup40(context);
                    group.decode(message);
                    allocGroups[i] = group;
                }
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationInstructionMsg] message version [4.0].";
    }
