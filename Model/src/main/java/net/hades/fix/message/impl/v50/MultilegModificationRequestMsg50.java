...
/*
 * MultilegModificationRequestMsg50.java
 *
 * $Id: MultilegModificationRequestMsg50.java,v 1.1 2011-09-10 05:39:46 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.LegOrdGroup50;
...
import net.hades.fix.message.group.impl.v50.PreAllocMLegGroup50;
...
/**
 * FIX version 5.0 MultilegModificationRequestMsg implementation.
 *
...
public class MultilegModificationRequestMsg50 extends MultilegModificationRequestMsg {
    ...
    protected static final Set<Integer> ALLOC_GROUP_TAGS = new PreAllocMLegGroup50().getFragmentAllTags();
    ...
    protected static final Set<Integer> LEG_ORD_GROUP_TAGS = new LegOrdGroup50().getFragmentAllTags();
    ...
    public MultilegModificationRequestMsg50() {
        super();
    }

    public MultilegModificationRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MultilegModificationRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public MultilegModificationRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MultilegModificationRequestMsg50 fixml = (MultilegModificationRequestMsg50) fragment;
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocGroups.length; i++) {
                allocGroups[i] = new PreAllocMLegGroup50(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public PreAllocMLegGroup addAllocGroup() {
        PreAllocMLegGroup group = new PreAllocMLegGroup50(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public void setNoTradingSessions(Integer noTradingSessions) {
        ...
        if (noTradingSessions != null) {
            ...
            for (int i = 0; i < tradingSessionGroups.length; i++) {
                tradingSessionGroups[i] = new TradingSessionGroup50(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public TradingSessionGroup addTradingSessionGroup() {
        TradingSessionGroup group = new TradingSessionGroup50(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legOrdGroups.length; i++) {
                legOrdGroups[i] = new LegOrdGroup50(context);
            }
        }
    }
    ...
    public LegOrdGroup addLegOrdGroup() {
        LegOrdGroup group = new LegOrdGroup50(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
        ...
        if (ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAllocs != null && noAllocs.intValue() > 0) {
                ...
                for (int i = 0; i < noAllocs.intValue(); i++) {
                    PreAllocMLegGroup group = new PreAllocMLegGroup50(context);
        ...
        if (LEG_ORD_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    LegOrdGroup group = new LegOrdGroup50(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MultilegModificationRequestMsg] message version [5.0].";
    }
