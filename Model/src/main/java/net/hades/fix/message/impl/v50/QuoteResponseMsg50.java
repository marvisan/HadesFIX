...
/*
 * QuoteResponseMsg50.java
 *
 * $Id: QuoteResponseMsg50.java,v 1.11 2011-04-14 23:44:41 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 QuoteResponseMsg implementation.
 *
...
public class QuoteResponseMsg50 extends QuoteResponseMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -4795895824631042600L;
    ...
    protected static final Set<Integer> LEG_QUOTE_GROUP_TAGS = new LegQuoteGroup50().getFragmentAllTags();
    ...
    public QuoteResponseMsg50() {
        super();
    }
    
    public QuoteResponseMsg50(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }
 
    public QuoteResponseMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        instrument = new Instrument50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    
    public QuoteResponseMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteResponseMsg50 fixml = (QuoteResponseMsg50) fragment;
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteGroups.length; i++) {
                legQuoteGroups[i] = new LegQuoteGroup50(context);
            }
        }
    }
    ...
    public LegQuoteGroup addLegQuoteGroup() {
        LegQuoteGroup group = new LegQuoteGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (LEG_QUOTE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                message.reset();
                legQuoteGroups = new LegQuoteGroup50[noLegs.intValue()];
                for (int i = 0; i < legQuoteGroups.length; i++) {
                    LegQuoteGroup component = new LegQuoteGroup50(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteResponseMsg] message version [5.0].";
    }
