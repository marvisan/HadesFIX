...
/*
 * TradingSessionStatusMsg50.java
 *
 * $Id: TradingSessionStatusMsg50.java,v 1.1 2011-04-23 00:19:04 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 TradingSessionStatusMsg implementation.
 *
...
@XmlType(propOrder = {"header", "instrument"})
@XmlAccessorType(XmlAccessType.NONE)
public class TradingSessionStatusMsg50 extends TradingSessionStatusMsg {
    ...
    public TradingSessionStatusMsg50() {
        super();
    }

    public TradingSessionStatusMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradingSessionStatusMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradingSessionStatusMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradingSessionStatusMsg50 fixml = (TradingSessionStatusMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradingSessionStatusMsg] message version [5.0].";
    }
