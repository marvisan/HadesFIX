...
/**
 * FIX version 5.0 CollateralInquiryMsg implementation.
 *
...
public class CollateralInquiryMsg50 extends CollateralInquiryMsg {
    ...
    public CollateralInquiryMsg50() {
        super();
    }

    public CollateralInquiryMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralInquiryMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralInquiryMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralInquiryMsg50 fixml = (CollateralInquiryMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralInquiryMsg] message version [5.0].";
    }
