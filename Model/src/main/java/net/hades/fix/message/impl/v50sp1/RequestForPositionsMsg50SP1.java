...
/*
 * RequestForPositionsMsg50SP1.java
 *
...
/**
 * FIX version 5.0SP1 RequestForPositionsMsg implementation.
 *
...
public class RequestForPositionsMsg50SP1 extends RequestForPositionsMsg {
    ...
    public RequestForPositionsMsg50SP1() {
        super();
    }

    public RequestForPositionsMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RequestForPositionsMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public RequestForPositionsMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        RequestForPositionsMsg50SP1 fixml = (RequestForPositionsMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RequestForPositionsMsg] message version [5.0SP1].";
    }
