...
/*
 * ListCancelRequestMsg50SP1.java
 *
 * $Id: ListCancelRequestMsg50SP1.java,v 1.2 2011-04-14 23:44:56 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 ListCancelRequestMsg implementation.
 *
...
public class ListCancelRequestMsg50SP1 extends ListCancelRequestMsg {
    ...
    public ListCancelRequestMsg50SP1() {
        super();
    }

    public ListCancelRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ListCancelRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ListCancelRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ListCancelRequestMsg50SP1 fixml = (ListCancelRequestMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListCancelRequestMsg] message version [5.0SP1].";
    }
