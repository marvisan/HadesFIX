...
/*
 * RequestForPositionsAckMsg50.java
 *
...
/**
 * FIX version 5.0 RequestForPositionsAckMsg implementation.
 *
...
public class RequestForPositionsAckMsg50 extends RequestForPositionsAckMsg {
    ...
    public RequestForPositionsAckMsg50() {
        super();
    }

    public RequestForPositionsAckMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RequestForPositionsAckMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public RequestForPositionsAckMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        RequestForPositionsAckMsg50 fixml = (RequestForPositionsAckMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RequestForPositionsAckMsg] message version [5.0].";
    }
