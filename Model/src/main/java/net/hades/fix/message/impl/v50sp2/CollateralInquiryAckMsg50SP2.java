...
/*
 * CollateralInquiryAckMsg50SP2.java
 *
...
/**
 * FIX version 5.0SP2 CollateralInquiryAckMsg implementation.
 *
...
public class CollateralInquiryAckMsg50SP2 extends CollateralInquiryAckMsg {
    ...
    public CollateralInquiryAckMsg50SP2() {
        super();
    }

    public CollateralInquiryAckMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralInquiryAckMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralInquiryAckMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralInquiryAckMsg50SP2 fixml = (CollateralInquiryAckMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralInquiryAckMsg] message version [5.0SP2].";
    }
