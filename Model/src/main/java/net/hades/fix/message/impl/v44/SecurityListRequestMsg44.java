...
/*
 * SecurityListRequestMsg44.java
 *
 * $Id: SecurityListRequestMsg44.java,v 1.1 2011-04-27 03:47:47 vrotaru Exp $
 */
...
/**
 * FIX version 4.4 SecurityListRequestMsg implementation.
 *
...
public class SecurityListRequestMsg44 extends SecurityListRequestMsg {
    ...
    public SecurityListRequestMsg44() {
        super();
    }

    public SecurityListRequestMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityListRequestMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityListRequestMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityListRequestMsg44 fixml = (SecurityListRequestMsg44) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityListRequestMsg] message version [4.4].";
    }
