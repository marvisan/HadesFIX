...
/*
 * QuoteResponseMsg50SP2.java
 *
 * $Id: QuoteResponseMsg50SP2.java,v 1.11 2011-04-14 23:44:28 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 EmailMsg implementation.
 *
...
public class QuoteResponseMsg50SP2 extends QuoteResponseMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -6984362880895814773L;
    ...
    protected static final Set<Integer> LEG_QUOTE_GROUP_TAGS = new LegQuoteGroup50SP2().getFragmentAllTags();
    ...
    public QuoteResponseMsg50SP2() {
        super();
    }
    
    public QuoteResponseMsg50SP2(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public QuoteResponseMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        instrument = new Instrument50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    
    public QuoteResponseMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteResponseMsg50SP2 fixml = (QuoteResponseMsg50SP2) fragment;
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteGroups.length; i++) {
                legQuoteGroups[i] = new LegQuoteGroup50SP2(context);
            }
        }
    }
    ...
    public LegQuoteGroup addLegQuoteGroup() {
        LegQuoteGroup group = new LegQuoteGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (LEG_QUOTE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                legQuoteGroups = new LegQuoteGroup[noLegs.intValue()];
                for (int i = 0; i < legQuoteGroups.length; i++) {
                    LegQuoteGroup component = new LegQuoteGroup50SP2(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteResponseMsg] message version [5.0SP2].";
    }
