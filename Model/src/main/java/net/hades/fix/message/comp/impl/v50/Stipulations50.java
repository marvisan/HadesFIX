 ...
 * Stipulations50.java
 *
 * $Id: Stipulations50.java,v 1.7 2011-04-14 23:44:50 vrotaru Exp $
 */
package net.hades.fix.message.comp.impl.v50;

import net.hades.fix.message.FragmentContext;
import net.hades.fix.message.group.impl.v50.StipulationsGroup50;
...
/**
 * FIX version 5.0 implementation of Stipulations component.
 *
 ...
 */
@XmlTransient
public class Stipulations50 extends Stipulations {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -737792255780539942L;

    protected static final Set<Integer> START_COMP_TAGS;

    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> STIPS_GROUP_TAGS = new StipulationsGroup50().getFragmentAllTags();
    ...
    public Stipulations50() {
        super();
    }

    public Stipulations50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoStipulations(Integer noStipulations) {
        ...
        if (noStipulations != null) {
            ...
            for (int i = 0; i < stipulationsGroups.length; i++) {
                stipulationsGroups[i] = new StipulationsGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public StipulationsGroup addStipulationsGroup() {
        ...
        StipulationsGroup group = new StipulationsGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (STIPS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noStipulations != null && noStipulations.intValue() > 0) {
                ...
                for (int i = 0; i < noStipulations.intValue(); i++) {
                    StipulationsGroup group = new StipulationsGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [Stipulations] component version [5.0].";
    }
