...
/*
 * QuoteStatusRequestMsg50SP1.java
 *
 * $Id: QuoteStatusRequestMsg50SP1.java,v 1.11 2011-04-14 23:44:56 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 QuoteStatusRequestMsg implementation.
 *
...
@XmlType(propOrder = {"header", "instrument", "financingDetails", "underlyingInstruments",
    "instrumentLegs", "partyIDGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class QuoteStatusRequestMsg50SP1 extends QuoteStatusRequestMsg {
    ...
    public QuoteStatusRequestMsg50SP1() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        instrument = new Instrument50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    
    public QuoteStatusRequestMsg50SP1(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteStatusRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    ...
    public QuoteStatusRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteStatusRequestMsg] message version [5.0SP1].";
    }
