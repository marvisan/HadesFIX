...
/*
 * OrderMassCancelRequestMsg50SP1.java
 *
 * $Id: OrderMassCancelRequestMsg50SP1.java,v 1.2 2011-05-02 05:16:37 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 OrderMassCancelRequestMsg implementation.
 *
...
public class OrderMassCancelRequestMsg50SP1 extends OrderMassCancelRequestMsg {
    ...
    public OrderMassCancelRequestMsg50SP1() {
        super();
    }

    public OrderMassCancelRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderMassCancelRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderMassCancelRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderMassCancelRequestMsg50SP1 fixml = (OrderMassCancelRequestMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderMassCancelRequestMsg] message version [5.0SP1].";
    }
