...
/*
 * AllocationInstructionMsg50.java
 *
 * $Id: AllocationInstructionMsg50.java,v 1.3 2011-04-14 23:44:41 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 AllocationInstructionMsg implementation.
 *
...
public class AllocationInstructionMsg50 extends AllocationInstructionMsg {
    ...
    public AllocationInstructionMsg50() {
        super();
    }

    public AllocationInstructionMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AllocationInstructionMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AllocationInstructionMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationInstructionMsg50 fixml = (AllocationInstructionMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationInstructionMsg] message version [5.0].";
    }
