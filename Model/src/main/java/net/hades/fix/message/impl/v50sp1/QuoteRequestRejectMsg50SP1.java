...
/*
 * QuoteRequestRejectMsg50SP1.java
 *
 * $Id: QuoteRequestRejectMsg50SP1.java,v 1.10 2011-04-14 23:44:55 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.QuoteRequestRejectGroup50SP1;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.xml.codec.jaxb.adapter.FixBooleanAdapter;

/**
 * FIX version 5.0SP1 QuoteRequestRejectMsg implementation.
 *
...
public class QuoteRequestRejectMsg50SP1 extends QuoteRequestRejectMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -4694555692721556547L;
    ...
    protected static final Set<Integer> QUOT_REQ_REJ_GROUP_TAGS = new QuoteRequestRejectGroup50SP1().getFragmentAllTags();
    ...
    public QuoteRequestRejectMsg50SP1() {
        super();
    }
    
    public QuoteRequestRejectMsg50SP1(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public QuoteRequestRejectMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public QuoteRequestRejectMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteRequestRejectMsg50SP1 fixml = (QuoteRequestRejectMsg50SP1) fragment;
    ...
    public void setNoRelatedSym(Integer noRelatedSym) {
        ...
        if (noRelatedSym != null) {
            ...
            for (int i = 0; i < quoteRequestRejectGroups.length; i++) {
                quoteRequestRejectGroups[i] = new QuoteRequestRejectGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public QuoteRequestRejectGroup addQuoteRequestRejectGroup() {
        QuoteRequestRejectGroup group = new QuoteRequestRejectGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (QUOT_REQ_REJ_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRelatedSym != null && noRelatedSym.intValue() > 0) {
                ...
                quoteRequestRejectGroups = new QuoteRequestRejectGroup[noRelatedSym.intValue()];
                for (int i = 0; i < quoteRequestRejectGroups.length; i++) {
                    QuoteRequestRejectGroup group = new QuoteRequestRejectGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteRequestRejectMsg] message version [5.0SP1].";
    }
