...
/*
 * QuoteEntryAckGroup43.java
 *
 * $Id: QuoteEntryAckGroup43.java,v 1.7 2011-04-14 23:44:48 vrotaru Exp $
 */
...
/**
 * FIX 4.3 implementation of QuoteEntryAckGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.7 $
 * @created 12/02/2009, 7:22:35 PM
 */
public class QuoteEntryAckGroup43 extends QuoteEntryAckGroup {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -6784925939437780349L;
    ...
    public QuoteEntryAckGroup43() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public QuoteEntryAckGroup43(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;  
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteEntryAckGroup] group version [4.3].";
    }
