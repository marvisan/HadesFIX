...
/*
 * InstrmtLegExecGroup.java
 *
 * $Id: InstrmtLegExecGroup.java,v 1.4 2011-10-13 07:18:34 vrotaru Exp $
 */
...
/**
 * Instrument leg group for ExecutionReport message.
 *
...
public abstract class InstrmtLegExecGroup extends Group {
    ...
    /**
     * TagNum = 685. Starting with 5.0SP1 version.
     */
    ...
    /**
     * TagNum = 1366. Starting with 5.0SP1 version.
     */
    protected String legAllocID;

    /**
     * TagNum = 670. Starting with 5.0SP1 version.
     */
     ...
     */
    protected NestedParties3 nestedParties3;
    ...
    /**
     * TagNum = 637. Starting with 4.3 version.
     */
    ...
    public InstrmtLegExecGroup() {
    }

    public InstrmtLegExecGroup(FragmentContext context) {
        super(context);
    }
    ...
    protected byte[] encodeFragmentAll() throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (nestedParties3 != null) {
                bao.write(nestedParties3.encode(MsgSecureType.ALL_FIELDS));
            }
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [InstrmtLegExecGroup] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        ...
        printTagValue(b, nestedParties3);
