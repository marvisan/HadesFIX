...
/*
 * QuoteCancelMsg50SP1.java
 *
 * $Id: QuoteCancelMsg50SP1.java,v 1.10 2011-04-14 23:44:56 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.QuoteCancelGroup50SP1;
...
/**
 * FIX version 5.0SP1 QuoteCancelMsg implementation.
 *
...
public class QuoteCancelMsg50SP1 extends QuoteCancelMsg {
    ...
    protected static final Set<Integer> QUOTE_CANCEL_GROUP_TAGS = new QuoteCancelGroup50SP1().getFragmentAllTags();
    ...
    public QuoteCancelMsg50SP1() {
        super();
    }
    
    public QuoteCancelMsg50SP1(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public QuoteCancelMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public QuoteCancelMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteCancelMsg50SP1 fixml = (QuoteCancelMsg50SP1) fragment;
    ...
    public void setNoQuoteEntries(Integer noQuoteEntries) {
        ...
        if (noQuoteEntries != null) {
            ...
            for (int i = 0; i < quoteCancelEntries.length; i++) {
                quoteCancelEntries[i] = new QuoteCancelGroup50SP1(context);
            }
        }
    }
    ...
    public QuoteCancelGroup addQuoteCancelEntry() {
        QuoteCancelGroup group = new QuoteCancelGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (QUOTE_CANCEL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noQuoteEntries != null && noQuoteEntries.intValue() > 0) {
                ...
                for (int i = 0; i < noQuoteEntries.intValue(); i++) {
                    QuoteCancelGroup group = new QuoteCancelGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteCancelMsg] message version [5.0SP1].";
    }
