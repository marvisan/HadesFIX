...
/*
 * OrderMassStatusRequestMsg50SP1.java
 *
 * $Id: OrderMassStatusRequestMsg50SP1.java,v 1.1 2011-05-09 08:21:13 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 OrderMassStatusRequestMsg implementation.
 *
...
public class OrderMassStatusRequestMsg50SP1 extends OrderMassStatusRequestMsg {
    ...
    public OrderMassStatusRequestMsg50SP1() {
        super();
    }

    public OrderMassStatusRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderMassStatusRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderMassStatusRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderMassStatusRequestMsg50SP1 fixml = (OrderMassStatusRequestMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderMassStatusRequestMsg] message version [5.0SP1].";
    }
