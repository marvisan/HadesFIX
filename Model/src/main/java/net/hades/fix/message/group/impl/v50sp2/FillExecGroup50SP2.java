...
/*
 * FillExecGroup50SP2.java
 *
 * $Id: FillExecGroup50SP2.java,v 1.2 2011-04-14 23:44:30 vrotaru Exp $
 */
...
import net.hades.fix.message.comp.impl.v50sp2.NestedParties450SP2;
...
/**
 * FIX 5.0SP2 implementation of FillExecGroup group.
 *
...
public class FillExecGroup50SP2 extends FillExecGroup {
    ...
    protected static final Set<Integer> NESTED_PARTIES4_COMP_TAGS = new NestedParties450SP2().getFragmentAllTags();
    ...
    public FillExecGroup50SP2() {
        super();
    }

    public FillExecGroup50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNestedParties4() {
        this.nestedParties4 = new NestedParties450SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setNested4PartyIDGroups(Nested4PartyGroup[] nested4PartyIDGroups) {
        if (nested4PartyIDGroups != null) {
            ...
            ((NestedParties450SP2) nestedParties4).setNested4PartyIDGroups(nested4PartyIDGroups);
        }
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NESTED_PARTIES4_COMP_TAGS.contains(tag.tagNum)) {
            if (nestedParties4 == null) {
                nestedParties4 = new NestedParties450SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [FillExecGroup] group version [5.0SP2].";
    }
