 ...
 * IOIMsg50SP1.java
 *
 * $Id: IOIMsg50SP1.java,v 1.12 2011-04-14 23:44:57 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.IOIQualifierGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.LegIOIGroup50SP1;
...
/**
 * FIX version 5.0SP1 IOIMsg implementation.
 *
...
public class IOIMsg50SP1 extends IOIMsg {
    ...
    protected static final Set<Integer> IOI_QUALIFIER_GROUP_TAGS = new IOIQualifierGroup50SP1().getFragmentAllTags();
    ...
    protected static final Set<Integer> LEG_IOI_GROUP_TAGS = new LegIOIGroup50SP1().getFragmentAllTags();
    ...
    public IOIMsg50SP1(Header header, ByteBuffer rawMsg)
    ...
    public IOIMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        instrument = new Instrument50SP1(context);
    }

    public IOIMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        IOIMsg50SP1 fixml = (IOIMsg50SP1) fragment;
    ...
    public void setInstrument() {
        this.instrument = new Instrument50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setPartyGroups(PartyGroup[] partyGroups) {
        if (partyGroups != null) {
            ...
            ((Parties50SP1) parties).setPartyIDGroups(partyGroups);
        }
    }
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legIOIGroups.length; i++) {
                legIOIGroups[i] = new LegIOIGroup50SP1(context);
            }
        }
    }
    ...
    public LegIOIGroup addLegIOIGroup() {
        LegIOIGroup group = new LegIOIGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoIOIQualifiers(Integer noIOIQualifiers) {
        ...
        if (noIOIQualifiers != null) {
            ...
            for (int i = 0; i < ioiQualifiers.length; i++) {
                ioiQualifiers[i] = new IOIQualifierGroup50SP1(context);
            }
        }
    }
    ...
    public IOIQualifierGroup addIoiQualifier() {
        ...
        IOIQualifierGroup group = new IOIQualifierGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (IOI_QUALIFIER_GROUP_TAGS.contains(tag.tagNum)) {
            if (noIOIQualifiers != null && noIOIQualifiers.intValue() > 0) {
                ...
                for (int i = 0; i < ioiQualifiers.length; i++) {
                    IOIQualifierGroup group = new IOIQualifierGroup50SP1(context);
                    group.decode(message);
        ...
        if (LEG_IOI_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    LegIOIGroup group = new LegIOIGroup50SP1(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [IOIMsg] message version [5.0SP1].";
    }
