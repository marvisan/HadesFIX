 ...
 * NewsMsg50SP2.java
 *
 * $Id: NewsMsg50SP2.java,v 1.13 2011-04-14 23:44:28 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.LinesOfTextGroup50SP2;
...
import net.hades.fix.message.comp.impl.v50sp2.NewsRefGrp50SP2;
...
import net.hades.fix.message.group.impl.v50sp2.RoutingIDGroup50SP2;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.Urgency;
import net.hades.fix.message.xml.codec.jaxb.type.v50sp2.InstrumentType50SP2;

/**
 * FIX version 5.0SP1 NewsMsg implementation.
 *
...
@XmlType(propOrder = {"header", "applicationSequenceControl", "newsRefGroups", "routingIDGroups",
    "instrumentsType", "instrumentLegs", "underlyingInstruments", "linesOfTextGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class NewsMsg50SP2 extends NewsMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -1038944314904790974L;

    protected static final Set<Integer> START_COMP_TAGS;

    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> LINES_OF_TEXT_GROUP_TAGS = new LinesOfTextGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> ROUTING_ID_GROUP_TAGS = new RoutingIDGroup50SP2().getFragmentAllTags();
    ...
    protected static final Set<Integer> UNDLY_INSTRUMENT_COMP_TAGS = new UnderlyingInstrument50SP2().getFragmentAllTags();
    protected static final Set<Integer> APPL_SEQ_CONTROL_COMP_TAGS = new ApplicationSequenceControl50SP2().getFragmentAllTags();
    protected static final Set<Integer> NEWS_REF_GRP_COMP_TAGS = new NewsRefGrp50SP2().getFragmentAllTags();
    ...
    static {
        ...
        ALL_TAGS.addAll(NEWS_REF_GRP_COMP_TAGS);
        ...
        START_COMP_TAGS.addAll(NEWS_REF_GRP_COMP_TAGS);
    }
    ...
    private InstrumentType50SP2[] instrumentsType;
    ...
    public NewsMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public NewsMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public NewsMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewsMsg50SP2 fixml = (NewsMsg50SP2) fragment;
        if (fixml.getApplicationSequenceControl() != null) {
            applicationSequenceControl = fixml.getApplicationSequenceControl();
        }
        if (fixml.getNewsID() != null) {
            newsID = fixml.getNewsID();
        }
        if (fixml.getNewsRefGrp() != null) {
            newsRefGrp = fixml.getNewsRefGrp();
        }
        if (fixml.getNewsCategory() != null) {
            newsCategory = fixml.getNewsCategory();
        }
        if (fixml.getLanguageCode() != null) {
            languageCode = fixml.getLanguageCode();
        }
    ...
    public void setNewsRefGrp() {
        this.newsRefGrp = new NewsRefGrp50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }

    @Override
    public void clearNewsRefGrp() {
        this.newsRefGrp = null;
    }

    @XmlElementRef
    public NewsRefGroup[] getNewsRefGroups() {
        return newsRefGrp == null ? null : newsRefGrp.getNewsRefGroups();
    }

    public void setNewsRefGroups(NewsRefGroup[] newsRefGrps) {
        if (newsRefGrps != null) {
            if (newsRefGrp == null) {
                setNewsRefGrp();
            }
            ((NewsRefGrp50SP2) newsRefGrp).setNewsRefGroups(newsRefGrps);
        }
    }
    ...
    public void setNoRoutingIDs(Integer noRoutingIDs) {
        ...
        if (noRoutingIDs != null) {
            ...
            for (int i = 0; i < routingIDGroups.length; i++) {
                routingIDGroups[i] = new RoutingIDGroup50SP2(context);
            }
        }
    }
    ...
    public RoutingIDGroup addRoutingIDGroup() {
        ...
        RoutingIDGroup group = new RoutingIDGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoRelatedSyms(Integer noRelatedSyms) {
        ...
        if (noRelatedSyms != null) {
            ...
            for (int i = 0; i < instruments.length; i++) {
                instruments[i] = new Instrument50SP2(context);
            }
        }
    }
    ...
    public Instrument addInstrument() {
        Instrument group = new Instrument50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    @XmlElementRef
    public InstrumentType50SP2[] getInstrumentsType() {
        if (instruments != null && instruments.length > 0) {
            instrumentsType = new InstrumentType50SP2[instruments.length];
            for (int i = 0; i < instruments.length; i++) {
                instrumentsType[i] = new InstrumentType50SP2((Instrument50SP2) instruments[i]);
            }
        }
    ...
    public void setInstrumentsType(InstrumentType50SP2[] instrumentsType) {
    ...
    public void setNoLinesOfText(Integer noLinesOfText) {
        ...
        if (noLinesOfText != null) {
            ...
            for (int i = 0; i < linesOfTextGroups.length; i++) {
                linesOfTextGroups[i] = new LinesOfTextGroup50SP2(context);
            }
        }
    }
    ...
    public LinesOfTextGroup addLinesOfTextGroup() {
        LinesOfTextGroup group = new LinesOfTextGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (NEWS_REF_GRP_COMP_TAGS.contains(tag.tagNum)) {
            if (newsRefGrp == null) {
                newsRefGrp = new NewsRefGrp50SP2(context);
            }
            newsRefGrp.decode(tag, message);
        }
        if (ROUTING_ID_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRoutingIDs != null && noRoutingIDs.intValue() > 0) {
                ...
                for (int i = 0; i < noRoutingIDs.intValue(); i++) {
                    RoutingIDGroup group = new RoutingIDGroup50SP2(context);
        ...
        if (INSTRUMENT_COMP_TAGS.contains(tag.tagNum)) {
            if (noRelatedSyms != null && noRelatedSyms.intValue() > 0) {
                ...
                for (int i = 0; i < noRelatedSyms.intValue(); i++) {
                    Instrument group = new Instrument50SP2(context);
                    group.decode(message);
                    instruments[i] = group;
                }
            }
        ...
        if (LINES_OF_TEXT_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLinesOfText != null && noLinesOfText.intValue() > 0) {
                ...
                for (int i = 0; i < noLinesOfText.intValue(); i++) {
                    LinesOfTextGroup group = new LinesOfTextGroup50SP2(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewsMsg] message version [5.0SP2].";
    }
