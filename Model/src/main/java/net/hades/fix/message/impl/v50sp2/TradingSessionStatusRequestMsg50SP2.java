...
/*
 * TradingSessionStatusRequestMsg50SP2.java
 *
 * $Id: TradingSessionStatusRequestMsg50SP2.java,v 1.1 2011-04-22 01:59:22 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 TradingSessionStatusRequestMsg implementation.
 *
...
public class TradingSessionStatusRequestMsg50SP2 extends TradingSessionStatusRequestMsg {
    ...
    public TradingSessionStatusRequestMsg50SP2() {
        super();
    }

    public TradingSessionStatusRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradingSessionStatusRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradingSessionStatusRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradingSessionStatusRequestMsg50SP2 fixml = (TradingSessionStatusRequestMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradingSessionStatusRequestMsg] message version [5.0SP2].";
    }
