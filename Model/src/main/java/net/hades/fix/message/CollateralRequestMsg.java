 ...
 * An initiator that requires collateral from a respondent sends a Collateral Request. The initiator can be either
 * counterparty to a trade in a two party model or an intermediary such as an ATS or clearinghouse in a three party
 * model. A Collateral Assignment is expected as a response to a request for collateral.
 *
...
public abstract class CollateralRequestMsg extends FIXMsg {
    ...
    public CollateralRequestMsg() {
        super();
    }

    public CollateralRequestMsg(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralRequestMsg(BeginString beginString) throws InvalidMsgException {
        super(MsgType.CollateralRequest.getValue(), beginString);
    }

    public CollateralRequestMsg(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
        super(MsgType.CollateralRequest.getValue(), beginString, applVerID);
    }
    ...
    @TagNumRef(tagNum=TagNum.CollReqID, required=true)
   ...
   /**
    ...
    protected void validateRequiredTags() throws TagNotPresentException {
        ...
        if (collReqID == null || collReqID.trim().isEmpty()) {
            errorMsg.append(" [CollReqID]");
            hasMissingTag = true;
        }
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {            
           ...
           case SettlSessSubID:
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [CollateralRequestMsg] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("{CollateralRequestMsg=");
