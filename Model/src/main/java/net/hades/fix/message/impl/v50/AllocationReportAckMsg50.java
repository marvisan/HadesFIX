...
/**
 * FIX version 5.0 AllocationReportAckMsg implementation.
 *
...
public class AllocationReportAckMsg50 extends AllocationReportAckMsg {
    ...
    public AllocationReportAckMsg50() {
        super();
    }

    public AllocationReportAckMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AllocationReportAckMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AllocationReportAckMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationReportAckMsg50 fixml = (AllocationReportAckMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationReportAckMsg] message version [5.0].";
    }
