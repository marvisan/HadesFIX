...
/*
 * CrossOrderModificationRequestMsg50.java
 *
 * $Id: CrossOrderModificationRequestMsg50.java,v 1.1 2011-05-17 09:28:25 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 CrossOrderModificationRequestMsg implementation.
 *
...
public class CrossOrderModificationRequestMsg50 extends CrossOrderModificationRequestMsg {
    ...
    public CrossOrderModificationRequestMsg50() {
        super();
    }

    public CrossOrderModificationRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CrossOrderModificationRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CrossOrderModificationRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CrossOrderModificationRequestMsg50 fixml = (CrossOrderModificationRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CrossOrderModificationRequestMsg] message version [5.0].";
    }
