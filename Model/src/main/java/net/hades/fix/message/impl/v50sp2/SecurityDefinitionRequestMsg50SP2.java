...
/*
 * SecurityDefinitionRequestMsg50SP2.java
 *
 * $Id: SecurityDefinitionRequestMsg50SP2.java,v 1.2 2011-04-16 09:39:02 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 SecurityDefinitionRequestMsg implementation.
 *
...
public class SecurityDefinitionRequestMsg50SP2 extends SecurityDefinitionRequestMsg {
    ...
    public SecurityDefinitionRequestMsg50SP2() {
        super();
    }

    public SecurityDefinitionRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityDefinitionRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityDefinitionRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityDefinitionRequestMsg50SP2 fixml = (SecurityDefinitionRequestMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityDefinitionRequestMsg] message version [5.0SP2].";
    }
