...
/*
 * UnderlyingInstrument50SP1.java
 *
 * $Id: UnderlyingInstrument50SP1.java,v 1.9 2011-04-14 23:44:46 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of UnderlyingInstrument component.
 *
...
public class UnderlyingInstrument50SP1 extends UnderlyingInstrument {
    ...
    protected static final Set<Integer> UNDLY_SEC_ALT_ID_GROUP_TAGS = new UnderlyingSecurityAltIDGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> UNDLY_STIP_GROUP_TAGS = new UnderlyingStipulations50SP1().getFragmentAllTags();
    protected static final Set<Integer> UNDLY_INSTR_PARTIES_COMP_TAGS = new UndlyInstrumentParties50SP1().getFragmentAllTags();
    ...
    public UnderlyingInstrument50SP1() {
        super();
    }

    public UnderlyingInstrument50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoUnderlyingSecurityAltID(Integer noUnderlyingSecurityAltID) {
        ...
        if (noUnderlyingSecurityAltID != null) {
            ...
            for (int i = 0; i < underlyingSecurityAltIDGroups.length; i++) {
                underlyingSecurityAltIDGroups[i] = new UnderlyingSecurityAltIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UnderlyingSecurityAltIDGroup addUnderlyingSecurityAltIDGroup() {
        ...
        UnderlyingSecurityAltIDGroup group = new UnderlyingSecurityAltIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setUnderlyingStipsGroups(UnderlyingStipsGroup[] underlyingStipsGroups) {
        if (underlyingStipsGroups != null) {
            ...
            underlyingStipulations = new UnderlyingStipulations50SP1(context);
            ((UnderlyingStipulations50SP1) underlyingStipulations).setUnderlyingStipsGroups(underlyingStipsGroups);
        }
    }
    ...
    public void setUnderlyingStipulations() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        this.underlyingStipulations = new UnderlyingStipulations50SP1(context);
    }
    ...
    public void setUndlyInstrumentParties() {
        undlyInstrumentParties = new UndlyInstrumentParties50SP1();
    }
    ...
    public void setUndlyInstrumentPartyIDGroups(UndlyInstrumentPartyIDGroup[] undlyInstrumentPartyIDGroups) {
        if (undlyInstrumentPartyIDGroups != null) {
            FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
            undlyInstrumentParties = new UndlyInstrumentParties50SP1(context);
            undlyInstrumentParties.setNoUndlyInstrumentParties(undlyInstrumentPartyIDGroups.length);
            ((UndlyInstrumentParties50SP1) undlyInstrumentParties).setUndlyInstrumentPartyIDGroups(undlyInstrumentPartyIDGroups);
        }
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [UnderlyingInstrument] component version [5.0SP1].";
    }
