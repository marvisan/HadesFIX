...
/*
 * BidReqComponentGroup.java
 *
 * $Id: BidReqComponentGroup.java,v 1.1 2011-04-14 11:44:44 vrotaru Exp $
 */
...
/**
 * Bid request component group data.
 *
...
public abstract class BidReqComponentGroup extends Group {
    ...
    public BidReqComponentGroup() {
    }

    public BidReqComponentGroup(FragmentContext context) {
        super(context);
    }
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [BidReqComponentGroup] fields.";
                LOGGER.severe(error);
