...
/*
 * Nested2PartyGroup50.java
 *
 * $Id: Nested2PartyGroup50.java,v 1.2 2011-04-14 23:44:36 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of Nested2PartyGroup group.
 *
...
public class Nested2PartyGroup50 extends Nested2PartyGroup {
    ...
    protected static final Set<Integer> NSTD2_PARTY_SUB_GROUP_TAGS = new Nested2PartySubGroup50().getFragmentAllTags();
    ...
    public Nested2PartyGroup50() {
    }

    public Nested2PartyGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoNested2PartySubIDs(Integer noNested2PartySubIDs) {
        ...
        if (noNested2PartySubIDs != null) {
            ...
            for (int i = 0; i < nstd2PtysSubGroups.length; i++) {
                nstd2PtysSubGroups[i] = new Nested2PartySubGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public Nested2PartySubGroup addNstd2PtysSubGroup() {    
        Nested2PartySubGroup group = new Nested2PartySubGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NSTD2_PARTY_SUB_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNested2PartySubIDs != null && noNested2PartySubIDs.intValue() > 0) {
                ...
                for (int i = 0; i < nstd2PtysSubGroups.length; i++) {
                    Nested2PartySubGroup group = new Nested2PartySubGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [Nested2PartyGroup] group version [5.0].";
    }
