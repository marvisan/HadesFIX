...
/*
 * QuoteEntryGroup.java
 *
 * $Id: QuoteEntryGroup.java,v 1.9 2010-11-23 10:20:16 vrotaru Exp $
 */
...
public abstract class QuoteEntryGroup extends Group {
    ...
    public QuoteEntryGroup() {
    }
    
    public QuoteEntryGroup(FragmentContext context) {
        super(context);
    }
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [QuoteEntryGroup] fields.";
                LOGGER.severe(error);
