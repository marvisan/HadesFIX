 ...
 * MDIncGroup43.java
 *
 * $Id: MDIncGroup43.java,v 1.8 2011-04-14 23:44:48 vrotaru Exp $
 */
 ...
 */
public class MDIncGroup43 extends MDIncGroup {
    ...
    public MDIncGroup43(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    @XmlElementRef(namespace = "http://www.fixprotocol.org/FIXML-4-4")
    @Override
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MDIncGroup] group version [4.3].";
    }
