...
/*
 * QuoteRequestGroup50SP1.java
 *
 * $Id: QuoteRequestGroup50SP1.java,v 1.10 2011-04-14 23:44:53 vrotaru Exp $
 */
...
public class QuoteRequestGroup50SP1 extends QuoteRequestGroup {
    ...
    protected static final Set<Integer> LEG_QUOTE_SYMBOL_GROUP_TAGS = new QuoteRequestLegGroup50SP1().getFragmentAllTags();
    ...
    public void setNoUnderlyings(Integer noUnderlyings) {
        ...
        if (noUnderlyings != null) {
            ...
            for (int i = 0; i < underlyingInstruments.length; i++) {
                underlyingInstruments[i] = new UnderlyingInstrument50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteSymbolGroups.length; i++) {
                legQuoteSymbolGroups[i] = new QuoteRequestLegGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteRelatedSymbolGroup] group version [5.0SP1].";
    }
