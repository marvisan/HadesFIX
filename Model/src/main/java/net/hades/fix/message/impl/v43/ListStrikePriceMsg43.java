...
/*
 * ListStrikePriceMsg43.java
 *
 * $Id: ListStrikePriceMsg43.java,v 1.1 2011-04-15 04:37:44 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v43.InstrmtStrikePriceGroup43;
...
/**
 * FIX version 4.3 ListStrikePriceMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class ListStrikePriceMsg43 extends ListStrikePriceMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> INSTRMT_STRK_PX_GROUP_TAGS = new InstrmtStrikePriceGroup43().getFragmentAllTags();
    ...
    public ListStrikePriceMsg43() {
        super();
    }

    public ListStrikePriceMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListStrikePriceMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListStrikePriceMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoStrikes(Integer noStrikes) {
        ...
        if (noStrikes != null) {
            ...
            for (int i = 0; i < instrmtStrikePriceGroups.length; i++) {
                instrmtStrikePriceGroups[i] = new InstrmtStrikePriceGroup43(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public InstrmtStrikePriceGroup addInstrmtStrikePriceGroup() {
        InstrmtStrikePriceGroup group = new InstrmtStrikePriceGroup43(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (INSTRMT_STRK_PX_GROUP_TAGS.contains(tag.tagNum)) {
            if (noStrikes != null && noStrikes.intValue() > 0) {
                ...
                instrmtStrikePriceGroups = new InstrmtStrikePriceGroup[noStrikes.intValue()];
                for (int i = 0; i < noStrikes.intValue(); i++) {
                    InstrmtStrikePriceGroup group = new InstrmtStrikePriceGroup43(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListStrikePriceMsg] message version [4.3].";
    }
