...
/*
 * BaseTradingRules50SP2.java
 *
 * $Id: BaseTradingRules50SP2.java,v 1.2 2011-04-20 00:32:34 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.LotTypeRuleGroup50SP2;
import net.hades.fix.message.group.impl.v50sp2.TickRuleGroup50SP2;
...
/**
 * FIX 5.0SP2 implementation of BaseTradingRules component.
 * 
...
public class BaseTradingRules50SP2 extends BaseTradingRules {
    ...
    protected static final Set<Integer> TICK_RULE_GROUP_TAGS = new TickRuleGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> LOT_TYPE_RULE_GROUP_TAGS = new LotTypeRuleGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> PRICE_LIMITS_COMP_TAGS = new PriceLimits50SP2().getFragmentAllTags();
    ...
    public BaseTradingRules50SP2() {
        super();
    }

    public BaseTradingRules50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoTickRules(Integer noTickRules) {
        ...
        if (noTickRules != null) {
            ...
            for (int i = 0; i < tickRuleGroups.length; i++) {
                tickRuleGroups[i] = new TickRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public TickRuleGroup addTickRuleGroup() {
        TickRuleGroup group = new TickRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoLotTypeRules(Integer noLotTypeRules) {
        ...
        if (noLotTypeRules != null) {
            ...
            for (int i = 0; i < lotTypeRuleGroups.length; i++) {
                lotTypeRuleGroups[i] = new LotTypeRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public LotTypeRuleGroup addLotTypeRuleGroup() {
        LotTypeRuleGroup group = new LotTypeRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setPriceLimits() {
        this.priceLimits = new PriceLimits50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (noTickRules != null && noTickRules.intValue() > 0) {
            if (TICK_RULE_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noTickRules.intValue(); i++) {
                    TickRuleGroup group = new TickRuleGroup50SP2(context);
        ...
        if (noLotTypeRules != null && noLotTypeRules.intValue() > 0) {
            if (LOT_TYPE_RULE_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noLotTypeRules.intValue(); i++) {
                    LotTypeRuleGroup group = new LotTypeRuleGroup50SP2(context);
                    group.decode(message);
        ...
        if (PRICE_LIMITS_COMP_TAGS.contains(tag.tagNum)) {
            if (priceLimits == null) {
                priceLimits = new PriceLimits50SP2(context);
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [BaseTradingRules] component release [5.0SP2].";
    }
