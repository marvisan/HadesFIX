 ...
 * QuoteMsg50SP2.java
 *
 * $Id: QuoteMsg50SP2.java,v 1.13 2011-04-14 23:44:27 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 QuoteMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.13 $
 * @created 17/06/2009, 9:32:41 AM
 */
@XmlRootElement(name="Quot")
@XmlType(propOrder = {"header", "quoteQualifierGroups", "partyIDGroups", "instrument", "financingDetails",
    "underlyingInstruments", "orderQtyData", "rateSources", "stipulationsGroups", "legQuoteSymbolGroups",
    "spreadOrBenchmarkCurveData", "yieldData"})
@XmlAccessorType(XmlAccessType.NONE)
public class QuoteMsg50SP2 extends QuoteMsg {
    ...
    protected static final Set<Integer> LEG_QUOTE_SYMBOL_GROUP_TAGS = new LegQuoteGroup50SP2().getFragmentAllTags();
    ...
    public QuoteMsg50SP2() {
        super();
    }

    public QuoteMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        instrument = new Instrument50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }

    public QuoteMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        instrument = new Instrument50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }

    public QuoteMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteMsg50SP2 fixml = (QuoteMsg50SP2) fragment;
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteSymbolGroups.length; i++) {
                legQuoteSymbolGroups[i] = new LegQuoteGroup50SP2(context);
            }
        }
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteMsg] message version [5.0SP2].";
    }
