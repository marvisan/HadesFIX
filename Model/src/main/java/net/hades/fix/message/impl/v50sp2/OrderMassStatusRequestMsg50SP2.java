...
/*
 * OrderMassStatusRequestMsg50SP2.java
 *
 * $Id: OrderMassStatusRequestMsg50SP2.java,v 1.1 2011-05-09 08:21:11 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 OrderMassStatusRequestMsg implementation.
 *
...
public class OrderMassStatusRequestMsg50SP2 extends OrderMassStatusRequestMsg {
    ...
    public OrderMassStatusRequestMsg50SP2() {
        super();
    }

    public OrderMassStatusRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderMassStatusRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderMassStatusRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderMassStatusRequestMsg50SP2 fixml = (OrderMassStatusRequestMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderMassStatusRequestMsg] message version [5.0SP2].";
    }
