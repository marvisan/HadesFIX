...
/**
 * FIX version 4.4 CollateralRequestMsg implementation.
 *
...
public class CollateralRequestMsg44 extends CollateralRequestMsg {
    ...
    public CollateralRequestMsg44() {
        super();
    }

    public CollateralRequestMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CollateralRequestMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CollateralRequestMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralRequestMsg44 fixml = (CollateralRequestMsg44) fragment;
