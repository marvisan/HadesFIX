...
/**
 * FIX 5.0 implementation of PosUndInstrmtGroup group.
 *
...
public class PosUndInstrmtGroup50 extends PosUndInstrmtGroup {
    ...
    protected static final Set<Integer> UND_AMT_GROUP_TAGS = new UnderlyingAmountGroup50().getFragmentAllTags();
    ...
    public PosUndInstrmtGroup50() {
    }

    public PosUndInstrmtGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoUnderlyingAmounts(Integer noUnderlyingAmounts) {
        ...
        if (noUnderlyingAmounts != null) {
            ...
            for (int i = 0; i < underlyingAmountGroups.length; i++) {
                underlyingAmountGroups[i] = new UnderlyingAmountGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UnderlyingAmountGroup addUnderlyingAmountGroup() {
        UnderlyingAmountGroup group = new UnderlyingAmountGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (UND_AMT_GROUP_TAGS.contains(tag.tagNum)) {
            if (noUnderlyingAmounts != null && noUnderlyingAmounts.intValue() > 0) {
                ...
                for (int i = 0; i < underlyingAmountGroups.length; i++) {
                    UnderlyingAmountGroup group = new UnderlyingAmountGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PosUndInstrmtGroup] group version [5.0].";
    }
