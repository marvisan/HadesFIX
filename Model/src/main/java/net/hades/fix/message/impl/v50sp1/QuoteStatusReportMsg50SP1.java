 ...
 *
 * $Id: QuoteStatusReportMsg50SP1.java,v 1.11 2011-04-14 23:44:56 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.LegQuoteStatusGroup50SP1;
...
public class QuoteStatusReportMsg50SP1 extends QuoteStatusReportMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -4738882475537818100L;
    ...
    protected static final Set<Integer> LEG_QUOTE_STATUS_GROUP_TAGS = new LegQuoteGroup50SP1().getFragmentAllTags();
    ...
    public QuoteStatusReportMsg50SP1() {
        super();
        instrument = new Instrument50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }

    public QuoteStatusReportMsg50SP1(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public QuoteStatusReportMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        instrument = new Instrument50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }

    public QuoteStatusReportMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteStatusReportMsg50SP1 fixml = (QuoteStatusReportMsg50SP1) fragment;
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteStatusGroups.length; i++) {
                legQuoteStatusGroups[i] = new LegQuoteStatusGroup50SP1(context);
            }
        }
    }
    ...
    public LegQuoteStatusGroup addLegQuoteStatusGroup() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        LegQuoteStatusGroup group = new LegQuoteStatusGroup50SP1(context);
        ...
        if (LEG_QUOTE_STATUS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    LegQuoteStatusGroup component = new LegQuoteStatusGroup50SP1(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteStatusReportMsg] message version [5.0SP1].";
    }
