...
/*
 * SecListGroup50SP1.java
 *
 * $Id: SecListGroup50SP1.java,v 1.2 2011-04-29 03:11:04 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of SecListGroup group.
 *
...
public class SecListGroup50SP1 extends SecListGroup {
    ...
    protected static final Set<Integer> INSTRMNT_LEG_SEC_LIST_GROUP_TAGS = new InstrmtLegSecListGroup50SP1().getFragmentAllTags();
    ...
    public SecListGroup50SP1() {
    }

    public SecListGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < instrmtLegSecListGroups.length; i++) {
                instrmtLegSecListGroups[i] = new InstrmtLegSecListGroup50SP1(context);
            }
        }
    }
    ...
    @Override
     public InstrmtLegSecListGroup addInstrmtLegSecListGroup() {
        InstrmtLegSecListGroup group = new InstrmtLegSecListGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (INSTRMNT_LEG_SEC_LIST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    InstrmtLegSecListGroup component = new InstrmtLegSecListGroup50SP1(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecListGroup] group version [5.0SP1].";
    }
