...
/*
 * InstrumentLeg50.java
 *
 * $Id: InstrumentLeg50.java,v 1.10 2011-04-14 23:44:50 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.LegSecurityAltIDGroup50;
...
/**
 * InstrumentLeg FIX version 5.0 implementation.
 * 
...
public class InstrumentLeg50 extends InstrumentLeg {
    ...
    protected static final Set<Integer> LEG_SEC_ALT_ID_GROUP_TAGS = new LegSecurityAltIDGroup50().getFragmentAllTags();
    ...
    public InstrumentLeg50() {
        super();
    }

    public InstrumentLeg50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoLegSecurityAltID(Integer noLegSecurityAltID) {
        ...
        if (noLegSecurityAltID != null) {
            ...
            for (int i = 0; i < legSecurityAltIDGroups.length; i++) {
                legSecurityAltIDGroups[i] = new LegSecurityAltIDGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public LegSecurityAltIDGroup addLegSecurityAltIDGroup() {
        ...
        LegSecurityAltIDGroup group = new LegSecurityAltIDGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noLegSecurityAltID != null && noLegSecurityAltID.intValue() > 0) {
            if (LEG_SEC_ALT_ID_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noLegSecurityAltID.intValue(); i++) {
                    LegSecurityAltIDGroup group = new LegSecurityAltIDGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrumentLeg] component version [5.0].";
    }
