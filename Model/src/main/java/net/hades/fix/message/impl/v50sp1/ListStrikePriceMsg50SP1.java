...
/*
 * ListStrikePriceMsg50SP1.java
 *
 * $Id: ListStrikePriceMsg50SP1.java,v 1.1 2011-04-15 04:37:43 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.InstrmtStrikePriceGroup50SP1;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.xml.codec.jaxb.adapter.FixBooleanAdapter;

/**
 * FIX version 5.0SP1 ListStrikePriceMsg implementation.
 *
...
public class ListStrikePriceMsg50SP1 extends ListStrikePriceMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> INSTRMT_STRK_PX_GROUP_TAGS = new InstrmtStrikePriceGroup50SP1().getFragmentAllTags();
    ...
    public ListStrikePriceMsg50SP1() {
        super();
    }

    public ListStrikePriceMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ListStrikePriceMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ListStrikePriceMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ListStrikePriceMsg50SP1 fixml = (ListStrikePriceMsg50SP1) fragment;
    ...
    public void setNoStrikes(Integer noStrikes) {
        ...
        if (noStrikes != null) {
            ...
            for (int i = 0; i < instrmtStrikePriceGroups.length; i++) {
                instrmtStrikePriceGroups[i] = new InstrmtStrikePriceGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public InstrmtStrikePriceGroup addInstrmtStrikePriceGroup() {
        InstrmtStrikePriceGroup group = new InstrmtStrikePriceGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (INSTRMT_STRK_PX_GROUP_TAGS.contains(tag.tagNum)) {
            if (noStrikes != null && noStrikes.intValue() > 0) {
                ...
                for (int i = 0; i < noStrikes.intValue(); i++) {
                    InstrmtStrikePriceGroup group = new InstrmtStrikePriceGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListStrikePriceMsg] message version [5.0SP1].";
    }
