...
/*
 * TradingSessionStatusMsg50SP2.java
 *
 * $Id: TradingSessionStatusMsg50SP2.java,v 1.1 2011-04-23 00:19:04 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 TradingSessionStatusMsg implementation.
 *
...
public class TradingSessionStatusMsg50SP2 extends TradingSessionStatusMsg {
    ...
    public TradingSessionStatusMsg50SP2() {
        super();
    }

    public TradingSessionStatusMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradingSessionStatusMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradingSessionStatusMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradingSessionStatusMsg50SP2 fixml = (TradingSessionStatusMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradingSessionStatusMsg] message version [5.0SP2].";
    }
