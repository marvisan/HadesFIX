...
/*
 * RegistrationInstructionsResponseMsg50SP1.java
 *
 * $Id: RegistrationInstructionsResponseMsg50SP1.java,v 1.1 2011-10-29 02:16:41 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 RegistrationInstructionsResponseMsg implementation.
 *
...
public class RegistrationInstructionsResponseMsg50SP1 extends RegistrationInstructionsResponseMsg {
    ...
    public RegistrationInstructionsResponseMsg50SP1() {
        super();
    }

    public RegistrationInstructionsResponseMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RegistrationInstructionsResponseMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public RegistrationInstructionsResponseMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        RegistrationInstructionsResponseMsg50SP1 fixml = (RegistrationInstructionsResponseMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RegistrationInstructionsResponseMsg] message version [5.0SP1].";
    }
