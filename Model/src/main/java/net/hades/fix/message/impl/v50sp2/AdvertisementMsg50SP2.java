...
/*
 * AdvertisementMsg50SP2.java
 *
 * $Id: AdvertisementMsg50SP2.java,v 1.13 2011-04-14 23:44:29 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 AdvertisementMsg implementation.
 *
...
public class AdvertisementMsg50SP2 extends AdvertisementMsg {
    ...
    public AdvertisementMsg50SP2() {
        super();
    }

    public AdvertisementMsg50SP2(Header header, ByteBuffer rawMsg)
    ...
    public AdvertisementMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        if (messageEncoding == null) {
            messageEncoding = Charset.forName(FIXMsg.DEFAULT_CHARACTER_SET);
        }
    ...
    public AdvertisementMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AdvertisementMsg50SP2 fixml = (AdvertisementMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AdvertismentMsg] message version [5.0SP2].";
    }
