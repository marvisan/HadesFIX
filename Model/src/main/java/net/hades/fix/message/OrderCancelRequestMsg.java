...
/*
 * OrderCancelRequestMsg.java
 *
 * $Id: OrderCancelRequestMsg.java,v 1.4 2011-05-02 04:04:21 vrotaru Exp $
 */
 ...
 * Note that the Order Cancel/Replace Request should be used to partially cancel (reduce) an order).<br/>
 * The request will only be accepted if the order can successfully be pulled back from the exchange floor without
 * executing.<br/>
 * A cancel request is assigned a ClOrdID and is treated as a separate entity. If rejected, the ClOrdID of the
 * cancel request will be sent in the Cancel Reject message, as well as the ClOrdID of the actual order in the
 * OrigClOrdID field. The ClOrdID assigned to the cancel request must be unique amongst the ClOrdID assigned
 * to regular orders and replacement orders.<br/>
...
public abstract class OrderCancelRequestMsg extends FIXMsg {
   ...
   /**
    ...
    /**
     * TagNum = 125. Starting with 4.0 version.
     */
    protected String cxlType;
    ...
    public OrderCancelRequestMsg(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderCancelRequestMsg(BeginString beginString) throws InvalidMsgException {
        super(MsgType.OrderCancelRequest.getValue(), beginString);
    }

    public OrderCancelRequestMsg(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
        super(MsgType.OrderCancelRequest.getValue(), beginString, applVerID);
    }
    ...
    @TagNumRef(tagNum = TagNum.CxlType)
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {
           ...
           case SecondaryClOrdID:
            ...
            case CxlType:
                cxlType = new String(tag.value, sessionCharset);
                break;
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [OrderCancelRequestMsg] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("{OrderCancelRequestMsg=");
        ...
        printTagValue(b, TagNum.CxlType, cxlType);
