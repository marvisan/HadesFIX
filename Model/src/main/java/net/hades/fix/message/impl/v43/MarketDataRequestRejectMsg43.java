...
/*
 * MarketDataRequestRejectMsg43.java
 *
 * $Id: MarketDataRequestRejectMsg43.java,v 1.5 2010-08-25 05:30:35 vrotaru Exp $
 */
...
/**
 * FIX version 4.3 MarketDataRequestRejectMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.5 $
 * @created 01/04/2009, 8:41:14 AM
 */
public class MarketDataRequestRejectMsg43 extends MarketDataRequestRejectMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -1704378601758739055L;
    ...
    public MarketDataRequestRejectMsg43() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataRequestRejectMsg43(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public MarketDataRequestRejectMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataRequestRejectMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MarketDataRequestRejectMsg] message version [4.3].";
    }
