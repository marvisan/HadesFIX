...
/*
 * InstrmtLegExecGroup44.java
 *
 * $Id: InstrmtLegExecGroup44.java,v 1.3 2011-04-14 23:44:43 vrotaru Exp $
 */
...
public class InstrmtLegExecGroup44 extends InstrmtLegExecGroup {
    ...
    public InstrmtLegExecGroup44() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public InstrmtLegExecGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrmtLegExecGroup] group version [4.4].";
    }
