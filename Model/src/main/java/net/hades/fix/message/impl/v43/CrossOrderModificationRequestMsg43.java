...
/*
 * CrossOrderModificationRequestMsg43.java
 *
 * $Id: CrossOrderModificationRequestMsg43.java,v 1.1 2011-05-17 09:28:23 vrotaru Exp $
 */
...
/**
 * FIX version 4.3 CrossOrderModificationRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 17/05/2011, 9:32:41 AM
 */
public class CrossOrderModificationRequestMsg43 extends CrossOrderModificationRequestMsg {
    ...
    public CrossOrderModificationRequestMsg43() {
        super();
    }

    public CrossOrderModificationRequestMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CrossOrderModificationRequestMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CrossOrderModificationRequestMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CrossOrderModificationRequestMsg] message version [4.3].";
    }
