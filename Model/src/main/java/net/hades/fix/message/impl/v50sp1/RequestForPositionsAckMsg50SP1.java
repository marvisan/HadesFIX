...
/*
 * RequestForPositionsAckMsg50SP1.java
 *
...
/**
 * FIX version 5.0SP1 RequestForPositionsAckMsg implementation.
 *
...
public class RequestForPositionsAckMsg50SP1 extends RequestForPositionsAckMsg {
    ...
    public RequestForPositionsAckMsg50SP1() {
        super();
    }

    public RequestForPositionsAckMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RequestForPositionsAckMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public RequestForPositionsAckMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        RequestForPositionsAckMsg50SP1 fixml = (RequestForPositionsAckMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RequestForPositionsAckMsg] message version [5.0SP1].";
    }
