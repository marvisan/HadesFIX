...
public class ConfirmationAckMsg50 extends ConfirmationAckMsg {
    ...
    public ConfirmationAckMsg50() {
        super();
    }

    public ConfirmationAckMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ConfirmationAckMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ConfirmationAckMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ConfirmationAckMsg50 fixml = (ConfirmationAckMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ConfirmationAckMsg] message version [5.0].";
    }
