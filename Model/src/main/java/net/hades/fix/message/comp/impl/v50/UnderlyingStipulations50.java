...
/*
 * UnderlyingStipulations50.java
 *
 * $Id: UnderlyingStipulations50.java,v 1.8 2011-04-14 23:44:50 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.UnderlyingStipsGroup50;

/**
 * Underlying stipulation component.
 * 
 ...
 */
@XmlTransient
public class UnderlyingStipulations50 extends UnderlyingStipulations {
    ...
    protected static final Set<Integer> UNDLY_STIPS_GROUP_TAGS = new UnderlyingStipsGroup50().getFragmentAllTags();
    ...
    public UnderlyingStipulations50() {
        super();
    }

    public UnderlyingStipulations50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoUnderlyingStips(Integer noUnderlyingStips) {
        ...
        if (noUnderlyingStips != null) {
            ...
            for (int i = 0; i < underlyingStipsGroups.length; i++) {
                underlyingStipsGroups[i] = new UnderlyingStipsGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UnderlyingStipsGroup addUnderlyingStipsGroup() {
        UnderlyingStipsGroup group = new UnderlyingStipsGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noUnderlyingStips != null && noUnderlyingStips.intValue() > 0) {
            if (UNDLY_STIPS_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noUnderlyingStips.intValue(); i++) {
                    UnderlyingStipsGroup group = new UnderlyingStipsGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [UnderlyingStipulations] component version [5.0].";
    }
