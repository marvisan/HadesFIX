...
/*
 * MassQuoteMsg50SP1.java
 *
 * $Id: MassQuoteMsg50SP1.java,v 1.11 2011-04-14 23:44:58 vrotaru Exp $
 */
...
public class MassQuoteMsg50SP1 extends MassQuoteMsg {
    ...
    protected static final Set<Integer> QUOTE_SET_GROUP_TAGS = new QuoteSetGroup50SP1().getFragmentAllTags();
    ...
    public MassQuoteMsg50SP1() {
        super();
    }
    
    public MassQuoteMsg50SP1(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MassQuoteMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MassQuoteMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoQuoteSets(Integer noQuoteSets) {
        ...
        if (noQuoteSets != null) {
            ...
            for (int i = 0; i < quoteSetGroups.length; i++) {
                quoteSetGroups[i] = new QuoteSetGroup50SP1(context);
            }
        }
    }
    ...
    public QuoteSetGroup addQuoteSetGroup() {
        QuoteSetGroup group = new QuoteSetGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (QUOTE_SET_GROUP_TAGS.contains(tag.tagNum)) {
            if (noQuoteSets != null && noQuoteSets.intValue() > 0) {
                ...
                for (int i = 0; i < noQuoteSets.intValue(); i++) {
                    QuoteSetGroup component = new QuoteSetGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MassQuoteMsg] message version [5.0SP1].";
    }
