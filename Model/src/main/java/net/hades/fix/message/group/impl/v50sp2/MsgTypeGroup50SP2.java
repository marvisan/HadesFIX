...
/*
 * MsgTypeGroup50SP2.java
 *
 * $Id: MsgTypeGroup50SP2.java,v 1.1 2010-03-31 11:05:18 vrotaru Exp $
 */
...
/**
 * MsgTypeGroup implementation for FIX 5.0SP2 version.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/11/2008, 5:00:09 PM
 */
public class MsgTypeGroup50SP2 extends MsgTypeGroup {
    ...
    public MsgTypeGroup50SP2() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MsgTypeGroup50SP2(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MsgTypeGroup] group version [5.0SP2].";
    }
