...
/*
 * NestedParties450SP2.java
 *
 * $Id: NestedParties450SP2.java,v 1.2 2011-04-14 23:44:49 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.Nested4PartyGroup50SP2;
...
/**
 * FIX version 5.0SP2 implementation of NestedParties4 component.
 *
 ...
 */
@XmlTransient
public class NestedParties450SP2 extends NestedParties4 {
    ...
    protected static final Set<Integer> NESTED4_PARTY_GROUP_TAGS = new Nested4PartyGroup50SP2().getFragmentAllTags();
    ...
    public NestedParties450SP2() {
        super();
    }

    public NestedParties450SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoNested4PartyIDs(Integer noNested4PartyIDs) {
        ...
        if (noNested4PartyIDs != null) {
            ...
            for (int i = 0; i < nested4PartyGroups.length; i++) {
                nested4PartyGroups[i] = new Nested4PartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public Nested4PartyGroup addNested4PartyGroup() {
        Nested4PartyGroup group = new Nested4PartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NESTED4_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNested4PartyIDs != null && noNested4PartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < nested4PartyGroups.length; i++) {
                    Nested4PartyGroup group = new Nested4PartyGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NestedParties4] component version [5.0SP2].";
    }
