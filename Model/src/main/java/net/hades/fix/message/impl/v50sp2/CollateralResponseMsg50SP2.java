...
/*
 * CollateralResponseMsg50SP2.java
 *
...
import net.hades.fix.message.group.impl.v50sp2.UndInstrmtCollGroup50SP2;
...
/**
 * FIX version 5.0SP2 CollateralResponseMsg implementation.
 *
...
public class CollateralResponseMsg50SP2 extends CollateralResponseMsg {
    ...
    protected static final Set<Integer> UND_INSTRMT_COLL_GROUP_TAGS = new UndInstrmtCollGroup50SP2().getFragmentAllTags();
    ...
    public CollateralResponseMsg50SP2() {
        super();
    }

    public CollateralResponseMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralResponseMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralResponseMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralResponseMsg50SP2 fixml = (CollateralResponseMsg50SP2) fragment;
    ...
    public void setNoUnderlyings(Integer noUnderlyings) {
        ...
        if (noUnderlyings != null) {
            ...
            for (int i = 0; i < undInstrmtCollGroups.length; i++) {
                undInstrmtCollGroups[i] = new UndInstrmtCollGroup50SP2(context);
            }
        }
    }
    ...
    public UndInstrmtCollGroup addUndInstrmtCollGroup() {
        UndInstrmtCollGroup group = new UndInstrmtCollGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (UND_INSTRMT_COLL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noUnderlyings != null && noUnderlyings.intValue() > 0) {
                ...
                for (int i = 0; i < noUnderlyings.intValue(); i++) {
                    UndInstrmtCollGroup component = new UndInstrmtCollGroup50SP2(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralRequestMsg] message version [5.0SP2].";
    }
