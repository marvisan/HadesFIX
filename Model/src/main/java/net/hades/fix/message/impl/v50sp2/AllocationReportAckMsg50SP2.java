...
/*
 * AllocationReportAckMsg50SP2.java
 *
...
/**
 * FIX version 5.0SP2 AllocationReportAckMsg implementation.
 *
...
public class AllocationReportAckMsg50SP2 extends AllocationReportAckMsg {
    ...
    public AllocationReportAckMsg50SP2() {
        super();
    }

    public AllocationReportAckMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AllocationReportAckMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AllocationReportAckMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationReportAckMsg50SP2 fixml = (AllocationReportAckMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationReportAckMsg] message version [5.0SP2].";
    }
