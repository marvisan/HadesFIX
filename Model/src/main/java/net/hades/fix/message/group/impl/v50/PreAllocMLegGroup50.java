...
/*
 * PreAllocMLegGroup50.java
 *
 * $Id: PreAllocMLegGroup50.java,v 1.2 2011-09-09 08:05:13 vrotaru Exp $
 */
package net.hades.fix.message.group.impl.v50;

import net.hades.fix.message.FragmentContext;
import net.hades.fix.message.comp.NestedParties3;
import net.hades.fix.message.comp.impl.v50.NestedParties350;
...
/**
 * FIX 5.0 implementation of PreAllocMLegGroup group.
 *
...
public class PreAllocMLegGroup50 extends PreAllocMLegGroup {
    ...
    protected static final Set<Integer> NESTED_PARTIES3_COMP_TAGS = new NestedParties350().getFragmentAllTags();
    ...
    public PreAllocMLegGroup50() {
    }

    public PreAllocMLegGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNestedParties3() {
        ...
        this.nestedParties3 = new NestedParties350(context);
    }
    ...
    public void setNestedPartyIDGroups(Nested3PartyGroup[] nestedPartyIDGroups) {
        if (nestedPartyIDGroups != null) {
            ...
            ((NestedParties350) nestedParties3).setNested3PartyIDGroups(nestedPartyIDGroups);
        }
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (NESTED_PARTIES3_COMP_TAGS.contains(tag.tagNum)) {
            if (nestedParties3 == null) {
                nestedParties3 = new NestedParties350(context);
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PreMLegAllocGroup] group version [5.0].";
    }
