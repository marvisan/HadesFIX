...
/*
 * NewOrderSingleMsg50.java
 *
 * $Id: NewOrderSingleMsg50.java,v 1.8 2011-05-12 09:26:08 vrotaru Exp $
 */
...
public class NewOrderSingleMsg50 extends NewOrderSingleMsg {
    ...
    public NewOrderSingleMsg50() {
        super();
    }

    public NewOrderSingleMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public NewOrderSingleMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public NewOrderSingleMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewOrderSingleMsg50 fixml = (NewOrderSingleMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderSingleMsg] message version [5.0].";
    }
