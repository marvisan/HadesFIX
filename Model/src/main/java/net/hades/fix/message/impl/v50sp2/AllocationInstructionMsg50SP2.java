...
/*
 * AllocationInstructionMsg50SP2.java
 *
 * $Id: AllocationInstructionMsg50SP2.java,v 1.3 2011-04-14 23:44:28 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.AllocGroup50SP2;
import net.hades.fix.message.group.impl.v50sp2.ExecAllocGroup50SP2;
...
import net.hades.fix.message.group.impl.v50sp2.OrderAllocGroup50SP2;
...
/**
 * FIX version 5.0SP2 AllocationInstructionMsg implementation.
 *
...
public class AllocationInstructionMsg50SP2 extends AllocationInstructionMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> ORDER_ALLOC_GROUP_TAGS = new OrderAllocGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> EXEC_ALLOC_GROUP_TAGS = new ExecAllocGroup50SP2().getFragmentAllTags();
    ...
    protected static final Set<Integer> ALLOC_GROUP_TAGS = new AllocGroup50SP2().getFragmentAllTags();
    ...
    public AllocationInstructionMsg50SP2() {
        super();
    }

    public AllocationInstructionMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AllocationInstructionMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AllocationInstructionMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationInstructionMsg50SP2 fixml = (AllocationInstructionMsg50SP2) fragment;
    ...
    public void setNoOrders(Integer noOrders) {
        ...
        if (noOrders != null) {
            ...
            for (int i = 0; i < orderAllocGroups.length; i++) {
                orderAllocGroups[i] = new OrderAllocGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public OrderAllocGroup addOrderAllocGroup() {
        OrderAllocGroup group = new OrderAllocGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoExecs(Integer noExecs) {
        ...
        if (noExecs != null) {
            ...
            for (int i = 0; i < execAllocGroups.length; i++) {
                execAllocGroups[i] = new ExecAllocGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public ExecAllocGroup addExecAllocGroup() {
        ExecAllocGroup group = new ExecAllocGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocGroups.length; i++) {
                allocGroups[i] = new AllocGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public AllocGroup addAllocGroup() {
        AllocGroup group = new AllocGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (ORDER_ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noOrders != null && noOrders.intValue() > 0) {
                ...
                for (int i = 0; i < noOrders.intValue(); i++) {
                    OrderAllocGroup group = new OrderAllocGroup50SP2(context);
        ...
        if (EXEC_ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noExecs != null && noExecs.intValue() > 0) {
                ...
                for (int i = 0; i < noExecs.intValue(); i++) {
                    ExecAllocGroup group = new ExecAllocGroup50SP2(context);
                    group.decode(message);
        ...
        if (ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAllocs != null && noAllocs.intValue() > 0) {
                ...
                for (int i = 0; i < noAllocs.intValue(); i++) {
                    AllocGroup group = new AllocGroup50SP2(context);
                    group.decode(message);
                    allocGroups[i] = group;
                }
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationInstructionMsg] message version [5.0SP2].";
    }
