...
/*
 * UnderlyingInstrument50SP2.java
 *
 * $Id: UnderlyingInstrument50SP2.java,v 1.10 2011-04-14 23:44:49 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.UnderlyingSecurityAltIDGroup50SP1;
import net.hades.fix.message.group.impl.v50sp2.UnderlyingSecurityAltIDGroup50SP2;
...
/**
 * FIX 5.0SP2 implementation of UnderlyingInstrument component.
 *
...
public class UnderlyingInstrument50SP2 extends UnderlyingInstrument {
    ...
    protected static final Set<Integer> UNDLY_SEC_ALT_ID_GROUP_TAGS = new UnderlyingSecurityAltIDGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> UNDLY_STIP_GROUP_TAGS = new UnderlyingStipulations50SP2().getFragmentAllTags();
    protected static final Set<Integer> UNDLY_INSTR_PARTIES_COMP_TAGS = new UndlyInstrumentParties50SP2().getFragmentAllTags();
    ...
    public UnderlyingInstrument50SP2() {
        super();
    }

    public UnderlyingInstrument50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoUnderlyingSecurityAltID(Integer noUnderlyingSecurityAltID) {
        ...
        if (noUnderlyingSecurityAltID != null) {
            ...
            for (int i = 0; i < underlyingSecurityAltIDGroups.length; i++) {
                underlyingSecurityAltIDGroups[i] = new UnderlyingSecurityAltIDGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UnderlyingSecurityAltIDGroup addUnderlyingSecurityAltIDGroup() {
        ...
        UnderlyingSecurityAltIDGroup group = new UnderlyingSecurityAltIDGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setUnderlyingStipsGroups(UnderlyingStipsGroup[] underlyingStipsGroups) {
        if (underlyingStipsGroups != null) {
            ...
            underlyingStipulations = new UnderlyingStipulations50SP2(context);
            ((UnderlyingStipulations50SP2) underlyingStipulations).setUnderlyingStipsGroups(underlyingStipsGroups);
        }
    }
    ...
    public void setUnderlyingStipulations() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        this.underlyingStipulations = new UnderlyingStipulations50SP2(context);
    }
    ...
    public void setUndlyInstrumentParties() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        undlyInstrumentParties = new UndlyInstrumentParties50SP2(context);
    }
    ...
    public void setUndlyInstrumentPartyIDGroups(UndlyInstrumentPartyIDGroup[] undlyInstrumentPartyIDGroups) {
        if (undlyInstrumentPartyIDGroups != null) {
            ...
            ((UndlyInstrumentParties50SP2) undlyInstrumentParties).setUndlyInstrumentPartyIDGroups(undlyInstrumentPartyIDGroups);
        }
    }
        ...
        if (noUnderlyingSecurityAltID != null && noUnderlyingSecurityAltID.intValue() > 0) {
            if (UNDLY_SEC_ALT_ID_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noUnderlyingSecurityAltID.intValue(); i++) {
                    UnderlyingSecurityAltIDGroup group = new UnderlyingSecurityAltIDGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [UnderlyingInstrument] component version [5.0SP2].";
    }
