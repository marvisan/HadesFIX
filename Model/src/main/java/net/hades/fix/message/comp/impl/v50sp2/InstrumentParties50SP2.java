...
/*
 * InstrumentParties50SP2.java
 *
 * $Id: InstrumentParties50SP2.java,v 1.8 2011-04-14 23:44:49 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.InstrumentPartyGroup50SP2;

/**
 * FIX 5.0SP2 implementation of InstrumentParties component.
 * 
 ...
 */
@XmlTransient
public class InstrumentParties50SP2 extends InstrumentParties {
    ...
    protected static final Set<Integer> INSTRUMENT_PARTY_GROUP_TAGS = new InstrumentPartyGroup50SP2().getFragmentAllTags();
    ...
    public InstrumentParties50SP2() {
        super();
    }

    public InstrumentParties50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoInstrumentParties(Integer noInstrumentParties) {
        ...
        if (noInstrumentParties != null) {
            ...
            for (int i = 0; i < instrumentPartyGroups.length; i++) {
                instrumentPartyGroups[i] = new InstrumentPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public InstrumentPartyGroup addInstrumentPartyGroup() {
        ...
        InstrumentPartyGroup group = new InstrumentPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (INSTRUMENT_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noInstrumentParties != null && noInstrumentParties.intValue() > 0) {
                ...
                for (int i = 0; i < noInstrumentParties.intValue(); i++) {
                    InstrumentPartyGroup group = new InstrumentPartyGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in InstrumentParties component release [5.0SP2].";
    }
