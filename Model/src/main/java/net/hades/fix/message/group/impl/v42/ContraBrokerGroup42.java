...
/*
 * ContraBrokerGroup42.java
 *
 * $Id: ContraBrokerGroup42.java,v 1.1 2010-12-22 09:30:31 vrotaru Exp $
 */
 ...
 */
public class ContraBrokerGroup42 extends ContraBrokerGroup {
    ...
    public ContraBrokerGroup42() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ContraBrokerGroup42(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ContraBrokerGroup] group version [4.2].";
    }
