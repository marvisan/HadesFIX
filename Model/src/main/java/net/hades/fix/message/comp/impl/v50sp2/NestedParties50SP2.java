...
/*
 * NestedParties50SP2.java
 *
 * $Id: NestedParties50SP2.java,v 1.7 2011-04-14 23:44:49 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.NestedPartyGroup50SP2;
import net.hades.fix.message.struct.Tag;

/**
 * FIX version 5.0SP2 implementation of NestedParties component.
 *
...
public class NestedParties50SP2 extends NestedParties {
    ...
    protected static final Set<Integer> NESTED_PARTY_GROUP_TAGS = new NestedPartyGroup50SP2().getFragmentAllTags();
    ...
    public NestedParties50SP2() {
        super();
    }

    public NestedParties50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoNestedPartyIDs(Integer noNestedPartyIDs) {
        ...
        if (noNestedPartyIDs != null) {
            ...
            for (int i = 0; i < nestedPartyGroups.length; i++) {
                nestedPartyGroups[i] = new NestedPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public NestedPartyGroup addNestedPartyGroup() {
        NestedPartyGroup group = new NestedPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NESTED_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNestedPartyIDs != null && noNestedPartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < nestedPartyGroups.length; i++) {
                    NestedPartyGroup group = new NestedPartyGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NestedParties] component version [5.0SP2].";
    }
