...
/*
 * QuoteRequestGroup50SP2.java
 *
 * $Id: QuoteRequestGroup50SP2.java,v 1.12 2011-04-14 23:44:31 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of QuoteRequestGroup group.
 *
...
@XmlType(propOrder = {"instrument", "financingDetails", "underlyingInstruments", "orderQtyData",
    "rateSources", "stipulationsGroups", "legQuoteSymbolGroups", "quoteQualifierGroups",
    "spreadOrBenchmarkCurveData", "yieldData", "partyIDGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class QuoteRequestGroup50SP2 extends QuoteRequestGroup {
    ...
    protected static final Set<Integer> LEG_QUOTE_SYMBOL_GROUP_TAGS = new QuoteRequestLegGroup50SP2().getFragmentAllTags();
    ...
    public void setNoUnderlyings(Integer noUnderlyings) {
        ...
        if (noUnderlyings != null) {
            ...
            for (int i = 0; i < underlyingInstruments.length; i++) {
                underlyingInstruments[i] = new UnderlyingInstrument50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteSymbolGroups.length; i++) {
                legQuoteSymbolGroups[i] = new QuoteRequestLegGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public QuoteRequestLegGroup addLegQuoteSymbolGroup() {
        QuoteRequestLegGroup group = new QuoteRequestLegGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (LEG_QUOTE_SYMBOL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    QuoteRequestLegGroup group = new QuoteRequestLegGroup50SP2(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteRequestGroup] group version [5.0SP2].";
    }
