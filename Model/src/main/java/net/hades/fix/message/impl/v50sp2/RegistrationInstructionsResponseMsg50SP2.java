...
/*
 * RegistrationInstructionsResponseMsg50SP2.java
 *
 * $Id: RegistrationInstructionsResponseMsg50SP2.java,v 1.1 2011-10-29 02:16:41 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 RegistrationInstructionsResponseMsg implementation.
 *
...
public class RegistrationInstructionsResponseMsg50SP2 extends RegistrationInstructionsResponseMsg {
    ...
    public RegistrationInstructionsResponseMsg50SP2() {
        super();
    }

    public RegistrationInstructionsResponseMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RegistrationInstructionsResponseMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public RegistrationInstructionsResponseMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        RegistrationInstructionsResponseMsg50SP2 fixml = (RegistrationInstructionsResponseMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RegistrationInstructionsResponseMsg] message version [5.0SP2].";
    }
