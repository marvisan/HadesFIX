...
/*
 * NewOrderSingleMsg42.java
 *
 * $Id: NewOrderSingleMsg42.java,v 1.5 2011-04-16 07:38:25 vrotaru Exp $
 */
...
/**
 * FIX version 4.2 NewOrderSingleMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.5 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class NewOrderSingleMsg42 extends NewOrderSingleMsg {
    ...
    public NewOrderSingleMsg42(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderSingleMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderSingleMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (TRAD_SESSION_GROUP_TAGS.contains(tag.tagNum)) {
            if (noTradingSessions != null && noTradingSessions.intValue() > 0) {
                message.reset();
                tradingSessionGroups = new TradingSessionGroup[noAllocs.intValue()];
                for (int i = 0; i < noAllocs.intValue(); i++) {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderSingleMsg] message version [4.2].";
    }
