...
/*
 * SettlInstructionsData50SP2.java
 *
 * $Id: SettlInstructionsData50SP2.java,v 1.3 2011-04-14 23:44:49 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.DeliveryInstructionGroup50SP2;
...
/**
 * FIX 5.0SP2 implementation of SettlInstructionsData component.
 *
...
public class SettlInstructionsData50SP2 extends SettlInstructionsData {
    ...
    protected static final Set<Integer> DLVY_INST_GROUP_TAGS = new DeliveryInstructionGroup50SP2().getFragmentAllTags();
    ...
    public SettlInstructionsData50SP2() {
    }

    public SettlInstructionsData50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoDlvyInst(Integer noDlvyInst) {
        ...
        if (noDlvyInst != null) {
            ...
            for (int i = 0; i < deliveryInstructionGroups.length; i++) {
                deliveryInstructionGroups[i] = new DeliveryInstructionGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public DeliveryInstructionGroup addDeliveryInstructionGroup() {
        DeliveryInstructionGroup group = new DeliveryInstructionGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (DLVY_INST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noDlvyInst != null && noDlvyInst.intValue() > 0) {
                ...
                for (int i = 0; i < deliveryInstructionGroups.length; i++) {
                    DeliveryInstructionGroup group = new DeliveryInstructionGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SettlInstructionsData] component version [5.0SP2].";
    }
