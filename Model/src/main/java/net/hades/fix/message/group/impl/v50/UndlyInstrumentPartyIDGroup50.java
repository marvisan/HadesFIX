...
/*
 * UndlyInstrumentPartyIDGroup50.java
 *
 * $Id: UndlyInstrumentPartyIDGroup50.java,v 1.8 2011-04-14 23:44:35 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of UndlyInstrumentPartyIDGroup.
 *
...
public class UndlyInstrumentPartyIDGroup50 extends UndlyInstrumentPartyIDGroup {
    ...
    protected static final Set<Integer> UNDLY_INSTR_PARTY_SUBID_GROUP_TAGS = new UndlyInstrumentPartySubIDGroup50().getFragmentAllTags();
    ...
    public UndlyInstrumentPartyIDGroup50() {
    }

    public UndlyInstrumentPartyIDGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoUndlyInstrumentPartySubIDGroups(Integer noUndlyInstrumentPartySubIDGroups) {
        ...
        if (noUndlyInstrumentPartySubIDGroups != null) {
            ...
            for (int i = 0; i < undlyInstrumentPartySubIDGroups.length; i++) {
                undlyInstrumentPartySubIDGroups[i] = new UndlyInstrumentPartySubIDGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UndlyInstrumentPartySubIDGroup addUndlyInstrumentPartySubIDGroup() {
        UndlyInstrumentPartySubIDGroup group = new UndlyInstrumentPartySubIDGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (UNDLY_INSTR_PARTY_SUBID_GROUP_TAGS.contains(tag.tagNum)) {
            if (noUndlyInstrumentPartySubIDGroups != null && noUndlyInstrumentPartySubIDGroups.intValue() > 0) {
                ...
                for (int i = 0; i < undlyInstrumentPartySubIDGroups.length; i++) {
                    UndlyInstrumentPartySubIDGroup group = new UndlyInstrumentPartySubIDGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [UndlyInstrumentPartyIDGroup] component version [5.0].";
    }
