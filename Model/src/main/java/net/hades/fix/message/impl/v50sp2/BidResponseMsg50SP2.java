...
/*
 * BidResponseMsg50SP2.java
 *
 * $Id: BidResponseMsg50SP2.java,v 1.2 2011-04-14 23:44:28 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.BidRespComponentGroup50SP2;
import net.hades.fix.message.type.BeginString;

/**
 * FIX version 5.0SP2 BidResponseMsg implementation.
 *
...
public class BidResponseMsg50SP2 extends BidResponseMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> BID_COMP_GROUP_TAGS = new BidRespComponentGroup50SP2().getFragmentAllTags();
    ...
    public BidResponseMsg50SP2() {
        super();
    }

    public BidResponseMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public BidResponseMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public BidResponseMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        BidResponseMsg50SP2 fixml = (BidResponseMsg50SP2) fragment;
    ...
    public void setNoBidComponents(Integer noBidComponents) {
        ...
        if (noBidComponents != null) {
            ...
            for (int i = 0; i < bidComponentGroups.length; i++) {
                bidComponentGroups[i] = new BidRespComponentGroup50SP2(context);
            }
        }
    }
    ...
    public BidRespComponentGroup addBidComponentGroup() {
        BidRespComponentGroup group = new BidRespComponentGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (BID_COMP_GROUP_TAGS.contains(tag.tagNum)) {
            if (noBidComponents != null && noBidComponents.intValue() > 0) {
                ...
                for (int i = 0; i < noBidComponents.intValue(); i++) {
                    BidRespComponentGroup component = new BidRespComponentGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [BidResponseMsg] message version [5.0SP2].";
    }
