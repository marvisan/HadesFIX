...
import net.hades.fix.message.group.impl.v50sp2.CpctyConfGroup50SP2;
...
/**
 * FIX version 5.0SP2 ConfirmationMsg implementation.
 *
...
public class ConfirmationMsg50SP2 extends ConfirmationMsg {
    ...
    protected static final Set<Integer> CPCTY_CONF_GROUP_TAGS = new CpctyConfGroup50SP2().getFragmentAllTags();
    ...
    public ConfirmationMsg50SP2() {
        super();
    }

    public ConfirmationMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ConfirmationMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ConfirmationMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ConfirmationMsg50SP2 fixml = (ConfirmationMsg50SP2) fragment;
    ...
    public void setNoCapacities(Integer noExecs) {
        ...
        if (noExecs != null) {
            ...
            for (int i = 0; i < cpctyConfGroups.length; i++) {
                cpctyConfGroups[i] = new CpctyConfGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public CpctyConfGroup addCpctyConfGroup() {
        CpctyConfGroup group = new CpctyConfGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public MiscFeeGroup addMiscFeeGroup() {
        MiscFeeGroup group = new MiscFeeGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
        ...
        if (CPCTY_CONF_GROUP_TAGS.contains(tag.tagNum)) {
            if (noCapacities != null && noCapacities.intValue() > 0) {
                ...
                for (int i = 0; i < noCapacities.intValue(); i++) {
                    CpctyConfGroup group = new CpctyConfGroup50SP2(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ConfirmationMsg] message version [5.0SP2].";
    }
