...
/*
 * ListExecuteMsg50SP1.java
 *
 * $Id: ListExecuteMsg50SP1.java,v 1.1 2011-02-05 08:52:45 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 ListExecuteMsg implementation.
 *
...
public class ListExecuteMsg50SP1 extends ListExecuteMsg {
    ...
    public ListExecuteMsg50SP1() {
        super();
    }

    public ListExecuteMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ListExecuteMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ListExecuteMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ListExecuteMsg50SP1 fixml = (ListExecuteMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListExecuteMsg] message version [5.0SP1].";
    }
