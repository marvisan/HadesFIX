...
/*
 * InstrmtLegSecListGroup50SP1.java
 *
 * $Id: InstrmtLegSecListGroup50SP1.java,v 1.1 2011-04-28 10:07:49 vrotaru Exp $
 */
...
public class InstrmtLegSecListGroup50SP1 extends InstrmtLegSecListGroup {
    ...
    protected static final Set<Integer> LEG_BENCHMARK_CURVE_DATA_COMP_TAGS = new LegBenchmarkCurveData50SP1().getFragmentAllTags();
    ...
    public InstrmtLegSecListGroup50SP1() {
        super();
    }

    public InstrmtLegSecListGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setLegBenchmarkCurveData() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        this.legBenchmarkCurveData = new LegBenchmarkCurveData50SP1(context);
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (LEG_BENCHMARK_CURVE_DATA_COMP_TAGS.contains(tag.tagNum)) {
            if (legBenchmarkCurveData == null) {
                legBenchmarkCurveData = new LegBenchmarkCurveData50SP1(context);
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrmtLegSecListGroup] group version [5.0SP1].";
    }
