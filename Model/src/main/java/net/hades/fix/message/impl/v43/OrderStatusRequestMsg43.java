...
/*
 * OrderStatusRequestMsg43.java
 *
 * $Id: OrderStatusRequestMsg43.java,v 1.3 2011-04-14 23:44:34 vrotaru Exp $
 */
...
/**
 * FIX version 4.3 OrderStatusRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class OrderStatusRequestMsg43 extends OrderStatusRequestMsg {
    ...
    public OrderStatusRequestMsg43() {
        super();
    }

    public OrderStatusRequestMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderStatusRequestMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderStatusRequestMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderStatusRequestMsg] message version [4.3].";
    }
