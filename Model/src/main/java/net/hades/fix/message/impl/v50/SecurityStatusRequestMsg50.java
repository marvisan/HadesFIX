...
/*
 * SecurityStatusRequestMsg50.java
 *
 * $Id: SecurityStatusRequestMsg50.java,v 1.1 2011-04-20 06:57:51 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 SecurityStatusRequestMsg implementation.
 *
...
public class SecurityStatusRequestMsg50 extends SecurityStatusRequestMsg {
    ...
    public SecurityStatusRequestMsg50() {
        super();
    }

    public SecurityStatusRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityStatusRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityStatusRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityStatusRequestMsg50 fixml = (SecurityStatusRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityStatusRequestMsg] message version [5.0].";
    }
