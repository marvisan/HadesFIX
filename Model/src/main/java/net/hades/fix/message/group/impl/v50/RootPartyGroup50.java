...
/*
 * RootPartyGroup50.java
 *
 * $Id: RootPartyGroup50.java,v 1.8 2011-04-14 23:44:35 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of RootPartyGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.8 $
 * @created 08/04/2009, 2:35:04 PM
 */
@XmlRootElement(name="RtPrtys")
@XmlType
@XmlAccessorType(XmlAccessType.NONE)
public class RootPartyGroup50 extends RootPartyGroup {
    ...
    protected static final Set<Integer> ROOT_PARTY_SUB_GROUP_TAGS = new RootPartySubGroup50().getFragmentAllTags();
    ...
    public RootPartyGroup50() {
    }

    public RootPartyGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoRootPartySubIDs(Integer noRootPartySubIDs) {
        ...
        if (noRootPartySubIDs != null) {
            ...
            for (int i = 0; i < rootPartySubGroups.length; i++) {
                rootPartySubGroups[i] = new RootPartySubGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public RootPartySubGroup addRootPartySubGroup() {
        ...
        RootPartySubGroup group = new RootPartySubGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (ROOT_PARTY_SUB_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRootPartySubIDs != null && noRootPartySubIDs.intValue() > 0) {
                ...
                for (int i = 0; i < rootPartySubGroups.length; i++) {
                    RootPartySubGroup group = new RootPartySubGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RootPartyGroup] group version [5.0].";
    }
