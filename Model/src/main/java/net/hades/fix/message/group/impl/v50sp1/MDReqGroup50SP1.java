...
/*
 * MDReqGroup50SP1.java
 *
 * $Id: MDReqGroup50SP1.java,v 1.7 2011-04-14 23:44:52 vrotaru Exp $
 */
...
public class MDReqGroup50SP1 extends MDReqGroup {
    ...
    public MDReqGroup50SP1() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        instrument = new Instrument50SP1(context);
    }

    public MDReqGroup50SP1(FragmentContext context) {
        super(context);
        instrument = new Instrument50SP1(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MDReqGroup] group version [5.0SP1].";
    }
