...
/*
 * TradeCaptureReportAckMsg50.java
 *
...
import net.hades.fix.message.group.impl.v50.TrdCapRptAckSideGroup50;
...
/**
 * FIX version 5.0 TradeCaptureReportAckMsg implementation.
 *
...
@XmlType(propOrder = {"header", "rootPartyIDGroups", "instrument", "underlyingInstruments", "trdInstrmtLegGroups", "trdRegTimestampsGroups", "posAmtGroups", "trdCapRptAckSideGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class TradeCaptureReportAckMsg50 extends TradeCaptureReportAckMsg {
    ...
    protected static final Set<Integer> TRD_CAP_RPT_ACK_SIDE_GROUP_TAGS = new TrdCapRptAckSideGroup50().getFragmentAllTags();
    ...
    public TradeCaptureReportAckMsg50() {
        super();
    }

    public TradeCaptureReportAckMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradeCaptureReportAckMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradeCaptureReportAckMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradeCaptureReportAckMsg50 fixml = (TradeCaptureReportAckMsg50) fragment;
    ...
    public void setNoSides(Integer noSides) {
        ...
        if (noSides != null) {
            ...
            for (int i = 0; i < trdCapRptAckSideGroups.length; i++) {
                trdCapRptAckSideGroups[i] = new TrdCapRptAckSideGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public TrdCapRptAckSideGroup addTrdCapRptAckSideGroup() {
        TrdCapRptAckSideGroup group = new TrdCapRptAckSideGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (TRD_CAP_RPT_ACK_SIDE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSides != null && noSides.intValue() > 0) {
                ...
                for (int i = 0; i < noSides.intValue(); i++) {
                    TrdCapRptAckSideGroup component = new TrdCapRptAckSideGroup50(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradeCaptureReportAckMsg] message version [5.0].";
    }
