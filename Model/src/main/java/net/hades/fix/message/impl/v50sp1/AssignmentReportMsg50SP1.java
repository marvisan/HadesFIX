...
/**
 * FIX version 5.0SP1 AssignmentReportMsg implementation.
 *
...
public class AssignmentReportMsg50SP1 extends AssignmentReportMsg {
    ...
    public AssignmentReportMsg50SP1() {
        super();
    }

    public AssignmentReportMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AssignmentReportMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AssignmentReportMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AssignmentReportMsg50SP1 fixml = (AssignmentReportMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AssignmentReportMsg] message version [5.0SP1].";
    }
