...
/*
 * SecurityTradingRules50SP1.java
 *
 * $Id: SecurityTradingRules50SP1.java,v 1.2 2011-04-20 00:32:34 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.NestedInstrmtAttribGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.TradingSessionRuleGroup50SP1;
...
/**
 * FIX 5.0SP1 implementation of SecurityTradingRules component.
 * 
...
public class SecurityTradingRules50SP1 extends SecurityTradingRules {
    ...
    protected static final Set<Integer> BASE_TRADING_RULES_COMP_TAGS = new BaseTradingRules50SP1().getFragmentAllTags();
    protected static final Set<Integer> TRAD_SESSION_RULE_GROUP_TAGS = new TradingSessionRuleGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> NESTED_INSTR_ATTR_GROUP_TAGS = new NestedInstrmtAttribGroup50SP1().getFragmentAllTags();
    ...
    public SecurityTradingRules50SP1() {
        super();
    }

    public SecurityTradingRules50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setBaseTradingRules() {
        this.baseTradingRules = new BaseTradingRules50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setNoTradingSessionRules(Integer noTradingSessionRules) {
        ...
        if (noTradingSessionRules != null) {
            ...
            for (int i = 0; i < tradingSessionRuleGroups.length; i++) {
                tradingSessionRuleGroups[i] = new TradingSessionRuleGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public TradingSessionRuleGroup addTradingSessionRuleGroup() {
        TradingSessionRuleGroup group = new TradingSessionRuleGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoNestedInstrAttrib(Integer noNestedInstrAttrib) {
        ...
        if (noNestedInstrAttrib != null) {
            ...
            for (int i = 0; i < nestedInstrmtAttribGroups.length; i++) {
                nestedInstrmtAttribGroups[i] = new NestedInstrmtAttribGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public NestedInstrmtAttribGroup addNestedInstrmtAttribGroup() {
        NestedInstrmtAttribGroup group = new NestedInstrmtAttribGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (BASE_TRADING_RULES_COMP_TAGS.contains(tag.tagNum)) {
            if (baseTradingRules == null) {
                baseTradingRules = new BaseTradingRules50SP1(context);
            }
        ...
        if (noTradingSessionRules != null && noTradingSessionRules.intValue() > 0) {
            if (TRAD_SESSION_RULE_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noTradingSessionRules.intValue(); i++) {
                    TradingSessionRuleGroup group = new TradingSessionRuleGroup50SP1(context);
        ...
        if (noNestedInstrAttrib != null && noNestedInstrAttrib.intValue() > 0) {
            if (NESTED_INSTR_ATTR_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noNestedInstrAttrib.intValue(); i++) {
                    NestedInstrmtAttribGroup group = new NestedInstrmtAttribGroup50SP1(context);
                    group.decode(message);
