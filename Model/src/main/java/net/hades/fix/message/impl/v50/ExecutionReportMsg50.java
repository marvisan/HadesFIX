...
/*
 * ExecutionReportMsg50.java
 *
 * $Id: ExecutionReportMsg50.java,v 1.4 2011-04-14 23:44:42 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.ContraBrokerGroup50;
...
import net.hades.fix.message.group.impl.v50.ContAmtGroup50;
import net.hades.fix.message.group.impl.v50.InstrmtLegExecGroup50;
...
/**
 * FIX version 5.0 ExecutionReport implementation.
 *
...
@XmlType(propOrder = {"header", "partyIDGroups", "contraBrokers", "instrument", "financingDetails",
    ...
    "strategyParametersGroups", "commissionData", "spreadOrBenchmarkCurveData", "yieldData", "displayInstruction",
    "contAmtGroups", "instrmtLegExecGroups", "miscFeeGroups", "trdRegTimestampsGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class ExecutionReportMsg50 extends ExecutionReportMsg {
    ...
    protected static final Set<Integer> CONTRA_BROKER_GROUP_TAGS = new ContraBrokerGroup50().getFragmentAllTags();
    ...
    protected static final Set<Integer> INSTRMT_LEG_EXEC_GROUP_TAGS = new InstrmtLegExecGroup50().getFragmentAllTags();
    ...
    public ExecutionReportMsg50() {
        super();
    }

    public ExecutionReportMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ExecutionReportMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ExecutionReportMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ExecutionReportMsg50 fixml = (ExecutionReportMsg50) fragment;
    ...
    public void setNoContraBrokers(Integer noContraBrokers) {
        ...
        if (noContraBrokers != null) {
            ...
            for (int i = 0; i < contraBrokers.length; i++) {
                contraBrokers[i] = new ContraBrokerGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public ContraBrokerGroup addContraBroker() {
        ContraBrokerGroup group = new ContraBrokerGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < instrmtLegExecGroups.length; i++) {
                instrmtLegExecGroups[i] = new InstrmtLegExecGroup50(context);
            }
        }
    }
    ...
    public InstrmtLegExecGroup addInstrmtLegExecGroup() {
        InstrmtLegExecGroup group = new InstrmtLegExecGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (CONTRA_BROKER_GROUP_TAGS.contains(tag.tagNum)) {
            if (noContraBrokers != null && noContraBrokers.intValue() > 0) {
                ...
                for (int i = 0; i < noContraBrokers.intValue(); i++) {
                    ContraBrokerGroup group = new ContraBrokerGroup50(context);
        ...
        if (INSTRMT_LEG_EXEC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    InstrmtLegExecGroup component = new InstrmtLegExecGroup50(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ExecutionReportMsg] message version [5.0].";
    }
