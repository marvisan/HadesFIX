...
/*
 * QuoteStatusRequestMsg50SP2.java
 *
 * $Id: QuoteStatusRequestMsg50SP2.java,v 1.11 2011-04-14 23:44:28 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 QuoteStatusRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.11 $
 * @created 01/04/2009, 8:41:14 AM
 */
@XmlRootElement(name="QuotStatReq")
@XmlType(propOrder = {"header", "instrument", "financingDetails", "underlyingInstruments",
    "instrumentLegs", "partyIDGroups", "targetPartyGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class QuoteStatusRequestMsg50SP2 extends QuoteStatusRequestMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -5097387140112891690L;
    ...
    public QuoteStatusRequestMsg50SP2() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        instrument = new Instrument50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    
    public QuoteStatusRequestMsg50SP2(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteStatusRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    ...
    public QuoteStatusRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteStatusRequestMsg fixml = (QuoteStatusRequestMsg) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteStatusRequestMsg] message version [5.0SP2].";
    }
