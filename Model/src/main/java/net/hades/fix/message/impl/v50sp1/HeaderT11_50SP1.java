/*
 *   Copyright (c) 2006-2040 Marvisan Pty. Ltd. All rights reserved.
 *               Use is subject to license terms.
 */

/*
 * HeaderT11_50SP1.java
 *
 * $Id: HeaderT11_50SP1.java,v 1.11 2011-04-14 23:44:57 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.HopsGroup50SP1;
...
public class HeaderT11_50SP1 extends HeaderFIXT11 {
    ...
    public HeaderT11_50SP1() {
        super();
        applVerID = ApplVerID.FIX50SP1;
    }
    
    public HeaderT11_50SP1(FragmentContext context) {
        super(context);
        applVerID = ApplVerID.FIX50SP1;
        messageEncoding = Charset.forName(FIXMsg.DEFAULT_CHARACTER_SET);
    }
    
    public HeaderT11_50SP1(String msgType, FragmentContext context) {
    ...
    public void setNoHops(Integer noEvents) {
        ...
        if (noHops != null) {
            ...
            for (int i = 0; i < hopsGroups.length; i++) {
                hopsGroups[i] = new HopsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public HopsGroup addHopsGroup() {
        ...
        HopsGroup group = new HopsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noHops != null && noHops.intValue() > 0) {
            if (HOPS_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noHops.intValue(); i++) {
                    HopsGroup group = new HopsGroup50SP1(context);
