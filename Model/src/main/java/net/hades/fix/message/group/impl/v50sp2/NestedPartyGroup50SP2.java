...
/*
 * NestedPartyGroup50SP2.java
 *
 * $Id: NestedPartyGroup50SP2.java,v 1.8 2011-04-14 23:44:30 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.NestedPartySubGroup50SP1;
import net.hades.fix.message.type.PartyIDSource;

/**
 * FIX 5.0SP2 implementation of NestedPartyGroup group.
 *
...
public class NestedPartyGroup50SP2 extends NestedPartyGroup {
    ...
    public NestedPartyGroup50SP2() {
    }

    public NestedPartyGroup50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoNestedPartySubIDs(Integer noNestedPartySubIDs) {
        ...
        if (noNestedPartySubIDs != null) {
            ...
            for (int i = 0; i < nstdPtysSubGroups.length; i++) {
                nstdPtysSubGroups[i] = new NestedPartySubGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public NestedPartySubGroup addNstdPtysSubGroup() {
        ...
        NestedPartySubGroup group = new NestedPartySubGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NestedPartyGroup] group version [5.0SP2].";
    }
