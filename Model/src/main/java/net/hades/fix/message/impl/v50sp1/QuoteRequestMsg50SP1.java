...
/*
 * QuoteRequestMsg50SP1.java
 *
 * $Id: QuoteRequestMsg50SP1.java,v 1.12 2011-04-14 23:44:58 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.QuoteRequestGroup50SP1;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.OrderCapacity;
import net.hades.fix.message.xml.codec.jaxb.adapter.FixBooleanAdapter;

/**
 * FIX version 5.0SP1 QuoteRequestMsg implementation.
 *
...
public class QuoteRequestMsg50SP1 extends QuoteRequestMsg {
    ...
    protected static final Set<Integer> RELATED_SYM_GROUP_TAGS = new QuoteRequestGroup50SP1().getFragmentAllTags();
    ...
    public QuoteRequestMsg50SP1() {
        super();
    }

    public QuoteRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public QuoteRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public QuoteRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteRequestMsg50SP1 fixml = (QuoteRequestMsg50SP1) fragment;
    ...
    public void setNoRelatedSym(Integer noRelatedSym) {
        ...
        if (noRelatedSym != null) {
            ...
            for (int i = 0; i < quoteRelatedSymbols.length; i++) {
                quoteRelatedSymbols[i] = new QuoteRequestGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public QuoteRequestGroup addQuoteRelatedSymbolGroup() {
        QuoteRequestGroup group = new QuoteRequestGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (RELATED_SYM_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRelatedSym != null && noRelatedSym.intValue() > 0) {
                ...
                quoteRelatedSymbols = new QuoteRequestGroup[noRelatedSym.intValue()];
                for (int i = 0; i < quoteRelatedSymbols.length; i++) {
                    QuoteRequestGroup group = new QuoteRequestGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteRequestMsg] message version [5.0SP1].";
    }
