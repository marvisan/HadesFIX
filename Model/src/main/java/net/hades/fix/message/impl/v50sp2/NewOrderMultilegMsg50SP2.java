...
/*
 * NewOrderMultilegMsg50SP2.java
 *
 * $Id: NewOrderMultilegMsg50SP2.java,v 1.2 2011-09-09 08:05:14 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 NewOrderMultilegMsg implementation.
 *
...
public class NewOrderMultilegMsg50SP2 extends NewOrderMultilegMsg {
    ...
    public NewOrderMultilegMsg50SP2() {
        super();
    }

    public NewOrderMultilegMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public NewOrderMultilegMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public NewOrderMultilegMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewOrderMultilegMsg50SP2 fixml = (NewOrderMultilegMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderMultilegMsg] message version [5.0SP2].";
    }
