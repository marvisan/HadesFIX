...
/**
 * FIX 4.4 implementation of CpctyConfGroup group.
 *
...
public class CpctyConfGroup44 extends CpctyConfGroup {
    ...
    public CpctyConfGroup44() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CpctyConfGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (MsgUtil.isTagInList(TagNum.OrderCapacityQty, SECURED_TAGS, secured)) {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CpctyConfGroup] group version [4.4].";
    }
