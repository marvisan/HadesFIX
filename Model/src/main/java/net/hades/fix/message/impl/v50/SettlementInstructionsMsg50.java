...
/*
 * SettlementInstructionsMsg50.java
 *
 * $Id: SettlementInstructionsMsg50.java,v 1.3 2011-04-14 23:44:42 vrotaru Exp $
 */
package net.hades.fix.message.impl.v50;

import net.hades.fix.message.FragmentContext;
import net.hades.fix.message.group.SettlInstGroup;
import net.hades.fix.message.group.impl.v50.SettlInstGroup50;
...
/**
 * FIX version 5.0 SettlementInstructionsMsg implementation.
 *
...
public class SettlementInstructionsMsg50 extends SettlementInstructionsMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> SETTL_INST_GROUP_TAGS = new SettlInstGroup50().getFragmentAllTags();
    ...
    public SettlementInstructionsMsg50() {
        super();
    }

    public SettlementInstructionsMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SettlementInstructionsMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SettlementInstructionsMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SettlementInstructionsMsg50 fixml = (SettlementInstructionsMsg50) fragment;
    ...
    public void setNoSettlInst(Integer noSettlInst) {
        ...
        if (noSettlInst != null) {
            ...
            for (int i = 0; i < settlInstGroups.length; i++) {
                settlInstGroups[i] = new SettlInstGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public SettlInstGroup addSettlInstGroup() {
        SettlInstGroup group = new SettlInstGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (SETTL_INST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSettlInst != null && noSettlInst.intValue() > 0) {
                ...
                for (int i = 0; i < noSettlInst.intValue(); i++) {
                    SettlInstGroup group = new SettlInstGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SettlementInstructionsMsg] message version [5.0].";
    }
