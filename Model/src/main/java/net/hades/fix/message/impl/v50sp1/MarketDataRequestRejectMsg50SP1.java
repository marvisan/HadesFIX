 ...
 *
 * $Id: MarketDataRequestRejectMsg50SP1.java,v 1.9 2011-04-14 23:44:55 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.AltMDSourceGroup50SP1;
...
public class MarketDataRequestRejectMsg50SP1 extends MarketDataRequestRejectMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -7652565470810162593L;

    protected static final Set<Integer> START_COMP_TAGS;
    
    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> ALT_MD_SOURCE_GROUP_TAGS = new AltMDSourceGroup50SP1().getFragmentAllTags();
    ...
    public MarketDataRequestRejectMsg50SP1() {
        super();
    }
    
    public MarketDataRequestRejectMsg50SP1(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MarketDataRequestRejectMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MarketDataRequestRejectMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MarketDataRequestRejectMsg fixml = (MarketDataRequestRejectMsg50SP1) fragment;
    ...
    public void setNoAltMDSource(Integer noAltMDSource) {
        ...
        if (noAltMDSource != null) {
            ...
            for (int i = 0; i < altMDSourceGroups.length; i++) {
                altMDSourceGroups[i] = new AltMDSourceGroup50SP1(context);
            }
        }
    }
    ...
    public AltMDSourceGroup addAltMDSourceGroup() {
        AltMDSourceGroup group = new AltMDSourceGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (ALT_MD_SOURCE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAltMDSource != null && noAltMDSource.intValue() > 0) {
                ...
                for (int i = 0; i < noAltMDSource.intValue(); i++) {
                    AltMDSourceGroup group = new AltMDSourceGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MarketDataRequestRejectMsg] message version [5.0SP1].";
    }
