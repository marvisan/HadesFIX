...
/*
 * TradeAllocGroup50.java
 *
 * $Id: TradeAllocGroup50.java,v 1.1 2011-10-21 10:31:02 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of TradeAllocGroup group.
 *
...
public class TradeAllocGroup50 extends TradeAllocGroup {
    ...
    public TradeAllocGroup50() {
    }

    public TradeAllocGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNestedParties2() {
        ...
        this.nestedParties2 = new NestedParties250(context);
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (NESTED_PARTIES2_COMP_TAGS.contains(tag.tagNum)) {
            if (nestedParties2 == null) {
                nestedParties2 = new NestedParties250(context);
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradeAllocGroup] group version [5.0].";
    }
