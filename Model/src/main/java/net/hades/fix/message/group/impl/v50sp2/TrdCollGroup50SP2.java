...
/**
 * FIX 5.0SP2 implementation of TrdCollGroup group.
 *
...
public class TrdCollGroup50SP2 extends TrdCollGroup {
    ...
    public TrdCollGroup50SP2() {
    }
    
    public TrdCollGroup50SP2(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TrdCollGroup] group version [5.0SP2].";
    }
