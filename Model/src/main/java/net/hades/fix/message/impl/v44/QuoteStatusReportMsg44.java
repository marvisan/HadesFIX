...
/*
 * QuoteStatusReportMsg44.java
 *
 * $Id: QuoteStatusReportMsg44.java,v 1.11 2011-04-14 23:44:37 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v44.LegQuoteStatusGroup44;
...
/**
 * FIX version 4.4 QuoteStatusReportMsg implementation.
 *
...
@XmlType(propOrder = {"header", "partyIDGroups", "instrument", "financingDetails", 
    "underlyingInstruments", "orderQtyData", "stipulationsGroups", "legQuoteStatusGroups",
    "quoteQualifierGroups", "spreadOrBenchmarkCurveData", "yieldData"})
@XmlAccessorType(XmlAccessType.NONE)
public class QuoteStatusReportMsg44 extends QuoteStatusReportMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -6621850641724424735L;
    ...
    protected static final Set<Integer> LEG_QUOTE_STATUS_GROUP_TAGS = new LegQuoteGroup44().getFragmentAllTags();
    ...
    public QuoteStatusReportMsg44(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteStatusReportMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired);
        instrument = new Instrument44(context);
    ...
    public QuoteStatusReportMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        QuoteStatusReportMsg44 fixml = (QuoteStatusReportMsg44) fragment;
    ...
    public void setParties() {
        this.parties = new Parties44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    }
    ...
    public void setInstrument() {
        instrument = new Instrument44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    }
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < legQuoteStatusGroups.length; i++) {
                legQuoteStatusGroups[i] = new LegQuoteStatusGroup44(context);
            }
        }
    }
    ...
    public LegQuoteStatusGroup addLegQuoteStatusGroup() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired);
        LegQuoteStatusGroup group = new LegQuoteStatusGroup44(context);
                    ...
                    if (legQuoteStatusGroups != null && legQuoteStatusGroups.length == noLegs.intValue()) {
                        for (int i = 0; i < noLegs.intValue(); i++) {
                            if (legQuoteStatusGroups[i] != null) {
                                bao.write(legQuoteStatusGroups[i].encode(getMsgSecureTypeForFlag(secured)));
                            }
                        }
                    } else {
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (LEG_QUOTE_STATUS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                legQuoteStatusGroups = new LegQuoteStatusGroup[noLegs.intValue()];
                for (int i = 0; i < noLegs.intValue(); i++) {
                    LegQuoteStatusGroup component = new LegQuoteStatusGroup44(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteStatusReportMsg] message version [4.4].";
    }
