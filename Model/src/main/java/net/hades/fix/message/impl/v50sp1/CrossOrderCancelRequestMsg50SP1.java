...
/*
 * CrossOrderCancelRequestMsg50SP1.java
 *
 * $Id: CrossOrderCancelRequestMsg50SP1.java,v 1.1 2011-05-21 23:53:24 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.SideCrossOrdCxlGroup50SP1;
...
/**
 * FIX version 5.0SP1 CrossOrderCancelRequestMsg implementation.
 *
...
public class CrossOrderCancelRequestMsg50SP1 extends CrossOrderCancelRequestMsg {
    ...
    protected static final Set<Integer> SIDE_CROSS_ORD_MOD_GROUP_TAGS = new SideCrossOrdCxlGroup50SP1().getFragmentAllTags();
    ...
    public CrossOrderCancelRequestMsg50SP1() {
        super();
    }

    public CrossOrderCancelRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CrossOrderCancelRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CrossOrderCancelRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CrossOrderCancelRequestMsg50SP1 fixml = (CrossOrderCancelRequestMsg50SP1) fragment;
    ...
    public void setNoSides(Integer noSides) {
        ...
        if (noSides != null) {
            ...
            for (int i = 0; i < sideCrossOrdCxlGroups.length; i++) {
                sideCrossOrdCxlGroups[i] = new SideCrossOrdCxlGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public SideCrossOrdCxlGroup addSideCrossOrdCxlGroup() {
        SideCrossOrdCxlGroup group = new SideCrossOrdCxlGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public InstrumentLeg addInstrumentLeg() {
        InstrumentLeg group = new InstrumentLeg50SP1(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
        ...
        if (SIDE_CROSS_ORD_MOD_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSides != null && noSides.intValue() > 0) {
                ...
                for (int i = 0; i < noSides.intValue(); i++) {
                    SideCrossOrdCxlGroup component = new SideCrossOrdCxlGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CrossOrderCancelRequestMsg] message version [5.0SP1].";
    }
