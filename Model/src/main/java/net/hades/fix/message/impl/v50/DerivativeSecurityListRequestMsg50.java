...
/*
 * DerivativeSecurityListRequestMsg50.java
 *
 * $Id: DerivativeSecurityListRequestMsg50.java,v 1.1 2011-09-22 08:54:33 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 DerivativeSecurityListRequestMsg implementation.
 *
...
public class DerivativeSecurityListRequestMsg50 extends DerivativeSecurityListRequestMsg {
    ...
    public DerivativeSecurityListRequestMsg50() {
        super();
    }

    public DerivativeSecurityListRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public DerivativeSecurityListRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public DerivativeSecurityListRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        DerivativeSecurityListRequestMsg50 fixml = (DerivativeSecurityListRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DerivativeSecurityListRequestMsg] message version [5.0].";
    }
