...
/*
 * OrderCancelRejectMsg50.java
 *
 * $Id: OrderCancelRejectMsg50.java,v 1.1 2011-01-23 10:02:05 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 OrderCancelRejectMsg implementation.
 *
...
public class OrderCancelRejectMsg50 extends OrderCancelRejectMsg {
    ...
    public OrderCancelRejectMsg50() {
        super();
    }

    public OrderCancelRejectMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderCancelRejectMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderCancelRejectMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderCancelRejectMsg50 fixml = (OrderCancelRejectMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderCancelRejectMsg] message version [5.0].";
    }
