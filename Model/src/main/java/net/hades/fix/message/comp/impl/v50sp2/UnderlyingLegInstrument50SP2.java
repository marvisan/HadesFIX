...
/*
 * UnderlyingLegInstrument50SP2.java
 *
 * $Id: UnderlyingLegInstrument50SP2.java,v 1.2 2011-10-25 08:29:21 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.UnderlyingLegSecurityAltIDGroup50SP2;
...
/**
 * FIX 5.0SP2 implementation of UnderlyingLegInstrument component.
 *
...
public class UnderlyingLegInstrument50SP2 extends UnderlyingLegInstrument {
    ...
    protected static final Set<Integer> UNDLY_LEG_SEC_ALT_ID_GROUP_TAGS = new UnderlyingLegSecurityAltIDGroup50SP2().getFragmentAllTags();
    ...
    public UnderlyingLegInstrument50SP2() {
        super();
    }

    public UnderlyingLegInstrument50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoUnderlyingLegSecurityAltID(Integer noUnderlyingLegSecurityAltID) {
        ...
        if (noUnderlyingLegSecurityAltID != null) {
            ...
            for (int i = 0; i < underlyingLegSecurityAltIDGroups.length; i++) {
                underlyingLegSecurityAltIDGroups[i] = new UnderlyingLegSecurityAltIDGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UnderlyingLegSecurityAltIDGroup addUnderlyingLegSecurityAltIDGroup() {
        UnderlyingLegSecurityAltIDGroup group = new UnderlyingLegSecurityAltIDGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noUnderlyingLegSecurityAltID != null && noUnderlyingLegSecurityAltID.intValue() > 0) {
            if (UNDLY_LEG_SEC_ALT_ID_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noUnderlyingLegSecurityAltID.intValue(); i++) {
                    UnderlyingLegSecurityAltIDGroup group = new UnderlyingLegSecurityAltIDGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [UnderlyingLegInstrument] component version [5.0SP2].";
    }
