...
public abstract class CollateralResponseMsg extends FIXMsg {
    ...
    protected static final Set<Integer> TAGS = new HashSet<Integer>(Arrays.asList(new Integer[] {
        TagNum.CollRespID.getValue(),
        TagNum.CollAsgnID.getValue(),
        TagNum.CollReqID.getValue(),
        TagNum.CollAsgnReason.getValue(),
        TagNum.CollAsgnTransType.getValue(),
        TagNum.CollAsgnRespType.getValue(),
        TagNum.CollAsgnRejectReason.getValue(),
    ...
    /**
     * TagNum = 904 REQUIRED. Starting with 4.4 version.
     */
    protected String collRespID;

    /**
     * TagNum = 902. Starting with 4.4 version.
     */
    protected String collAsgnID;

    /**
     * TagNum = 894. Starting with 4.4 version.
     */
    protected String collReqID;
    
    /**
     * TagNum = 895. Starting with 4.4 version.
     */
    protected CollAsgnReason collAsgnReason;
  
    /**
     * TagNum = 903. Starting with 4.4 version.
     */
    protected CollAsgnTransType collAsgnTransType;

    /**
     * TagNum = 905 REQUIRED. Starting with 4.4 version.
     */
    protected CollAsgnRespType collAsgnRespType;
    
    /**
     * TagNum = 906. Starting with 4.4 version.
     */
    protected CollAsgnRejectReason collAsgnRejectReason;
     ...
     * Starting with 4.4 version.
     */
    protected UndInstrmtCollGroup[] undInstrmtCollGroups;
    ...
    public CollateralResponseMsg() {
        super();
    }

    public CollateralResponseMsg(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralResponseMsg(BeginString beginString) throws InvalidMsgException {
        super(MsgType.CollateralResponse.getValue(), beginString);
    }

    public CollateralResponseMsg(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
        super(MsgType.CollateralResponse.getValue(), beginString, applVerID);
    }
    ...
    @TagNumRef(tagNum=TagNum.CollRespID, required=true)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnID)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollReqID)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnReason)
    ...
    /**
     * Message field setter.
     * @param collAsgnReason field value
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnReason)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnTransType)
    ...
    /**
     * Message field setter.
     * @param collAsgnTransType field value
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnTransType)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnRespType, required=true)
    ...
    /**
     * Message field setter.
     * @param collAsgnRespType field value
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnRespType, required=true)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnRejectReason)
    ...
    /**
     * Message field setter.
     * @param collAsgnRejectReason field value
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.CollAsgnRejectReason)
   ...
   /**
    ...
    /**
     * This method sets the number of {@link UndInstrmtCollGroup} components. It will also create an array
     * of {@link UndInstrmtCollGroup} objects and set the <code>undInstrmtCollGroups</code>
     * field with this array.
     * The created objects inside the array need to be populated with data for encoding.<br/>
     * If there where already objects in <code>undInstrmtCollGroups</code> array they will be discarded.<br/>
    ...
    /**
     * Message field getter for {@link UndInstrmtCollGroup} array of groups.
     * @return field array value
     */
    @FIXVersion(introduced = "4.4")
    ...
    /**
     * This method adds a {@link UndInstrmtCollGroup} object to the existing array of <code>undInstrmtCollGroups</code>
     * and expands the static array with 1 place.<br/>
     ...
     * <code>undInstrmtCollGroups</code> array created.<br/>
     * @return newly created block and added to the array group object
     */
    @FIXVersion(introduced = "4.4")
    ...
    /**
     * This method deletes a {@link UndInstrmtCollGroup} object from the existing array of <code>undInstrmtCollGroups</code>
     * and shrink the static array with 1 place.<br/>
     * If the array does not have the index position then a null object will be returned.)<br/>
     * This method will also update <code>noUnderlyings</code> field to the proper value.<br/>
     * @param index position in array to be deleted starting at 0
    ...
    /**
     * Deletes all the {@link UndInstrmtCollGroup} objects from the <code>undInstrmtCollGroups</code> array
     * (sets the array to 0 length)<br/>
                ...
                if (undInstrmtCollGroups != null && undInstrmtCollGroups.length == noUnderlyings.intValue()) {
                    for (int i = 0; i < noUnderlyings.intValue(); i++) {
                        if (undInstrmtCollGroups[i] != null) {
                            bao.write(undInstrmtCollGroups[i].encode(MsgSecureType.ALL_FIELDS));
                        }
                    }
                } else {
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {     
            case CollRespID:
                collRespID = new String(tag.value, sessionCharset);
                break;
                
            case CollAsgnID:
                collAsgnID = new String(tag.value, sessionCharset);
                break;

            case CollReqID:
                collReqID = new String(tag.value, sessionCharset);
                break;

            case CollAsgnReason:
                collAsgnReason = CollAsgnReason.valueFor(Integer.valueOf(new String(tag.value, sessionCharset)));
                break;

            case CollAsgnTransType:
                collAsgnTransType = CollAsgnTransType.valueFor(Integer.valueOf(new String(tag.value, sessionCharset)));
                break;

            case CollAsgnRespType:
                collAsgnRespType = CollAsgnRespType.valueFor(Integer.valueOf(new String(tag.value, sessionCharset)));
                break;

            case CollAsgnRejectReason:
                collAsgnRejectReason = CollAsgnRejectReason.valueFor(Integer.valueOf(new String(tag.value, sessionCharset)));
                break;
           ...
           case SecondaryClOrdID:
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [CollateralResponseMsg] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("{CollateralResponseMsg=");
        b.append(header != null ? header.toString() : "");
        b.append(System.getProperty("line.separator")).append("{Body=");
        printTagValue(b, TagNum.CollRespID, collRespID);
        printTagValue(b, TagNum.CollAsgnID, collAsgnID);
        printTagValue(b, TagNum.CollReqID, collReqID);
        printTagValue(b, TagNum.CollAsgnReason, collAsgnReason);
        printTagValue(b, TagNum.CollAsgnTransType, collAsgnTransType);
        printTagValue(b, TagNum.CollAsgnRespType, collAsgnRespType);
        printTagValue(b, TagNum.CollAsgnRejectReason, collAsgnRejectReason);
        ...
        printTagValue(b, undInstrmtCollGroups);
