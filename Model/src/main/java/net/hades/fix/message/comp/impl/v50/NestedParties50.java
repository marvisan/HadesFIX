...
/*
 * NestedParties50.java
 *
 * $Id: NestedParties50.java,v 1.7 2011-04-14 23:44:50 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.NestedPartyGroup50;

/**
 * FIX version 5.0 implementation of NestedParties component.
 *
 ...
 */
@XmlTransient
public class NestedParties50 extends NestedParties {
    ...
    protected static final Set<Integer> NESTED_PARTY_GROUP_TAGS = new NestedPartyGroup50().getFragmentAllTags();
    ...
    public NestedParties50() {
        super();
    }

    public NestedParties50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoNestedPartyIDs(Integer noNestedPartyIDs) {
        ...
        if (noNestedPartyIDs != null) {
            ...
            for (int i = 0; i < nestedPartyGroups.length; i++) {
                nestedPartyGroups[i] = new NestedPartyGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public NestedPartyGroup addNestedPartyGroup() {
        NestedPartyGroup group = new NestedPartyGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NESTED_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNestedPartyIDs != null && noNestedPartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < nestedPartyGroups.length; i++) {
                    NestedPartyGroup group = new NestedPartyGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NestedParties] component version [5.0].";
    }
