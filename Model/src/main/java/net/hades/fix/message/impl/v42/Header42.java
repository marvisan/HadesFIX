 ...
 * Header42.java
 *
 * $Id: Header42.java,v 1.8 2010-04-25 09:49:58 vrotaru Exp $
 */
...
/**
 * Standard header for FIX version 4.2.
 * 
...
public class Header42 extends Header {

    // <editor-fold defaultstate="collapsed" desc="Constants">
    
    private static final long serialVersionUID = -6793847414439420475L;
    ...
    public Header42(FragmentContext context) {
        super(context);
        beginString = BeginString.FIX_4_2;
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        messageEncoding = Charset.forName(FIXMsg.DEFAULT_CHARACTER_SET);
        
    }
    
    public Header42(String msgType, FragmentContext context) {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        Header42 fixmlHeader = (Header42) fragment;
