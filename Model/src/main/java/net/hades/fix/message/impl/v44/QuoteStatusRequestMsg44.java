...
/*
 * QuoteStatusRequestMsg44.java
 *
 * $Id: QuoteStatusRequestMsg44.java,v 1.12 2011-04-14 23:44:38 vrotaru Exp $
 */
...
/**
 * FIX version 4.4 QuoteStatusRequestMsg implementation.
 *
...
public class QuoteStatusRequestMsg44 extends QuoteStatusRequestMsg {
    ...
    public QuoteStatusRequestMsg44() {
        super();
    ...
    public QuoteStatusRequestMsg44(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteStatusRequestMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired);
        instrument = new Instrument44(context);
    ...
    public QuoteStatusRequestMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteStatusRequestMsg] message version [4.4].";
    }
