...
/*
 * SecurityStatusMsg50SP2.java
 *
 * $Id: SecurityStatusMsg50SP2.java,v 1.1 2011-04-21 09:45:43 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 SecurityStatusMsg implementation.
 *
...
public class SecurityStatusMsg50SP2 extends SecurityStatusMsg {
    ...
    public SecurityStatusMsg50SP2() {
        super();
    }

    public SecurityStatusMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityStatusMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityStatusMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityStatusMsg50SP2 fixml = (SecurityStatusMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityStatusMsg] message version [5.0SP2].";
    }
