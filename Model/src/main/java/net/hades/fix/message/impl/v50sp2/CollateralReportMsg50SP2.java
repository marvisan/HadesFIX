...
/**
 * FIX version 5.0SP2 CollateralReportMsg implementation.
 *
...
public class CollateralReportMsg50SP2 extends CollateralReportMsg {
    ...
    public CollateralReportMsg50SP2() {
        super();
    }

    public CollateralReportMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralReportMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralReportMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralReportMsg50SP2 fixml = (CollateralReportMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralReportMsg] message version [5.0SP2].";
    }
