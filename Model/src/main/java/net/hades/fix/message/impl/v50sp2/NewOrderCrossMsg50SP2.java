...
/*
 * NewOrderCrossMsg50SP2.java
 *
 * $Id: NewOrderCrossMsg50SP2.java,v 1.2 2011-05-13 08:16:05 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 NewOrderCrossMsg implementation.
 *
...
public class NewOrderCrossMsg50SP2 extends NewOrderCrossMsg {
    ...
    public NewOrderCrossMsg50SP2() {
        super();
    }

    public NewOrderCrossMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public NewOrderCrossMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public NewOrderCrossMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewOrderCrossMsg50SP2 fixml = (NewOrderCrossMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderCrossMsg] message version [5.0SP2].";
    }
