...
/*
 * SecurityDefinitionMsg50SP2.java
 *
 * $Id: SecurityDefinitionMsg50SP2.java,v 1.3 2011-04-21 09:45:43 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 SecurityDefinitionMsg implementation.
 *
...
public class SecurityDefinitionMsg50SP2 extends SecurityDefinitionMsg {
    ...
    public SecurityDefinitionMsg50SP2() {
        super();
    }

    public SecurityDefinitionMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityDefinitionMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityDefinitionMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityDefinitionMsg50SP2 fixml = (SecurityDefinitionMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityDefinitionMsg] message version [5.0SP2].";
    }
