...
/*
 * OrderStatusRequestMsg50SP2.java
 *
 * $Id: OrderStatusRequestMsg50SP2.java,v 1.3 2011-04-14 23:44:27 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 OrderStatusRequestMsg implementation.
 *
...
public class OrderStatusRequestMsg50SP2 extends OrderStatusRequestMsg {
    ...
    public OrderStatusRequestMsg50SP2() {
        super();
    }

    public OrderStatusRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderStatusRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderStatusRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderStatusRequestMsg50SP2 fixml = (OrderStatusRequestMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderStatusRequestMsg] message version [5.0SP2].";
    }
