...
/*
 * MarketDataIncrRefreshMsg50SP2.java
 *
 * $Id: MarketDataIncrRefreshMsg50SP2.java,v 1.9 2011-04-14 23:44:28 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.MDIncGroup50SP2;
...
/**
 * FIX version 5.0SP2 MarketDataIncrRefreshMsg implementation.
 *
...
@XmlType(propOrder = {"header", "applicationSequenceControl", "MDIncGroups", "routingIDGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class MarketDataIncrRefreshMsg50SP2 extends MarketDataIncrRefreshMsg {
    ...
    protected static final Set<Integer> MD_INC_GROUP_TAGS = new MDIncGroup50SP2().getFragmentAllTags();
    ...
    public MarketDataIncrRefreshMsg50SP2() {
        super();
    }
    
    public MarketDataIncrRefreshMsg50SP2(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MarketDataIncrRefreshMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MarketDataIncrRefreshMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MarketDataIncrRefreshMsg50SP2 fixml = (MarketDataIncrRefreshMsg50SP2) fragment;
    ...
    public void setNoMDEntries(Integer noMDEntries) {
        ...
        if (noMDEntries != null) {
            ...
            for (int i = 0; i < mdIncGroups.length; i++) {
                mdIncGroups[i] = new MDIncGroup50SP2(context);
            }
        }
    }
    ...
    public MDIncGroup addMDIncGroup() {
        MDIncGroup group = new MDIncGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (MD_INC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noMDEntries != null && noMDEntries.intValue() > 0) {
                ...
                for (int i = 0; i < noMDEntries.intValue(); i++) {
                    MDIncGroup component = new MDIncGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MarketDataIncrRefreshMsg] message version [4.2].";
    }
