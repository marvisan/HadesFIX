...
/*
 * OrderAllocGroup50SP1.java
 *
 * $Id: OrderAllocGroup50SP1.java,v 1.3 2011-04-14 23:44:51 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of OrderAllocGroup group.
 *
...
public class OrderAllocGroup50SP1 extends OrderAllocGroup {
    ...
    public OrderAllocGroup50SP1() {
    }
    
    public OrderAllocGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNestedParties2() {
        this.nestedParties2 = new NestedParties250SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NESTED_PARTIES2_COMP_TAGS.contains(tag.tagNum)) {
            if (nestedParties2 == null) {
                nestedParties2 = new NestedParties250SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderAllocGroup] group version [5.0SP1].";
    }
