...
/*
 * QuoteCancelGroup42.java
 *
 * $Id: QuoteCancelGroup42.java,v 1.8 2010-08-25 05:30:33 vrotaru Exp $
 */
...
/**
 * FIX 4.2 implementation of QuoteCancelGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.8 $
 * @created 12/02/2009, 7:22:35 PM
 */
public class QuoteCancelGroup42 extends QuoteCancelGroup {
    ...
    public QuoteCancelGroup42() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public QuoteCancelGroup42(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (MsgUtil.isTagInList(TagNum.UnderlyingSymbol, SECURED_TAGS, secured)) {
                TagEncoder.encode(bao, TagNum.UnderlyingSymbol, underlyingSymbol, sessionCharset);
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteCancelGroup] group version [4.2].";
    }
