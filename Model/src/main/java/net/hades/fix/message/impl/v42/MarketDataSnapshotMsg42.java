...
/*
 * MarketDataSnapshotMsg42.java
 *
 * $Id: MarketDataSnapshotMsg42.java,v 1.9 2011-04-14 23:44:39 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v42.MDFullGroup42;
...
/**
 * FIX version 4.2 MarketDataSnapshottMsg implementation.
 *
 ...
 */
@XmlTransient
public class MarketDataSnapshotMsg42 extends MarketDataSnapshotMsg {
    ...
    protected static final Set<Integer> MD_FULL_GROUP_TAGS = new MDFullGroup42().getFragmentAllTags();
    ...
    public MarketDataSnapshotMsg42() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataSnapshotMsg42(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataSnapshotMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataSnapshotMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoMDEntries(Integer noMDEntries) {
        ...
        if (noMDEntries != null) {
            ...
            for (int i = 0; i < mdFullGroups.length; i++) {
                mdFullGroups[i] = new MDFullGroup42(context);
            }
        }
    }
    ...
    public MDFullGroup addMdFullGroup() {
        MDFullGroup group = new MDFullGroup42(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (MD_FULL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noMDEntries != null && noMDEntries.intValue() > 0) {
                ...
                mdFullGroups = new MDFullGroup[noMDEntries.intValue()];
                for (int i = 0; i < noMDEntries.intValue(); i++) {
                    MDFullGroup component = new MDFullGroup42(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MarketDataSnapshotMsg] message version [4.2].";
    }
