...
/*
 * DontKnowTradeMsg50.java
 *
 * $Id: DontKnowTradeMsg50.java,v 1.3 2011-04-14 23:44:40 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 DontKnowTradeMsg implementation.
 *
...
public class DontKnowTradeMsg50 extends DontKnowTradeMsg {
    ...
    public DontKnowTradeMsg50() {
        super();
    }

    public DontKnowTradeMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public DontKnowTradeMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public DontKnowTradeMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        DontKnowTradeMsg50 fixml = (DontKnowTradeMsg50) fragment;
    ...
    @Override
    public net.hades.fix.message.type.DKReason getDKReason() {
        return DKReason;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DontKnowTradeMsg] message version [5.0].";
    }
