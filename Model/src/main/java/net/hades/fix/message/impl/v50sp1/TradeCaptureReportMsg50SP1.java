...
/*
 * TradeCaptureReportMsg50SP1.java
 *
 * $Id: TradeCaptureReportMsg50SP1.java,v 1.2 2011-10-25 08:29:21 vrotaru Exp $
 */
...
import net.hades.fix.message.comp.impl.v50sp1.RootParties50SP1;
...
import net.hades.fix.message.group.impl.v50sp1.PosAmtGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.TrdCapRptSideGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.TrdInstrmtLegGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.TrdRegTimestampsGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.TrdRepIndicatorsGroup50SP1;
...
/**
 * FIX version 5.0SP1 TradeCaptureReportMsg implementation.
 *
...
@XmlType(propOrder = {"header", "applicationSequenceControl", "rootPartyIDGroups", "instrument", "financingDetails", "orderQtyData", 
    "yieldData", "underlyingInstruments", "spreadOrBenchmarkCurveData", "posAmtGroups", "trdInstrmtLegGroups", "trdRegTimestampsGroups",
    "trdCapRptSideGroups", "trdRepIndicatorsGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class TradeCaptureReportMsg50SP1 extends TradeCaptureReportMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> TAGS_V50SP1 = new HashSet<>(Arrays.asList(new Integer[] {
    ...
    protected static final Set<Integer> ROOT_PARTIES_COMP_TAGS = new RootParties50SP1().getFragmentAllTags();
    ...
    protected static final Set<Integer> POS_AMT_GROUP_TAGS = new PosAmtGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> TRD_INSTRMT_LEG__GROUP_TAGS = new TrdInstrmtLegGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> TRD_REG_TSTAMP_GROUP_TAGS = new TrdRegTimestampsGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> TRD_CAP_RPT_SIDE_GROUP_TAGS = new TrdCapRptSideGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> TRD_REP_INDICATORS_GROUP_TAGS = new TrdRepIndicatorsGroup50SP1().getFragmentAllTags();
    ...
    static {
        ALL_TAGS = new HashSet<Integer>(TAGS_V50SP1);
    ...
    public TradeCaptureReportMsg50SP1() {
        super();
    }

    public TradeCaptureReportMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradeCaptureReportMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradeCaptureReportMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradeCaptureReportMsg50SP1 fixml = (TradeCaptureReportMsg50SP1) fragment;
        ...
        if (fixml.getCurrencyRatio() != null) {
            currencyRatio = fixml.getCurrencyRatio();
        }
        ...
        if (fixml.getRejectText() != null) {
            rejectText = fixml.getRejectText();
        }
    ...
    public void setRootParties() {
        this.rootParties = new RootParties50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setRootPartyIDGroups(RootPartyGroup[] rootPartyIDGroups) {
        if (rootPartyIDGroups != null) {
            ...
            ((RootParties50SP1) rootParties).setRootPartyIDGroups(rootPartyIDGroups);
        }
    }
    ...
    public void setNoPosAmt(Integer noPosAmt) {
        ...
        if (noPosAmt != null) {
            ...
            for (int i = 0; i < posAmtGroups.length; i++) {
                posAmtGroups[i] = new PosAmtGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public PosAmtGroup addPosAmtGroup() {
        PosAmtGroup group = new PosAmtGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < trdInstrmtLegGroups.length; i++) {
                trdInstrmtLegGroups[i] = new TrdInstrmtLegGroup50SP1(context);
            }
        }
    }
    ...
    public TrdInstrmtLegGroup addTrdInstrmtLegGroup() {
        TrdInstrmtLegGroup group = new TrdInstrmtLegGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoSides(Integer noSides) {
        ...
        if (noSides != null) {
            ...
            for (int i = 0; i < trdCapRptSideGroups.length; i++) {
                trdCapRptSideGroups[i] = new TrdCapRptSideGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public TrdCapRptSideGroup addTrdCapRptSideGroup() {
        TrdCapRptSideGroup group = new TrdCapRptSideGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoTrdRepIndicators(Integer noTrdRepIndicators) {
        ...
        if (noTrdRepIndicators != null) {
            ...
            for (int i = 0; i < trdRepIndicatorsGroups.length; i++) {
                trdRepIndicatorsGroups[i] = new TrdRepIndicatorsGroup50SP1(context);
            }
        }
    }
    ...
    public TrdRepIndicatorsGroup addTrdRepIndicatorsGroup() {
        TrdRepIndicatorsGroup group = new TrdRepIndicatorsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (ROOT_PARTIES_COMP_TAGS.contains(tag.tagNum)) {
            if (rootParties == null) {
                rootParties = new RootParties50SP1(context);
            }
        ...
        if (POS_AMT_GROUP_TAGS.contains(tag.tagNum)) {
            if (noPosAmt != null && noPosAmt.intValue() > 0) {
                ...
                for (int i = 0; i < noPosAmt.intValue(); i++) {
                    PosAmtGroup group = new PosAmtGroup50SP1(context);
        ...
        if (TRD_INSTRMT_LEG__GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    TrdInstrmtLegGroup group = new TrdInstrmtLegGroup50SP1(context);
                    group.decode(message);
        ...
        if (TRD_CAP_RPT_SIDE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSides != null && noSides.intValue() > 0) {
                ...
                for (int i = 0; i < noSides.intValue(); i++) {
                    TrdCapRptSideGroup component = new TrdCapRptSideGroup50SP1(context);
                    component.decode(message);
        ...
        if (TRD_REP_INDICATORS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noTrdRepIndicators != null && noTrdRepIndicators.intValue() > 0) {
                ...
                for (int i = 0; i < noTrdRepIndicators.intValue(); i++) {
                    TrdRepIndicatorsGroup component = new TrdRepIndicatorsGroup50SP1(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradeCaptureReportMsg] message version [5.0SP1].";
    }
