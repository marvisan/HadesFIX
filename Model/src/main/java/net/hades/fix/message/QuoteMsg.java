 ...
 * QuoteMsg.java
 *
 * $Id: QuoteMsg.java,v 1.17 2011-04-28 10:07:42 vrotaru Exp $
 */
 ...
 * The Quote message is used as the response to a Quote Request or a Quote Response
 * message in both indicative, tradeable, and restricted tradeable quoting markets.
 * In tradeable and restricted tradeable quoting models, the market maker sends quotes
 * into a market as opposed to sending quotes directly to a counterparty.<br/>
 * For Fixed Income in the indicative and tradeable quoting models, the quotes are
 * typically sent directly to an interested counterparty as opposed to a market place.
 * The quote message can be used to send unsolicited quotes in both indicative, tradeable,
 * and restricted tradeable quoting markets.<br/>
 * The quote message contains a quote for a single product. If the issuer of the quote
 * requires a response (i.e. notification that the quote message has been accepted) then
 * the QuoteResponseLevel field should be populated on the quote message – the response
 * would be made using the Quote Status Report message.<br/>
 * The quote should not be used in tradeable and restricted tradeable quoting markets,
 * such as electronic trading systems, to broadcast quotes to market participants.
 * The recommended approach to reporting market state changes that result from quotes
 * received by a market is to use the market data messages. Quotes supplied as the result
 * of a Quote Request message will specify the appropriate QuoteReqID, unsolicited quotes
 * can be identified by the absence of a QuoteReqID.<br/>
 * Orders can be generated based on Quotes. Quoted orders include the QuoteID and are
 * OrdType=Previously Quoted The time in force for a quote is determined by agreement
 * between counterparties. A quote can be canceled either using the Quote Cancel message
 * or by sending a quote message with bid and offer prices and sizes all set to zero
 * (BidPx, OfferPx, BidSize, OfferSize).
 *
...
public abstract class QuoteMsg extends FIXMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -5979719646755918758L;
    ...
    protected static final Set<Integer> TAGS = new HashSet<Integer>(Arrays.asList(new Integer[] {
        ...
        TagNum.BidSwapPoints.getValue(),
        TagNum.OfferSwapPoints.getValue(),
    ...
    /**
     * TagNum = 131. Starting with 4.0 version.
     */
    protected String quoteReqID;

    /**
     * TagNum = 117 REQUIRED. Starting with 4.0 version.
     */
    ...
    /**
     * TagNum = 301. Starting with 4.0 version.
     */
     ...
     * Starting with 4.4 version.
     */
    protected LegQuoteGroup[] legQuoteSymbolGroups;

    /**
     * TagNum = 132 CONDITIONAL REQUIRED. Starting with 4.0 version.
     */
    protected Double bidPx;

    /**
     * TagNum = 133 CONDITIONAL REQUIRED. Starting with 4.0 version.
     */
    ...
    /**
     * TagNum = 134. Starting with 4.0 version.
     */
    ...
    /**
     * TagNum = 135. Starting with 4.0 version.
     */
    ...
    /**
     * TagNum = 188. Starting with 4.1 version.
     */
    protected Double bidSpotRate;

    /**
     * TagNum = 190. Starting with 4.1 version.
     */
    protected Double offerSpotRate;

    /**
     * TagNum = 189. Starting with 4.1 version.
     */
    protected Double bidForwardPoints;

    /**
     * TagNum = 191. Starting with 4.1 version.
     */
    protected Double offerForwardPoints;

    /**
     * TagNum = 1065. Starting with 5.0 version.
     */
    protected Double bidSwapPoints;

    /**
     * TagNum = 1066. Starting with 5.0 version.
     */
    protected Double offerSwapPoints;
    ...
    public QuoteMsg(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public QuoteMsg(BeginString beginString) throws InvalidMsgException {
        super(MsgType.Quote.getValue(), beginString);
    }

    public QuoteMsg(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
        super(MsgType.Quote.getValue(), beginString, applVerID);
    }
     ...
     * of {@link LegQuoteGroup} objects and set the <code>legQuoteSymbolGroups</code> field with this array.
     * The created objects inside the array need to be populated with data for encoding.<br/>
    ...
    /**
     * This method adds a {@link LegQuoteGroup} object to the existing array of <code>legQuoteSymbolGroups</code>
     * and expands the static array with 1 place.<br/>
    ...
    /**
     * This method deletes a {@link LegQuoteGroup} object from the existing array of <code>legQuoteSymbolGroups</code>
     * and shrink the static array with 1 place.<br/>
     * If the array does not have the index position then a null object will be returned.)<br/>
     * This method will also update <code>noLegs</code> field to the proper value.<br/>
     * @param index position in array to be deleted starting at 0
    ...
    /**
     * Deletes all the {@link LegQuoteGroup} objects from the <code>legQuoteSymbolGroups</code> array
     * (sets the array to 0 length)<br/>
    ...
    @TagNumRef(tagNum=TagNum.BidSwapPoints)
    ...
    /**
     * Message field setter.
     * @param bidSwapPoints field value
     */
    @FIXVersion(introduced="5.0")
    @TagNumRef(tagNum=TagNum.BidSwapPoints)
     ...
     */
    @FIXVersion(introduced="5.0")
    @TagNumRef(tagNum=TagNum.OfferSwapPoints)
    ...
    /**
     * Message field setter.
     * @param offerSwapPoints field value
     */
    @FIXVersion(introduced="5.0")
    @TagNumRef(tagNum=TagNum.OfferSwapPoints)
    ...
    protected void validateRequiredTags() throws TagNotPresentException {
        ...
        if (bidPx == null && offerPx == null) {
            errorMsg.append(" [BidPx/OfferPx]");
            hasMissingTag = true;
        }
    ...
    protected byte[] encodeFragmentAll() throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            TagEncoder.encode(bao, TagNum.BidSwapPoints, bidSwapPoints);
            TagEncoder.encode(bao, TagNum.OfferSwapPoints, offerSwapPoints);
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {
            ...
            case BidSwapPoints:
                bidSwapPoints = new Double(new String(tag.value, sessionCharset));
                break;

            case OfferSwapPoints:
                offerSwapPoints = new Double(new String(tag.value, sessionCharset));
                break;
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [QuoteMsg] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("{QuoteMsg=");
        ...
        printTagValue(b, TagNum.BidSwapPoints, bidSwapPoints);
        printTagValue(b, TagNum.OfferSwapPoints, offerSwapPoints);
