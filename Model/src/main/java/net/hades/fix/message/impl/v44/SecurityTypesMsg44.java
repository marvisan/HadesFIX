...
/*
 * SecurityTypesMsg44.java
 *
 * $Id: SecurityTypesMsg44.java,v 1.1 2011-04-27 01:09:57 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v44.SecTypesGroup44;
...
/**
 * FIX version 4.4 SecurityTypesMsg implementation.
 *
...
public class SecurityTypesMsg44 extends SecurityTypesMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> SEC_TYPES_GROUP_TAGS = new SecTypesGroup44().getFragmentAllTags();
    ...
    public SecurityTypesMsg44() {
        super();
    }

    public SecurityTypesMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityTypesMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SecurityTypesMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityTypesMsg44 fixml = (SecurityTypesMsg44) fragment;
    ...
    public void setNoSecurityTypes(Integer noSecurityTypes) {
        ...
        if (noSecurityTypes != null) {
            ...
            for (int i = 0; i < secTypesGroups.length; i++) {
                secTypesGroups[i] = new SecTypesGroup44(context);
            }
        }
    }
    ...
    public SecTypesGroup addSecTypesGroup() {
        SecTypesGroup group = new SecTypesGroup44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (SEC_TYPES_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSecurityTypes != null && noSecurityTypes.intValue() > 0) {
                ...
                secTypesGroups = new SecTypesGroup[noSecurityTypes.intValue()];
                for (int i = 0; i < noSecurityTypes.intValue(); i++) {
                    SecTypesGroup component = new SecTypesGroup44(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityTypesMsg] message version [4.4].";
    }
