...
/*
 * DeliveryInstructionGroup50SP1.java
 *
 * $Id: DeliveryInstructionGroup50SP1.java,v 1.2 2011-04-14 23:44:53 vrotaru Exp $
 */
...
public class DeliveryInstructionGroup50SP1 extends DeliveryInstructionGroup {
    ...
    public DeliveryInstructionGroup50SP1() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public DeliveryInstructionGroup50SP1(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DeliveryInstructionGroup] group version [5.0SP1].";
    }
