...
/*
 * OrderListGroup41.java
 *
 * $Id: OrderStatusGroup41.java,v 1.1 2011-02-03 10:36:54 vrotaru Exp $
 */
...
/**
 * FIX 4.1 implementation of OrderStatusGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 12/02/2009, 7:22:35 PM
 */
public class OrderStatusGroup41 extends OrderStatusGroup {
    ...
    public OrderStatusGroup41() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public OrderStatusGroup41(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderStatusGroup] group version [4.1].";
    }
