...
/**
 * FIX 5.0 implementation of UndInstrmtCollGroup group.
 *
...
public class UndInstrmtCollGroup50 extends UndInstrmtCollGroup {
    ...
    public UndInstrmtCollGroup50() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public UndInstrmtCollGroup50(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [UndInstrmtCollGroup] group version [5.0].";
    }
