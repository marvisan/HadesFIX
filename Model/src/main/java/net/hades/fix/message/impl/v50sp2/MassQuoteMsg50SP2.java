...
/*
 * MassQuoteMsg50SP2.java
 *
 * $Id: MassQuoteMsg50SP2.java,v 1.11 2011-05-02 04:04:19 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.QuoteSetGroup50SP2;
...
public class MassQuoteMsg50SP2 extends MassQuoteMsg {
    ...
    protected static final Set<Integer> QUOTE_SET_GROUP_TAGS = new QuoteSetGroup50SP2().getFragmentAllTags();
    ...
    public MassQuoteMsg50SP2() {
        super();
    }
    
    public MassQuoteMsg50SP2(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MassQuoteMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MassQuoteMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoQuoteSets(Integer noQuoteSets) {
        ...
        if (noQuoteSets != null) {
            ...
            for (int i = 0; i < quoteSetGroups.length; i++) {
                quoteSetGroups[i] = new QuoteSetGroup50SP2(context);
            }
        }
    }
    ...
    public QuoteSetGroup addQuoteSetGroup() {
        QuoteSetGroup group = new QuoteSetGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (QUOTE_SET_GROUP_TAGS.contains(tag.tagNum)) {
            if (noQuoteSets != null && noQuoteSets.intValue() > 0) {
                ...
                for (int i = 0; i < noQuoteSets.intValue(); i++) {
                    QuoteSetGroup component = new QuoteSetGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MassQuoteMsg] message version [5.0SP2].";
    }
