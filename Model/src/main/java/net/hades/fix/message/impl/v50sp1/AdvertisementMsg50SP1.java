...
/*
 * AdvertisementMsg50SP1.java
 *
 * $Id: AdvertisementMsg50SP1.java,v 1.11 2011-04-14 23:44:58 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 AdvertisementMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.11 $
 * @created 10/12/2008, 8:58:00 PM
 */
@XmlRootElement(name="Adv")
@XmlType(propOrder = {"header", "instrument", "instrumentLegs", "underlyingInstruments"})
@XmlAccessorType(XmlAccessType.NONE)
public class AdvertisementMsg50SP1 extends AdvertisementMsg {
    ...
    public AdvertisementMsg50SP1() {
        super();
    }

    public AdvertisementMsg50SP1(Header header, ByteBuffer rawMsg)
    ...
    public AdvertisementMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        if (messageEncoding == null) {
            messageEncoding = Charset.forName(FIXMsg.DEFAULT_CHARACTER_SET);
        }
    ...
    public AdvertisementMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AdvertisementMsg50SP1 fixml = (AdvertisementMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AdvertismentMsg] message version [5.0SP1].";
    }
