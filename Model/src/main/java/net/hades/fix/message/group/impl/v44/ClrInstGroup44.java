...
/**
 * FIX 4.4 implementation of ClrInstGroup group.
 *
...
public class ClrInstGroup44 extends ClrInstGroup {
    ...
    public ClrInstGroup44() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ClrInstGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ClrInstGroup] group version [4.4].";
    }
