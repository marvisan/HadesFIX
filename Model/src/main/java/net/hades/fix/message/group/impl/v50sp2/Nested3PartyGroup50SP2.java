...
/*
 * Nested3PartyGroup50SP2.java
 *
 * $Id: Nested3PartyGroup50SP2.java,v 1.2 2011-04-14 23:44:32 vrotaru Exp $
 */
...
public class Nested3PartyGroup50SP2 extends Nested3PartyGroup {
    ...
    protected static final Set<Integer> NSTD3_PARTY_SUB_GROUP_TAGS = new Nested3PartySubGroup50SP2().getFragmentAllTags();
    ...
    public Nested3PartyGroup50SP2() {
    }

    public Nested3PartyGroup50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoNested3PartySubIDs(Integer noNested3PartySubIDs) {
        ...
        if (noNested3PartySubIDs != null) {
            ...
            for (int i = 0; i < nstd3PtysSubGroups.length; i++) {
                nstd3PtysSubGroups[i] = new Nested3PartySubGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public Nested3PartySubGroup addNstd3PtysSubGroup() {
        Nested3PartySubGroup group = new Nested3PartySubGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NSTD3_PARTY_SUB_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNested3PartySubIDs != null && noNested3PartySubIDs.intValue() > 0) {
                ...
                for (int i = 0; i < nstd3PtysSubGroups.length; i++) {
                    Nested3PartySubGroup group = new Nested3PartySubGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [Nested3PartyGroup] group version [5.0SP2].";
    }
