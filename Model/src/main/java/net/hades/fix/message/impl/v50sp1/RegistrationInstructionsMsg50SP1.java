...
/*
 * RegistrationInstructionsMsg50SP1.java
 *
 * $Id: RegistrationInstructionsMsg50SP1.java,v 1.2 2011-10-29 01:31:22 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.RgstDtlsGroup50SP1;
...
import net.hades.fix.message.group.impl.v50sp1.DistribInstsGroup50SP1;
import net.hades.fix.message.type.RegistTransType;

/**
 * FIX version 5.0SP1 RegistrationInstructionsMsg implementation.
 *
...
public class RegistrationInstructionsMsg50SP1 extends RegistrationInstructionsMsg {
    ...
    protected static final Set<Integer> RGST_DTLS_GROUP_TAGS = new RgstDtlsGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> DISTRIB_INSTS_GROUP_TAGS = new DistribInstsGroup50SP1().getFragmentAllTags();
    ...
    public RegistrationInstructionsMsg50SP1() {
        super();
    }

    public RegistrationInstructionsMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RegistrationInstructionsMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public RegistrationInstructionsMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        RegistrationInstructionsMsg50SP1 fixml = (RegistrationInstructionsMsg50SP1) fragment;
    ...
    public void setNoRegistDtls(Integer noRegistDtls) {
        ...
        if (noRegistDtls != null) {
            ...
            for (int i = 0; i < registDtlsGroups.length; i++) {
                registDtlsGroups[i] = new RgstDtlsGroup50SP1(context);
            }
        }
    }
    ...
    public RgstDtlsGroup addRgstDtlsGroup() {
        RgstDtlsGroup group = new RgstDtlsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public void setNoDistribInsts(Integer noDistribInsts) {
        ...
        if (noDistribInsts != null) {
            ...
            for (int i = 0; i < distribInstsGroups.length; i++) {
                distribInstsGroups[i] = new DistribInstsGroup50SP1(context);
            }
        }
    }
    ...
    public DistribInstsGroup addDistribInstsGroup() {
        DistribInstsGroup group = new DistribInstsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
        ...
        if (RGST_DTLS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRegistDtls != null && noRegistDtls.intValue() > 0) {
                ...
                for (int i = 0; i < noRegistDtls.intValue(); i++) {
                    RgstDtlsGroup group = new RgstDtlsGroup50SP1(context);
        ...
        if (DISTRIB_INSTS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noDistribInsts != null && noDistribInsts.intValue() > 0) {
                ...
                for (int i = 0; i < noDistribInsts.intValue(); i++) {
                    DistribInstsGroup component = new DistribInstsGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RegistrationInstructionsMsg] message version [5.0SP1].";
    }
