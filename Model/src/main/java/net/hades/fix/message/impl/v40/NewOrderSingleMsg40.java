...
/*
 * NewOrderSingleMsg40.java
 *
 * $Id: NewOrderSingleMsg40.java,v 1.2 2010-12-08 10:56:51 vrotaru Exp $
 */
...
/**
 * FIX version 4.1 NewOrderSingleMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class NewOrderSingleMsg40 extends NewOrderSingleMsg {
    ...
    public NewOrderSingleMsg40(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderSingleMsg40(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderSingleMsg40(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderSingleMsg] message version [4.0].";
    }
