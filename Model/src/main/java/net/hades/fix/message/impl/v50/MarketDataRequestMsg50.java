...
/*
 * MarketDataRequestMsg50.java
 *
 * $Id: MarketDataRequestMsg50.java,v 1.9 2011-04-14 23:44:40 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.MDEntryTypeGroup50;
import net.hades.fix.message.group.impl.v50.MDReqGroup50;
...
/**
 * FIX version 5.0 MarketDataRequestMsg implementation.
 *
...
@XmlType(propOrder = {"header", "mdEntryTypeGroups", "mdReqGroups", "tradingSessionGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class MarketDataRequestMsg50 extends MarketDataRequestMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -8304563244519619265L;
    
    protected static final Set<Integer> START_COMP_TAGS;
    
    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> MD_ENTRY_TYPE_GROUP_TAGS = new MDEntryTypeGroup50().getFragmentAllTags();
    protected static final Set<Integer> MD_REQ_GROUP_TAGS = new MDReqGroup50().getFragmentAllTags();
    protected static final Set<Integer> TRADING_SESS_GROUP_TAGS = new TradingSessionGroup50().getFragmentAllTags();
    ...
    public MarketDataRequestMsg50() {
        super();
    }
    
    public MarketDataRequestMsg50(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MarketDataRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MarketDataRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MarketDataRequestMsg50 fixml = (MarketDataRequestMsg50) fragment;
    ...
    public void setNoMDEntryTypes(Integer noMDEntryTypes) {
        ...
        if (noMDEntryTypes != null) {
            ...
            for (int i = 0; i < mdEntryTypeGroups.length; i++) {
                mdEntryTypeGroups[i] = new MDEntryTypeGroup50(context);
            }
        }
    }
    ...
    public MDEntryTypeGroup addMdEntryTypeGroup() {
        MDEntryTypeGroup group = new MDEntryTypeGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoRelatedSym(Integer noRelatedSym) {
        ...
        if (noRelatedSym != null) {
            ...
            for (int i = 0; i < mdReqGroups.length; i++) {
                mdReqGroups[i] = new MDReqGroup50(context);
            }
        }
    }
    ...
    public MDReqGroup addMdReqGroup() {
        MDReqGroup group = new MDReqGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoTradingSessions(Integer noTradingSessions) {
        ...
        if (noTradingSessions != null) {
            ...
            for (int i = 0; i < tradingSessionGroups.length; i++) {
                tradingSessionGroups[i] = new TradingSessionGroup50(context);
            }
        }
    }
        ...
        if (MD_ENTRY_TYPE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noMDEntryTypes != null && noMDEntryTypes.intValue() > 0) {
                ...
                for (int i = 0; i < noMDEntryTypes.intValue(); i++) {
                    MDEntryTypeGroup group = new MDEntryTypeGroup50(context);
        ...
        if (MD_REQ_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRelatedSym != null && noRelatedSym.intValue() > 0) {
                ...
                for (int i = 0; i < noRelatedSym.intValue(); i++) {
                    MDReqGroup group = new MDReqGroup50(context);
                    group.decode(message);
                    mdReqGroups[i] = group;
                }
            }
        ...
        if (TRADING_SESS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noTradingSessions != null && noTradingSessions.intValue() > 0) {
                ...
                for (int i = 0; i < noTradingSessions.intValue(); i++) {
                    TradingSessionGroup50 group = new TradingSessionGroup50(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MarketDataRequestMsg] message version [5.0].";
    }
