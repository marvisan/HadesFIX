...
/*
 * RootParties50SP2.java
 *
 * $Id: RootParties50SP2.java,v 1.7 2011-04-14 23:44:49 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.RootPartyGroup50SP2;
...
/**
 * FIX version 5.0SP2 implementation of RootParties component.
 *
 ...
 */
@XmlTransient
public class RootParties50SP2 extends RootParties {
    ...
    protected static final Set<Integer> ROOT_PARTY_GROUP_TAGS = new RootPartyGroup50SP2().getFragmentAllTags();
    ...
    public RootParties50SP2() {
        super();
    }

    public RootParties50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoRootPartyIDs(Integer noRootPartyIDs) {
        ...
        if (noRootPartyIDs != null) {
            ...
            for (int i = 0; i < rootPartyGroups.length; i++) {
                rootPartyGroups[i] = new RootPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public RootPartyGroup addRootPartyGroup() {
        RootPartyGroup group = new RootPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (ROOT_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRootPartyIDs != null && noRootPartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < rootPartyGroups.length; i++) {
                    RootPartyGroup group = new RootPartyGroup50SP2(context);
