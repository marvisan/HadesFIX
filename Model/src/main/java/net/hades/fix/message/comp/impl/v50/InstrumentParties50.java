...
/*
 * InstrumentParties50.java
 *
 * $Id: InstrumentParties50.java,v 1.8 2011-04-14 23:44:50 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.InstrumentPartyGroup50;

/**
 * FIX 5.0 implementation of InstrumentParties component.
 * 
 ...
 */
@XmlTransient
public class InstrumentParties50 extends InstrumentParties {
    ...
    protected static final Set<Integer> INSTRUMENT_PARTY_GROUP_TAGS = new InstrumentPartyGroup50().getFragmentAllTags();
    ...
    public InstrumentParties50() {
        super();
    }

    public InstrumentParties50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoInstrumentParties(Integer noInstrumentParties) {
        ...
        if (noInstrumentParties != null) {
            ...
            for (int i = 0; i < instrumentPartyGroups.length; i++) {
                instrumentPartyGroups[i] = new InstrumentPartyGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public InstrumentPartyGroup addInstrumentPartyGroup() {
        ...
        InstrumentPartyGroup group = new InstrumentPartyGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noInstrumentParties != null && noInstrumentParties.intValue() > 0) {
            if (INSTRUMENT_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noInstrumentParties.intValue(); i++) {
                    InstrumentPartyGroup group = new InstrumentPartyGroup50(context);
