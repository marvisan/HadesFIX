 ...
 * EmailMsg50SP2.java
 *
 * $Id: EmailMsg50SP2.java,v 1.10 2011-04-14 23:44:29 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 EmailMsg implementation.
 *
...
public class EmailMsg50SP2 extends EmailMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -2353316317531322615L;
    ...
    public EmailMsg50SP2() {
        super();
    }

    public EmailMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public EmailMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public EmailMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        EmailMsg50SP2 fixml = (EmailMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [EmailMsg] message version [5.0SP2].";
    }
