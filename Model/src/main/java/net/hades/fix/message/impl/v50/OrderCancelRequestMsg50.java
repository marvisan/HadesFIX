...
/*
 * OrderCancelRequestMsg50.java
 *
 * $Id: OrderCancelRequestMsg50.java,v 1.3 2011-05-02 04:04:19 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 OrderCancelRequestMsg implementation.
 *
...
public class OrderCancelRequestMsg50 extends OrderCancelRequestMsg {
    ...
    public OrderCancelRequestMsg50() {
        super();
    }

    public OrderCancelRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderCancelRequestMsg50 fixml = (OrderCancelRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderCancelRequestMsg] message version [5.0].";
    }
