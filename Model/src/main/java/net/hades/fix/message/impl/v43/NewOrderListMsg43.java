...
/*
 * NewOrderListMsg43.java
 *
 * $Id: NewOrderListMsg43.java,v 1.3 2011-04-14 23:44:33 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v43.OrderListGroup43;
...
/**
 * FIX version 4.3 NewOrderListMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class NewOrderListMsg43 extends NewOrderListMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> ORDER_LIST_GROUP_TAGS = new OrderListGroup43().getFragmentAllTags();
    ...
    public NewOrderListMsg43() {
        super();
    }

    public NewOrderListMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderListMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderListMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoOrders(Integer noOrders) {
        ...
        if (noOrders != null) {
            ...
            for (int i = 0; i < orderListGroups.length; i++) {
                orderListGroups[i] = new OrderListGroup43(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public OrderListGroup addOrderListGroup() {
        OrderListGroup group = new OrderListGroup43(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (ORDER_LIST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noOrders != null && noOrders.intValue() > 0) {
                ...
                orderListGroups = new OrderListGroup[noOrders.intValue()];
                for (int i = 0; i < noOrders.intValue(); i++) {
                    OrderListGroup group = new OrderListGroup43(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderListMsg] message version [4.3].";
    }
