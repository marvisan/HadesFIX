...
/*
 * DerivativeSecurityAltIDGroup50SP1.java
 *
 * $Id: DerivativeSecurityAltIDGroup50SP1.java,v 1.2 2011-09-22 08:54:34 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of DerivativeSecurityAltIDGroup group.
 *
...
public class DerivativeSecurityAltIDGroup50SP1 extends DerivativeSecurityAltIDGroup {
    ...
    public DerivativeSecurityAltIDGroup50SP1() {
    }

    public DerivativeSecurityAltIDGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DerivativeSecurityAltIDGroup] group version [5.0SP1].";
    }
