...
/*
 * ConfirmationRequestMsg50SP2.java
 *
...
/**
 * FIX version 5.0SP2 ConfirmationRequestMsg implementation.
 *
...
public class ConfirmationRequestMsg50SP2 extends ConfirmationRequestMsg {
    ...
    public ConfirmationRequestMsg50SP2() {
        super();
    }

    public ConfirmationRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ConfirmationRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ConfirmationRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ConfirmationRequestMsg50SP2 fixml = (ConfirmationRequestMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ConfirmationRequestMsg] message version [5.0SP2].";
    }
