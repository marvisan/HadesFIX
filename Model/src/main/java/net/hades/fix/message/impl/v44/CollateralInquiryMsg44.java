...
/**
 * FIX version 4.4 CollateralInquiryMsg implementation.
 *
...
public class CollateralInquiryMsg44 extends CollateralInquiryMsg {
    ...
    public CollateralInquiryMsg44() {
        super();
    }

    public CollateralInquiryMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CollateralInquiryMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CollateralInquiryMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralInquiryMsg44 fixml = (CollateralInquiryMsg44) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralInquiryMsg] message version [4.4].";
    }
