 ...
 *
 * $Id: MDFullGroup50SP1.java,v 1.9 2011-04-14 23:44:52 vrotaru Exp $
 */
...
@XmlType(propOrder = {"yieldData", "spreadOrBenchmarkCurveData", "partyIDGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class MDFullGroup50SP1 extends MDFullGroup {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -1697173501231151225L;
    ...
    public MDFullGroup50SP1() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public MDFullGroup50SP1(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MDFullGroup] group version [5.0SP1].";
    }
