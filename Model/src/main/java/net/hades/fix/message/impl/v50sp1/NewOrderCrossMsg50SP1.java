...
/*
 * NewOrderCrossMsg50SP1.java
 *
 * $Id: NewOrderCrossMsg50SP1.java,v 1.2 2011-05-13 08:16:06 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 NewOrderCrossMsg implementation.
 *
...
public class NewOrderCrossMsg50SP1 extends NewOrderCrossMsg {
    ...
    public NewOrderCrossMsg50SP1() {
        super();
    }

    public NewOrderCrossMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public NewOrderCrossMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public NewOrderCrossMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewOrderCrossMsg50SP1 fixml = (NewOrderCrossMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderCrossMsg] message version [5.0SP1].";
    }
