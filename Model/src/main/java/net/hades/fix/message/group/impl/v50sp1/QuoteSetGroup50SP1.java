...
/*
 * QuoteSetGroup50SP1.java
 *
 * $Id: QuoteSetGroup50SP1.java,v 1.9 2011-04-14 23:44:53 vrotaru Exp $
 */
...
public class QuoteSetGroup50SP1 extends QuoteSetGroup {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -5095577128363078573L;
    
    protected static final Set<Integer> START_COMP_TAGS;

    protected static final Set<Integer> ALL_TAGS;
    
    protected static final Set<Integer> QUOTE_ENTRY_GROUP_TAGS = new QuoteEntryGroup50SP1().getFragmentAllTags();
    ...
    public QuoteSetGroup50SP1() {
    }
    
    public QuoteSetGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoQuoteEntries(Integer noQuoteEntries) {
        ...
        if (noQuoteEntries != null) {
            ...
            for (int i = 0; i < quoteEntryGroups.length; i++) {
                quoteEntryGroups[i] = new QuoteEntryGroup50SP1(context);
            }
        }
    }
    ...
    public QuoteEntryGroup addQuoteEntryGroup() {
        QuoteEntryGroup group = new QuoteEntryGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (QUOTE_ENTRY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noQuoteEntries != null && noQuoteEntries.intValue() > 0) {
                ...
                for (int i = 0; i < quoteEntryGroups.length; i++) {
                    QuoteEntryGroup group = new QuoteEntryGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteSetGroup] group version [5.0SP1].";
    }
