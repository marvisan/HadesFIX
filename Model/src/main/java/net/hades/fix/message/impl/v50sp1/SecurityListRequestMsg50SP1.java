...
/*
 * SecurityListRequestMsg50SP1.java
 *
 * $Id: SecurityListRequestMsg50SP1.java,v 1.1 2011-04-27 03:47:47 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 SecurityListRequestMsg implementation.
 *
...
public class SecurityListRequestMsg50SP1 extends SecurityListRequestMsg {
    ...
    public SecurityListRequestMsg50SP1() {
        super();
    }

    public SecurityListRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityListRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityListRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityListRequestMsg50SP1 fixml = (SecurityListRequestMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityListRequestMsg] message version [5.0SP1].";
    }
