...
/*
 * SettlInstructionsData50.java
 *
 * $Id: SettlInstructionsData50.java,v 1.3 2011-04-14 23:44:50 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.DeliveryInstructionGroup50;
...
/**
 * FIX 5.0 implementation of SettlInstructionsData component.
 *
...
public class SettlInstructionsData50 extends SettlInstructionsData {
    ...
    protected static final Set<Integer> DLVY_INST_GROUP_TAGS = new DeliveryInstructionGroup50().getFragmentAllTags();
    ...
    public SettlInstructionsData50() {
    }

    public SettlInstructionsData50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoDlvyInst(Integer noDlvyInst) {
        ...
        if (noDlvyInst != null) {
            ...
            for (int i = 0; i < deliveryInstructionGroups.length; i++) {
                deliveryInstructionGroups[i] = new DeliveryInstructionGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public DeliveryInstructionGroup addDeliveryInstructionGroup() {
        DeliveryInstructionGroup group = new DeliveryInstructionGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (DLVY_INST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noDlvyInst != null && noDlvyInst.intValue() > 0) {
                ...
                for (int i = 0; i < deliveryInstructionGroups.length; i++) {
                    DeliveryInstructionGroup group = new DeliveryInstructionGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SettlInstructionsData] component version [5.0].";
    }
