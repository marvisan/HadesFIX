...
/*
 * ListStrikePriceMsg50SP2.java
 *
 * $Id: ListStrikePriceMsg50SP2.java,v 1.1 2011-04-15 04:37:42 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.InstrmtStrikePriceGroup50SP2;
...
/**
 * FIX version 5.0SP2 ListStrikePriceMsg implementation.
 *
...
public class ListStrikePriceMsg50SP2 extends ListStrikePriceMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> INSTRMT_STRK_PX_GROUP_TAGS = new InstrmtStrikePriceGroup50SP2().getFragmentAllTags();
    ...
    public ListStrikePriceMsg50SP2() {
        super();
    }

    public ListStrikePriceMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ListStrikePriceMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ListStrikePriceMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ListStrikePriceMsg50SP2 fixml = (ListStrikePriceMsg50SP2) fragment;
    ...
    public void setNoStrikes(Integer noStrikes) {
        ...
        if (noStrikes != null) {
            ...
            for (int i = 0; i < instrmtStrikePriceGroups.length; i++) {
                instrmtStrikePriceGroups[i] = new InstrmtStrikePriceGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public InstrmtStrikePriceGroup addInstrmtStrikePriceGroup() {
        InstrmtStrikePriceGroup group = new InstrmtStrikePriceGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (INSTRMT_STRK_PX_GROUP_TAGS.contains(tag.tagNum)) {
            if (noStrikes != null && noStrikes.intValue() > 0) {
                ...
                for (int i = 0; i < noStrikes.intValue(); i++) {
                    InstrmtStrikePriceGroup group = new InstrmtStrikePriceGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListStrikePriceMsg] message version [5.0SP2].";
    }
