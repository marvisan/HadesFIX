...
/*
 * UndlyInstrumentPartyIDGroup50SP2.java
 *
 * $Id: UndlyInstrumentPartyIDGroup50SP2.java,v 1.9 2011-04-14 23:44:31 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP2 implementation of UndlyInstrumentPartyIDGroup.
 *
...
public class UndlyInstrumentPartyIDGroup50SP2 extends UndlyInstrumentPartyIDGroup {
    ...
    protected static final Set<Integer> UNDLY_INSTR_PARTY_SUBID_GROUP_TAGS = new UndlyInstrumentPartySubIDGroup50SP2().getFragmentAllTags();
    ...
    public UndlyInstrumentPartyIDGroup50SP2() {
    }

    public UndlyInstrumentPartyIDGroup50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoUndlyInstrumentPartySubIDGroups(Integer noUndlyInstrumentPartySubIDGroups) {
        ...
        if (noUndlyInstrumentPartySubIDGroups != null) {
            ...
            for (int i = 0; i < undlyInstrumentPartySubIDGroups.length; i++) {
                undlyInstrumentPartySubIDGroups[i] = new UndlyInstrumentPartySubIDGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UndlyInstrumentPartySubIDGroup addUndlyInstrumentPartySubIDGroup() {
        UndlyInstrumentPartySubIDGroup group = new UndlyInstrumentPartySubIDGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (UNDLY_INSTR_PARTY_SUBID_GROUP_TAGS.contains(tag.tagNum)) {
            if (noUndlyInstrumentPartySubIDGroups != null && noUndlyInstrumentPartySubIDGroups.intValue() > 0) {
                ...
                for (int i = 0; i < undlyInstrumentPartySubIDGroups.length; i++) {
                    UndlyInstrumentPartySubIDGroup group = new UndlyInstrumentPartySubIDGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [UndlyInstrumentPartyIDGroup] component version [5.0SP2].";
    }
