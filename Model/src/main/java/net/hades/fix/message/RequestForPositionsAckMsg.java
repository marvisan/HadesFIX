...
/*
 * RequestForPositionsAckMsg.java
 *
...
public abstract class RequestForPositionsAckMsg extends FIXMsg {
    ...
    /**
     * TagNum = 728 REQUIRED. Starting with 4.4 version.
     */
    protected Integer posReqResult;
  
    /**
     * TagNum = 729 REQUIRED. Starting with 4.4 version.
     */
    protected PosReqStatus posReqStatus;

    /**
     * TagNum = 727. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 263. Starting with 5.0 version.
     */
    ...
    public RequestForPositionsAckMsg() {
        super();
    }

    public RequestForPositionsAckMsg(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RequestForPositionsAckMsg(BeginString beginString) throws InvalidMsgException {
        super(MsgType.RequestForPositionsAck.getValue(), beginString);
    }

    public RequestForPositionsAckMsg(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
        super(MsgType.RequestForPositionsAck.getValue(), beginString, applVerID);
    }
   ...
   /**
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.PosReqResult, required=true)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.PosReqStatus, required=true)
    ...
    /**
     * Message field setter.
     * @param posReqStatus field value
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.PosReqStatus, required=true)
    ...
    protected void validateRequiredTags() throws TagNotPresentException {
        ...
        if (posReqStatus == null) {
            errorMsg.append(" [PosReqStatus]");
            hasMissingTag = true;
        }
    ...
    protected byte[] encodeFragmentAll() throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (posReqStatus != null) {
                TagEncoder.encode(bao, TagNum.PosReqStatus, posReqStatus.getValue());
            } 
            if (posReqType != null) {
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {            
            ...
            case PosReqStatus:
                posReqStatus = PosReqStatus.valueFor(Integer.valueOf(new String(tag.value, sessionCharset)));
                break;
           ...
           case SettlSessSubID:
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [RequestForPositionsAckMsg] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("{RequestForPositionsAckMsg=");
        ...
        printTagValue(b, TagNum.PosReqStatus, posReqStatus);
