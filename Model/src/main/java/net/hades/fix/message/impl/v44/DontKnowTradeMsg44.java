...
/*
 * DontKnowTradeMsg44.java
 *
 * $Id: DontKnowTradeMsg44.java,v 1.3 2011-04-14 23:44:38 vrotaru Exp $
 */
...
/**
 * FIX version 4.4 DontKnowTradeMsg implementation.
 *
...
public class DontKnowTradeMsg44 extends DontKnowTradeMsg {
    ...
    public DontKnowTradeMsg44() {
        super();
    }

    public DontKnowTradeMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public DontKnowTradeMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public DontKnowTradeMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        DontKnowTradeMsg44 fixml = (DontKnowTradeMsg44) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DontKnowTradeMsg] message version [4.4].";
    }
