...
/*
 * ListExecuteMsg42.java
 *
 * $Id: ListExecuteMsg42.java,v 1.1 2011-02-05 08:52:44 vrotaru Exp $
 */
 ...
 */
public class ListExecuteMsg42 extends ListExecuteMsg {
    ...
    public ListExecuteMsg42() {
        super();
    }

    public ListExecuteMsg42(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListExecuteMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListExecuteMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListExecuteMsg] message version [4.2].";
    }
