...
/*
 * SecurityStatusRequestMsg50SP2.java
 *
 * $Id: SecurityStatusRequestMsg50SP2.java,v 1.1 2011-04-20 06:57:50 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 SecurityStatusRequestMsg implementation.
 *
...
public class SecurityStatusRequestMsg50SP2 extends SecurityStatusRequestMsg {
    ...
    public SecurityStatusRequestMsg50SP2() {
        super();
    }

    public SecurityStatusRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityStatusRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityStatusRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityStatusRequestMsg50SP2 fixml = (SecurityStatusRequestMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityStatusRequestMsg] message version [5.0SP2].";
    }
