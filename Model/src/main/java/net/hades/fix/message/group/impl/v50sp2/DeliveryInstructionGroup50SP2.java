...
/*
 * DeliveryInstructionGroup50SP2.java
 *
 * $Id: DeliveryInstructionGroup50SP2.java,v 1.2 2011-04-14 23:44:30 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP2 implementation of DeliveryInstructionGroup group.
 *
...
public class DeliveryInstructionGroup50SP2 extends DeliveryInstructionGroup {
    ...
    protected static final Set<Integer> SETTL_PARTY_GROUP_TAGS = new SettlPartyGroup50SP2().getFragmentAllTags();
    ...
    public DeliveryInstructionGroup50SP2() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public DeliveryInstructionGroup50SP2(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    public void setNoSettlPartyIDs(Integer noSettlPartyIDs) {
        ...
        if (noSettlPartyIDs != null) {
            ...
            for (int i = 0; i < settlPartyGroups.length; i++) {
                settlPartyGroups[i] = new SettlPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public SettlPartyGroup addSettlPartyGroup() {
        SettlPartyGroup group = new SettlPartyGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (SETTL_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSettlPartyIDs != null && noSettlPartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < settlPartyGroups.length; i++) {
                    SettlPartyGroup group = new SettlPartyGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DeliveryInstructionGroup] group version [5.0SP2].";
    }
