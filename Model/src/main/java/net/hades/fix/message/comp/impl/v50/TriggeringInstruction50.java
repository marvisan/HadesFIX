...
/*
 * TriggeringInstruction50.java
 *
 * $Id: TriggeringInstruction50.java,v 1.1 2010-12-05 08:13:27 vrotaru Exp $
 */
...
public class TriggeringInstruction50 extends TriggeringInstruction {
    ...
    public TriggeringInstruction50() {
        super();
    }

    public TriggeringInstruction50(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TriggeringInstruction] component version [5.0].";
    }
