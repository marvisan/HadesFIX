...
/*
 * DerivativeSecurityDefinition50SP1.java
 *
 * $Id: DerivativeSecurityDefinition50SP1.java,v 1.1 2011-09-27 08:57:26 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.DerivativeInstrAttribGroup50SP1;
...
/**
 * FIX 5.0SP1 implementation of DerivativeSecurityDefinition component.
 * 
...
public class DerivativeSecurityDefinition50SP1 extends DerivativeSecurityDefinition {
    ...
    protected static final Set<Integer> DERIVATIVE_INSTRUMENT_COMP_TAGS = new DerivativeInstrument50SP1().getFragmentAllTags();
    protected static final Set<Integer> DERIV_INSTR_ATTRIB_GROUP_TAGS = new DerivativeInstrAttribGroup50SP1().getFragmentAllTags();
    ...
    public DerivativeSecurityDefinition50SP1() {
        super();
    }

    public DerivativeSecurityDefinition50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setDerivativeInstrument() {
        derivativeInstrument = new DerivativeInstrument50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setNoDerivativeInstrAttrib(Integer noDerivativeInstrAttrib) {
        ...
        if (noDerivativeInstrAttrib != null) {
            ...
            for (int i = 0; i < derivativeInstrAttribGroups.length; i++) {
                derivativeInstrAttribGroups[i] = new DerivativeInstrAttribGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public DerivativeInstrAttribGroup addDerivativeInstrAttribGroup() {
        DerivativeInstrAttribGroup group = new DerivativeInstrAttribGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (DERIVATIVE_INSTRUMENT_COMP_TAGS.contains(tag.tagNum)) {
            if (derivativeInstrument == null) {
                derivativeInstrument = new DerivativeInstrument50SP1(context);
            }
        ...
        if (noDerivativeInstrAttrib != null && noDerivativeInstrAttrib.intValue() > 0) {
            if (DERIV_INSTR_ATTRIB_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noDerivativeInstrAttrib.intValue(); i++) {
                    DerivativeInstrAttribGroup group = new DerivativeInstrAttribGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DerivativeSecurityDefinition] component release [5.0SP1].";
    }
