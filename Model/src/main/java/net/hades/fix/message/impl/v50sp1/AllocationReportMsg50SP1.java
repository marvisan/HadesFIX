...
/**
 * FIX version 5.0SP1 AllocationReportMsg implementation.
 *
...
public class AllocationReportMsg50SP1 extends AllocationReportMsg {
    ...
    public AllocationReportMsg50SP1() {
        super();
    }

    public AllocationReportMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AllocationReportMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AllocationReportMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationReportMsg50SP1 fixml = (AllocationReportMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationReportMsg] message version [5.0SP1].";
    }
