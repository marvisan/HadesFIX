...
/*
 * SecurityStatusMsg50SP1.java
 *
 * $Id: SecurityStatusMsg50SP1.java,v 1.1 2011-04-21 09:45:46 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 SecurityStatusMsg implementation.
 *
...
@XmlType(propOrder = {"header", "applicationSequenceControl", "instrument", "instrumentExtension", "underlyingInstruments", "instrumentLegs"})
@XmlAccessorType(XmlAccessType.NONE)
public class SecurityStatusMsg50SP1 extends SecurityStatusMsg {
    ...
    public SecurityStatusMsg50SP1() {
        super();
    }

    public SecurityStatusMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityStatusMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityStatusMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityStatusMsg50SP1 fixml = (SecurityStatusMsg50SP1) fragment;
        ...
        if (fixml.getSecurityTradingEvent() != null) {
            securityTradingEvent = fixml.getSecurityTradingEvent();
        }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityStatusMsg] message version [5.0SP1].";
    }
