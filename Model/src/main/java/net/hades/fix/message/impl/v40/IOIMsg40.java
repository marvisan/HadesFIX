 ...
 * IOIMsg40.java
 *
 * $Id: IOIMsg40.java,v 1.9 2010-08-25 05:30:31 vrotaru Exp $
 */
...
/**
 * FIX version 4.0 IOIMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.9 $
 * @created 09/02/2009, 7:06:44 PM
 */
public class IOIMsg40 extends IOIMsg {
    ...
    public IOIMsg40(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public IOIMsg40(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public IOIMsg40(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (ioiQualifier != null && MsgUtil.isTagInList(TagNum.IOIQualifier, SECURED_TAGS, secured)) {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [IOIMsg] message version [4.0].";
    }
