...
/*
 * SecurityListMsg50.java
 *
 * $Id: SecurityListMsg50.java,v 1.2 2011-04-29 03:11:03 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.SecListGroup50;
...
/**
 * FIX version 5.0 SecurityListMsg implementation.
 *
...
public class SecurityListMsg50 extends SecurityListMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> SEC_LIST_GROUP_TAGS = new SecListGroup50().getFragmentAllTags();
    ...
    public SecurityListMsg50() {
        super();
    }

    public SecurityListMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityListMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityListMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityListMsg50 fixml = (SecurityListMsg50) fragment;
    ...
    public void setNoRelatedSyms(Integer noRelatedSyms) {
        ...
        if (noRelatedSyms != null) {
            ...
            for (int i = 0; i < secListGroups.length; i++) {
                secListGroups[i] = new SecListGroup50(context);
            }
        }
    }
    ...
    public SecListGroup addSecListGroup() {
        SecListGroup group = new SecListGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (SEC_LIST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRelatedSyms != null && noRelatedSyms.intValue() > 0) {
                ...
                for (int i = 0; i < noRelatedSyms.intValue(); i++) {
                    SecListGroup group = new SecListGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityListMsg] message version [5.0].";
    }
