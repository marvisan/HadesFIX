 ...
 *
 * $Id: NestedParties44.java,v 1.10 2011-04-29 04:43:54 vrotaru Exp $
 */
...
/**
 * FIX version 4.4 implementation of NestedParties component.
 *
 ...
 */
@XmlTransient
public class NestedParties44 extends NestedParties {
    ...
    protected static final Set<Integer> NESTED_PARTY_GROUP_TAGS = new NestedPartyGroup44().getFragmentAllTags();
    ...
    public NestedParties44() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NestedParties44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    public void setNoNestedPartyIDs(Integer noNestedPartyIDs) {
        ...
        if (noNestedPartyIDs != null) {
            ...
            for (int i = 0; i < nestedPartyGroups.length; i++) {
                nestedPartyGroups[i] = new NestedPartyGroup44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public NestedPartyGroup addNestedPartyGroup() {
        NestedPartyGroup group = new NestedPartyGroup44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NESTED_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNestedPartyIDs != null && noNestedPartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < nestedPartyGroups.length; i++) {
                    NestedPartyGroup group = new NestedPartyGroup44(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NestedParties] component version [4.4].";
    }
