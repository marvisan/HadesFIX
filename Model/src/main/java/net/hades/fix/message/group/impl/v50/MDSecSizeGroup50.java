...
/*
 * MDSecSizeGroup50.java
 *
 * $Id: MDSecSizeGroup50.java,v 1.3 2010-02-04 10:11:07 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of MDSecSizeGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 05/04/2009, 11:39:24 AM
 */
@XmlRootElement(name="MktDataSnap")
@XmlType
@XmlAccessorType(XmlAccessType.NONE)
public class MDSecSizeGroup50 extends MDSecSizeGroup {
    ...
    public MDSecSizeGroup50() {
    }

    public MDSecSizeGroup50(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MDSecSizeGroup] group version [5.0].";
    }
