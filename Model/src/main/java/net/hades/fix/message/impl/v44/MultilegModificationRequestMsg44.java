...
/*
 * MultilegModificationRequestMsg44.java
 *
 * $Id: MultilegModificationRequestMsg44.java,v 1.1 2011-09-10 05:39:46 vrotaru Exp $
 */
...
/**
 * FIX version 4.4 MultilegModificationRequestMsg implementation.
 *
...
public class MultilegModificationRequestMsg44 extends MultilegModificationRequestMsg {
    ...
    public MultilegModificationRequestMsg44() {
        super();
    }

    public MultilegModificationRequestMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public MultilegModificationRequestMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public MultilegModificationRequestMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MultilegModificationRequestMsg44 fixml = (MultilegModificationRequestMsg44) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MultilegModificationRequestMsg] message version [4.4].";
    }
