...
/*
 * QuoteSetAckGroup50.java
 *
 * $Id: QuoteSetAckGroup50.java,v 1.8 2011-04-14 23:44:36 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of QuoteSetAckGroup group.
 *
...
public class QuoteSetAckGroup50 extends QuoteSetAckGroup {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -2291713471529137463L;

    protected static final Set<Integer> START_COMP_TAGS;

    protected static final Set<Integer> ALL_TAGS;
    
    protected static final Set<Integer> QUOTE_ENTRY_ACK_GROUP_TAGS = new QuoteEntryAckGroup50().getFragmentAllTags();
    protected static final Set<Integer> UND_INSTR_COMP_TAGS = new UnderlyingInstrument50().getFragmentAllTags();
    ...
    public QuoteSetAckGroup50() {
    }
    
    public QuoteSetAckGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setUnderlyingInstrument() {
        this.underlyingInstrument = new UnderlyingInstrument50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setNoQuoteEntries(Integer noQuoteEntries) {
        ...
        if (noQuoteEntries != null) {
            ...
            for (int i = 0; i < quoteEntryAckGroups.length; i++) {
                quoteEntryAckGroups[i] = new QuoteEntryAckGroup50(context);
            }
        }
    }
    ...
    public QuoteEntryAckGroup addQuoteEntryAckGroup() {
        QuoteEntryAckGroup group = new QuoteEntryAckGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (QUOTE_ENTRY_ACK_GROUP_TAGS.contains(tag.tagNum)) {
            if (noQuoteEntries != null && noQuoteEntries.intValue() > 0) {
                ...
                for (int i = 0; i < quoteEntryAckGroups.length; i++) {
                    QuoteEntryAckGroup group = new QuoteEntryAckGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteSetAckGroup] group version [5.0].";
    }
