...
/*
 * AllocationInstructionAckMsg50SP1.java
 *
 * $Id: AllocationInstructionAckMsg50SP1.java,v 1.3 2011-04-14 23:44:58 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 AllocationInstructionAckMsg implementation.
 *
...
public class AllocationInstructionAckMsg50SP1 extends AllocationInstructionAckMsg {
    ...
    public AllocationInstructionAckMsg50SP1() {
        super();
    }

    public AllocationInstructionAckMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AllocationInstructionAckMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AllocationInstructionAckMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationInstructionAckMsg50SP1 fixml = (AllocationInstructionAckMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationInstructionAckMsg] message version [5.0SP1].";
    }
