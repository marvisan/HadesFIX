...
/*
 * UndlyInstrumentParties50.java
 *
 * $Id: UndlyInstrumentParties50.java,v 1.7 2011-04-14 23:44:50 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.UndlyInstrumentPartyIDGroup50;

/**
 * FIX 5.0 implementation of UndlyInstrumentParties component.
 *
 ...
 */
@XmlTransient
public class UndlyInstrumentParties50 extends UndlyInstrumentParties {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -8489574058159949431L;

    protected static final Set<Integer> START_COMP_TAGS;

    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> UNDLY_INSTR_PARTY_ID_GROUP_TAGS = new UndlyInstrumentPartyIDGroup50().getFragmentAllTags();
    ...
    public UndlyInstrumentParties50() {
        super();
    }

    public UndlyInstrumentParties50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoUndlyInstrumentParties(Integer noUndlyInstrumentParties) {
        ...
        if (noUndlyInstrumentParties != null) {
            ...
            for (int i = 0; i < undlyInstrumentPartyIDGroups.length; i++) {
                undlyInstrumentPartyIDGroups[i] = new UndlyInstrumentPartyIDGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UndlyInstrumentPartyIDGroup addUndlyInstrumentPartyIDGroup() {
        ...
        UndlyInstrumentPartyIDGroup group = new UndlyInstrumentPartyIDGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noUndlyInstrumentParties != null && noUndlyInstrumentParties.intValue() > 0) {
            if (UNDLY_INSTR_PARTY_ID_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noUndlyInstrumentParties.intValue(); i++) {
                    UndlyInstrumentPartyIDGroup group = new UndlyInstrumentPartyIDGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [UndlyInstrumentParties] component version [5.0].";
    }
