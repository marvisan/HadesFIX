...
/*
 * QuoteRequestRejectGroup50.java
 *
 * $Id: QuoteRequestRejectGroup50.java,v 1.9 2011-04-14 23:44:36 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of QuoteRequestRejectGroup group.
 *
...
public class QuoteRequestRejectGroup50 extends QuoteRequestRejectGroup {
    ...
    protected static final Set<Integer> QUOT_REQ_LEG_GROUP_TAGS = new QuoteRequestLegGroup50().getFragmentAllTags();
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < quoteRequestLegGroups.length; i++) {
                quoteRequestLegGroups[i] = new QuoteRequestLegGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteRequestRejectGroup] group version [5.0].";
    }
