 ...
 * Parties50SP1.java
 *
 * $Id: Parties50SP1.java,v 1.8 2011-04-14 23:44:47 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.PartyGroup50SP1;

/**
 * FIX 5.0SP1 implementation of Parties component.
 *
 ...
 */
@XmlTransient
public class Parties50SP1 extends Parties {
    ...
    protected static final Set<Integer> PARTY_ID_GROUP_TAGS = new PartyGroup50SP1().getFragmentAllTags();
    ...
    public Parties50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoPartyIDs(Integer noPartyIDs) {
        ...
        if (noPartyIDs != null) {
            ...
            for (int i = 0; i < partyIDGroups.length; i++) {
                partyIDGroups[i] = new PartyGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public PartyGroup addPartyIDGroup() {
        PartyGroup group = new PartyGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (PARTY_ID_GROUP_TAGS.contains(tag.tagNum)) {
            if (noPartyIDs != null && noPartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < partyIDGroups.length; i++) {
                    PartyGroup group = new PartyGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [Parties] component version [5.0SP1].";
    }
