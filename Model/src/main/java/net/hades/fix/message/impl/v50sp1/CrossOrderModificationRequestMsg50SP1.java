...
/*
 * CrossOrderModificationRequestMsg50SP1.java
 *
 * $Id: CrossOrderModificationRequestMsg50SP1.java,v 1.1 2011-05-17 09:28:25 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.SideCrossOrdModGroup50SP1;
...
/**
 * FIX version 5.0SP1 CrossOrderModificationRequestMsg implementation.
 *
...
public class CrossOrderModificationRequestMsg50SP1 extends CrossOrderModificationRequestMsg {
    ...
    protected static final Set<Integer> SIDE_CROSS_ORD_MOD_GROUP_TAGS = new SideCrossOrdModGroup50SP1().getFragmentAllTags();
    ...
    public CrossOrderModificationRequestMsg50SP1() {
        super();
    }

    public CrossOrderModificationRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CrossOrderModificationRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CrossOrderModificationRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CrossOrderModificationRequestMsg50SP1 fixml = (CrossOrderModificationRequestMsg50SP1) fragment;
    ...
    public void setNoSides(Integer noSides) {
        ...
        if (noSides != null) {
            ...
            for (int i = 0; i < sideCrossOrdModGroups.length; i++) {
                sideCrossOrdModGroups[i] = new SideCrossOrdModGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public SideCrossOrdModGroup addSideCrossOrdModGroup() {
        SideCrossOrdModGroup group = new SideCrossOrdModGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoTradingSessions(Integer noTradingSessions) {
        ...
        if (noTradingSessions != null) {
            ...
            for (int i = 0; i < tradingSessionGroups.length; i++) {
                tradingSessionGroups[i] = new TradingSessionGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public TradingSessionGroup addTradingSessionGroup() {
        TradingSessionGroup group = new TradingSessionGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (SIDE_CROSS_ORD_MOD_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSides != null && noSides.intValue() > 0) {
                ...
                for (int i = 0; i < noSides.intValue(); i++) {
                    SideCrossOrdModGroup component = new SideCrossOrdModGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CrossOrderModificationRequestMsg] message version [5.0SP1].";
    }
