...
/*
 * QuoteStatusRequestMsg42.java
 *
 * $Id: QuoteStatusRequestMsg42.java,v 1.9 2010-08-25 05:30:24 vrotaru Exp $
 */
...
/**
 * FIX version 4.2 QuoteStatusRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.9 $
 * @created 01/04/2009, 8:41:14 AM
 */
public class QuoteStatusRequestMsg42 extends QuoteStatusRequestMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">
    
    private static final long serialVersionUID = -6282902349824573195L;
    ...
    public QuoteStatusRequestMsg42() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public QuoteStatusRequestMsg42(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteStatusRequestMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public QuoteStatusRequestMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteStatusRequestMsg] message version [4.2].";
    }
