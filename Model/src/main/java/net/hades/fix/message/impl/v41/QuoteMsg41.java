 ...
 * QuoteMsg41.java
 *
 * $Id: QuoteMsg41.java,v 1.8 2010-08-25 05:30:35 vrotaru Exp $
 */
...
/**
 * FIX version 4.1 QuoteMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.8 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class QuoteMsg41 extends QuoteMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -2686645926943759929L;
    ...
    protected static final Set<Integer> START_DATA_TAGS_V41 = new HashSet<Integer>(Arrays.asList(new Integer[] {
    ...
    static {
        ...
        ALL_TAGS.addAll(START_DATA_TAGS_V41);
    }
    ...
    public QuoteMsg41(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteMsg41(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteMsg41(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteMsg] message version [4.1].";
    }
