...
/*
 * QuoteEntryGroup42.java
 *
 * $Id: QuoteEntryGroup42.java,v 1.8 2010-08-25 05:30:33 vrotaru Exp $
 */
...
/**
 * FIX 4.2 implementation of QuoteEntryGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.8 $
 * @created 12/02/2009, 7:22:35 PM
 */
public class QuoteEntryGroup42 extends QuoteEntryGroup {
    ...
    public QuoteEntryGroup42() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public QuoteEntryGroup42(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteEntryGroup] group version [4.2].";
    }
