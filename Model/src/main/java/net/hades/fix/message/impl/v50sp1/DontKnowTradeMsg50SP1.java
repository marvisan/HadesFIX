...
/*
 * DontKnowTradeMsg50SP1.java
 *
 * $Id: DontKnowTradeMsg50SP1.java,v 1.3 2011-04-14 23:44:56 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 DontKnowTradeMsg implementation.
 *
...
public class DontKnowTradeMsg50SP1 extends DontKnowTradeMsg {
    ...
    public DontKnowTradeMsg50SP1() {
        super();
    }

    public DontKnowTradeMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public DontKnowTradeMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public DontKnowTradeMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        DontKnowTradeMsg50SP1 fixml = (DontKnowTradeMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DontKnowTradeMsg] message version [5.0SP1].";
    }
