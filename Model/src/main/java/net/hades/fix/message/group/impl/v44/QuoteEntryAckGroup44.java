...
/*
 * QuoteEntryAckGroup44.java
 *
 * $Id: QuoteEntryAckGroup44.java,v 1.9 2011-04-14 23:44:42 vrotaru Exp $
 */
...
/**
 * FIX 4.4 implementation of QuoteEntryAckGroup group.
 *
...
public class QuoteEntryAckGroup44 extends QuoteEntryAckGroup {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -6573286603942230432L;
    ...
    public QuoteEntryAckGroup44() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public QuoteEntryAckGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteEntryAckGroup] group version [4.4].";
    }
