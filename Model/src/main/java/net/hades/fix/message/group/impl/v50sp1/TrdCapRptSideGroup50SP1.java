...
/*
 * TrdCapRptSideGroup50SP1.java
 *
 * $Id: TrdCapRptSideGroup50SP1.java,v 1.2 2011-10-25 08:29:20 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of TrdCapRptSideGroup group.
 *
...
@XmlType(propOrder = {"partyIDGroups", "clrInstGroups", "commissionData", "contAmtGroups", "stipulationsGroups", "miscFeeGroups",
    "allocGroups", "sideTrdRegTimestampsGroups", "settlDetailsGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class TrdCapRptSideGroup50SP1 extends TrdCapRptSideGroup {
    ...
    protected static final Set<Integer> CLR_INST_GROUP_TAGS = new ClrInstGroup50SP1().getFragmentAllTags();
    ...
    protected static final Set<Integer> ALLOC_GROUP_TAGS = new TradeAllocGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> SIDE_TRD_REG_TS_GROUP_TAGS = new SideTrdRegTimestampsGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> SETTL_DETAILS_GROUP_TAGS = new SettlDetailsGroup50SP1().getFragmentAllTags();
    ...
    public TrdCapRptSideGroup50SP1() {
    }
    
    public TrdCapRptSideGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoClearingInstructions(Integer noClearingInstructions) {
        ...
        if (noClearingInstructions != null) {
            ...
            for (int i = 0; i < clrInstGroups.length; i++) {
                clrInstGroups[i] = new ClrInstGroup50SP1(context);
            }
        }
    }
    ...
    public ClrInstGroup addClrInstGroup() {
        ClrInstGroup group = new ClrInstGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocGroups.length; i++) {
                allocGroups[i] = new TradeAllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public TradeAllocGroup addAllocGroup() {
        TradeAllocGroup group = new TradeAllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoSideTrdRegTS(Integer noSideTrdRegTS) {
        ...
        if (noSideTrdRegTS != null) {
            ...
            for (int i = 0; i < sideTrdRegTimestampsGroups.length; i++) {
                sideTrdRegTimestampsGroups[i] = new SideTrdRegTimestampsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public SideTrdRegTimestampsGroup addSideTrdRegTimestampsGroup() {
        SideTrdRegTimestampsGroup group = new SideTrdRegTimestampsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoSettlDetails(Integer noSettlDetails) {
        ...
        if (noSettlDetails != null) {
            ...
            for (int i = 0; i < settlDetailsGroups.length; i++) {
                settlDetailsGroups[i] = new SettlDetailsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public SettlDetailsGroup addSettlDetailsGroup() {
        SettlDetailsGroup group = new SettlDetailsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (CLR_INST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noClearingInstructions != null && noClearingInstructions.intValue() > 0) {
                ...
                for (int i = 0; i < noClearingInstructions.intValue(); i++) {
                    ClrInstGroup component = new ClrInstGroup50SP1(context);
        ...
        if (ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAllocs != null && noAllocs.intValue() > 0) {
                ...
                for (int i = 0; i < noAllocs.intValue(); i++) {
                    TradeAllocGroup group = new TradeAllocGroup50SP1(context);
        ...
        if (SIDE_TRD_REG_TS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSideTrdRegTS != null && noSideTrdRegTS.intValue() > 0) {
                ...
                for (int i = 0; i < noSideTrdRegTS.intValue(); i++) {
                    SideTrdRegTimestampsGroup group = new SideTrdRegTimestampsGroup50SP1(context);
                    group.decode(message);
        ...
        if (SETTL_DETAILS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSettlDetails != null && noSettlDetails.intValue() > 0) {
                ...
                for (int i = 0; i < noSettlDetails.intValue(); i++) {
                    SettlDetailsGroup group = new SettlDetailsGroup50SP1(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TrdCapRptSideGroup] group version [5.0SP1].";
    }
