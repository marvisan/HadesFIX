...
/*
 * LegStipulations50SP1.java
 *
 * $Id: LegStipulations50SP1.java,v 1.8 2011-04-14 23:44:47 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.LegStipulationsGroup50SP1;

/**
 * FIX version 5.0SP1 implementation of LegStipulations component.
 *
 ...
 */
@XmlTransient
public class LegStipulations50SP1 extends LegStipulations {
    ...
    protected static final Set<Integer> LEG_STIPS_GROUP_TAGS = new LegStipulationsGroup50SP1().getFragmentAllTags();
    ...
    public LegStipulations50SP1() {
        super();
    }

    public LegStipulations50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoLegStipulations(Integer noLegStipulations) {
        ...
        if (noLegStipulations != null) {
            ...
            for (int i = 0; i < legStipulationsGroups.length; i++) {
                legStipulationsGroups[i] = new LegStipulationsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public LegStipulationsGroup addLegStipulationsGroup() {
        ...
        LegStipulationsGroup group = new LegStipulationsGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noLegStipulations != null && noLegStipulations.intValue() > 0) {
            if (LEG_STIPS_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noLegStipulations.intValue(); i++) {
                    LegStipulationsGroup group = new LegStipulationsGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [LegStipulations] component version [5.0SP1].";
    }
