...
/*
 * DerivativeSecurityListRequestMsg43.java
 *
 * $Id: DerivativeSecurityListRequestMsg43.java,v 1.1 2011-09-22 08:54:31 vrotaru Exp $
 */
...
/**
 * FIX version 4.3 DerivativeSecurityListRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class DerivativeSecurityListRequestMsg43 extends DerivativeSecurityListRequestMsg {
    ...
    public DerivativeSecurityListRequestMsg43() {
        super();
    }

    public DerivativeSecurityListRequestMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public DerivativeSecurityListRequestMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public DerivativeSecurityListRequestMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DerivativeSecurityListRequestMsg] message version [4.3].";
    }
