 ...
 * NewsMsg50SP1.java
 *
 * $Id: NewsMsg50SP1.java,v 1.11 2011-04-14 23:44:58 vrotaru Exp $
 */
...
@XmlType(propOrder = {"header", "applicationSequenceControl", "routingIDGroups", "instrumentsType",
    "instrumentLegs", "underlyingInstruments", "linesOfTextGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class NewsMsg50SP1 extends NewsMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -3922265953146295771L;
    ...
    public NewsMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public NewsMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public NewsMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewsMsg50SP1 fixml = (NewsMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewsMsg] message version [5.0SP1].";
    }
