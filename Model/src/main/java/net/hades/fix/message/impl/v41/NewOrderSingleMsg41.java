...
/*
 * NewOrderSingleMsg41.java
 *
 * $Id: NewOrderSingleMsg41.java,v 1.2 2010-12-08 10:56:51 vrotaru Exp $
 */
 ...
 */
public class NewOrderSingleMsg41 extends NewOrderSingleMsg {
    ...
    public NewOrderSingleMsg41(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderSingleMsg41(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderSingleMsg41(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderSingleMsg] message version [4.1].";
    }
