...
/*
 * TrdCapRptSideGroup50SP2.java
 *
 * $Id: TrdCapRptSideGroup50SP2.java,v 1.2 2011-10-25 08:29:21 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP2 implementation of TrdCapRptSideGroup group.
 *
...
@XmlType(propOrder = {"partyIDGroups", "clrInstGroups", "commissionData", "contAmtGroups", "stipulationsGroups", "miscFeeGroups",
    "allocGroups", "sideTrdRegTimestampsGroups", "settlDetailsGroups", "tradeReportOrderDetail"})
@XmlAccessorType(XmlAccessType.NONE)
public class TrdCapRptSideGroup50SP2 extends TrdCapRptSideGroup {
    ...
    public TrdCapRptSideGroup50SP2() {
    }
    
    public TrdCapRptSideGroup50SP2(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TrdCapRptSideGroup] group version [5.0SP2].";
    }
