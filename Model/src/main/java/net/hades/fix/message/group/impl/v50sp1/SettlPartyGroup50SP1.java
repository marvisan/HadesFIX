...
/*
 * SettlPartyGroup50SP1.java
 *
 * $Id: SettlPartyGroup50SP1.java,v 1.2 2011-04-14 23:44:52 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of SettlPartyGroup group.
 *
...
public class SettlPartyGroup50SP1 extends SettlPartyGroup {
    ...
    protected static final Set<Integer> SETTL_PARTY_SUB_GROUP_TAGS = new SettlPartySubGroup50SP1().getFragmentAllTags();
    ...
    public SettlPartyGroup50SP1() {
    }

    public SettlPartyGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoSettlPartySubIDs(Integer noSettlPartySubIDs) {
        ...
        if (noSettlPartySubIDs != null) {
            ...
            for (int i = 0; i < settlPartySubIDGroups.length; i++) {
                settlPartySubIDGroups[i] = new SettlPartySubGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public SettlPartySubGroup addSettlPartySubIDGroup() {
        SettlPartySubGroup group = new SettlPartySubGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (SETTL_PARTY_SUB_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSettlPartySubIDs != null && noSettlPartySubIDs.intValue() > 0) {
                ...
                for (int i = 0; i < settlPartySubIDGroups.length; i++) {
                    SettlPartySubGroup group = new SettlPartySubGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SettlPartyGroup] group version [5.0SP1].";
    }
