...
/*
 * QuoteSetGroup50.java
 *
 * $Id: QuoteSetGroup50.java,v 1.9 2011-04-14 23:44:34 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of QuoteSetGroup group.
 *
...
public class QuoteSetGroup50 extends QuoteSetGroup {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -7509345803970669428L;
    
    protected static final Set<Integer> START_COMP_TAGS;

    protected static final Set<Integer> ALL_TAGS;
    
    protected static final Set<Integer> QUOTE_ENTRY_GROUP_TAGS = new QuoteEntryGroup50().getFragmentAllTags();
    ...
    public QuoteSetGroup50() {
    }
    
    public QuoteSetGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoQuoteEntries(Integer noQuoteEntries) {
        ...
        if (noQuoteEntries != null) {
            ...
            for (int i = 0; i < quoteEntryGroups.length; i++) {
                quoteEntryGroups[i] = new QuoteEntryGroup50(context);
            }
        }
    }
    ...
    public QuoteEntryGroup addQuoteEntryGroup() {
        QuoteEntryGroup group = new QuoteEntryGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (QUOTE_ENTRY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noQuoteEntries != null && noQuoteEntries.intValue() > 0) {
                ...
                for (int i = 0; i < quoteEntryGroups.length; i++) {
                    QuoteEntryGroup group = new QuoteEntryGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteSetGroup] group version [5.0].";
    }
