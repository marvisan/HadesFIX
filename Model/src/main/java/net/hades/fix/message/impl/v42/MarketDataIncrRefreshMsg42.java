...
/*
 * MarketDataIncrRefreshMsg42.java
 *
 * $Id: MarketDataIncrRefreshMsg42.java,v 1.6 2011-04-14 23:44:39 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v42.MDIncGroup42;
...
/**
 * FIX version 4.2 MarketDataIncrRefreshMsg implementation.
 *
 ...
 */
@XmlTransient
public class MarketDataIncrRefreshMsg42 extends MarketDataIncrRefreshMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -3045700159825776347L;

    protected static final Set<Integer> START_COMP_TAGS;

    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> MD_INC_GROUP_TAGS = new MDIncGroup42().getFragmentAllTags();
    ...
    public MarketDataIncrRefreshMsg42() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataIncrRefreshMsg42(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataIncrRefreshMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataIncrRefreshMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoMDEntries(Integer noMDEntries) {
        ...
        if (noMDEntries != null) {
            ...
            for (int i = 0; i < mdIncGroups.length; i++) {
                mdIncGroups[i] = new MDIncGroup42(context);
            }
        }
    }
    ...
    public MDIncGroup addMDIncGroup() {
        MDIncGroup group = new MDIncGroup42(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    protected void setFragmentCompTagValue(Tag tag, ByteBuffer message)
        ...
        if (MD_INC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noMDEntries != null && noMDEntries.intValue() > 0) {
                ...
                mdIncGroups = new MDIncGroup[noMDEntries.intValue()];
                for (int i = 0; i < noMDEntries.intValue(); i++) {
                    MDIncGroup component = new MDIncGroup42(context);
