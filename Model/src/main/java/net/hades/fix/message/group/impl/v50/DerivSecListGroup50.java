...
/*
 * DerivSecListGroup50.java
 *
 * $Id: DerivSecListGroup50.java,v 1.2 2011-09-28 08:10:20 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of DerivSecListGroup group.
 *
...
public class DerivSecListGroup50 extends DerivSecListGroup {
    ...
    protected static final Set<Integer> INSTRMNT_LEG_SEC_LIST_GROUP_TAGS = new InstrmtLegDerivSecListGroup50().getFragmentAllTags();
    ...
    public DerivSecListGroup50() {
    }

    public DerivSecListGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < instrmtLegDerivSecListGroups.length; i++) {
                instrmtLegDerivSecListGroups[i] = new InstrmtLegDerivSecListGroup50(context);
            }
        }
    }
    ...
    @Override
     public InstrmtLegDerivSecListGroup addInstrmtLegDerivSecListGroup() {
        InstrmtLegDerivSecListGroup group = new InstrmtLegDerivSecListGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setInstrumentLegs(InstrumentLeg[] instrumentLegs) {
        ...
        for (int i = 0; i < instrmtLegDerivSecListGroups.length; i++) {
            instrmtLegDerivSecListGroups[i] =  new InstrmtLegDerivSecListGroup50(context);
            ((InstrmtLegDerivSecListGroup50)instrmtLegDerivSecListGroups[i]).setInstrumentLeg(instrumentLegs[i]);
        }
        ...
        if (INSTRMNT_LEG_SEC_LIST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    InstrmtLegDerivSecListGroup component = new InstrmtLegDerivSecListGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DerivSecListGroup] group version [5.0].";
    }
