...
/*
 * MDIncGroup50SP2.java
 *
 * $Id: MDIncGroup50SP2.java,v 1.7 2011-04-14 23:44:30 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP2 implementation of MDReqGroup group.
 *
...
@XmlType(propOrder = {"instrument", "underlyingInstruments", "instrumentLegs", "yieldData", 
    "spreadOrBenchmarkCurveData", "rateSources", "MDSecSizeGroups", "statsIndGroups", "partyIDGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class MDIncGroup50SP2 extends MDIncGroup {
    ...
    protected static final Set<Integer> STATS_IND_GROUP_TAGS = new StatsIndGroupSP2().getFragmentAllTags();
    ...
    public MDIncGroup50SP2() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public MDIncGroup50SP2(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    public void setNoStatsIndicators(Integer noStatsIndicators) {
        ...
        if (noStatsIndicators != null) {
            ...
            for (int i = 0; i < statsIndGroups.length; i++) {
                statsIndGroups[i] = new StatsIndGroupSP2(context);
            }
        }
    }
    ...
    public StatsIndGroup addStatsIndGroup() {
        StatsIndGroup group = new StatsIndGroupSP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MDIncGroup] group version [5.0SP2].";
    }
