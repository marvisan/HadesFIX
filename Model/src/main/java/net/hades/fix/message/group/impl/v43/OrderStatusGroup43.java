 ...
 *
 * $Id: OrderStatusGroup43.java,v 1.2 2011-02-04 09:58:24 vrotaru Exp $
 */
...
/**
 * FIX 4.3 implementation of OrderStatusGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 12/02/2009, 7:22:35 PM
 */
public class OrderStatusGroup43 extends OrderStatusGroup {
    ...
    public OrderStatusGroup43() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public OrderStatusGroup43(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderStatusGroup] group version [4.3].";
    }
