...
/*
 * InstrmtLegExecGroup50SP1.java
 *
 * $Id: InstrmtLegExecGroup50SP1.java,v 1.2 2011-04-14 23:44:51 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of InstrmtLegExecGroup group.
 *
...
public class InstrmtLegExecGroup50SP1 extends InstrmtLegExecGroup {
    ...
    protected static final Set<Integer> LEG_ALLOC_GROUP_TAGS = new LegAllocGroup50SP1().getFragmentAllTags();
    ...
    public InstrmtLegExecGroup50SP1() {
        super();
    }

    public InstrmtLegExecGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoLegAllocs(Integer noLegAllocs) {
        ...
        if (noLegAllocs != null) {
            ...
            for (int i = 0; i < legAllocGroups.length; i++) {
                legAllocGroups[i] = new LegAllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public LegAllocGroup addLegAllocGroup() {
        LegAllocGroup group = new LegAllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNested3PartyIDGroups(Nested3PartyGroup[] nested3PartyIDGroups) {
        if (nested3PartyIDGroups != null) {
            ...
            ((NestedParties350SP1) nestedParties3).setNested3PartyIDGroups(nested3PartyIDGroups);
        }
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (LEG_ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegAllocs != null && noLegAllocs.intValue() > 0) {
                message.reset();
                legAllocGroups = new LegAllocGroup50SP1[noLegAllocs.intValue()];
                for (int i = 0; i < noLegAllocs.intValue(); i++) {
                    LegAllocGroup group = new LegAllocGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrmtLegExecGroup] group version [5.0SP1].";
    }
