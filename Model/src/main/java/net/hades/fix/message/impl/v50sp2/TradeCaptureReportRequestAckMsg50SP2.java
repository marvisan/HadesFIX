...
/*
 * TradeCaptureReportRequestAckMsg50SP2.java
 *
...
/**
 * FIX version 5.0SP2 TradeCaptureReportRequestAckMsg implementation.
 *
...
public class TradeCaptureReportRequestAckMsg50SP2 extends TradeCaptureReportRequestAckMsg {
    ...
    public TradeCaptureReportRequestAckMsg50SP2() {
        super();
    }

    public TradeCaptureReportRequestAckMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradeCaptureReportRequestAckMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradeCaptureReportRequestAckMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradeCaptureReportRequestAckMsg50SP2 fixml = (TradeCaptureReportRequestAckMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradeCaptureReportRequestAckMsg] message version [5.0SP2].";
    }
