...
/*
 * InstrmtLegDerivSecListGroup44.java
 *
 * $Id: InstrmtLegDerivSecListGroup44.java,v 1.1 2011-09-27 08:57:25 vrotaru Exp $
 */
...
public class InstrmtLegDerivSecListGroup44 extends InstrmtLegDerivSecListGroup {
    ...
    public InstrmtLegDerivSecListGroup44() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public InstrmtLegDerivSecListGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrmtLegDerivSecListGroup] group version [4.4].";
    }
