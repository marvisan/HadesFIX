...
/*
 * TrdCapDtGroup44.java
 *
 * $Id: TrdCapDtGroup44.java,v 1.2 2011-10-08 08:42:54 vrotaru Exp $
 */
...
/**
 * FIX 4.4 implementation of TrdCapDtGroup group.
 *
...
public class TrdCapDtGroup44 extends TrdCapDtGroup {
    ...
    public TrdCapDtGroup44() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public TrdCapDtGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TrdCapDtGroup] group version [4.4].";
    }
