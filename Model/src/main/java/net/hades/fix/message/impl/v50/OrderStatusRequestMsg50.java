...
/*
 * OrderStatusRequestMsg50.java
 *
 * $Id: OrderStatusRequestMsg50.java,v 1.3 2011-04-14 23:44:42 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 OrderStatusRequestMsg implementation.
 *
...
public class OrderStatusRequestMsg50 extends OrderStatusRequestMsg {
    ...
    public OrderStatusRequestMsg50() {
        super();
    }

    public OrderStatusRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderStatusRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderStatusRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderStatusRequestMsg50 fixml = (OrderStatusRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderStatusRequestMsg] message version [5.0].";
    }
