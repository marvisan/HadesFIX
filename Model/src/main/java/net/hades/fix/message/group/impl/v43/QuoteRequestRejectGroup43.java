...
/*
 * QuoteRequestRejectGroup43.java
 *
 * $Id: QuoteRequestRejectGroup43.java,v 1.10 2011-04-14 23:44:47 vrotaru Exp $
 */
...
/**
 * FIX 4.3 implementation of QuoteRequestRejectGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.10 $
 * @created 12/02/2009, 7:22:35 PM
 */
public class QuoteRequestRejectGroup43 extends QuoteRequestRejectGroup {
    ...
    public QuoteRequestRejectGroup43() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired);
        instrument = new Instrument43(context);
    }
    
    public QuoteRequestRejectGroup43(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        instrument = new Instrument43(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteRequestRejectGroup] group version [4.3].";
    }
