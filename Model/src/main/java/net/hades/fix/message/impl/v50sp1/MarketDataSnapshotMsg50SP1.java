...
/*
 * MarketDataSnapshotMsg50SP1.java
 *
 * $Id: MarketDataSnapshotMsg50SP1.java,v 1.9 2011-04-14 23:44:58 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 MarketDataSnapshottMsg implementation.
 *
...
@XmlType(propOrder = {"header", "applicationSequenceControl", "instrument", "underlyingInstruments", "instrumentLegs", "mdFullGroups", "routingIDGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class MarketDataSnapshotMsg50SP1 extends MarketDataSnapshotMsg {
    ...
    protected static final Set<Integer> MD_FULL_GROUP_TAGS = new MDFullGroup50SP1().getFragmentAllTags();
    ...
    public MarketDataSnapshotMsg50SP1() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataSnapshotMsg50SP1(Header header, ByteBuffer rawMsg)
    ...
    public MarketDataSnapshotMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        instrument = new Instrument50SP1(context);
    ...
    public MarketDataSnapshotMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MarketDataSnapshotMsg50SP1 fixml = (MarketDataSnapshotMsg50SP1) fragment;
    ...
    public void setNoMDEntries(Integer noMDEntries) {
        ...
        if (noMDEntries != null) {
            ...
            for (int i = 0; i < mdFullGroups.length; i++) {
                mdFullGroups[i] = new MDFullGroup50SP1(context);
            }
        }
    }
    ...
    public MDFullGroup addMdFullGroup() {
        MDFullGroup group = new MDFullGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (MD_FULL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noMDEntries != null && noMDEntries.intValue() > 0) {
                ...
                for (int i = 0; i < noMDEntries.intValue(); i++) {
                    MDFullGroup component = new MDFullGroup50SP1(context);
                    component.decode(message);
        ...
        if (ROUTING_ID_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRoutingIDs != null && noRoutingIDs.intValue() > 0) {
                ...
                for (int i = 0; i < noRoutingIDs.intValue(); i++) {
                    RoutingIDGroup component = new RoutingIDGroup50SP1(context);
                    component.decode(message);
