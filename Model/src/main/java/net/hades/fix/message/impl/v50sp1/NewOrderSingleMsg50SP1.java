...
/*
 * NewOrderSingleMsg50SP1.java
 *
 * $Id: NewOrderSingleMsg50SP1.java,v 1.7 2011-05-12 09:26:09 vrotaru Exp $
 */
...
public class NewOrderSingleMsg50SP1 extends NewOrderSingleMsg {
    ...
    public NewOrderSingleMsg50SP1() {
        super();
    }

    public NewOrderSingleMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public NewOrderSingleMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public NewOrderSingleMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewOrderSingleMsg50SP1 fixml = (NewOrderSingleMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderSingleMsg] message version [5.0SP1].";
    }
