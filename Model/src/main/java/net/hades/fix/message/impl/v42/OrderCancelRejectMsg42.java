...
/*
 * OrderCancelRejectMsg42.java
 *
 * $Id: OrderCancelRejectMsg42.java,v 1.1 2011-01-23 10:02:05 vrotaru Exp $
 */
...
/**
 * FIX version 4.2 OrderCancelRejectMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class OrderCancelRejectMsg42 extends OrderCancelRejectMsg {
    ...
    public OrderCancelRejectMsg42() {
        super();
    }

    public OrderCancelRejectMsg42(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRejectMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRejectMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderCancelRejectMsg] message version [4.2].";
    }
