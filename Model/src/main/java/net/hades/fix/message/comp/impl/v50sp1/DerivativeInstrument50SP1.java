...
/*
 * DerivativeInstrument50SP1.java
 *
 * $Id: DerivativeInstrument50SP1.java,v 1.2 2011-09-22 08:54:32 vrotaru Exp $
 */
package net.hades.fix.message.comp.impl.v50sp1;

import net.hades.fix.message.FragmentContext;
import net.hades.fix.message.group.DerivativeInstrumentPartyGroup;
import net.hades.fix.message.group.impl.v50sp1.DerivativeSecurityAltIDGroup50SP1;
...
import net.hades.fix.message.group.impl.v50sp1.DerivativeEventGroup50SP1;
...
/**
 * FIX version 5.0SP1 DerivativeInstrument component data.
 * 
...
public class DerivativeInstrument50SP1 extends DerivativeInstrument {
    ...
    protected static final Set<Integer> SEC_ALT_ID_GROUP_TAGS = new DerivativeSecurityAltIDGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> SECURITY_XML_COMP_TAGS = new DerivativeSecurityXML50SP1().getFragmentAllTags();
    protected static final Set<Integer> EVENT_GROUP_TAGS = new DerivativeEventGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> INSTRUMENT_PARTIES_COMP_TAGS = new DerivativeInstrumentParties50SP1().getFragmentAllTags();
    ...
    public DerivativeInstrument50SP1() {
        super();
    ...
    public DerivativeInstrument50SP1(FragmentContext context) {
        super(context);
        if (messageEncoding == null) {
            messageEncoding = Charset.forName(FIXMsg.DEFAULT_CHARACTER_SET);
        }
    ...
    public void setNoDerivativeSecurityAltID(Integer noDerivativeSecurityAltID) {
        ...
        if (noDerivativeSecurityAltID != null) {
            ...
            for (int i = 0; i < derivativeSecurityAltIDGroups.length; i++) {
                derivativeSecurityAltIDGroups[i] = new DerivativeSecurityAltIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public DerivativeSecurityAltIDGroup addDerivativeSecurityAltIDGroup() {       
        DerivativeSecurityAltIDGroup group = new DerivativeSecurityAltIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setDerivativeSecurityXML() {
        ...
        derivativeSecurityXML = new DerivativeSecurityXML50SP1(context);
    }
    ...
    public void setNoDerivativeEvents(Integer noDerivativeEvents) {
        ...
        if (noDerivativeEvents != null) {
            ...
            for (int i = 0; i < derivativeEvents.length; i++) {
                derivativeEvents[i] = new DerivativeEventGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public DerivativeEventGroup addDerivativeEvent() {
        DerivativeEventGroup group = new DerivativeEventGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setDerivativeInstrumentParties() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        derivativeInstrumentParties = new DerivativeInstrumentParties50SP1(context);
    }
    ...
    public void setDerivativeInstrumentPartyGroups(DerivativeInstrumentPartyGroup[] instrumentPartyGroups) {
        if (instrumentPartyGroups != null) {
            ...
            ((DerivativeInstrumentParties50SP1) derivativeInstrumentParties).setDerivativeInstrumentPartyGroups(instrumentPartyGroups);
        }
    }
        ...
        if (noDerivativeSecurityAltID != null && noDerivativeSecurityAltID.intValue() > 0) {
            if (SEC_ALT_ID_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noDerivativeSecurityAltID.intValue(); i++) {
                    DerivativeSecurityAltIDGroup group = new DerivativeSecurityAltIDGroup50SP1(context);
        ...
        if (noDerivativeEvents != null && noDerivativeEvents.intValue() > 0) {
            if (EVENT_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noDerivativeEvents.intValue(); i++) {
                    DerivativeEventGroup group = new DerivativeEventGroup50SP1(context);
                    group.decode(message);
