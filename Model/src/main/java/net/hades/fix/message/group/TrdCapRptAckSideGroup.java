...
/**
 * Trade capture report acknowledgment sides group data.
 *
...
public abstract class TrdCapRptAckSideGroup extends Group {
    ...
    protected static final Set<Integer> TAGS = new HashSet<Integer>(Arrays.asList(new Integer[] {
        ...
        TagNum.SideCurrency.getValue(),
        TagNum.SideSettlCurrency.getValue(),
    ...
    /**
     * TagNum = 54. Starting with 5.0 version.
     */
    protected Side side;
    ...
    /**
     * TagNum = 37. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 11. Starting with 5.0 version.
     */
    protected String clOrdID;

    /**
     * TagNum = 526. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 1. Starting with 5.0 version.
     */
    protected String account;

    /**
     * TagNum = 660. Starting with 5.0 version.
     */
    protected AcctIDSource acctIDSource;

    /**
     * TagNum = 581. Starting with 5.0 version.
     */
    protected AccountType accountType;

    /**
     * TagNum = 81. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 575. Starting with 5.0 version.
     */
    protected Boolean oddLot;

    /**
     * TagNum = 576. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 821. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 376. Starting with 5.0 version.
     */
    protected String complianceID;

    /**
     * TagNum = 377. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 529. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 18. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 336. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 430. Starting with 5.0SP1 version.
     */
    protected NetGrossInd netGrossInd;
    
    /**
     * TagNum = 1154. Starting with 5.0SP1 version.
     */
    protected Currency sideCurrency;
   
    /**
     * TagNum = 1155. Starting with 5.0SP1 version.
     */
    protected Currency sideSettlCurrency;
    ...
    /**
     * TagNum = 157. Starting with 5.0 version.
     */
    protected Integer numDaysInterest;

    /**
     * TagNum = 230. Starting with 5.0 version.
     */
    protected Date exDate;

    /**
     * TagNum = 158. Starting with 5.0 version.
     */
    protected Double accruedInterestRate;

    /**
     * TagNum = 159. Starting with 5.0 version.
     */
    protected Double accruedInterestAmt;

    /**
     * TagNum = 738. Starting with 5.0 version.
     */
    protected Double interestAtMaturity;

    /**
     * TagNum = 920. Starting with 5.0 version.
     */
    protected Double endAccruedInterestAmt;

    /**
     * TagNum = 921. Starting with 5.0 version.
     */
    protected Double startCash;

    /**
     * TagNum = 922. Starting with 5.0 version.
     */
    protected Double endCash;

    /**
     * TagNum = 238. Starting with 5.0 version.
     */
    protected Double concession;

    /**
     * TagNum = 237. Starting with 5.0 version.
     */
    protected Double totalTakedown;

    /**
     * TagNum = 118. Starting with 5.0 version.
     */
    protected Double netMoney;

    /**
     * TagNum = 119. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 155. Starting with 5.0 version.
     */
    protected Double settlCurrFxRate;

    /**
     * TagNum = 156. Starting with 5.0 version.
     */
    protected SettlCurrFxRateCalc settlCurrFxRateCalc;

    /**
     * TagNum = 77. Starting with 5.0 version.
     */
    protected PositionEffect positionEffect;

    /**
     * TagNum = 752. Starting with 5.0 version.
     */
    protected MultiLegReportingType sideMultiLegReportingType;

    /**
     * TagNum = 518. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 555. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 825. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 826. Starting with 5.0 version.
     */
    protected TradeAllocIndicator tradeAllocIndicator;

    /**
     * TagNum = 591. Starting with 5.0.
     */
    protected PreallocMethod preallocMethod;

    /**
     * TagNum = 70. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 1072. Starting with 5.0 version.
     */
    ...
    /**
     * TagNum = 1016. Starting with 5.0 version.
     */
    ...
    public TrdCapRptAckSideGroup() {
    }
    
    public TrdCapRptAckSideGroup(FragmentContext context) {
        super(context);
    }
     ...
     */
    @FIXVersion(introduced="5.0SP1")
    @TagNumRef(tagNum=TagNum.SideCurrency)
    ...
    /**
     * Message field setter.
     * @param sideCurrency field value
     */
    @FIXVersion(introduced="5.0SP1")
    @TagNumRef(tagNum=TagNum.SideCurrency)
     ...
     * @param noSideTrdRegTS field value
     */
    @FIXVersion(introduced="5.0")
    @TagNumRef(tagNum=TagNum.NoSideTrdRegTS)
    ...
    protected byte[] encodeFragmentAll() throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (sideCurrency != null) {
                TagEncoder.encode(bao, TagNum.SideCurrency, sideCurrency.getValue());
            }
            if (sideSettlCurrency != null) {
                TagEncoder.encode(bao, TagNum.SideSettlCurrency, sideSettlCurrency.getValue());
            }
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {
            ...
            case SideCurrency:
                sideCurrency = Currency.valueFor(new String(tag.value, sessionCharset));
                break;

            case SideSettlCurrency:
                sideSettlCurrency = Currency.valueFor(new String(tag.value, sessionCharset));
                break;
           ...
           case OrderCategory:
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [TrdCapRptAckSideGroup] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        ...
        b.append("{TrdCapRptAckSideGroup=");
        ...
        printTagValue(b, TagNum.SideCurrency, sideCurrency);
        printTagValue(b, TagNum.SideSettlCurrency, sideSettlCurrency);
