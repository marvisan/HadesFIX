...
/*
 * NestedParties350SP1.java
 *
 * $Id: NestedParties350SP1.java,v 1.2 2011-04-14 23:44:47 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.Nested3PartyGroup50SP1;

/**
 * FIX version 5.0SP1 implementation of NestedParties3 component.
 *
 ...
 */
@XmlTransient
public class NestedParties350SP1 extends NestedParties3 {
    ...
    protected static final Set<Integer> NESTED3_PARTY_GROUP_TAGS = new Nested3PartyGroup50SP1().getFragmentAllTags();
    ...
    public NestedParties350SP1() {
        super();
    }

    public NestedParties350SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoNested3PartyIDs(Integer noNested3PartyIDs) {
        ...
        if (noNested3PartyIDs != null) {
            ...
            for (int i = 0; i < nested3PartyGroups.length; i++) {
                nested3PartyGroups[i] = new Nested3PartyGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public Nested3PartyGroup addNested3PartyGroup() {
        Nested3PartyGroup group = new Nested3PartyGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (NESTED3_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNested3PartyIDs != null && noNested3PartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < nested3PartyGroups.length; i++) {
                    Nested3PartyGroup group = new Nested3PartyGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NestedParties3] component version [5.0SP1].";
    }
