...
import net.hades.fix.message.group.impl.v50.CpctyConfGroup50;
...
/**
 * FIX version 5.0 ConfirmationMsg implementation.
 *
...
public class ConfirmationMsg50 extends ConfirmationMsg {
    ...
    protected static final Set<Integer> CPCTY_CONF_GROUP_TAGS = new CpctyConfGroup50().getFragmentAllTags();
    ...
    public ConfirmationMsg50() {
        super();
    }

    public ConfirmationMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ConfirmationMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ConfirmationMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ConfirmationMsg50 fixml = (ConfirmationMsg50) fragment;
    ...
    public void setNoCapacities(Integer noExecs) {
        ...
        if (noExecs != null) {
            ...
            for (int i = 0; i < cpctyConfGroups.length; i++) {
                cpctyConfGroups[i] = new CpctyConfGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public CpctyConfGroup addCpctyConfGroup() {
        CpctyConfGroup group = new CpctyConfGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public MiscFeeGroup addMiscFeeGroup() {
        MiscFeeGroup group = new MiscFeeGroup50(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
        ...
        if (CPCTY_CONF_GROUP_TAGS.contains(tag.tagNum)) {
            if (noCapacities != null && noCapacities.intValue() > 0) {
                ...
                for (int i = 0; i < noCapacities.intValue(); i++) {
                    CpctyConfGroup group = new CpctyConfGroup50(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ConfirmationMsg] message version [5.0].";
    }
