...
/**
 * FIX 5.0SP1 implementation of PosUndInstrmtGroup group.
 *
...
public class PosUndInstrmtGroup50SP1 extends PosUndInstrmtGroup {
    ...
    protected static final Set<Integer> UND_AMT_GROUP_TAGS = new UnderlyingAmountGroup50SP1().getFragmentAllTags();
    ...
    public PosUndInstrmtGroup50SP1() {
    }

    public PosUndInstrmtGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoUnderlyingAmounts(Integer noUnderlyingAmounts) {
        ...
        if (noUnderlyingAmounts != null) {
            ...
            for (int i = 0; i < underlyingAmountGroups.length; i++) {
                underlyingAmountGroups[i] = new UnderlyingAmountGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UnderlyingAmountGroup addUnderlyingAmountGroup() {
        UnderlyingAmountGroup group = new UnderlyingAmountGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (UND_AMT_GROUP_TAGS.contains(tag.tagNum)) {
            if (noUnderlyingAmounts != null && noUnderlyingAmounts.intValue() > 0) {
                ...
                for (int i = 0; i < underlyingAmountGroups.length; i++) {
                    UnderlyingAmountGroup group = new UnderlyingAmountGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PosUndInstrmtGroup] group version [5.0SP1].";
    }
