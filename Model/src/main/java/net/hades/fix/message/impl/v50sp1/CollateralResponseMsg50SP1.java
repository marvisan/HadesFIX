...
/*
 * CollateralResponseMsg50SP1.java
 *
...
import net.hades.fix.message.group.impl.v50sp1.UndInstrmtCollGroup50SP1;
...
/**
 * FIX version 5.0SP1 CollateralResponseMsg implementation.
 *
...
public class CollateralResponseMsg50SP1 extends CollateralResponseMsg {
    ...
    protected static final Set<Integer> UND_INSTRMT_COLL_GROUP_TAGS = new UndInstrmtCollGroup50SP1().getFragmentAllTags();
    ...
    public CollateralResponseMsg50SP1() {
        super();
    }

    public CollateralResponseMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralResponseMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralResponseMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralResponseMsg50SP1 fixml = (CollateralResponseMsg50SP1) fragment;
    ...
    public void setNoUnderlyings(Integer noUnderlyings) {
        ...
        if (noUnderlyings != null) {
            ...
            for (int i = 0; i < undInstrmtCollGroups.length; i++) {
                undInstrmtCollGroups[i] = new UndInstrmtCollGroup50SP1(context);
            }
        }
    }
    ...
    public UndInstrmtCollGroup addUndInstrmtCollGroup() {
        UndInstrmtCollGroup group = new UndInstrmtCollGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public MiscFeeGroup addMiscFeeGroup() {
        MiscFeeGroup group = new MiscFeeGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (UND_INSTRMT_COLL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noUnderlyings != null && noUnderlyings.intValue() > 0) {
                ...
                for (int i = 0; i < noUnderlyings.intValue(); i++) {
                    UndInstrmtCollGroup component = new UndInstrmtCollGroup50SP1(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralRequestMsg] message version [5.0SP1].";
    }
