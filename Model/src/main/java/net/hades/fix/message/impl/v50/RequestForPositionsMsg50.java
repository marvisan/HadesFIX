...
/**
 * FIX version 5.0 RequestForPositionsMsg implementation.
 *
...
public class RequestForPositionsMsg50 extends RequestForPositionsMsg {
    ...
    public RequestForPositionsMsg50() {
        super();
    }

    public RequestForPositionsMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RequestForPositionsMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public RequestForPositionsMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        RequestForPositionsMsg50 fixml = (RequestForPositionsMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RequestForPositionsMsg] message version [5.0].";
    }
