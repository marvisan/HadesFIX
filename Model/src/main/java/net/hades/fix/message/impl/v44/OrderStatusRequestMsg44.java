...
/*
 * OrderStatusRequestMsg44.java
 *
 * $Id: OrderStatusRequestMsg44.java,v 1.3 2011-04-14 23:44:39 vrotaru Exp $
 */
...
/**
 * FIX version 4.4 OrderStatusRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 21/04/2009, 9:32:41 AM
 */
@XmlRootElement(name="OrdStatReq")
@XmlType(propOrder = {"header", "partyIDGroups", "instrument", "financingDetails", "underlyingInstruments"})
@XmlAccessorType(XmlAccessType.NONE)
public class OrderStatusRequestMsg44 extends OrderStatusRequestMsg {
    ...
    public OrderStatusRequestMsg44() {
        super();
    }

    public OrderStatusRequestMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderStatusRequestMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderStatusRequestMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderStatusRequestMsg44 fixml = (OrderStatusRequestMsg44) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderStatusRequestMsg] message version [4.4].";
    }
