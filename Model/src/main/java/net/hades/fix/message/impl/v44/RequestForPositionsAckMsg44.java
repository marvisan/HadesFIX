...
/*
 * RequestForPositionsAckMsg44.java
 *
...
/**
 * FIX version 4.4 RequestForPositionsAckMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 09/12/2011, 9:32:41 AM
 */
@XmlRootElement(name="PosReqAck")
@XmlType(propOrder = {"header", "partyIDGroups", "instrument", "instrumentLegs", "underlyingInstruments"})
@XmlAccessorType(XmlAccessType.NONE)
public class RequestForPositionsAckMsg44 extends RequestForPositionsAckMsg {
    ...
    public RequestForPositionsAckMsg44() {
        super();
    }

    public RequestForPositionsAckMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public RequestForPositionsAckMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public RequestForPositionsAckMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        RequestForPositionsAckMsg44 fixml = (RequestForPositionsAckMsg44) fragment;
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (posReqStatus != null && MsgUtil.isTagInList(TagNum.PosReqStatus, SECURED_TAGS, secured)) {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RequestForPositionsAckMsg] message version [4.4].";
    }
