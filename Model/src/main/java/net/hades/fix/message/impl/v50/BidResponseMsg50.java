...
/*
 * BidResponseMsg50.java
 *
 * $Id: BidResponseMsg50.java,v 1.2 2011-04-14 23:44:42 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.BidRespComponentGroup50;
import net.hades.fix.message.type.BeginString;

/**
 * FIX version 5.0 BidResponseMsg implementation.
 *
...
public class BidResponseMsg50 extends BidResponseMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> BID_COMP_GROUP_TAGS = new BidRespComponentGroup50().getFragmentAllTags();
    ...
    public BidResponseMsg50() {
        super();
    }

    public BidResponseMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public BidResponseMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public BidResponseMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        BidResponseMsg50 fixml = (BidResponseMsg50) fragment;
    ...
    public void setNoBidComponents(Integer noBidComponents) {
        ...
        if (noBidComponents != null) {
            ...
            for (int i = 0; i < bidComponentGroups.length; i++) {
                bidComponentGroups[i] = new BidRespComponentGroup50(context);
            }
        }
    }
    ...
    public BidRespComponentGroup addBidComponentGroup() {
        BidRespComponentGroup group = new BidRespComponentGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (BID_COMP_GROUP_TAGS.contains(tag.tagNum)) {
            if (noBidComponents != null && noBidComponents.intValue() > 0) {
                ...
                for (int i = 0; i < noBidComponents.intValue(); i++) {
                    BidRespComponentGroup component = new BidRespComponentGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [BidResponseMsg] message version [5.0].";
    }
