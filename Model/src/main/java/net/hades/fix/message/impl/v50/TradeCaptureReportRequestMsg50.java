...
/*
 * TradeCaptureReportRequestMsg50.java
 *
 * $Id: TradeCaptureReportRequestMsg50.java,v 1.1 2011-10-08 08:42:54 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.TrdCapDtGroup50;
...
/**
 * FIX version 5.0 TradeCaptureReportRequestMsg implementation.
 *
...
public class TradeCaptureReportRequestMsg50 extends TradeCaptureReportRequestMsg {
    ...
    protected static final Set<Integer> TRD_CAP_DATE_GROUP_TAGS = new TrdCapDtGroup50().getFragmentAllTags();
    ...
    public TradeCaptureReportRequestMsg50() {
        super();
    }

    public TradeCaptureReportRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradeCaptureReportRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradeCaptureReportRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradeCaptureReportRequestMsg50 fixml = (TradeCaptureReportRequestMsg50) fragment;
    ...
    public void setNoDates(Integer noDates) {
        ...
        if (noDates != null) {
            ...
            for (int i = 0; i < trdCapDtGroups.length; i++) {
                trdCapDtGroups[i] = new TrdCapDtGroup50(context);
            }
        }
    }
    ...
    public TrdCapDtGroup addTrdCapDtGroup() {
        TrdCapDtGroup group = new TrdCapDtGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (TRD_CAP_DATE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noDates != null && noDates.intValue() > 0) {
                ...
                for (int i = 0; i < noDates.intValue(); i++) {
                    TrdCapDtGroup group = new TrdCapDtGroup50(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradeCaptureReportRequestMsg] message version [5.0].";
    }
