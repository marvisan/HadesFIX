...
/*
 * OrderCancelRequestMsg44.java
 *
 * $Id: OrderCancelRequestMsg44.java,v 1.3 2011-05-02 04:04:19 vrotaru Exp $
 */
...
/**
 * FIX version 4.4 OrderCancelRequestMsg implementation.
 *
...
public class OrderCancelRequestMsg44 extends OrderCancelRequestMsg {
    ...
    public OrderCancelRequestMsg44() {
        super();
    }

    public OrderCancelRequestMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRequestMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRequestMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderCancelRequestMsg44 fixml = (OrderCancelRequestMsg44) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderCancelRequestMsg] message version [4.4].";
    }
