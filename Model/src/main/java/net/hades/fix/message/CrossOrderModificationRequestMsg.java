...
/*
 * CrossOrderModificationRequestMsg.java
 *
 * $Id: CrossOrderModificationRequestMsg.java,v 1.1 2011-05-17 09:28:23 vrotaru Exp $
 */
 ...
 * Used to modify a cross order previously submitted using the New Order - Cross message. See Order Cancel
 * Replace Request for details concerning message usage.<br/>
 * Refer to the Order Cancel Replace Request (a.k.a. Order Modification Request) message for restrictions on
 * what fields can be changed during a cancel replace.<br/>
 * The Cross Order-specific fields, CrossType (tag 549) and CrossPrioritization (tag 550), can not be modified
 * using the Cross Order Cancel Replace Request.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 17/05/2011, 9:25:04 AM
 */
@XmlAccessorType(XmlAccessType.NONE)
public abstract class CrossOrderModificationRequestMsg extends FIXMsg {
     ...
     */
    protected net.hades.fix.message.type.GTBookingInst GTBookingInst;
    ...
    public CrossOrderModificationRequestMsg() {
        super();
    }

    public CrossOrderModificationRequestMsg(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CrossOrderModificationRequestMsg(BeginString beginString) throws InvalidMsgException {
        super(MsgType.CrossOrderModificationRequest.getValue(), beginString);
    }

    public CrossOrderModificationRequestMsg(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
        super(MsgType.CrossOrderModificationRequest.getValue(), beginString, applVerID);
    }
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {
           ...
           case QuoteID:
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [CrossOrderModificationRequestMsg] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("{CrossOrderModificationRequestMsg=");
