 ...
 *
 * $Id: OrderListGroup44.java,v 1.3 2011-04-14 23:44:44 vrotaru Exp $
 */
...
@XmlType(propOrder = {"partyIDGroups", "allocGroups", "tradingSessionGroups", "instrument",
...
public class OrderListGroup44 extends OrderListGroup {
    ...
    public OrderListGroup44() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired);
        instrument = new Instrument44(context);
    }
    
    public OrderListGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        instrument = new Instrument44(context);
    }
