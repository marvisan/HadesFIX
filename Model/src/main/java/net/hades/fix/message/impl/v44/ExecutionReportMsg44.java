...
/*
 * ExecutionReportMsg44.java
 *
 * $Id: ExecutionReportMsg44.java,v 1.4 2011-10-21 10:31:01 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v44.ContAmtGroup44;
import net.hades.fix.message.group.impl.v44.ContraBrokerGroup44;
import net.hades.fix.message.group.impl.v44.InstrmtLegExecGroup44;
...
/**
 * FIX version 4.4 ExecutionReport implementation.
 *
...
@XmlType(propOrder = {"header", "partyIDGroups", "contraBrokers", "instrument", "financingDetails",
    "underlyingInstruments", "stipulationsGroups", "orderQtyData", "pegInstructions", "discretionInstructions",
    "commissionData", "spreadOrBenchmarkCurveData", "yieldData", "contAmtGroups", "instrmtLegExecGroups", "miscFeeGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class ExecutionReportMsg44 extends ExecutionReportMsg {
    ...
    protected static final Set<Integer> CONTRA_BROKER_GROUP_TAGS = new ContraBrokerGroup44().getFragmentAllTags();
    ...
    protected static final Set<Integer> INSTRMT_LEG_EXEC_GROUP_TAGS = new InstrmtLegExecGroup44().getFragmentAllTags();
    ...
    public ExecutionReportMsg44() {
        super();
    }

    public ExecutionReportMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ExecutionReportMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ExecutionReportMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ExecutionReportMsg44 fixml = (ExecutionReportMsg44) fragment;
    ...
    public void setNoContraBrokers(Integer noContraBrokers) {
        ...
        if (noContraBrokers != null) {
            ...
            for (int i = 0; i < contraBrokers.length; i++) {
                contraBrokers[i] = new ContraBrokerGroup44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public ContraBrokerGroup addContraBroker() {
        ContraBrokerGroup group = new ContraBrokerGroup44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < instrmtLegExecGroups.length; i++) {
                instrmtLegExecGroups[i] = new InstrmtLegExecGroup44(context);
            }
        }
    }
    ...
    public InstrmtLegExecGroup addInstrmtLegExecGroup() {
        InstrmtLegExecGroup group = new InstrmtLegExecGroup44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (MsgUtil.isTagInList(TagNum.OrdStatusReqID, SECURED_TAGS, secured)) {
            ...
            if (MsgUtil.isTagInList(TagNum.PeggedPrice, SECURED_TAGS, secured)) {
                TagEncoder.encode(bao, TagNum.PeggedPrice, peggedPrice);
            }
            if (MsgUtil.isTagInList(TagNum.DiscretionPrice, SECURED_TAGS, secured)) {
            ...
            if (MsgUtil.isTagInList(TagNum.TargetStrategyPerformance, SECURED_TAGS, secured)) {
            ...
            if (MsgUtil.isTagInList(TagNum.UnderlyingLastPx, SECURED_TAGS, secured)) {
            ...
            if (MsgUtil.isTagInList(TagNum.LastForwardPoints2, SECURED_TAGS, secured)) {
            ...
            if (lastLiquidityInd != null && MsgUtil.isTagInList(TagNum.LastLiquidityInd, SECURED_TAGS, secured)) {
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (CONTRA_BROKER_GROUP_TAGS.contains(tag.tagNum)) {
            if (noContraBrokers != null && noContraBrokers.intValue() > 0) {
                ...
                contraBrokers = new ContraBrokerGroup[noContraBrokers.intValue()];
                for (int i = 0; i < noContraBrokers.intValue(); i++) {
                    ContraBrokerGroup group = new ContraBrokerGroup44(context);
        ...
        if (INSTRMT_LEG_EXEC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                instrmtLegExecGroups = new InstrmtLegExecGroup[noLegs.intValue()];
                for (int i = 0; i < noLegs.intValue(); i++) {
                    InstrmtLegExecGroup component = new InstrmtLegExecGroup44(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ExecutionReportMsg] message version [4.4].";
    }
