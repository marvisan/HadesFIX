...
/*
 * OrderCancelRejectMsg43.java
 *
 * $Id: OrderCancelRejectMsg43.java,v 1.1 2011-01-23 10:02:04 vrotaru Exp $
 */
...
/**
 * FIX version 4.3 OrderCancelRejectMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class OrderCancelRejectMsg43 extends OrderCancelRejectMsg {
    ...
    public OrderCancelRejectMsg43() {
        super();
    }

    public OrderCancelRejectMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRejectMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRejectMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderCancelRejectMsg] message version [4.3].";
    }
