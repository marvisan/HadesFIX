...
/*
 * CommissionData44.java
 *
 * $Id: CommissionData44.java,v 1.1 2010-12-05 08:13:28 vrotaru Exp $
 */
...
/**
 * FIX 4.4 implementation of CommissionData component.
 *
...
public class CommissionData44 extends CommissionData {
    ...
    public CommissionData44() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CommissionData44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (commCurrency != null && MsgUtil.isTagInList(TagNum.CommCurrency, SECURED_TAGS, secured)) {
                TagEncoder.encode(bao, TagNum.CommCurrency, commCurrency.getValue());
            }
            if (MsgUtil.isTagInList(TagNum.FundRenewWaiv, SECURED_TAGS, secured)) {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CommissionData] component version [4.4].";
    }
