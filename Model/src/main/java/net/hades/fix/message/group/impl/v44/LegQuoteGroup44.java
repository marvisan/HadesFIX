...
/*
 * LegQuoteGroup44.java
 *
 * $Id: LegQuoteGroup44.java,v 1.10 2011-04-14 23:44:45 vrotaru Exp $
 */
...
/**
 * FIX 4.4 implementation of LegQuoteGroup group.
 *
...
public class LegQuoteGroup44 extends LegQuoteGroup {
    ...
    public LegQuoteGroup44() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public LegQuoteGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (legPriceType != null && MsgUtil.isTagInList(TagNum.LegPriceType, SECURED_TAGS, secured)) {
                TagEncoder.encode(bao, TagNum.LegPriceType, legPriceType.getValue());
            }
            if (MsgUtil.isTagInList(TagNum.LegBidPx, SECURED_TAGS, secured)) {
                TagEncoder.encode(bao, TagNum.LegBidPx, legBidPx);
            }
            if (MsgUtil.isTagInList(TagNum.LegOfferPx, SECURED_TAGS, secured)) {
