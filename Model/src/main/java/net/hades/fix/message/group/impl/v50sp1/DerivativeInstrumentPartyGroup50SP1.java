 ...
 *
 * $Id: DerivativeInstrumentPartyGroup50SP1.java,v 1.1 2011-09-19 08:15:45 vrotaru Exp $
 */
...
public class DerivativeInstrumentPartyGroup50SP1 extends DerivativeInstrumentPartyGroup {
    ...
    protected static final Set<Integer> INSTRUMENT_PARTY_SUB_ID_GROUP_TAGS = new DerivativeInstrumentPartySubIDGroup50SP1().getFragmentAllTags();
    ...
    public DerivativeInstrumentPartyGroup50SP1() {
    }

    public DerivativeInstrumentPartyGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoDerivativeInstrumentPartySubIDs(Integer noDerivativeInstrumentPartySubIDs) {
        ...
        if (noDerivativeInstrumentPartySubIDs != null) {
            ...
            for (int i = 0; i < derivativeInstrumentPartySubIDGroups.length; i++) {
                derivativeInstrumentPartySubIDGroups[i] = new DerivativeInstrumentPartySubIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public DerivativeInstrumentPartySubIDGroup addDerivativeInstrumentPartySubIDGroup() {
        DerivativeInstrumentPartySubIDGroup group = new DerivativeInstrumentPartySubIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noDerivativeInstrumentPartySubIDs != null && noDerivativeInstrumentPartySubIDs.intValue() > 0) {
            if (INSTRUMENT_PARTY_SUB_ID_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noDerivativeInstrumentPartySubIDs.intValue(); i++) {
                    DerivativeInstrumentPartySubIDGroup group = new DerivativeInstrumentPartySubIDGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DerivativeInstrumentPartyGroup] component version [5.0SP1].";
    }
