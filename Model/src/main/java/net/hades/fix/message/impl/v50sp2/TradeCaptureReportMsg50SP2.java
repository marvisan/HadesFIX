...
/*
 * TradeCaptureReportMsg50SP2.java
 *
 * $Id: TradeCaptureReportMsg50SP2.java,v 1.2 2011-10-25 08:29:20 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.TrdCapRptSideGroup50SP2;
...
@XmlType(propOrder = {"header", "applicationSequenceControl", "rootPartyIDGroups", "instrument", "financingDetails",
...
public class TradeCaptureReportMsg50SP2 extends TradeCaptureReportMsg {
    ...
    protected static final Set<Integer> TRD_CAP_RPT_SIDE_GROUP_TAGS = new TrdCapRptSideGroup50SP2().getFragmentAllTags();
    ...
    public TradeCaptureReportMsg50SP2() {
        super();
    }

    public TradeCaptureReportMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradeCaptureReportMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradeCaptureReportMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradeCaptureReportMsg50SP2 fixml = (TradeCaptureReportMsg50SP2) fragment;
    ...
    public void setNoSides(Integer noSides) {
        ...
        if (noSides != null) {
            ...
            for (int i = 0; i < trdCapRptSideGroups.length; i++) {
                trdCapRptSideGroups[i] = new TrdCapRptSideGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public TrdCapRptSideGroup addTrdCapRptSideGroup() {
        TrdCapRptSideGroup group = new TrdCapRptSideGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (TRD_CAP_RPT_SIDE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSides != null && noSides.intValue() > 0) {
                ...
                for (int i = 0; i < noSides.intValue(); i++) {
                    TrdCapRptSideGroup component = new TrdCapRptSideGroup50SP2(context);
                    component.decode(message);
