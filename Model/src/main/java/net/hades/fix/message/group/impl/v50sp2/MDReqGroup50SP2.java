 ...
 *
 * $Id: MDReqGroup50SP2.java,v 1.7 2011-04-14 23:44:29 vrotaru Exp $
 */
...
public class MDReqGroup50SP2 extends MDReqGroup {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -8593655857749583647L;
    ...
    public MDReqGroup50SP2() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        instrument = new Instrument50SP2(context);
    }

    public MDReqGroup50SP2(FragmentContext context) {
        super(context);
        instrument = new Instrument50SP2(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MDReqGroup] group version [5.0SP2].";
    }
