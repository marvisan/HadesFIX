 ...
 * QuoteMsg40.java
 *
 * $Id: QuoteMsg40.java,v 1.10 2010-12-05 08:13:28 vrotaru Exp $
 */
...
/**
 * FIX version 4.0 QuoteMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.10 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class QuoteMsg40 extends QuoteMsg {
    ...
    protected static final Set<Integer> START_DATA_TAGS_V40 = new HashSet<Integer>(Arrays.asList(new Integer[] {
    ...
    static {
        ...
        ALL_TAGS.addAll(START_DATA_TAGS_V40);
    }
    ...
    public QuoteMsg40(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteMsg40(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteMsg40(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteMsg] message version [4.0].";
    }
