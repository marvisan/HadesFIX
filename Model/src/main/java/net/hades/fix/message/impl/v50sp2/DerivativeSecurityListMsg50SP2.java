...
/*
 * DerivativeSecurityListMsg50SP2.java
 *
 * $Id: DerivativeSecurityListMsg50SP2.java,v 1.1 2011-09-27 08:57:26 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.DerivSecListGroup50SP2;
...
import net.hades.fix.message.comp.impl.v50sp2.DerivativeSecurityDefinition50SP2;
...
public class DerivativeSecurityListMsg50SP2 extends DerivativeSecurityListMsg {
    ...
    protected static final Set<Integer> DERIV_SEC_DEF_COMP_TAGS = new DerivativeSecurityDefinition50SP2().getFragmentAllTags();
    protected static final Set<Integer> DERIV_SEC_LIST_GROUP_TAGS = new DerivSecListGroup50SP2().getFragmentAllTags();
    ...
    public DerivativeSecurityListMsg50SP2() {
        super();
    }

    public DerivativeSecurityListMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public DerivativeSecurityListMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public DerivativeSecurityListMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        DerivativeSecurityListMsg50SP2 fixml = (DerivativeSecurityListMsg50SP2) fragment;
    ...
    public void setDerivativeSecurityDefinition() {
        this.derivativeSecurityDefinition = new DerivativeSecurityDefinition50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    ...
    public void setNoRelatedSyms(Integer noRelatedSyms) {
        ...
        if (noRelatedSyms != null) {
            ...
            for (int i = 0; i < derivSecListGroups.length; i++) {
                derivSecListGroups[i] = new DerivSecListGroup50SP2(context);
            }
        }
    }
    ...
    public DerivSecListGroup addDerivSecListGroup() {
        DerivSecListGroup group = new DerivSecListGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (DERIV_SEC_DEF_COMP_TAGS.contains(tag.tagNum)) {
            if (derivativeSecurityDefinition == null) {
                derivativeSecurityDefinition = new DerivativeSecurityDefinition50SP2(context);
            }
        ...
        if (DERIV_SEC_LIST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRelatedSyms != null && noRelatedSyms.intValue() > 0) {
                ...
                for (int i = 0; i < noRelatedSyms.intValue(); i++) {
                    DerivSecListGroup group = new DerivSecListGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DerivativeSecurityListMsg] message version [5.0SP2].";
    }
