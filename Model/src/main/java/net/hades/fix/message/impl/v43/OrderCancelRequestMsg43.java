...
/*
 * OrderCancelRequestMsg43.java
 *
 * $Id: OrderCancelRequestMsg43.java,v 1.3 2011-05-02 04:04:19 vrotaru Exp $
 */
...
/**
 * FIX version 4.3 OrderCancelRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class OrderCancelRequestMsg43 extends OrderCancelRequestMsg {
    ...
    public OrderCancelRequestMsg43() {
        super();
    }

    public OrderCancelRequestMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRequestMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRequestMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderCancelRequestMsg] message version [4.3].";
    }
