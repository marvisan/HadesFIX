...
/*
 * NewOrderMultilegMsg50.java
 *
 * $Id: NewOrderMultilegMsg50.java,v 1.2 2011-09-09 08:05:14 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 NewOrderMultilegMsg implementation.
 *
...
public class NewOrderMultilegMsg50 extends NewOrderMultilegMsg {
    ...
    public NewOrderMultilegMsg50() {
        super();
    }

    public NewOrderMultilegMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public NewOrderMultilegMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public NewOrderMultilegMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewOrderMultilegMsg50 fixml = (NewOrderMultilegMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderMultilegMsg] message version [5.0].";
    }
