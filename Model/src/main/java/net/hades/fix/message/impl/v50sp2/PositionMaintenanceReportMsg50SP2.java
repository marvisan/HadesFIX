...
/*
 * PositionMaintenanceReportMsg50SP2.java
 *
...
/**
 * FIX version 5.0SP2 PositionMaintenanceReportMsg implementation.
 *
...
public class PositionMaintenanceReportMsg50SP2 extends PositionMaintenanceReportMsg {
    ...
    public PositionMaintenanceReportMsg50SP2() {
        super();
    }

    public PositionMaintenanceReportMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public PositionMaintenanceReportMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public PositionMaintenanceReportMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        PositionMaintenanceReportMsg50SP2 fixml = (PositionMaintenanceReportMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PositionMaintenanceReportMsg] message version [5.0SP2].";
    }
