...
/*
 * PositionMaintenanceRequestMsg50.java
 *
...
/**
 * FIX version 5.0 PositionMaintenanceRequestMsg implementation.
 *
...
public class PositionMaintenanceRequestMsg50 extends PositionMaintenanceRequestMsg {
    ...
    public PositionMaintenanceRequestMsg50() {
        super();
    }

    public PositionMaintenanceRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public PositionMaintenanceRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public PositionMaintenanceRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        PositionMaintenanceRequestMsg50 fixml = (PositionMaintenanceRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PositionMaintenanceRequestMsg] message version [5.0].";
    }
