...
/*
 * OrderCancelRejectMsg50SP1.java
 *
 * $Id: OrderCancelRejectMsg50SP1.java,v 1.1 2011-01-23 10:02:05 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 OrderCancelRejectMsg implementation.
 *
...
public class OrderCancelRejectMsg50SP1 extends OrderCancelRejectMsg {
    ...
    public OrderCancelRejectMsg50SP1() {
        super();
    }

    public OrderCancelRejectMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderCancelRejectMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderCancelRejectMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderCancelRejectMsg50SP1 fixml = (OrderCancelRejectMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderCancelRejectMsg] message version [5.0SP1].";
    }
