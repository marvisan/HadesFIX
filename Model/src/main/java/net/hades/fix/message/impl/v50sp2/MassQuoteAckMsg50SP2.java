...
/*
 * MassQuoteAckMsg50SP2.java
 *
 * $Id: MassQuoteAckMsg50SP2.java,v 1.11 2011-05-02 04:04:19 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 MassQuoteMsg implementation.
 *
...
@XmlType(propOrder = {"header", "partyIDGroups", "targetPartyGroups", "quoteSetAckGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class MassQuoteAckMsg50SP2 extends MassQuoteAckMsg {
    ...
    protected static final Set<Integer> QUOTE_SET_ACK_GROUP_TAGS = new QuoteSetAckGroup50SP2().getFragmentAllTags();
    ...
    public MassQuoteAckMsg50SP2() {
        super();
    }
    
    public MassQuoteAckMsg50SP2(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MassQuoteAckMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MassQuoteAckMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MassQuoteAckMsg50SP2 fixml = (MassQuoteAckMsg50SP2) fragment;
    ...
    public void setNoQuoteSets(Integer noQuoteSets) {
        ...
        if (noQuoteSets != null) {
            ...
            for (int i = 0; i < quoteSetAckGroups.length; i++) {
                quoteSetAckGroups[i] = new QuoteSetAckGroup50SP2(context);
            }
        }
    }
    ...
    public QuoteSetAckGroup addQuoteSetAckGroup() {
        QuoteSetAckGroup group = new QuoteSetAckGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (QUOTE_SET_ACK_GROUP_TAGS.contains(tag.tagNum)) {
            if (noQuoteSets != null && noQuoteSets.intValue() > 0) {
                ...
                for (int i = 0; i < noQuoteSets.intValue(); i++) {
                    QuoteSetAckGroup component = new QuoteSetAckGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MassQuoteAckMsg] message version [5.0SP2].";
    }
