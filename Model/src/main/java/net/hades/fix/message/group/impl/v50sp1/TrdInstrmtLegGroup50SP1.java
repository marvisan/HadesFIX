...
/*
 * TrdInstrmtLegGroup50SP1.java
 *
 * $Id: TrdInstrmtLegGroup50SP1.java,v 1.2 2011-10-25 08:29:20 vrotaru Exp $
 */
...
import net.hades.fix.message.comp.impl.v50sp1.UnderlyingLegInstrument50SP1;
...
/**
 * FIX 5.0SP1 implementation of TrdInstrmtLegGroup group.
 *
...
public class TrdInstrmtLegGroup50SP1 extends TrdInstrmtLegGroup {
    ...
    protected static final Set<Integer> UNDLY_INSTRMT_LEG_COMP_TAGS = new UnderlyingLegInstrument50SP1().getFragmentAllTags();
    ...
    public TrdInstrmtLegGroup50SP1() {
        super();
    }

    public TrdInstrmtLegGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setLegStipulations() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        this.legStipulations = new LegStipulations50SP1(context);
    }
    ...
    public void setNestedParties() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        this.nestedParties = new NestedParties50SP1(context);
    }
    ...
    public void setNoOfLegUnderlyings(Integer noOfLegUnderlyings) {
        ...
        if (noOfLegUnderlyings != null) {
            ...
            for (int i = 0; i < underlyingLegInstruments.length; i++) {
                underlyingLegInstruments[i] = new UnderlyingLegInstrument50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public UnderlyingLegInstrument addUnderlyingLegInstrument() {
        ...
        UnderlyingLegInstrument group = new UnderlyingLegInstrument50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (LEG_STIPULATIONS_COMP_TAGS.contains(tag.tagNum)) {
            if (legStipulations == null) {
                legStipulations = new LegStipulations50SP1(context);
            }
            legStipulations.decode(tag, message);
        }
        if (NESTED_PARTIES_COMP_TAGS.contains(tag.tagNum)) {
            if (nestedParties == null) {
                nestedParties = new NestedParties50SP1(context);
            }
        ...
        if (noOfLegUnderlyings != null && noOfLegUnderlyings.intValue() > 0) {
            if (UNDLY_INSTRMT_LEG_COMP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noOfLegUnderlyings.intValue(); i++) {
                    UnderlyingLegInstrument group = new UnderlyingLegInstrument50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TrdInstrmtLegGroup] group version [5.0SP1].";
    }
