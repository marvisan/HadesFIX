...
/*
 * AllocationInstructionAckMsg50SP2.java
 *
 * $Id: AllocationInstructionAckMsg50SP2.java,v 1.3 2011-04-14 23:44:29 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.AllocAckGroup50SP2;
...
/**
 * FIX version 5.0SP2 AllocationInstructionAckMsg implementation.
 *
...
public class AllocationInstructionAckMsg50SP2 extends AllocationInstructionAckMsg {
    ...
    protected static final Set<Integer> ALLOC_ACK_GROUP_TAGS = new AllocAckGroup50SP2().getFragmentAllTags();
    ...
    public AllocationInstructionAckMsg50SP2() {
        super();
    }

    public AllocationInstructionAckMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AllocationInstructionAckMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AllocationInstructionAckMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationInstructionAckMsg50SP2 fixml = (AllocationInstructionAckMsg50SP2) fragment;
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocAckGroups.length; i++) {
                allocAckGroups[i] = new AllocAckGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public AllocAckGroup addAllocAckGroup() {
        AllocAckGroup group = new AllocAckGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (ALLOC_ACK_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAllocs != null && noAllocs.intValue() > 0) {
                ...
                for (int i = 0; i < noAllocs.intValue(); i++) {
                    AllocAckGroup group = new AllocAckGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationInstructionAckMsg] message version [5.0SP2].";
    }
