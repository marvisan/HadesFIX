 ...
 * MiscFeeGroup41.java
 *
 * $Id: MiscFeeGroup41.java,v 1.1 2011-01-09 07:27:42 vrotaru Exp $
 */
...
/**
 * FIX 4.1 implementation of MiscFeeGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 05/04/2009, 11:39:24 AM
 */
public class MiscFeeGroup41 extends MiscFeeGroup {
    ...
    public MiscFeeGroup41() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public MiscFeeGroup41(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MiscFeeGroup] group version [4.1].";
    }
