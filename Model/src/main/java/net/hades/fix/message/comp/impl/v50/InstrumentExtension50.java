...
/*
 * InstrumentExtension50.java
 *
 * $Id: InstrumentExtension50.java,v 1.3 2011-04-14 23:44:51 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.InstrmtAttribGroup50;
...
/**
 * InstrumentExtension FIX version 5.0 implementation.
 * 
...
public class InstrumentExtension50 extends InstrumentExtension {
    ...
    protected static final Set<Integer> INSTRMT_ATTRIB_GROUP_TAGS = new InstrmtAttribGroup50().getFragmentAllTags();
    ...
    public InstrumentExtension50() {
        super();
    }

    public InstrumentExtension50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoInstrAttrib(Integer noInstrAttrib) {
        ...
        if (noInstrAttrib != null) {
            ...
            for (int i = 0; i < instrmtAttribGroups.length; i++) {
                instrmtAttribGroups[i] = new InstrmtAttribGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public InstrmtAttribGroup addInstrmtAttribGroup() {
        InstrmtAttribGroup group = new InstrmtAttribGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noInstrAttrib != null && noInstrAttrib.intValue() > 0) {
            if (INSTRMT_ATTRIB_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noInstrAttrib.intValue(); i++) {
                    InstrmtAttribGroup group = new InstrmtAttribGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrumentExtension] component version [5.0].";
    }
