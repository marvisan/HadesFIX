...
/*
 * MarketDataIncrRefreshMsg50SP1.java
 *
 * $Id: MarketDataIncrRefreshMsg50SP1.java,v 1.9 2011-04-14 23:44:57 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 MarketDataIncrRefreshMsg implementation.
 *
...
public class MarketDataIncrRefreshMsg50SP1 extends MarketDataIncrRefreshMsg {
    ...
    protected static final Set<Integer> MD_INC_GROUP_TAGS = new MDIncGroup50SP1().getFragmentAllTags();
    ...
    public MarketDataIncrRefreshMsg50SP1() {
        super();
    }
    
    public MarketDataIncrRefreshMsg50SP1(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MarketDataIncrRefreshMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MarketDataIncrRefreshMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MarketDataIncrRefreshMsg50SP1 fixml = (MarketDataIncrRefreshMsg50SP1) fragment;
    ...
    public void setNoMDEntries(Integer noMDEntries) {
        ...
        if (noMDEntries != null) {
            ...
            for (int i = 0; i < mdIncGroups.length; i++) {
                mdIncGroups[i] = new MDIncGroup50SP1(context);
            }
        }
    }
    ...
    public MDIncGroup addMDIncGroup() {
        MDIncGroup group = new MDIncGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (MD_INC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noMDEntries != null && noMDEntries.intValue() > 0) {
                ...
                for (int i = 0; i < noMDEntries.intValue(); i++) {
                    MDIncGroup component = new MDIncGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MarketDataIncrRefreshMsg] message version [5.0SP1].";
    }
