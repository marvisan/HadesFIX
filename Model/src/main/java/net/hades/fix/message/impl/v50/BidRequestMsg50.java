...
/*
 * BidRequestMsg50.java
 *
 * $Id: BidRequestMsg50.java,v 1.3 2011-04-14 23:44:42 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.BidReqComponentGroup50;
...
import net.hades.fix.message.group.impl.v50.BidReqDescriptorGroup50;
...
/**
 * FIX version 5.0 BidRequestMsg implementation.
 *
...
public class BidRequestMsg50 extends BidRequestMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> BID_DESCR_GROUP_TAGS = new BidReqDescriptorGroup50().getFragmentAllTags();
    protected static final Set<Integer> BID_COMP_GROUP_TAGS = new BidReqComponentGroup50().getFragmentAllTags();
    ...
    public BidRequestMsg50() {
        super();
    }

    public BidRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public BidRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public BidRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        BidRequestMsg50 fixml = (BidRequestMsg50) fragment;
    ...
    public void setNoBidDescriptors(Integer noBidDescriptors) {
        ...
        if (noBidDescriptors != null) {
            ...
            for (int i = 0; i < bidDescriptorGroups.length; i++) {
                bidDescriptorGroups[i] = new BidReqDescriptorGroup50(context);
            }
        }
    }
    ...
    public BidReqDescriptorGroup addBidDescriptorGroup() {
        BidReqDescriptorGroup group = new BidReqDescriptorGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoBidComponents(Integer noBidComponents) {
        ...
        if (noBidComponents != null) {
            ...
            for (int i = 0; i < bidComponentGroups.length; i++) {
                bidComponentGroups[i] = new BidReqComponentGroup50(context);
            }
        }
    }
    ...
    public BidReqComponentGroup addBidComponentGroup() {
        BidReqComponentGroup group = new BidReqComponentGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (BID_DESCR_GROUP_TAGS.contains(tag.tagNum)) {
            if (noBidDescriptors != null && noBidDescriptors.intValue() > 0) {
                ...
                for (int i = 0; i < noBidDescriptors.intValue(); i++) {
                    BidReqDescriptorGroup component = new BidReqDescriptorGroup50(context);
        ...
        if (BID_COMP_GROUP_TAGS.contains(tag.tagNum)) {
            if (noBidComponents != null && noBidComponents.intValue() > 0) {
                ...
                for (int i = 0; i < noBidComponents.intValue(); i++) {
                    BidReqComponentGroup component = new BidReqComponentGroup50(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [BidRequestMsg] message version [5.0].";
    }
