...
/*
 * InstrumentPartyGroup50.java
 *
 * $Id: InstrumentPartyGroup50.java,v 1.8 2011-04-14 23:44:36 vrotaru Exp $
 */
...
/**
 * FIX 5.0 implementation of InstrumentPartyGroup group.
 *
...
public class InstrumentPartyGroup50 extends InstrumentPartyGroup {
    ...
    protected static final Set<Integer> INSTRUMENT_PARTY_SUB_ID_GROUP_TAGS = new InstrumentPartySubIDGroup50().getFragmentAllTags();
    ...
    public InstrumentPartyGroup50() {
    }

    public InstrumentPartyGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoInstrumentPartySubIDs(Integer noInstrumentPartySubIDs) {
        ...
        if (noInstrumentPartySubIDs != null) {
            ...
            for (int i = 0; i < instrumentPartySubIDGroups.length; i++) {
                instrumentPartySubIDGroups[i] = new InstrumentPartySubIDGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public InstrumentPartySubIDGroup addInstrumentPartySubIDGroup() {
        InstrumentPartySubIDGroup group = new InstrumentPartySubIDGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noInstrumentPartySubIDs != null && noInstrumentPartySubIDs.intValue() > 0) {
            if (INSTRUMENT_PARTY_SUB_ID_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noInstrumentPartySubIDs.intValue(); i++) {
                    InstrumentPartySubIDGroup group = new InstrumentPartySubIDGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrumentPartyGroup] component version [5.0].";
    }
