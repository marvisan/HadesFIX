...
/*
 * OrderModificationRequestMsg42.java
 *
 * $Id: OrderModificationRequestMsg42.java,v 1.4 2011-04-14 23:44:39 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v42.PreTradeAllocGroup42;
import net.hades.fix.message.group.impl.v42.TradingSessionGroup42;
...
/**
 * FIX version 4.2 OrderModificationRequesMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class OrderModificationRequestMsg42 extends OrderModificationRequestMsg {
    ...
    protected static final Set<Integer> TRADING_SESS_GROUP_TAGS = new TradingSessionGroup42().getFragmentAllTags();
    ...
    public OrderModificationRequestMsg42() {
        super();
    }

    public OrderModificationRequestMsg42(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderModificationRequestMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderModificationRequestMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoTradingSessions(Integer noTradingSessions) {
        ...
        if (noTradingSessions != null) {
            ...
            for (int i = 0; i < tradingSessionGroups.length; i++) {
                tradingSessionGroups[i] = new TradingSessionGroup42(context);
            }
        }
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderModificationRequestMsg] message version [4.2].";
    }
