...
/*
 * OrderAllocGroup40.java
 *
 * $Id: OrderAllocGroup40.java,v 1.1 2011-02-06 04:44:15 vrotaru Exp $
 */
...
/**
 * FIX 4.0/4.1/4.2/4.3 implementation of OrderAllocGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 12/02/2009, 7:22:35 PM
 */
public class OrderAllocGroup40 extends OrderAllocGroup {
    ...
    public OrderAllocGroup40() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public OrderAllocGroup40(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderAllocGroup] group version [4.0/1/2/3].";
    }
