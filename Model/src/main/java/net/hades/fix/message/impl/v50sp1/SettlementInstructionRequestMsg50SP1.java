...
/*
 * SettlementInstructionRequestMsg50SP1.java
 *
...
/**
 * FIX version 5.0SP1 SettlementInstructionRequestMsg implementation.
 *
...
public class SettlementInstructionRequestMsg50SP1 extends SettlementInstructionRequestMsg {
    ...
    public SettlementInstructionRequestMsg50SP1() {
        super();
    }

    public SettlementInstructionRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SettlementInstructionRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SettlementInstructionRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SettlementInstructionRequestMsg50SP1 fixml = (SettlementInstructionRequestMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SettlementInstructionRequestMsg] message version [5.0SP1].";
    }
