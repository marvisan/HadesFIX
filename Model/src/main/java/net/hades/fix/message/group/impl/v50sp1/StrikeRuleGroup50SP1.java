...
/*
 * StrikeRuleGroup50SP1.java
 *
 * $Id: StrikeRuleGroup50SP1.java,v 1.2 2011-04-20 00:32:34 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of StrikeRuleGroup group.
 *
...
public class StrikeRuleGroup50SP1 extends StrikeRuleGroup {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> MATURITY_RULE_GROUP_TAGS = new MaturityRuleGroup50SP1().getFragmentAllTags();
    ...
    public StrikeRuleGroup50SP1() {
    }

    public StrikeRuleGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoMaturityRules(Integer noMaturityRules) {
        ...
        if (noMaturityRules != null) {
            ...
            for (int i = 0; i < maturityRuleGroups.length; i++) {
                maturityRuleGroups[i] = new MaturityRuleGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public MaturityRuleGroup addMaturityRuleGroup() {
        MaturityRuleGroup group = new MaturityRuleGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noMaturityRules != null && noMaturityRules.intValue() > 0) {
            if (MATURITY_RULE_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noMaturityRules.intValue(); i++) {
                    MaturityRuleGroup group = new MaturityRuleGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [StrikeRuleGroup] group version [5.0SP1].";
    }
