...
/**
 * FIX version 5.0SP2 AllocationReportMsg implementation.
 *
...
@XmlType(propOrder = {"header", "orderAllocGroups", "execAllocGroups", "instrument", "instrumentExtension", "financingDetails",
    ...
    "posAmtGroups", "allocGroups", "rateSources"})
@XmlAccessorType(XmlAccessType.NONE)
public class AllocationReportMsg50SP2 extends AllocationReportMsg {
    ...
    public AllocationReportMsg50SP2() {
        super();
    }

    public AllocationReportMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AllocationReportMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AllocationReportMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationReportMsg50SP2 fixml = (AllocationReportMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationReportMsg] message version [5.0SP2].";
    }
