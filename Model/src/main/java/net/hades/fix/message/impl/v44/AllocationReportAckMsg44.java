...
/**
 * FIX version 4.4 AllocationReportAckMsg implementation.
 *
...
public class AllocationReportAckMsg44 extends AllocationReportAckMsg {
    ...
    public AllocationReportAckMsg44() {
        super();
    }

    public AllocationReportAckMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public AllocationReportAckMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public AllocationReportAckMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationReportAckMsg44 fixml = (AllocationReportAckMsg44) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationReportAckMsg] message version [4.4].";
    }
