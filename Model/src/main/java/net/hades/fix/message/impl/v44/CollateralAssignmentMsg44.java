...
/*
 * CollateralAssignmentMsg44.java
 *
...
/**
 * FIX version 4.4 CollateralAssignmentMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 16/12/2011, 9:32:41 AM
 */
@XmlRootElement(name="CollAsgn")
...
public class CollateralAssignmentMsg44 extends CollateralAssignmentMsg {
    ...
    public CollateralAssignmentMsg44() {
        super();
    }

    public CollateralAssignmentMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CollateralAssignmentMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public CollateralAssignmentMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralAssignmentMsg44 fixml = (CollateralAssignmentMsg44) fragment;
        ...
        if (fixml.getCollAsgnRefID() != null) {
            collAsgnRefID = fixml.getCollAsgnRefID();
        }
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            ...
            if (MsgUtil.isTagInList(TagNum.CollAsgnRefID, SECURED_TAGS, secured)) {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralAssignmentMsg] message version [4.4].";
    }
