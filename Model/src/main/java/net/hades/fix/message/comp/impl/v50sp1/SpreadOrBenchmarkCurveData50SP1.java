...
/*
 * SpreadOrBenchmarkCurveData50SP1.java
 *
 * $Id: SpreadOrBenchmarkCurveData50SP1.java,v 1.6 2010-02-25 08:37:37 vrotaru Exp $
 */
...
public class SpreadOrBenchmarkCurveData50SP1 extends SpreadOrBenchmarkCurveData {
    ...
    public SpreadOrBenchmarkCurveData50SP1() {
        super();
    }

    public SpreadOrBenchmarkCurveData50SP1(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SpreadOrBenchmarkCurveData] component version [5.0SP1].";
    }
