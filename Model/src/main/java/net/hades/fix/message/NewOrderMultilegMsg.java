...
/*
 * NewOrderMultilegMsg.java
 *
 * $Id: NewOrderMultilegMsg.java,v 1.3 2011-09-09 08:05:13 vrotaru Exp $
 */
 ...
 * The New Order - Multileg is provided to submit orders for securities that are made up of multiple securities,
 * known as legs.
 *
...
public abstract class NewOrderMultilegMsg extends FIXMsg {
    ...
    public NewOrderMultilegMsg() {
        super();
    }

    public NewOrderMultilegMsg(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public NewOrderMultilegMsg(BeginString beginString) throws InvalidMsgException {
        super(MsgType.NewOrderMultileg.getValue(), beginString);
    }

    public NewOrderMultilegMsg(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
        super(MsgType.NewOrderMultileg.getValue(), beginString, applVerID);
    }
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {
           ...
           case QuoteID:
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [NewOrderMultilegMsg] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("{NewOrderMultilegMsg=");
