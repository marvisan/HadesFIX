...
/*
 * PartyGroup50SP1.java
 *
 * $Id: PartyGroup50SP1.java,v 1.8 2011-04-14 23:44:51 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of PartyGroup group.
 *
...
public class PartyGroup50SP1 extends PartyGroup {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -7017209691347140066L;

    protected static final Set<Integer> START_COMP_TAGS;

    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> PARTY_SUB_ID_GROUP_TAGS = new PartySubGroup50SP1().getFragmentAllTags();
    ...
    public PartyGroup50SP1() {
    }

    public PartyGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoPartySubIDs(Integer noPartySubIDs) {
        ...
        if (noPartySubIDs != null) {
            ...
            for (int i = 0; i < partySubIDGroups.length; i++) {
                partySubIDGroups[i] = new PartySubGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public PartySubGroup addPartySubIDGroup() {
        PartySubGroup group = new PartySubGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (PARTY_SUB_ID_GROUP_TAGS.contains(tag.tagNum)) {
            if (noPartySubIDs != null && noPartySubIDs.intValue() > 0) {
                ...
                for (int i = 0; i < partySubIDGroups.length; i++) {
                    PartySubGroup group = new PartySubGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PartyGroup] group version [5.0SP1].";
    }
