...
/*
 * TradingSessionStatusRequestMsg42.java
 *
 * $Id: TradingSessionStatusRequestMsg42.java,v 1.1 2011-04-22 01:59:22 vrotaru Exp $
 */
...
/**
 * FIX version 4.2 TradingSessionStatusRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class TradingSessionStatusRequestMsg42 extends TradingSessionStatusRequestMsg {
    ...
    public TradingSessionStatusRequestMsg42() {
        super();
    }

    public TradingSessionStatusRequestMsg42(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public TradingSessionStatusRequestMsg42(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public TradingSessionStatusRequestMsg42(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradingSessionStatusRequestMsg] message version [4.2].";
    }
