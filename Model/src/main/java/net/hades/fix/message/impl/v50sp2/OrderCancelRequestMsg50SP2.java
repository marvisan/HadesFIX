...
/*
 * OrderCancelRequestMsg50SP2.java
 *
 * $Id: OrderCancelRequestMsg50SP2.java,v 1.3 2011-05-02 04:04:19 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP2 OrderCancelRequestMsg implementation.
 *
...
public class OrderCancelRequestMsg50SP2 extends OrderCancelRequestMsg {
    ...
    public OrderCancelRequestMsg50SP2() {
        super();
    }

    public OrderCancelRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public OrderCancelRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderCancelRequestMsg50SP2 fixml = (OrderCancelRequestMsg50SP2) fragment;
