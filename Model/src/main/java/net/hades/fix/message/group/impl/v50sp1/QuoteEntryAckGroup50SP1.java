...
/*
 * QuoteEntryAckGroup50SP1.java
 *
 * $Id: QuoteEntryAckGroup50SP1.java,v 1.8 2011-04-14 23:44:53 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP1 implementation of QuoteEntryAckGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.8 $
 * @created 12/02/2009, 7:22:35 PM
 */
@XmlRootElement(name="QuotEntryAck")
@XmlType(propOrder={"instrument", "instrumentLegs"})
@XmlAccessorType(XmlAccessType.NONE)
public class QuoteEntryAckGroup50SP1 extends QuoteEntryAckGroup {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -7192247627577622869L;
    ...
    public QuoteEntryAckGroup50SP1() {
    }
    
    public QuoteEntryAckGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteEntryAckGroup] group version [5.0SP1].";
    }
