...
/*
 * NewOrderListMsg50SP2.java
 *
 * $Id: NewOrderListMsg50SP2.java,v 1.3 2011-04-14 23:44:27 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.OrderListGroup50SP2;
...
/**
 * FIX version 5.0SP2 NewOrderListMsg implementation.
 *
...
public class NewOrderListMsg50SP2 extends NewOrderListMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> ORDER_LIST_GROUP_TAGS = new OrderListGroup50SP2().getFragmentAllTags();
    ...
    public NewOrderListMsg50SP2() {
        super();
    }

    public NewOrderListMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderListMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public NewOrderListMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        NewOrderListMsg50SP2 fixml = (NewOrderListMsg50SP2) fragment;
    ...
    public void setNoOrders(Integer noOrders) {
        ...
        if (noOrders != null) {
            ...
            for (int i = 0; i < orderListGroups.length; i++) {
                orderListGroups[i] = new OrderListGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public OrderListGroup addOrderListGroup() {
        OrderListGroup group = new OrderListGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (ORDER_LIST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noOrders != null && noOrders.intValue() > 0) {
                ...
                for (int i = 0; i < noOrders.intValue(); i++) {
                    OrderListGroup group = new OrderListGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [NewOrderListMsg] message version [5.0SP2].";
    }
