...
/**
 * FIX version 4.4 AllocationReportMsg implementation.
 *
...
public class AllocationReportMsg44 extends AllocationReportMsg {
    ...
    public AllocationReportMsg44() {
        super();
    }

    public AllocationReportMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public AllocationReportMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public AllocationReportMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationReportMsg44 fixml = (AllocationReportMsg44) fragment;
    ...
    public void setNoExecs(Integer noExecs) {
        ...
        if (noExecs != null) {
            ...
            for (int i = 0; i < execAllocGroups.length; i++) {
                execAllocGroups[i] = new ExecAllocGroup44(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public ExecAllocGroup addExecAllocGroup() {
        ExecAllocGroup group = new ExecAllocGroup44(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocGroups.length; i++) {
                allocGroups[i] = new AllocGroup44(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public AllocGroup addAllocGroup() {
        AllocGroup group = new AllocGroup44(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    protected void validateRequiredTags() throws TagNotPresentException {
        ...
        if (allocNoOrdersType == null) {
            errorMsg.append(" [AllocNoOrdersType]");
            hasMissingTag = true;
        }
        if (side == null) {
    ...
    protected byte[] encodeFragmentSecured(boolean secured) throws TagNotPresentException, BadFormatMsgException {
        ...
        try {
            if (MsgUtil.isTagInList(TagNum.AllocReportID, SECURED_TAGS, secured)) {
            ...
            if (MsgUtil.isTagInList(TagNum.AllocReportRefID, SECURED_TAGS, secured)) {
            ...
            if (allocReportType != null && MsgUtil.isTagInList(TagNum.AllocReportType, SECURED_TAGS, secured)) {
            ...
            if (MsgUtil.isTagInList(TagNum.ReversalIndicator, SECURED_TAGS, secured)) {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationReportMsg] message version [4.4].";
    }
