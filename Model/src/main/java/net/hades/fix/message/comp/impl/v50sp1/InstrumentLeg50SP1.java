...
/*
 * InstrumentLeg50SP1.java
 *
 * $Id: InstrumentLeg50SP1.java,v 1.9 2011-04-14 23:44:47 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.LegSecurityAltIDGroup50SP1;
...
/**
 * InstrumentLeg FIX version 5.0SP1 implementation.
 * 
...
public class InstrumentLeg50SP1 extends InstrumentLeg {
    ...
    protected static final Set<Integer> LEG_SEC_ALT_ID_GROUP_TAGS = new LegSecurityAltIDGroup50SP1().getFragmentAllTags();
    ...
    public InstrumentLeg50SP1() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public InstrumentLeg50SP1(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    public void setNoLegSecurityAltID(Integer noLegSecurityAltID) {
        ...
        if (noLegSecurityAltID != null) {
            ...
            for (int i = 0; i < legSecurityAltIDGroups.length; i++) {
                legSecurityAltIDGroups[i] = new LegSecurityAltIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public LegSecurityAltIDGroup addLegSecurityAltIDGroup() {
        ...
        LegSecurityAltIDGroup group = new LegSecurityAltIDGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noLegSecurityAltID != null && noLegSecurityAltID.intValue() > 0) {
            if (LEG_SEC_ALT_ID_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noLegSecurityAltID.intValue(); i++) {
                    LegSecurityAltIDGroup group = new LegSecurityAltIDGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrumentLeg] component version [5.0SP1].";
    }
