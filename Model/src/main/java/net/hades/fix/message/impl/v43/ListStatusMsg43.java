...
/*
 * ListStatusMsg43.java
 *
 * $Id: ListStatusMsg43.java,v 1.3 2011-04-14 23:44:34 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v43.OrderStatusGroup43;
 ...
 */
public class ListStatusMsg43 extends ListStatusMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> ORDER_STATUS_GROUP_TAGS = new OrderStatusGroup43().getFragmentAllTags();
    ...
    public ListStatusMsg43() {
        super();
    }

    public ListStatusMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListStatusMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListStatusMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoOrders(Integer noOrders) {
        ...
        if (noOrders != null) {
            ...
            for (int i = 0; i < orderStatusGroups.length; i++) {
                orderStatusGroups[i] = new OrderStatusGroup43(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public OrderStatusGroup addOrderStatusGroup() {
        OrderStatusGroup group = new OrderStatusGroup43(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (ORDER_STATUS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noOrders != null && noOrders.intValue() > 0) {
                ...
                orderStatusGroups = new OrderStatusGroup[noOrders.intValue()];
                for (int i = 0; i < noOrders.intValue(); i++) {
                    OrderStatusGroup group = new OrderStatusGroup43(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListStatusMsg] message version [4.3].";
    }
