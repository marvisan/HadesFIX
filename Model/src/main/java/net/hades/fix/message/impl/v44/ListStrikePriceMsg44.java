...
/*
 * ListStrikePriceMsg44.java
 *
 * $Id: ListStrikePriceMsg44.java,v 1.1 2011-04-15 04:37:42 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v44.InstrmtStrikePriceGroup44;
...
/**
 * FIX version 4.4 ListStrikePriceMsg implementation.
 *
...
public class ListStrikePriceMsg44 extends ListStrikePriceMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> INSTRMT_STRK_PX_GROUP_TAGS = new InstrmtStrikePriceGroup44().getFragmentAllTags();
    ...
    public ListStrikePriceMsg44() {
        super();
    }

    public ListStrikePriceMsg44(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListStrikePriceMsg44(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListStrikePriceMsg44(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ListStrikePriceMsg44 fixml = (ListStrikePriceMsg44) fragment;
    ...
    public void setNoStrikes(Integer noStrikes) {
        ...
        if (noStrikes != null) {
            ...
            for (int i = 0; i < instrmtStrikePriceGroups.length; i++) {
                instrmtStrikePriceGroups[i] = new InstrmtStrikePriceGroup44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public InstrmtStrikePriceGroup addInstrmtStrikePriceGroup() {
        InstrmtStrikePriceGroup group = new InstrmtStrikePriceGroup44(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (INSTRMT_STRK_PX_GROUP_TAGS.contains(tag.tagNum)) {
            if (noStrikes != null && noStrikes.intValue() > 0) {
                ...
                instrmtStrikePriceGroups = new InstrmtStrikePriceGroup[noStrikes.intValue()];
                for (int i = 0; i < noStrikes.intValue(); i++) {
                    InstrmtStrikePriceGroup group = new InstrmtStrikePriceGroup44(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListStrikePriceMsg] message version [4.4].";
    }
