...
/*
 * RegistrationInstructionsMsg50.java
 *
 * $Id: RegistrationInstructionsMsg50.java,v 1.2 2011-10-29 01:31:23 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.DistribInstsGroup50;
import net.hades.fix.message.group.impl.v50.RgstDtlsGroup50;
...
/**
 * FIX version 5.0 RegistrationInstructionsMsg implementation.
 *
...
public class RegistrationInstructionsMsg50 extends RegistrationInstructionsMsg {
    ...
    protected static final Set<Integer> RGST_DTLS_GROUP_TAGS = new RgstDtlsGroup50().getFragmentAllTags();
    protected static final Set<Integer> DISTRIB_INSTS_GROUP_TAGS = new DistribInstsGroup50().getFragmentAllTags();
    ...
    public RegistrationInstructionsMsg50() {
        super();
    }

    public RegistrationInstructionsMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public RegistrationInstructionsMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public RegistrationInstructionsMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        RegistrationInstructionsMsg50 fixml = (RegistrationInstructionsMsg50) fragment;
    ...
    public void setNoRegistDtls(Integer noRegistDtls) {
        ...
        if (noRegistDtls != null) {
            ...
            for (int i = 0; i < registDtlsGroups.length; i++) {
                registDtlsGroups[i] = new RgstDtlsGroup50(context);
            }
        }
    }
    ...
    public RgstDtlsGroup addRgstDtlsGroup() {
        RgstDtlsGroup group = new RgstDtlsGroup50(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public void setNoDistribInsts(Integer noDistribInsts) {
        ...
        if (noDistribInsts != null) {
            ...
            for (int i = 0; i < distribInstsGroups.length; i++) {
                distribInstsGroups[i] = new DistribInstsGroup50(context);
            }
        }
    }
    ...
    public DistribInstsGroup addDistribInstsGroup() {
        DistribInstsGroup group = new DistribInstsGroup50(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
        ...
        if (RGST_DTLS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRegistDtls != null && noRegistDtls.intValue() > 0) {
                ...
                for (int i = 0; i < noRegistDtls.intValue(); i++) {
                    RgstDtlsGroup group = new RgstDtlsGroup50(context);
        ...
        if (DISTRIB_INSTS_GROUP_TAGS.contains(tag.tagNum)) {
            if (noDistribInsts != null && noDistribInsts.intValue() > 0) {
                ...
                for (int i = 0; i < noDistribInsts.intValue(); i++) {
                    DistribInstsGroup component = new DistribInstsGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RegistrationInstructionsMsg] message version [5.0].";
    }
