...
/**
 * FIX 5.0 implementation of TrdCapRptAckSideGroup group.
 *
...
public class TrdCapRptAckSideGroup50 extends TrdCapRptAckSideGroup {
    ...
    public TrdCapRptAckSideGroup50() {
    }
    
    public TrdCapRptAckSideGroup50(FragmentContext context) {
        super(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TrdCapRptAckSideGroup] group version [5.0].";
    }
