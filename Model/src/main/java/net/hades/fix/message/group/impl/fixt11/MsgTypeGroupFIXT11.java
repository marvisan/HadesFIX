...
/*
 * MsgTypeGroupFIXT11.java
 *
 * $Id: MsgTypeGroupFIXT11.java,v 1.6 2010-03-31 11:05:17 vrotaru Exp $
 */
...
/**
 * MsgTypeGroup implementation for FIXT1.1 version.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.6 $
 * @created 01/11/2008, 5:00:09 PM
 */
public class MsgTypeGroupFIXT11 extends MsgTypeGroup {
    ...
    public MsgTypeGroupFIXT11() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MsgTypeGroupFIXT11(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MsgTypeGroup] group version [T1.1].";
    }
