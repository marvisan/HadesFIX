...
/*
 * TradingSessionStatusMsg43.java
 *
 * $Id: TradingSessionStatusMsg43.java,v 1.1 2011-04-23 00:19:04 vrotaru Exp $
 */
...
/**
 * FIX version 4.3 TradingSessionStatusMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class TradingSessionStatusMsg43 extends TradingSessionStatusMsg {
    ...
    public TradingSessionStatusMsg43() {
        super();
    }

    public TradingSessionStatusMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public TradingSessionStatusMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public TradingSessionStatusMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradingSessionStatusMsg] message version [4.3].";
    }
