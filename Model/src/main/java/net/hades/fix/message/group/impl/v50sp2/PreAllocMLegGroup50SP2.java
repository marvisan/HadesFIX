...
/*
 * PreAllocMLegGroup50SP2.java
 *
 * $Id: PreAllocMLegGroup50SP2.java,v 1.2 2011-09-09 08:05:13 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP2 implementation of PreAllocMLegGroup group.
 *
...
public class PreAllocMLegGroup50SP2 extends PreAllocMLegGroup {
    ...
    public PreAllocMLegGroup50SP2() {
    }

    public PreAllocMLegGroup50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNestedPartyIDGroups(Nested3PartyGroup[] nestedPartyIDGroups) {
        if (nestedPartyIDGroups != null) {
            ...
            ((NestedParties350SP2) nestedParties3).setNested3PartyIDGroups(nestedPartyIDGroups);
        }
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PreMLegAllocGroup] group version [5.0SP2].";
    }
