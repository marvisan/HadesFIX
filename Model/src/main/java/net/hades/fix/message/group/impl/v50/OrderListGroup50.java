...
/*
 * OrderListGroup50.java
 *
 * $Id: OrderListGroup50.java,v 1.3 2011-04-14 23:44:36 vrotaru Exp $
 */
...
/**
 * FIX 4.4 implementation of OrderListGroup group.
 *
...
public class OrderListGroup50 extends OrderListGroup {
    ...
    public OrderListGroup50() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        instrument = new Instrument50(context);
    }
    
    public OrderListGroup50(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        instrument = new Instrument50(context);
    }
