...
/*
 * ListCancelRequestMsg40.java
 *
 * $Id: ListCancelRequestMsg40.java,v 1.1 2011-02-06 01:06:14 vrotaru Exp $
 */
...
/**
 * FIX version 4.0 ListCancelRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class ListCancelRequestMsg40 extends ListCancelRequestMsg {
    ...
    public ListCancelRequestMsg40() {
        super();
    }

    public ListCancelRequestMsg40(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListCancelRequestMsg40(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public ListCancelRequestMsg40(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ListCancelRequestMsg] message version [4.0/4.1].";
    }
