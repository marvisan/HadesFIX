...
/*
 * OrderMassCancelReportMsg50SP2.java
 *
 * $Id: OrderMassCancelReportMsg50SP2.java,v 1.2 2011-05-07 06:58:55 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.AffectedOrdGroup50SP2;
import net.hades.fix.message.group.impl.v50sp2.NotAffectedOrdGroup50SP2;
...
/**
 * FIX version 5.0SP2 OrderMassCancelReportMsg implementation.
 *
...
@XmlType(propOrder = {"header", "affectedOrdGroups", "notAffectedOrdGroups", "partyIDGroups", "targetPartyGroups", "instrument", "underlyingInstrument"})
@XmlAccessorType(XmlAccessType.NONE)
public class OrderMassCancelReportMsg50SP2 extends OrderMassCancelReportMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> AFFECTED_ORD_GROUP_TAGS = new AffectedOrdGroup50SP2().getFragmentAllTags();
    ...
    protected static final Set<Integer> NOT_AFFECTED_ORD_GROUP_TAGS = new NotAffectedOrdGroup50SP2().getFragmentAllTags();
    ...
    public OrderMassCancelReportMsg50SP2() {
        super();
    }

    public OrderMassCancelReportMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderMassCancelReportMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderMassCancelReportMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderMassCancelReportMsg50SP2 fixml = (OrderMassCancelReportMsg50SP2) fragment;
    ...
    public void setNoAffectedOrders(Integer noAffectedOrders) {
        ...
        if (noAffectedOrders != null) {
            ...
            for (int i = 0; i < affectedOrdGroups.length; i++) {
                affectedOrdGroups[i] = new AffectedOrdGroup50SP2(context);
            }
        }
    }
    ...
    public AffectedOrdGroup addAffectedOrdGroup() {
        AffectedOrdGroup group = new AffectedOrdGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoNotAffectedOrders(Integer noNotAffectedOrders) {
        ...
        if (noNotAffectedOrders != null) {
            ...
            for (int i = 0; i < notAffectedOrdGroups.length; i++) {
                notAffectedOrdGroups[i] = new NotAffectedOrdGroup50SP2(context);
            }
        }
    }
    ...
    public NotAffectedOrdGroup addNotAffectedOrdGroup() {
        NotAffectedOrdGroup group = new NotAffectedOrdGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (AFFECTED_ORD_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAffectedOrders != null && noAffectedOrders.intValue() > 0) {
                ...
                for (int i = 0; i < noAffectedOrders.intValue(); i++) {
                    AffectedOrdGroup component = new AffectedOrdGroup50SP2(context);
        ...
        if (NOT_AFFECTED_ORD_GROUP_TAGS.contains(tag.tagNum)) {
            if (noNotAffectedOrders != null && noNotAffectedOrders.intValue() > 0) {
                ...
                for (int i = 0; i < noNotAffectedOrders.intValue(); i++) {
                    NotAffectedOrdGroup component = new NotAffectedOrdGroup50SP2(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderMassCancelReportMsg] message version [5.0SP2].";
    }
