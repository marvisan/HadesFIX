...
/*
 * QuoteRequestGroup42.java
 *
 * $Id: QuoteRequestGroup42.java,v 1.9 2010-11-23 10:20:18 vrotaru Exp $
 */
...
/**
 * FIX 4.2 implementation of QuoteRequestGroup group.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.9 $
 * @created 05/04/2009, 11:39:24 AM
 */
public class QuoteRequestGroup42 extends QuoteRequestGroup {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -1137809432819866333L;
    ...
    public QuoteRequestGroup42() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteRequestGroup42(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteRelatedSymbolGroup] group version [4.2].";
    }
