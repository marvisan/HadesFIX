...
/*
 * PositionMaintenanceReportMsg.java
 *
 ...
 * Used to report a position details.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.5 $
 * @created 07/12/2011, 9:25:04 AM
 */
@XmlAccessorType(XmlAccessType.NONE)
public abstract class PositionMaintenanceReportMsg extends FIXMsg {
    ...
    protected static final Set<Integer> TAGS = new HashSet<Integer>(Arrays.asList(new Integer[] {
        ...
        TagNum.PosMaintStatus.getValue(),
        TagNum.PosMaintResult.getValue(),
    ...
    /**
     * TagNum = 722 REQUIRED. Starting with 4.4 version.
     */
    protected PosMaintStatus posMaintStatus;
      
    /**
     * TagNum = 723. Starting with 4.4 version.
     */
    protected Integer posMaintResult;
    ...
    /**
     * TagNum = 719. Starting with 5.0 version.
     */
    protected Boolean contraryInstructionIndicator;

    /**
     * TagNum = 720. Starting with 5.0 version.
     */
    ...
    public PositionMaintenanceReportMsg() {
        super();
    }

    public PositionMaintenanceReportMsg(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public PositionMaintenanceReportMsg(BeginString beginString) throws InvalidMsgException {
        super(MsgType.PositionMaintenanceReport.getValue(), beginString);
    }

    public PositionMaintenanceReportMsg(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
        super(MsgType.PositionMaintenanceReport.getValue(), beginString, applVerID);
    }
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.PosMaintStatus, required=true)
    ...
    /**
     * Message field setter.
     * @param posMaintStatus field value
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.PosMaintStatus, required=true)
     ...
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.PosMaintResult)
    ...
    /**
     * Message field setter.
     * @param posMaintResult field value
     */
    @FIXVersion(introduced="4.4")
    @TagNumRef(tagNum=TagNum.PosMaintResult)
    ...
    protected void setFragmentTagValue(Tag tag) throws BadFormatMsgException {
        ...
        switch (tagNum) {          
            ...
            case PosMaintStatus:
                posMaintStatus = PosMaintStatus.valueFor(Integer.valueOf(new String(tag.value, sessionCharset)));
                break;

            case PosMaintResult:
                posMaintResult = new Integer(new String(tag.value, sessionCharset));
                break;
           ...
           case SettlSessSubID:
            ...
            default:
                String error = "Tag value [" + tag.tagNum + "] not present in [PositionMaintenanceReportMsg] fields.";
                LOGGER.severe(error);
    ...
    public String toString() {
        StringBuilder b = new StringBuilder("{PositionMaintenanceReportMsg=");
        ...
        printTagValue(b, TagNum.PosMaintStatus, posMaintStatus);
        printTagValue(b, TagNum.PosMaintResult, posMaintResult);
