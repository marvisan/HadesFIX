...
/*
 * SettlementInstructionsMsg43.java
 *
 * $Id: SettlementInstructionsMsg43.java,v 1.3 2011-04-14 23:44:32 vrotaru Exp $
 */
...
/**
 * FIX version 4.3 SettlementInstructionsMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class SettlementInstructionsMsg43 extends SettlementInstructionsMsg {
    ...
    protected static final Set<Integer> START_DATA_TAGS_V43 = null;
    ...
    public SettlementInstructionsMsg43() {
        super();
    }

    public SettlementInstructionsMsg43(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SettlementInstructionsMsg43(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public SettlementInstructionsMsg43(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected void validateRequiredTags() throws TagNotPresentException {
        ...
        if (settlInstRefID == null || settlInstRefID.trim().isEmpty()) {
            errorMsg.append(" [SettlInstRefID]");
            hasMissingTag = true;
        }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SettlementInstructionsMsg] message version [4.3].";
    }
