...
/*
 * BidRequestMsg50SP2.java
 *
 * $Id: BidRequestMsg50SP2.java,v 1.3 2011-04-14 23:44:27 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.BidReqComponentGroup50SP2;
import net.hades.fix.message.group.impl.v50sp2.BidReqDescriptorGroup50SP2;
...
/**
 * FIX version 5.0SP2 BidRequestMsg implementation.
 *
...
public class BidRequestMsg50SP2 extends BidRequestMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> BID_DESCR_GROUP_TAGS = new BidReqDescriptorGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> BID_COMP_GROUP_TAGS = new BidReqComponentGroup50SP2().getFragmentAllTags();
    ...
    public BidRequestMsg50SP2() {
        super();
    }

    public BidRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public BidRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public BidRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        BidRequestMsg50SP2 fixml = (BidRequestMsg50SP2) fragment;
    ...
    public void setNoBidDescriptors(Integer noBidDescriptors) {
        ...
        if (noBidDescriptors != null) {
            ...
            for (int i = 0; i < bidDescriptorGroups.length; i++) {
                bidDescriptorGroups[i] = new BidReqDescriptorGroup50SP2(context);
            }
        }
    }
    ...
    public BidReqDescriptorGroup addBidDescriptorGroup() {
        BidReqDescriptorGroup group = new BidReqDescriptorGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoBidComponents(Integer noBidComponents) {
        ...
        if (noBidComponents != null) {
            ...
            for (int i = 0; i < bidComponentGroups.length; i++) {
                bidComponentGroups[i] = new BidReqComponentGroup50SP2(context);
            }
        }
    }
    ...
    public BidReqComponentGroup addBidComponentGroup() {
        BidReqComponentGroup group = new BidReqComponentGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (BID_DESCR_GROUP_TAGS.contains(tag.tagNum)) {
            if (noBidDescriptors != null && noBidDescriptors.intValue() > 0) {
                ...
                for (int i = 0; i < noBidDescriptors.intValue(); i++) {
                    BidReqDescriptorGroup component = new BidReqDescriptorGroup50SP2(context);
        ...
        if (BID_COMP_GROUP_TAGS.contains(tag.tagNum)) {
            if (noBidComponents != null && noBidComponents.intValue() > 0) {
                ...
                for (int i = 0; i < noBidComponents.intValue(); i++) {
                    BidReqComponentGroup component = new BidReqComponentGroup50SP2(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [BidRequestMsg] message version [5.0SP2].";
    }
