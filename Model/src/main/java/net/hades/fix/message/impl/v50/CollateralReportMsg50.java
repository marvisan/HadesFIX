...
/**
 * FIX version 5.0 CollateralReportMsg implementation.
 *
...
public class CollateralReportMsg50 extends CollateralReportMsg {
    ...
    public CollateralReportMsg50() {
        super();
    }

    public CollateralReportMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralReportMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralReportMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralReportMsg50 fixml = (CollateralReportMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralReportMsg] message version [5.0].";
    }
