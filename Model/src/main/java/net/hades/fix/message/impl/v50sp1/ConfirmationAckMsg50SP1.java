...
public class ConfirmationAckMsg50SP1 extends ConfirmationAckMsg {
    ...
    public ConfirmationAckMsg50SP1() {
        super();
    }

    public ConfirmationAckMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ConfirmationAckMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ConfirmationAckMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ConfirmationAckMsg50SP1 fixml = (ConfirmationAckMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ConfirmationAckMsg] message version [5.0SP1].";
    }
