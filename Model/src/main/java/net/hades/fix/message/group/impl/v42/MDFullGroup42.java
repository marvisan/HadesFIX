 ...
 * MDReqGroup44.java
 *
 * $Id: MDFullGroup42.java,v 1.10 2010-11-23 10:20:18 vrotaru Exp $
 */
...
/**
 * FIX 4.2 implementation of MDReqGroup group.
 *
 ...
 */
@XmlTransient
public class MDFullGroup42 extends MDFullGroup {
    ...
    public MDFullGroup42() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public MDFullGroup42(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MDFullGroup] group version [4.2].";
    }
