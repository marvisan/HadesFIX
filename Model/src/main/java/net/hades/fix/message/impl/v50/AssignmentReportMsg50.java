...
/**
 * FIX version 5.0 AssignmentReportMsg implementation.
 *
...
public class AssignmentReportMsg50 extends AssignmentReportMsg {
    ...
    public AssignmentReportMsg50() {
        super();
    }

    public AssignmentReportMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AssignmentReportMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AssignmentReportMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AssignmentReportMsg50 fixml = (AssignmentReportMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AssignmentReportMsg] message version [5.0].";
    }
