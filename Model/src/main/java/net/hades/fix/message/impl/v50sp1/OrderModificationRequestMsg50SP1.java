...
/*
 * OrderModificationRequestMsg50SP1.java
 *
 * $Id: OrderModificationRequestMsg50SP1.java,v 1.2 2011-04-14 23:44:56 vrotaru Exp $
 */
...
/**
 * FIX version 5.0SP1 OrderModificationRequesMsg implementation.
 *
...
@XmlType(propOrder = {"header", "partyIDGroups", "allocGroups", "displayInstruction", "tradingSessionGroups", "instrument",
    "financingDetails", "underlyingInstruments", "orderQtyData", "triggeringInstruction", "spreadOrBenchmarkCurveData", "yieldData",
    "pegInstructions", "discretionInstructions", "strategyParametersGroups", "commissionData", "trdRegTimestampsGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class OrderModificationRequestMsg50SP1 extends OrderModificationRequestMsg {
    ...
    protected static final Set<Integer> TRADING_SESS_GROUP_TAGS = new TradingSessionGroup50SP1().getFragmentAllTags();
    ...
    public OrderModificationRequestMsg50SP1() {
        super();
    }

    public OrderModificationRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public OrderModificationRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public OrderModificationRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        OrderModificationRequestMsg50SP1 fixml = (OrderModificationRequestMsg50SP1) fragment;
    ...
    public void setNoTradingSessions(Integer noTradingSessions) {
        ...
        if (noTradingSessions != null) {
            ...
            for (int i = 0; i < tradingSessionGroups.length; i++) {
                tradingSessionGroups[i] = new TradingSessionGroup50SP1(context);
            }
        }
    }
    ...
    public void setNoStrategyParameters(Integer noStrategyParameters) {
        ...
        if (noStrategyParameters != null) {
            strategyParametersGroups = new StrategyParametersGroup[noAllocs.intValue()];
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [OrderModificationRequestMsg] message version [5.0].";
    }
