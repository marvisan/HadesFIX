...
import net.hades.fix.message.group.impl.v50sp1.PosUndInstrmtGroup50SP1;
...
/**
 * FIX version 5.0SP1 PositionReportMsg implementation.
 *
...
public class PositionReportMsg50SP1 extends PositionReportMsg {
    ...
    protected static final Set<Integer> POS_UND_INSTRMT_GROUP_TAGS = new PosUndInstrmtGroup50SP1().getFragmentAllTags();
    ...
    public PositionReportMsg50SP1() {
        super();
    }

    public PositionReportMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public PositionReportMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public PositionReportMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        PositionReportMsg50SP1 fixml = (PositionReportMsg50SP1) fragment;
    ...
    public void setNoUnderlyings(Integer noUnderlyings) {
        ...
        if (noUnderlyings != null) {
            ...
            for (int i = 0; i < posUndInstrmtGroups.length; i++) {
                posUndInstrmtGroups[i] = new PosUndInstrmtGroup50SP1(context);
            }
        }
    }
    ...
    public PosUndInstrmtGroup addPosUndInstrmtGroup() {
        PosUndInstrmtGroup group = new PosUndInstrmtGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (POS_UND_INSTRMT_GROUP_TAGS.contains(tag.tagNum)) {
            if (noUnderlyings != null && noUnderlyings.intValue() > 0) {
                ...
                for (int i = 0; i < noUnderlyings.intValue(); i++) {
                    PosUndInstrmtGroup component = new PosUndInstrmtGroup50SP1(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PositionReportMsg] message version [5.0SP1].";
    }
