...
/*
 * AllocationInstructionMsg50SP1.java
 *
 * $Id: AllocationInstructionMsg50SP1.java,v 1.3 2011-04-14 23:44:58 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.ExecAllocGroup50SP1;
...
import net.hades.fix.message.group.impl.v50sp1.AllocGroup50SP1;
...
/**
 * FIX version 5.0SP1 AllocationInstructionMsg implementation.
 *
...
public class AllocationInstructionMsg50SP1 extends AllocationInstructionMsg {
    ...
    protected static final Set<Integer> EXEC_ALLOC_GROUP_TAGS = new ExecAllocGroup50SP1().getFragmentAllTags();
    ...
    protected static final Set<Integer> ALLOC_GROUP_TAGS = new AllocGroup50SP1().getFragmentAllTags();
    ...
    public AllocationInstructionMsg50SP1() {
        super();
    }

    public AllocationInstructionMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public AllocationInstructionMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public AllocationInstructionMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        AllocationInstructionMsg50SP1 fixml = (AllocationInstructionMsg50SP1) fragment;
    ...
    public void setNoExecs(Integer noExecs) {
        ...
        if (noExecs != null) {
            ...
            for (int i = 0; i < execAllocGroups.length; i++) {
                execAllocGroups[i] = new ExecAllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public ExecAllocGroup addExecAllocGroup() {
        ExecAllocGroup group = new ExecAllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocGroups.length; i++) {
                allocGroups[i] = new AllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public AllocGroup addAllocGroup() {
        AllocGroup group = new AllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (EXEC_ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noExecs != null && noExecs.intValue() > 0) {
                ...
                for (int i = 0; i < noExecs.intValue(); i++) {
                    ExecAllocGroup group = new ExecAllocGroup50SP1(context);
                    group.decode(message);
        ...
        if (ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAllocs != null && noAllocs.intValue() > 0) {
                ...
                for (int i = 0; i < noAllocs.intValue(); i++) {
                    AllocGroup group = new AllocGroup50SP1(context);
                    group.decode(message);
                    allocGroups[i] = group;
                }
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationInstructionMsg] message version [5.0SP1].";
    }
