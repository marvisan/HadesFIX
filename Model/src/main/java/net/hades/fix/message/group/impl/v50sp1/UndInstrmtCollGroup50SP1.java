...
/**
 * FIX 5.0SP1 implementation of UndInstrmtCollGroup group.
 *
...
public class UndInstrmtCollGroup50SP1 extends UndInstrmtCollGroup {
    ...
    public UndInstrmtCollGroup50SP1() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public UndInstrmtCollGroup50SP1(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [UndInstrmtCollGroup] group version [5.0SP1].";
    }
