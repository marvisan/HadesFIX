 ...
 *
 * $Id: MarketDataRequestRejectMsg50.java,v 1.9 2011-04-14 23:44:41 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.AltMDSourceGroup50;
...
public class MarketDataRequestRejectMsg50 extends MarketDataRequestRejectMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -5681738158914969373L;

    protected static final Set<Integer> START_COMP_TAGS;
    
    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> ALT_MD_SOURCE_GROUP_TAGS = new AltMDSourceGroup50().getFragmentAllTags();
    ...
    public MarketDataRequestRejectMsg50() {
        super();
    }
    
    public MarketDataRequestRejectMsg50(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public MarketDataRequestRejectMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }
    
    public MarketDataRequestRejectMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MarketDataRequestRejectMsg fixml = (MarketDataRequestRejectMsg50) fragment;
    ...
    public void setNoAltMDSource(Integer noAltMDSource) {
        ...
        if (noAltMDSource != null) {
            ...
            for (int i = 0; i < altMDSourceGroups.length; i++) {
                altMDSourceGroups[i] = new AltMDSourceGroup50(context);
            }
        }
    }
    ...
    public AltMDSourceGroup addAltMDSourceGroup() {
        AltMDSourceGroup group = new AltMDSourceGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (ALT_MD_SOURCE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAltMDSource != null && noAltMDSource.intValue() > 0) {
                ...
                for (int i = 0; i < noAltMDSource.intValue(); i++) {
                    AltMDSourceGroup group = new AltMDSourceGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MarketDataRequestRejectMsg] message version [5.0].";
    }
