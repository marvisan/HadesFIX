 ...
 * RootParties50.java
 *
 * $Id: RootParties50.java,v 1.8 2011-04-14 23:44:50 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.RootPartyGroup50;
...
/**
 * FIX version 5.0 implementation of RootParties component.
 *
 ...
 */
@XmlTransient
public class RootParties50 extends RootParties {
    ...
    protected static final Set<Integer> ROOT_PARTY_GROUP_TAGS = new RootPartyGroup50().getFragmentAllTags();
    ...
    public RootParties50() {
        super();
    }

    public RootParties50(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoRootPartyIDs(Integer noRootPartyIDs) {
        ...
        if (noRootPartyIDs != null) {
            ...
            for (int i = 0; i < rootPartyGroups.length; i++) {
                rootPartyGroups[i] = new RootPartyGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public RootPartyGroup addRootPartyGroup() {
        RootPartyGroup group = new RootPartyGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setRootPartyIDGroups(RootPartyGroup[] rootPartyGroups) {
        this.rootPartyGroups = rootPartyGroups;
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        if (ROOT_PARTY_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRootPartyIDs != null && noRootPartyIDs.intValue() > 0) {
                ...
                for (int i = 0; i < rootPartyGroups.length; i++) {
                    RootPartyGroup group = new RootPartyGroup50(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RootParties] component version [5.0].";
    }
