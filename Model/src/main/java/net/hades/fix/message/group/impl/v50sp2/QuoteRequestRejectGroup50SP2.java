...
/*
 * QuoteRequestRejectGroup50SP2.java
 *
 * $Id: QuoteRequestRejectGroup50SP2.java,v 1.9 2011-04-14 23:44:30 vrotaru Exp $
 */
...
/**
 * FIX 5.0SP2 implementation of QuoteRequestRejectGroup group.
 *
...
public class QuoteRequestRejectGroup50SP2 extends QuoteRequestRejectGroup {
    ...
    protected static final Set<Integer> QUOT_REQ_LEG_GROUP_TAGS = new QuoteRequestLegGroup50SP2().getFragmentAllTags();
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < quoteRequestLegGroups.length; i++) {
                quoteRequestLegGroups[i] = new QuoteRequestLegGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteRequestRejectGroup] group version [5.0SP2].";
    }
