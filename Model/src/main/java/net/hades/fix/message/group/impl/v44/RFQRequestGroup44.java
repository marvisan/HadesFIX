...
/*
 * RFQRequestGroup44.java
 *
 * $Id: RFQRequestGroup44.java,v 1.10 2011-04-14 23:44:42 vrotaru Exp $
 */
...
/**
 * FIX 4.4 implementation of RFQRequestGroup group.
 *
...
public class RFQRequestGroup44 extends RFQRequestGroup {
    ...
    public RFQRequestGroup44() {
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired);
        instrument = new Instrument44(context);
    }
    
    public RFQRequestGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        instrument = new Instrument44(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [RFQRequestGroup] group version [4.4].";
    }
