...
/*
 * DerivSecListGroup50SP1.java
 *
 * $Id: DerivSecListGroup50SP1.java,v 1.2 2011-09-28 08:10:21 vrotaru Exp $
 */
...
import net.hades.fix.message.comp.impl.v50sp1.SecondaryPriceLimits50SP1;
...
/**
 * FIX 5.0SP1 implementation of DerivSecListGroup group.
 *
...
public class DerivSecListGroup50SP1 extends DerivSecListGroup {
    ...
    protected static final Set<Integer> SEC_PRICE_LIMITS_COMP_TAGS = new SecondaryPriceLimits50SP1().getFragmentAllTags();
    protected static final Set<Integer> INSTRUMENT_EXTENSION_COMP_TAGS = new InstrumentExtension50SP1().getFragmentAllTags();
    protected static final Set<Integer> INSTRMNT_LEG_SEC_LIST_GROUP_TAGS = new InstrmtLegDerivSecListGroup50SP1().getFragmentAllTags();
    ...
    public DerivSecListGroup50SP1() {
    }

    public DerivSecListGroup50SP1(FragmentContext context) {
        super(context);
    }
    ...
    public void setSecondaryPriceLimits() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        this.secondaryPriceLimits = new SecondaryPriceLimits50SP1(context);
    }
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < instrmtLegDerivSecListGroups.length; i++) {
                instrmtLegDerivSecListGroups[i] = new InstrmtLegDerivSecListGroup50SP1(context);
            }
        }
    }
    ...
    @Override
     public InstrmtLegDerivSecListGroup addInstrmtLegDerivSecListGroup() {
        InstrmtLegDerivSecListGroup group = new InstrmtLegDerivSecListGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setInstrumentLegs(InstrumentLeg[] instrumentLegs) {
        ...
        for (int i = 0; i < instrmtLegDerivSecListGroups.length; i++) {
            instrmtLegDerivSecListGroups[i] =  new InstrmtLegDerivSecListGroup50SP1(context);
            ((InstrmtLegDerivSecListGroup50SP1)instrmtLegDerivSecListGroups[i]).setInstrumentLeg(instrumentLegs[i]);
        }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (SEC_PRICE_LIMITS_COMP_TAGS.contains(tag.tagNum)) {
            if (secondaryPriceLimits == null) {
                secondaryPriceLimits = new SecondaryPriceLimits50SP1(context);
            }
        ...
        if (INSTRMNT_LEG_SEC_LIST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    InstrmtLegDerivSecListGroup component = new InstrmtLegDerivSecListGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DerivSecListGroup] group version [5.0SP1].";
    }
