...
/*
 * CollateralAssignmentMsg50.java
 *
 * $Id: AllocationInstructionMsg50.java,v 1.3 2011-04-14 23:44:38 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 CollateralAssignmentMsg implementation.
 *
...
public class CollateralAssignmentMsg50 extends CollateralAssignmentMsg {
    ...
    public CollateralAssignmentMsg50() {
        super();
    }

    public CollateralAssignmentMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralAssignmentMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralAssignmentMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralAssignmentMsg50 fixml = (CollateralAssignmentMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [CollateralAssignmentMsg] message version [5.0].";
    }
