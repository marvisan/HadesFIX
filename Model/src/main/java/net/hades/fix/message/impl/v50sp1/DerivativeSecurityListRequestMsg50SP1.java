...
/*
 * DerivativeSecurityListRequestMsg50SP1.java
 *
 * $Id: DerivativeSecurityListRequestMsg50SP1.java,v 1.1 2011-09-22 08:54:33 vrotaru Exp $
 */
package net.hades.fix.message.impl.v50sp1;

import net.hades.fix.message.FragmentContext;
import net.hades.fix.message.comp.impl.v50sp1.DerivativeInstrument50SP1;
...
/**
 * FIX version 5.0SP1 DerivativeSecurityListRequestMsg implementation.
 *
...
public class DerivativeSecurityListRequestMsg50SP1 extends DerivativeSecurityListRequestMsg {
    ...
    public DerivativeSecurityListRequestMsg50SP1() {
        super();
    }

    public DerivativeSecurityListRequestMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public DerivativeSecurityListRequestMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public DerivativeSecurityListRequestMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        DerivativeSecurityListRequestMsg50SP1 fixml = (DerivativeSecurityListRequestMsg50SP1) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [DerivativeSecurityListRequestMsg] message version [5.0SP1].";
    }
