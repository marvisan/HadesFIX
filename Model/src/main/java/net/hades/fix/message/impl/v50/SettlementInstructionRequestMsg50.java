...
/*
 * SettlementInstructionRequestMsg50.java
 *
...
/**
 * FIX version 5.0 SettlementInstructionRequestMsg implementation.
 *
...
public class SettlementInstructionRequestMsg50 extends SettlementInstructionRequestMsg {
    ...
    public SettlementInstructionRequestMsg50() {
        super();
    }

    public SettlementInstructionRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SettlementInstructionRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SettlementInstructionRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SettlementInstructionRequestMsg50 fixml = (SettlementInstructionRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SettlementInstructionRequestMsg] message version [5.0].";
    }
