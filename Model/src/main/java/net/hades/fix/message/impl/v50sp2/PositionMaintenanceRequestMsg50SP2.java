...
/*
 * PositionMaintenanceRequestMsg50SP2.java
 *
...
/**
 * FIX version 5.0SP2 PositionMaintenanceRequestMsg implementation.
 *
...
public class PositionMaintenanceRequestMsg50SP2 extends PositionMaintenanceRequestMsg {
    ...
    public PositionMaintenanceRequestMsg50SP2() {
        super();
    }

    public PositionMaintenanceRequestMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public PositionMaintenanceRequestMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public PositionMaintenanceRequestMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        PositionMaintenanceRequestMsg50SP2 fixml = (PositionMaintenanceRequestMsg50SP2) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [PositionMaintenanceRequestMsg] message version [5.0SP2].";
    }
