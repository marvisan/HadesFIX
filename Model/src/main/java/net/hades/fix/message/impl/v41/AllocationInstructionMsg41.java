...
/*
 * AllocationInstructionMsg41.java
 *
 * $Id: AllocationInstructionMsg41.java,v 1.3 2011-10-21 10:31:05 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v40.ExecAllocGroup40;
import net.hades.fix.message.group.impl.v40.OrderAllocGroup40;
import net.hades.fix.message.group.impl.v41.AllocGroup41;
...
/**
 * FIX version 4.1 AllocationInstructionMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 21/04/2009, 9:32:41 AM
 */
public class AllocationInstructionMsg41 extends AllocationInstructionMsg {
    ...
    protected static final Set<Integer> EXEC_ALLOC_GROUP_TAGS = new ExecAllocGroup40().getFragmentAllTags();
    protected static final Set<Integer> ALLOC_GROUP_TAGS = new AllocGroup41().getFragmentAllTags();
    ...
    public AllocationInstructionMsg41() {
        super();
    }

    public AllocationInstructionMsg41(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public AllocationInstructionMsg41(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public AllocationInstructionMsg41(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void setNoExecs(Integer noExecs) {
        ...
        if (noExecs != null) {
            ...
            for (int i = 0; i < execAllocGroups.length; i++) {
                execAllocGroups[i] = new ExecAllocGroup40(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public ExecAllocGroup addExecAllocGroup() {
        ExecAllocGroup group = new ExecAllocGroup40(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocGroups.length; i++) {
                allocGroups[i] = new AllocGroup41(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
            }
        }
    }
    ...
    public AllocGroup addAllocGroup() {
        AllocGroup group = new AllocGroup41(new FragmentContext(sessionCharset, messageEncoding, encryptionRequired, crypter, validateRequired));
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (EXEC_ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noExecs != null && noExecs.intValue() > 0) {
                ...
                execAllocGroups = new ExecAllocGroup[noExecs.intValue()];
                for (int i = 0; i < noExecs.intValue(); i++) {
                    ExecAllocGroup group = new ExecAllocGroup40(context);
                    group.decode(message);
        ...
        if (ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAllocs != null && noAllocs.intValue() > 0) {
                ...
                allocGroups = new AllocGroup[noAllocs.intValue()];
                for (int i = 0; i < noAllocs.intValue(); i++) {
                    AllocGroup group = new AllocGroup41(context);
                    group.decode(message);
                    allocGroups[i] = group;
                }
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [AllocationInstructionMsg] message version [4.1].";
    }
