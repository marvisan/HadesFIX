...
/*
 * TradingSessionRules50SP2.java
 *
 * $Id: TradingSessionRules50SP2.java,v 1.2 2011-04-20 00:32:34 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.ExecInstRuleGroup50SP2;
import net.hades.fix.message.group.impl.v50sp2.MDFeedTypeGroup50SP2;
import net.hades.fix.message.group.impl.v50sp2.MatchRuleGroup50SP2;
import net.hades.fix.message.group.impl.v50sp2.OrdTypeRuleGroup50SP2;
import net.hades.fix.message.group.impl.v50sp2.TimeInForceRuleGroup50SP2;

/**
 * FIX 5.0SP2 implementation of TradingSessionRules component.
 * 
...
public class TradingSessionRules50SP2 extends TradingSessionRules {
    ...
    protected static final Set<Integer> ORD_TYPE_RULE_GROUP_TAGS = new OrdTypeRuleGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> TIME_IN_FORCE_RULE_GROUP_TAGS = new TimeInForceRuleGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> EXEC_INST_RULE_GROUP_TAGS = new ExecInstRuleGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> MATCH_RULE_GROUP_TAGS = new MatchRuleGroup50SP2().getFragmentAllTags();
    protected static final Set<Integer> MD_FEED_TYPE_GROUP_TAGS = new MDFeedTypeGroup50SP2().getFragmentAllTags();
    ...
    public TradingSessionRules50SP2() {
        super();
    }

    public TradingSessionRules50SP2(FragmentContext context) {
        super(context);
    }
    ...
    public void setNoOrdTypeRules(Integer noOrdTypeRules) {
        ...
        if (noOrdTypeRules != null) {
            ...
            for (int i = 0; i < ordTypeRuleGroups.length; i++) {
                ordTypeRuleGroups[i] = new OrdTypeRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public OrdTypeRuleGroup addOrdTypeRuleGroup() {
        OrdTypeRuleGroup group = new OrdTypeRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
   ...
   public OrdTypeRuleGroup deleteOrdTypeRuleGroup(int index) {
    ...
    public void setNoTimeInForceRules(Integer noTimeInForceRules) {
        ...
        if (noTimeInForceRules != null) {
            ...
            for (int i = 0; i < timeInForceRuleGroups.length; i++) {
                timeInForceRuleGroups[i] = new TimeInForceRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public TimeInForceRuleGroup addTimeInForceRuleGroup() {
        TimeInForceRuleGroup group = new TimeInForceRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoExecInstRules(Integer noExecInstRules) {
        ...
        if (noExecInstRules != null) {
            ...
            for (int i = 0; i < execInstRuleGroups.length; i++) {
                execInstRuleGroups[i] = new ExecInstRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public ExecInstRuleGroup addExecInstRuleGroup() {
        ExecInstRuleGroup group = new ExecInstRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoMatchRules(Integer noMatchRules) {
        ...
        if (noMatchRules != null) {
            ...
            for (int i = 0; i < matchRuleGroups.length; i++) {
                matchRuleGroups[i] = new MatchRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public MatchRuleGroup addMatchRuleGroup() {
        MatchRuleGroup group = new MatchRuleGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoMDFeedTypes(Integer noMDFeedTypes) {
        ...
        if (noMDFeedTypes != null) {
            ...
            for (int i = 0; i < MDFeedTypeGroup.length; i++) {
                MDFeedTypeGroup[i] = new MDFeedTypeGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public MDFeedTypeGroup addMDFeedTypeGroup() {
        MDFeedTypeGroup group = new MDFeedTypeGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noOrdTypeRules != null && noOrdTypeRules.intValue() > 0) {
            if (ORD_TYPE_RULE_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noOrdTypeRules.intValue(); i++) {
                    OrdTypeRuleGroup group = new OrdTypeRuleGroup50SP2(context);
        ...
        if (noTimeInForceRules != null && noTimeInForceRules.intValue() > 0) {
            if (TIME_IN_FORCE_RULE_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noTimeInForceRules.intValue(); i++) {
                    TimeInForceRuleGroup group = new TimeInForceRuleGroup50SP2(context);
                    group.decode(message);
        ...
        if (noExecInstRules != null && noExecInstRules.intValue() > 0) {
            if (EXEC_INST_RULE_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noExecInstRules.intValue(); i++) {
                    ExecInstRuleGroup group = new ExecInstRuleGroup50SP2(context);
                    group.decode(message);
        ...
        if (noMatchRules != null && noMatchRules.intValue() > 0) {
            if (MATCH_RULE_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noMatchRules.intValue(); i++) {
                    MatchRuleGroup group = new MatchRuleGroup50SP2(context);
                    group.decode(message);
        ...
        if (noMDFeedTypes != null && noMDFeedTypes.intValue() > 0) {
            if (MD_FEED_TYPE_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noMDFeedTypes.intValue(); i++) {
                    MDFeedTypeGroup group = new MDFeedTypeGroup50SP2(context);
                    group.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradingSessionRules] component release [5.0SP2].";
    }
