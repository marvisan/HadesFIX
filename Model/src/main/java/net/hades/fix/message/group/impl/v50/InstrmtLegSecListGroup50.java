...
/*
 * InstrmtLegSecListGroup50.java
 *
 * $Id: InstrmtLegSecListGroup50.java,v 1.1 2011-04-28 10:07:49 vrotaru Exp $
 */
...
public class InstrmtLegSecListGroup50 extends InstrmtLegSecListGroup {
    ...
    protected static final Set<Integer> LEG_BENCHMARK_CURVE_DATA_COMP_TAGS = new LegBenchmarkCurveData50().getFragmentAllTags();
    ...
    public InstrmtLegSecListGroup50() {
        super();
    }

    public InstrmtLegSecListGroup50(FragmentContext context) {
        super(context);
    }
    ...
    public void setLegBenchmarkCurveData() {
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        this.legBenchmarkCurveData = new LegBenchmarkCurveData50(context);
    }
    ...
    throws BadFormatMsgException, InvalidMsgException, TagNotPresentException {
        ...
        if (LEG_BENCHMARK_CURVE_DATA_COMP_TAGS.contains(tag.tagNum)) {
            if (legBenchmarkCurveData == null) {
                legBenchmarkCurveData = new LegBenchmarkCurveData50(context);
            }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [InstrmtLegSecListGroup] group version [5.0].";
    }
