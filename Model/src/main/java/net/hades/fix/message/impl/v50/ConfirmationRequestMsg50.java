...
/**
 * FIX version 5.0 ConfirmationRequestMsg implementation.
 *
...
public class ConfirmationRequestMsg50 extends ConfirmationRequestMsg {
    ...
    public ConfirmationRequestMsg50() {
        super();
    }

    public ConfirmationRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ConfirmationRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ConfirmationRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ConfirmationRequestMsg50 fixml = (ConfirmationRequestMsg50) fragment;
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ConfirmationRequestMsg] message version [5.0].";
    }
