...
/*
 * ExecutionReportMsg50SP1.java
 *
 * $Id: ExecutionReportMsg50SP1.java,v 1.4 2011-04-14 23:44:58 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.ContAmtGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.ContraBrokerGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.FillExecGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.InstrmtLegExecGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.MiscFeeGroup50SP1;
import net.hades.fix.message.group.impl.v50sp1.PreTradeAllocGroup50SP1;
...
/**
 * FIX version 5.0SP1 ExecutionReport implementation.
 *
...
@XmlType(propOrder = {"header", "applicationSequenceControl", "partyIDGroups", "contraBrokers", "allocGroups", "instrument", "financingDetails",
    ...
    "strategyParametersGroups", "fillExecGroups", "commissionData", "spreadOrBenchmarkCurveData", "yieldData", "displayInstruction",
    "contAmtGroups", "instrmtLegExecGroups", "miscFeeGroups", "trdRegTimestampsGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class ExecutionReportMsg50SP1 extends ExecutionReportMsg {
    ...
    protected static final Set<Integer> CONTRA_BROKER_GROUP_TAGS = new ContraBrokerGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> ALLOC_GROUP_TAGS = new PreTradeAllocGroup50SP1().getFragmentAllTags();
    ...
    protected static final Set<Integer> FILL_EXECUTION_GROUP_TAGS = new FillExecGroup50SP1().getFragmentAllTags();
    ...
    protected static final Set<Integer> CONT_AMT_GROUP_TAGS = new ContAmtGroup50SP1().getFragmentAllTags();
    protected static final Set<Integer> INSTRMT_LEG_EXEC_GROUP_TAGS = new InstrmtLegExecGroup50SP1().getFragmentAllTags();
    ...
    public ExecutionReportMsg50SP1() {
        super();
    }

    public ExecutionReportMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public ExecutionReportMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public ExecutionReportMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        ExecutionReportMsg50SP1 fixml = (ExecutionReportMsg50SP1) fragment;
    ...
    public void setNoContraBrokers(Integer noContraBrokers) {
        ...
        if (noContraBrokers != null) {
            ...
            for (int i = 0; i < contraBrokers.length; i++) {
                contraBrokers[i] = new ContraBrokerGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public ContraBrokerGroup addContraBroker() {
        ContraBrokerGroup group = new ContraBrokerGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoAllocs(Integer noAllocs) {
        ...
        if (noAllocs != null) {
            ...
            for (int i = 0; i < allocGroups.length; i++) {
                allocGroups[i] = new PreTradeAllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public PreTradeAllocGroup addAllocGroup() {
        PreTradeAllocGroup group = new PreTradeAllocGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoFills(Integer noFills) {
        ...
        if (noFills != null) {
            ...
            for (int i = 0; i < fillExecGroups.length; i++) {
                fillExecGroups[i] = new FillExecGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public FillExecGroup addFillExecGroup() {
        FillExecGroup group = new FillExecGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoContAmts(Integer noContAmts) {
        ...
        if (noContAmts != null) {
            ...
            for (int i = 0; i < contAmtGroups.length; i++) {
                contAmtGroups[i] = new ContAmtGroup50SP1(context);
            }
        }
    }
    ...
    public ContAmtGroup addContAmtGroup() {
        ContAmtGroup group = new ContAmtGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    ...
    public void setNoLegs(Integer noLegs) {
        ...
        if (noLegs != null) {
            ...
            for (int i = 0; i < instrmtLegExecGroups.length; i++) {
                instrmtLegExecGroups[i] = new InstrmtLegExecGroup50SP1(context);
            }
        }
    }
    ...
    public InstrmtLegExecGroup addInstrmtLegExecGroup() {
        InstrmtLegExecGroup group = new InstrmtLegExecGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (CONTRA_BROKER_GROUP_TAGS.contains(tag.tagNum)) {
            if (noContraBrokers != null && noContraBrokers.intValue() > 0) {
                ...
                for (int i = 0; i < noContraBrokers.intValue(); i++) {
                    ContraBrokerGroup group = new ContraBrokerGroup50SP1(context);
        ...
        if (ALLOC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noAllocs != null && noAllocs.intValue() > 0) {
                ...
                for (int i = 0; i < noAllocs.intValue(); i++) {
                    PreTradeAllocGroup group = new PreTradeAllocGroup50SP1(context);
                    group.decode(message);
                    allocGroups[i] = group;
                }
            }
        ...
        if (FILL_EXECUTION_GROUP_TAGS.contains(tag.tagNum)) {
            if (noFills != null && noFills.intValue() > 0) {
                ...
                for (int i = 0; i < noFills.intValue(); i++) {
                    FillExecGroup group = new FillExecGroup50SP1(context);
                    group.decode(message);
        ...
        if (CONT_AMT_GROUP_TAGS.contains(tag.tagNum)) {
            if (noContAmts != null && noContAmts.intValue() > 0) {
                ...
                for (int i = 0; i < noContAmts.intValue(); i++) {
                    ContAmtGroup component = new ContAmtGroup50SP1(context);
                    component.decode(message);
        ...
        if (INSTRMT_LEG_EXEC_GROUP_TAGS.contains(tag.tagNum)) {
            if (noLegs != null && noLegs.intValue() > 0) {
                ...
                for (int i = 0; i < noLegs.intValue(); i++) {
                    InstrmtLegExecGroup component = new InstrmtLegExecGroup50SP1(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [ExecutionReportMsg] message version [5.0SP1].";
    }
