 ...
 * MDReqGroup44.java
 *
 * $Id: MDReqGroup44.java,v 1.10 2011-04-27 01:09:57 vrotaru Exp $
 */
...
public class MDReqGroup44 extends MDReqGroup {
    ...
    public MDReqGroup44(FragmentContext context) {
        super(context);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        instrument = new Instrument44(context);
    }
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MDReqGroup] group version [4.4].";
    }
