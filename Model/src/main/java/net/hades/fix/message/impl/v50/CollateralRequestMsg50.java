...
/**
 * FIX version 5.0 CollateralRequestMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 17/12/2011, 9:32:41 AM
 */
@XmlRootElement(name="CollReq")
...
public class CollateralRequestMsg50 extends CollateralRequestMsg {
    ...
    public CollateralRequestMsg50() {
        super();
    }

    public CollateralRequestMsg50(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public CollateralRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public CollateralRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        CollateralRequestMsg50 fixml = (CollateralRequestMsg50) fragment;
