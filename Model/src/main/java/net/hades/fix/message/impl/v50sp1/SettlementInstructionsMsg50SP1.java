...
/*
 * SettlementInstructionsMsg50SP1.java
 *
 * $Id: SettlementInstructionsMsg50SP1.java,v 1.3 2011-04-14 23:44:58 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.SettlInstGroup50SP1;
...
/**
 * FIX version 5.0SP1 SettlementInstructionsMsg implementation.
 *
...
public class SettlementInstructionsMsg50SP1 extends SettlementInstructionsMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> SETTL_INST_GROUP_TAGS = new SettlInstGroup50SP1().getFragmentAllTags();
    ...
    public SettlementInstructionsMsg50SP1() {
        super();
    }

    public SettlementInstructionsMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SettlementInstructionsMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SettlementInstructionsMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SettlementInstructionsMsg50SP1 fixml = (SettlementInstructionsMsg50SP1) fragment;
    ...
    public void setNoSettlInst(Integer noSettlInst) {
        ...
        if (noSettlInst != null) {
            ...
            for (int i = 0; i < settlInstGroups.length; i++) {
                settlInstGroups[i] = new SettlInstGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public SettlInstGroup addSettlInstGroup() {
        SettlInstGroup group = new SettlInstGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (SETTL_INST_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSettlInst != null && noSettlInst.intValue() > 0) {
                ...
                for (int i = 0; i < noSettlInst.intValue(); i++) {
                    SettlInstGroup group = new SettlInstGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SettlementInstructionsMsg] message version [5.0SP1].";
    }
