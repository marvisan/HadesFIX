...
/*
 * QuoteStatusRequestMsg50.java
 *
 * $Id: QuoteStatusRequestMsg50.java,v 1.10 2011-04-14 23:44:40 vrotaru Exp $
 */
...
/**
 * FIX version 5.0 QuoteStatusRequestMsg implementation.
 *
...
public class QuoteStatusRequestMsg50 extends QuoteStatusRequestMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -6380611742657697341L;
    ...
    public QuoteStatusRequestMsg50() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        instrument = new Instrument50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
    }
    
    public QuoteStatusRequestMsg50(Header header, ByteBuffer rawMsg)
        throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }

    public QuoteStatusRequestMsg50(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    ...
    public QuoteStatusRequestMsg50(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [QuoteStatusRequestMsg] message version [5.0].";
    }
