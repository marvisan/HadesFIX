...
/*
 * TradeCaptureReportAckMsg50SP1.java
 *
...
import net.hades.fix.message.group.impl.v50sp1.TrdCapRptAckSideGroup50SP1;
...
/**
 * FIX version 5.0SP1 TradeCaptureReportAckMsg implementation.
 *
...
public class TradeCaptureReportAckMsg50SP1 extends TradeCaptureReportAckMsg {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = 1L;

    protected static final Set<Integer> TAGS_V50SP1 = new HashSet<Integer>(Arrays.asList(new Integer[] {
    ...
    protected static final Set<Integer> TRD_CAP_RPT_ACK_SIDE_GROUP_TAGS = new TrdCapRptAckSideGroup50SP1().getFragmentAllTags();
    ...
    public TradeCaptureReportAckMsg50SP1() {
        super();
    }

    public TradeCaptureReportAckMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public TradeCaptureReportAckMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public TradeCaptureReportAckMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        TradeCaptureReportAckMsg50SP1 fixml = (TradeCaptureReportAckMsg50SP1) fragment;
    ...
    public void setNoSides(Integer noSides) {
        ...
        if (noSides != null) {
            ...
            for (int i = 0; i < trdCapRptAckSideGroups.length; i++) {
                trdCapRptAckSideGroups[i] = new TrdCapRptAckSideGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public TrdCapRptAckSideGroup addTrdCapRptAckSideGroup() {
        TrdCapRptAckSideGroup group = new TrdCapRptAckSideGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (TRD_CAP_RPT_ACK_SIDE_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSides != null && noSides.intValue() > 0) {
                ...
                for (int i = 0; i < noSides.intValue(); i++) {
                    TrdCapRptAckSideGroup component = new TrdCapRptAckSideGroup50SP1(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [TradeCaptureReportAckMsg] message version [5.0SP1].";
    }
