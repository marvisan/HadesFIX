...
/*
 * SecurityTypesMsg50SP2.java
 *
 * $Id: SecurityTypesMsg50SP2.java,v 1.1 2011-04-27 01:09:57 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.SecTypesGroup50SP2;

/**
 * FIX version 5.0SP2 SecurityTypesMsg implementation.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 */
@XmlRootElement(name="SecTyps")
@XmlType(propOrder = {"header", "applicationSequenceControl", "secTypesGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class SecurityTypesMsg50SP2 extends SecurityTypesMsg {
    ...
    protected static final Set<Integer> SEC_TYPES_GROUP_TAGS = new SecTypesGroup50SP2().getFragmentAllTags();
    ...
    public SecurityTypesMsg50SP2() {
        super();
    }

    public SecurityTypesMsg50SP2(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityTypesMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityTypesMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityTypesMsg50SP2 fixml = (SecurityTypesMsg50SP2) fragment;
    ...
    public void setNoSecurityTypes(Integer noSecurityTypes) {
        ...
        if (noSecurityTypes != null) {
            ...
            for (int i = 0; i < secTypesGroups.length; i++) {
                secTypesGroups[i] = new SecTypesGroup50SP2(context);
            }
        }
    }
    ...
    public SecTypesGroup addSecTypesGroup() {
        SecTypesGroup group = new SecTypesGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (SEC_TYPES_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSecurityTypes != null && noSecurityTypes.intValue() > 0) {
                ...
                for (int i = 0; i < noSecurityTypes.intValue(); i++) {
                    SecTypesGroup component = new SecTypesGroup50SP2(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityTypesMsg] message version [5.0SP2].";
    }
