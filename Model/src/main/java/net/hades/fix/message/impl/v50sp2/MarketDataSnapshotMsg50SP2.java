...
/*
 * MarketDataSnapshotMsg50SP2.java
 *
 * $Id: MarketDataSnapshotMsg50SP2.java,v 1.10 2011-04-29 04:07:49 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.MDFullGroup50SP2;
...
/**
 * FIX version 5.0SP2 MarketDataSnapshottMsg implementation.
 *
...
@XmlType(propOrder = {"header", "applicationSequenceControl", "instrument", "underlyingInstruments", "instrumentLegs",
    "mdFullGroups", "routingIDGroups"})
@XmlAccessorType(XmlAccessType.NONE)
public class MarketDataSnapshotMsg50SP2 extends MarketDataSnapshotMsg {
    
    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final long serialVersionUID = -6298178230005126966L;

    protected static final Set<Integer> START_COMP_TAGS;
    
    protected static final Set<Integer> ALL_TAGS;

    protected static final Set<Integer> MD_FULL_GROUP_TAGS = new MDFullGroup50SP2().getFragmentAllTags();
    ...
    public MarketDataSnapshotMsg50SP2() {
        super();
        SECURED_TAGS = STANDARD_SECURED_TAGS;
    }
    
    public MarketDataSnapshotMsg50SP2(Header header, ByteBuffer rawMsg)
    ...
    public MarketDataSnapshotMsg50SP2(BeginString beginString) throws InvalidMsgException {
        super(beginString);
        SECURED_TAGS = STANDARD_SECURED_TAGS;
        FragmentContext context = new FragmentContext(sessionCharset, messageEncoding, validateRequired);
        instrument = new Instrument50SP2(context);
    ...
    public MarketDataSnapshotMsg50SP2(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        MarketDataSnapshotMsg50SP2 fixml = (MarketDataSnapshotMsg50SP2) fragment;
    ...
    public void setNoMDEntries(Integer noMDEntries) {
        ...
        if (noMDEntries != null) {
            ...
            for (int i = 0; i < mdFullGroups.length; i++) {
                mdFullGroups[i] = new MDFullGroup50SP2(context);
            }
        }
    }
    ...
    public MDFullGroup addMdFullGroup() {
        MDFullGroup group = new MDFullGroup50SP2(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (MD_FULL_GROUP_TAGS.contains(tag.tagNum)) {
            if (noMDEntries != null && noMDEntries.intValue() > 0) {
                ...
                for (int i = 0; i < noMDEntries.intValue(); i++) {
                    MDFullGroup component = new MDFullGroup50SP2(context);
                    component.decode(message);
        ...
        if (ROUTING_ID_GROUP_TAGS.contains(tag.tagNum)) {
            if (noRoutingIDs != null && noRoutingIDs.intValue() > 0) {
                ...
                for (int i = 0; i < noRoutingIDs.intValue(); i++) {
                    RoutingIDGroup component = new RoutingIDGroup50SP2(context);
                    component.decode(message);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [MarketDataSnapshotMsg] message version [5.0SP1].";
    }
