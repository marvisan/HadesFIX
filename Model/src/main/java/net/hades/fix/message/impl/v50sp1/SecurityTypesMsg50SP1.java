...
/*
 * SecurityTypesMsg50SP1.java
 *
 * $Id: SecurityTypesMsg50SP1.java,v 1.1 2011-04-27 01:09:57 vrotaru Exp $
 */
package net.hades.fix.message.impl.v50sp1;

import net.hades.fix.message.FragmentContext;
import net.hades.fix.message.exception.InvalidMsgException;
import net.hades.fix.message.group.impl.v50sp1.SecTypesGroup50SP1;
...
/**
 * FIX version 5.0SP1 SecurityTypesMsg implementation.
 *
...
public class SecurityTypesMsg50SP1 extends SecurityTypesMsg {
    ...
    protected static final Set<Integer> SEC_TYPES_GROUP_TAGS = new SecTypesGroup50SP1().getFragmentAllTags();
    ...
    public SecurityTypesMsg50SP1() {
        super();
    }

    public SecurityTypesMsg50SP1(Header header, ByteBuffer rawMsg)
    throws InvalidMsgException, TagNotPresentException, BadFormatMsgException {
        super(header, rawMsg);
    }

    public SecurityTypesMsg50SP1(BeginString beginString) throws InvalidMsgException {
        super(beginString);
    }

    public SecurityTypesMsg50SP1(BeginString beginString, ApplVerID applVerID) throws InvalidMsgException {
    ...
    public void copyFixmlData(FIXFragment fragment) {
        SecurityTypesMsg50SP1 fixml = (SecurityTypesMsg50SP1) fragment;
    ...
    public void setNoSecurityTypes(Integer noSecurityTypes) {
        ...
        if (noSecurityTypes != null) {
            ...
            for (int i = 0; i < secTypesGroups.length; i++) {
                secTypesGroups[i] = new SecTypesGroup50SP1(context);
            }
        }
    }
    ...
    public SecTypesGroup addSecTypesGroup() {
        SecTypesGroup group = new SecTypesGroup50SP1(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (SEC_TYPES_GROUP_TAGS.contains(tag.tagNum)) {
            if (noSecurityTypes != null && noSecurityTypes.intValue() > 0) {
                ...
                for (int i = 0; i < noSecurityTypes.intValue(); i++) {
                    SecTypesGroup component = new SecTypesGroup50SP1(context);
    ...
    protected String getUnsupportedTagMessage() {
        return "This tag is not supported in [SecurityTypesMsg] message version [5.0SP1].";
    }
