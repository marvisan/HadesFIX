 ...
 * HeaderT11_50.java
 *
 * $Id: HeaderT11_50.java,v 1.11 2011-04-14 23:44:42 vrotaru Exp $
 */
...
/**
 * Standard header for FIX version FIXT 1.1 and application version 5.0.
 * 
...
public class HeaderT11_50 extends HeaderFIXT11 {
    ...
    public HeaderT11_50(FragmentContext context) {
        super(context);
        applVerID = ApplVerID.FIX50;
        messageEncoding = Charset.forName(FIXMsg.DEFAULT_CHARACTER_SET);
    }
    
    public HeaderT11_50(String msgType, FragmentContext context) {
    ...
    public void setNoHops(Integer noEvents) {
        ...
        if (noHops != null) {
            ...
            for (int i = 0; i < hopsGroups.length; i++) {
                hopsGroups[i] = new HopsGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
            }
        }
    }
    ...
    public HopsGroup addHopsGroup() {
        ...
        HopsGroup group = new HopsGroup50(new FragmentContext(sessionCharset, messageEncoding, validateRequired));
        ...
        if (noHops != null && noHops.intValue() > 0) {
            if (HOPS_GROUP_TAGS.contains(tag.tagNum)) {
                ...
                for (int i = 0; i < noHops.intValue(); i++) {
                    HopsGroup group = new HopsGroup50(context);
