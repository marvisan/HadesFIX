...
/*
 * DontKnowTradeMsg50Test.java
 *
 * $Id: DontKnowTradeMsg50Test.java,v 1.1 2011-01-16 00:47:41 vrotaru Exp $
 */
 ...
 */
public class DontKnowTradeMsg50Test extends MsgTest  {

    public DontKnowTradeMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (DontKnowTradeMsg) FIXMsgBuilder.build(MsgType.DontKnowTrade.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [DontKnowTradeMsg] message version [5.0].", ex.getMessage());
    }
}
