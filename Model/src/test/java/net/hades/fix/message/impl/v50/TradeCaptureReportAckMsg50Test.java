...
/*
 * TradeCaptureReportAckMsg50Test.java
 *
...
import net.hades.fix.message.impl.v50.data.TradeCaptureReportAckMsg50TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 5.0 TradeCaptureReportAckMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class TradeCaptureReportAckMsg50Test extends MsgTest  {

    public TradeCaptureReportAckMsg50Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        TradeCaptureReportAckMsg msg = (TradeCaptureReportAckMsg) FIXMsgBuilder.build(MsgType.TradeCaptureReportAck.getValue(), BeginString.FIX_5_0);
        TradeCaptureReportAckMsg50TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        TradeCaptureReportAckMsg50TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (TradeCaptureReportAckMsg) FIXMsgBuilder.build(MsgType.TradeCaptureReportAck.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [TradeCaptureReportAckMsg] message version [5.0].", ex.getMessage());
    }
}
