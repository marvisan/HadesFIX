...
/*
 * QuoteRequestMsg50SP1Test.java
 *
 * $Id: QuoteRequestMsg50SP1Test.java,v 1.3 2010-03-21 11:25:16 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v50sp1.data.QuoteRequestMsg50SP1TestData;
 ...
 */
public class QuoteRequestMsg50SP1Test extends MsgTest {

    public QuoteRequestMsg50SP1Test() {
    }
    ...
    public void a1_testEncodeDecodeReq() throws Exception {
        ...
        QuoteRequestMsg msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
    ...
    public void a2_testEncodeDecodeAll() throws Exception {
        ...
        QuoteRequestMsg msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        QuoteRequestMsg50SP1TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        QuoteRequestMsg dmsg = (QuoteRequestMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        QuoteRequestMsg50SP1TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testSetNoRelatedSym() throws Exception {
        QuoteRequestMsg comp = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
           msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
}
