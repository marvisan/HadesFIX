...
/*
 * RegistrationInstructionsMsg44TestData.java
 *
 * $Id: RegistrationInstructionsMsg44TestData.java,v 1.1 2011-10-29 01:31:22 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v44.RgstDtlsGroup44TestData;
...
/**
 * Test utility for RegistrationInstructionsMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class RegistrationInstructionsMsg44TestData extends MsgTest {

    private static final RegistrationInstructionsMsg44TestData INSTANCE;

    static {
        INSTANCE = new RegistrationInstructionsMsg44TestData();
    }

    public static RegistrationInstructionsMsg44TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(RegistrationInstructionsMsg msg) throws UnsupportedEncodingException {
        ...
        RgstDtlsGroup44TestData.getInstance().populate1(msg.getRgstDtlsGroups()[0]);
        RgstDtlsGroup44TestData.getInstance().populate2(msg.getRgstDtlsGroups()[1]);
    ...
    public void check(RegistrationInstructionsMsg expected, RegistrationInstructionsMsg actual) throws Exception {
        ...
        RgstDtlsGroup44TestData.getInstance().check(expected.getRgstDtlsGroups()[0], actual.getRgstDtlsGroups()[0]);
        RgstDtlsGroup44TestData.getInstance().check(expected.getRgstDtlsGroups()[1], actual.getRgstDtlsGroups()[1]);
