...
/*
 * PositionMaintenanceReportMsg44Test.java
 *
...
/**
 * Test suite for FIX 4.4 PositionMaintenanceReportMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 08/12/2011, 12:18:17 PM
 */
public class PositionMaintenanceReportMsg44Test extends MsgTest  {

    public PositionMaintenanceReportMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (PositionMaintenanceReportMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceReport.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    public void testEncodeMissingRequired() {
        ...
        try {
            ...
            assertEquals("Tag value(s) for [PosMaintRptID] [PosTransType] [PosMaintAction] [OrigPosReqRefID] [PosMaintStatus] [ClearingBusinessDate] [Parties] [Account] [AccountType] [Symbol] [TransactTime] [NoPositions] [NoPosAmt] is missing.", 
                    ex.getMessage());
        }
    }
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [PositionMaintenanceReportMsg] message version [4.4].", ex.getMessage());
    }
}
