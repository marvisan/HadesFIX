...
/*
 * OrderCancelRejectMsg50TestData.java
 *
 * $Id: OrderCancelRejectMsg50TestData.java,v 1.1 2011-01-23 10:02:05 vrotaru Exp $
 */
...
/**
 * Test utility for OrderCancelRejectMsg50 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class OrderCancelRejectMsg50TestData extends MsgTest {

    private static final OrderCancelRejectMsg50TestData INSTANCE;

    static {
        INSTANCE = new OrderCancelRejectMsg50TestData();
    }

    public static OrderCancelRejectMsg50TestData getInstance() {
        return INSTANCE;
    }
