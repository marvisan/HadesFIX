...
/*
 * BidResponseMsg50Test.java
 *
 * $Id: BidResponseMsg50Test.java,v 1.1 2011-04-14 11:44:44 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 BidResponseMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class BidResponseMsg50Test extends MsgTest  {

    public BidResponseMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (BidResponseMsg) FIXMsgBuilder.build(MsgType.BidResponse.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [BidResponseMsg] message version [5.0].", ex.getMessage());
    }
}
