...
/*
 * CrossOrderCancelRequestMsg44Test.java
 *
 * $Id: CrossOrderCancelRequestMsg44Test.java,v 1.1 2011-05-21 23:53:23 vrotaru Exp $
 */
 ...
 */
public class CrossOrderCancelRequestMsg44Test extends MsgTest  {

    public CrossOrderCancelRequestMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (CrossOrderCancelRequestMsg) FIXMsgBuilder.build(MsgType.CrossOrderCancelRequest.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [CrossOrderCancelRequestMsg] message version [4.4].", ex.getMessage());
    }
}
