...
/*
 * BatchSetMsg50SP1TestData.java
 *
 * $Id: BatchSetMsg50SP1TestData.java,v 1.1 2011-04-27 23:28:24 vrotaru Exp $
 */
 ...
 */
public class BatchSetMsg50SP1TestData extends MsgTest {

    private static final BatchSetMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new BatchSetMsg50SP1TestData();
    }

    public static BatchSetMsg50SP1TestData getInstance() {
        return INSTANCE;
    }

    public void populate1(BatchSetMsg batchSet) throws Exception {
        SecurityTypeRequestMsg m1b1 = (SecurityTypeRequestMsg) FIXMsgBuilder.build(MsgType.SecurityTypeRequest.getValue(), BeginString.FIX_5_0SP1);
        SecurityTypeRequestMsg50SP1TestData.getInstance().populate(m1b1);
        SecurityStatusRequestMsg m2b1 = (SecurityStatusRequestMsg) FIXMsgBuilder.build(MsgType.SecurityStatusRequest.getValue(), BeginString.FIX_5_0SP1);
        SecurityStatusRequestMsg50SP1TestData.getInstance().populate(m2b1);
    ...
    public void populate2(BatchSetMsg batchSet) throws Exception {
        ...
        b1.setHeader();
        TestUtils.populate44BatcHeader(b1.getHeader());
        SecurityTypesMsg m1b2 = (SecurityTypesMsg) FIXMsgBuilder.build(MsgType.SecurityTypes.getValue(), BeginString.FIX_5_0SP1);
        SecurityTypesMsg50SP1TestData.getInstance().populate(m1b2);
        SecurityStatusMsg m2b2 = (SecurityStatusMsg) FIXMsgBuilder.build(MsgType.SecurityStatus.getValue(), BeginString.FIX_5_0SP1);
        SecurityStatusMsg50SP1TestData.getInstance().populate(m2b2);
    ...
    public void check1(BatchSetMsg expected, BatchSetMsg actual) throws Exception {
        ...
        SecurityStatusRequestMsg50SP1TestData.getInstance().check((SecurityStatusRequestMsg) expected.getBatches()[0].getMessages()[1],
    ...
    public void check2(BatchSetMsg expected, BatchSetMsg actual) throws Exception {
        ...
        SecurityTypesMsg50SP1TestData.getInstance().check((SecurityTypesMsg) expected.getBatches()[1].getMessages()[0],
                (SecurityTypesMsg) actual.getBatches()[1].getMessages()[0]);
        SecurityStatusMsg50SP1TestData.getInstance().check((SecurityStatusMsg) expected.getBatches()[1].getMessages()[1],
