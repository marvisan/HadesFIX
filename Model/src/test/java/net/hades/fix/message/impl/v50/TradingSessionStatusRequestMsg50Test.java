...
/*
 * TradingSessionStatusRequestMsg50Test.java
 *
 * $Id: TradingSessionStatusRequestMsg50Test.java,v 1.1 2011-04-22 01:59:23 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 TradingSessionStatusRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class TradingSessionStatusRequestMsg50Test extends MsgTest  {

    public TradingSessionStatusRequestMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (TradingSessionStatusRequestMsg) FIXMsgBuilder.build(MsgType.TradingSessionStatusRequest.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [TradingSessionStatusRequestMsg] message version [5.0].", ex.getMessage());
    }
}
