...
/*
 * DerivativeSecurityListRequestMsg50SP2TestData.java
 *
 * $Id: DerivativeSecurityListRequestMsg50SP2TestData.java,v 1.2 2011-10-29 09:42:21 vrotaru Exp $
 */
...
import net.hades.fix.message.comp.impl.v50sp2.DerivativeInstrument50SP2TestData;
...
/**
 * Test utility for DerivativeSecurityListRequestMsg50SP2 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class DerivativeSecurityListRequestMsg50SP2TestData extends MsgTest {

    private static final DerivativeSecurityListRequestMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new DerivativeSecurityListRequestMsg50SP2TestData();
    }

    public static DerivativeSecurityListRequestMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(DerivativeSecurityListRequestMsg msg) throws UnsupportedEncodingException {
        ...
        DerivativeInstrument50SP2TestData.getInstance().populate(msg.getDerivativeInstrument());
