...
/*
 * BidRequestMsg44TestData.java
 *
 * $Id: BidRequestMsg44TestData.java,v 1.3 2011-10-29 09:42:17 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v44.BidReqComponentGroup44TestData;
 ...
 */
public class BidRequestMsg44TestData extends MsgTest {

    private static final BidRequestMsg44TestData INSTANCE;

    static {
        INSTANCE = new BidRequestMsg44TestData();
    }

    public static BidRequestMsg44TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(BidRequestMsg msg) throws UnsupportedEncodingException {
        ...
        BidReqComponentGroup44TestData.getInstance().populate1(msg.getBidComponentGroups()[0]);
        BidReqComponentGroup44TestData.getInstance().populate2(msg.getBidComponentGroups()[1]);
    ...
    public void check(BidRequestMsg expected, BidRequestMsg actual) throws Exception {
        ...
        BidReqComponentGroup44TestData.getInstance().check(expected.getBidComponentGroups()[0], actual.getBidComponentGroups()[0]);
        BidReqComponentGroup44TestData.getInstance().check(expected.getBidComponentGroups()[1], actual.getBidComponentGroups()[1]);
