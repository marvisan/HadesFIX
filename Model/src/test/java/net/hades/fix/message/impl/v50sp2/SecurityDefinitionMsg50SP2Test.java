...
/*
 * SecurityDefinitionMsg50SP2Test.java
 *
 * $Id: SecurityDefinitionMsg50SP2Test.java,v 1.1 2011-04-20 00:32:33 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP2 SecurityDefinitionMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SecurityDefinitionMsg50SP2Test extends MsgTest  {

    public SecurityDefinitionMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SecurityDefinitionMsg) FIXMsgBuilder.build(MsgType.SecurityDefinition.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SecurityDefinitionMsg] message version [5.0SP2].", ex.getMessage());
    }
}
