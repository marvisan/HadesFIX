...
/*
 * OrderModificationRequestMsg50TestData.java
 *
 * $Id: OrderModificationRequestMsg50TestData.java,v 1.2 2011-10-29 09:42:07 vrotaru Exp $
 */
 ...
 */
public class OrderModificationRequestMsg50TestData extends MsgTest {

    private static final OrderModificationRequestMsg50TestData INSTANCE;

    static {
        INSTANCE = new OrderModificationRequestMsg50TestData();
    }

    public static OrderModificationRequestMsg50TestData getInstance() {
        return INSTANCE;
    }
