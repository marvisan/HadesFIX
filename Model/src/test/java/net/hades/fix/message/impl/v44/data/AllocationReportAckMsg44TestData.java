 ...
 */
public class AllocationReportAckMsg44TestData extends MsgTest {

    private static final AllocationReportAckMsg44TestData INSTANCE;

    static {
        INSTANCE = new AllocationReportAckMsg44TestData();
    }

    public static AllocationReportAckMsg44TestData getInstance() {
        return INSTANCE;
    }
