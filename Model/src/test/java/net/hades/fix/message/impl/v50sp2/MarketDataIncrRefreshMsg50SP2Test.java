...
/*
 * MarketDataIncrRefreshMsg50SP2Test.java
 *
 * $Id: MarketDataIncrRefreshMsg50SP2Test.java,v 1.3 2010-03-21 11:25:16 vrotaru Exp $
 */
 ...
 */
public class MarketDataIncrRefreshMsg50SP2Test extends MsgTest  {

    public MarketDataIncrRefreshMsg50SP2Test() {
    }
    ...
    public void testSetNoRoutingIDs() throws Exception {
        MarketDataIncrRefreshMsg comp = (MarketDataIncrRefreshMsg) FIXMsgBuilder.build(MsgType.MarketDataIncrRefresh.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP2);
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MarketDataIncrRefreshMsg] message version [5.0SP2].", ex.getMessage());
    }
}
