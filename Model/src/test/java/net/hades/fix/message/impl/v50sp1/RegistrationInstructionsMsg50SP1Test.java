...
/*
 * RegistrationInstructionsMsg50SP1Test.java
 *
 * $Id: RegistrationInstructionsMsg50SP1Test.java,v 1.1 2011-10-29 01:31:22 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 RegistrationInstructionsMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class RegistrationInstructionsMsg50SP1Test extends MsgTest  {

    public RegistrationInstructionsMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (RegistrationInstructionsMsg) FIXMsgBuilder.build(MsgType.RegistrationInstructions.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [RegistrationInstructionsMsg] message version [5.0SP1].", ex.getMessage());
    }
}
