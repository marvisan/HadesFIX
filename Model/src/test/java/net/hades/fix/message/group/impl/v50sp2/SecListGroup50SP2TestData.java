...
/*
 * SecListGroup50SP2TestData.java
 *
 * $Id: SecListGroup50SP2TestData.java,v 1.2 2011-10-29 09:42:22 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.StrikeRuleGroup50SP1TestData;
 ...
 */
public class SecListGroup50SP2TestData extends MsgTest {

    private static final SecListGroup50SP2TestData INSTANCE;

    static {
        INSTANCE = new SecListGroup50SP2TestData();
    }

    public static SecListGroup50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate1(SecListGroup grp) throws UnsupportedEncodingException {
        ...
        grp.setNoLegs(2);
        InstrmtLegSecListGroup50SP2TestData.getInstance().populate1(grp.getInstrmtLegSecListGroups()[0]);
        InstrmtLegSecListGroup50SP2TestData.getInstance().populate2(grp.getInstrmtLegSecListGroups()[1]);
    ...
    public void check(SecListGroup expected, SecListGroup actual) throws Exception {
        ...
        InstrmtLegSecListGroup50SP2TestData.getInstance().check(expected.getInstrmtLegSecListGroups()[0], actual.getInstrmtLegSecListGroups()[0]);
        InstrmtLegSecListGroup50SP2TestData.getInstance().check(expected.getInstrmtLegSecListGroups()[1], actual.getInstrmtLegSecListGroups()[1]);
