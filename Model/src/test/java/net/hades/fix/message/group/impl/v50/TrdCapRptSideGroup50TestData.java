 ...
 *
 * $Id: TrdCapRptSideGroup50TestData.java,v 1.2 2011-10-29 09:42:30 vrotaru Exp $
 */
 ...
 */
public class TrdCapRptSideGroup50TestData extends MsgTest {

    private static final TrdCapRptSideGroup50TestData INSTANCE;

    static {
        INSTANCE = new TrdCapRptSideGroup50TestData();
    }

    public static TrdCapRptSideGroup50TestData getInstance() {
        return INSTANCE;
    }
