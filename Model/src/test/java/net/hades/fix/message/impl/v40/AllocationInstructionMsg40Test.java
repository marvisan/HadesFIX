...
/*
 * AllocationInstructionMsg40Test.java
 *
 * $Id: AllocationInstructionMsg40Test.java,v 1.1 2011-02-16 11:24:35 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v40.data.AllocationInstructionMsg40TestData;
 ...
 */
public class AllocationInstructionMsg40Test extends MsgTest  {

    public AllocationInstructionMsg40Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        AllocationInstructionMsg msg = (AllocationInstructionMsg) FIXMsgBuilder.build(MsgType.Allocation.getValue(), BeginString.FIX_4_0);
        AllocationInstructionMsg40TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        AllocationInstructionMsg40TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AllocationInstructionMsg) FIXMsgBuilder.build(MsgType.Allocation.getValue(), BeginString.FIX_4_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AllocationInstructionMsg] message version [4.0].", ex.getMessage());
    }
}
