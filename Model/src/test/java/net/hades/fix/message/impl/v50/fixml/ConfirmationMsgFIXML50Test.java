...
/*
 * ConfirmationMsgFIXML50Test.java
 *
...
import net.hades.fix.message.impl.v50.data.ConfirmationMsg50TestData;
...
/**
 * Test suite for ConfirmationMsg44 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class ConfirmationMsgFIXML50Test extends MsgTest {

    public ConfirmationMsgFIXML50Test() {
    }
    ...
    /**
     * Test of encode method, of class ConfirmationMsg for FIXML 4.4.
     * @throws Exception
     */
    @Test
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ConfirmationMsg msg = (ConfirmationMsg) FIXMsgBuilder.build(MsgType.Confirmation.getValue(), BeginString.FIX_5_0);
            ...
            ConfirmationMsg dmsg = (ConfirmationMsg) FIXMsgBuilder.build(MsgType.Confirmation.getValue(), BeginString.FIX_5_0);
    ...
    public void testMarshallUnmarshallFixml() throws Exception {
        ...
        try {
            ConfirmationMsg msg = (ConfirmationMsg) FIXMsgBuilder.build(MsgType.Confirmation.getValue(), BeginString.FIX_5_0);
            ConfirmationMsg50TestData.getInstance().populate(msg);
            String fixml = msg.toFixml();
            System.out.println("fixml-->" + fixml);
            XMLValidationResult result = validateXMLAgainstXSD(fixml, FIXML_SCHEMA_V50);
            if (result.hasErrors()) {
            ...
            ConfirmationMsg dmsg = (ConfirmationMsg) FIXMsgBuilder.build(MsgType.Confirmation.getValue(), BeginString.FIX_5_0);
            dmsg.fromFixml(fixml);
            ConfirmationMsg50TestData.getInstance().check(msg, dmsg);
        } finally {
            unsetPrintableFixml();
        }
    }
