...
/*
 * MassQuoteMsg44Test.java
 *
 * $Id: MassQuoteMsg44Test.java,v 1.3 2010-03-21 11:25:18 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 MassQuoteMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class MassQuoteMsg44Test extends MsgTest  {

    private DataDictionary dictionary;

    public MassQuoteMsg44Test() {
    }
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        quickfix.fix44.MassQuote qfMsg = new quickfix.fix44.MassQuote();
        qfMsg.fromString(encoded, dictionary, true);
        MassQuoteMsg44TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF44DataDictionary();
        quickfix.fix44.MassQuote msg = new quickfix.fix44.MassQuote();
        ...
        quickfix.fix44.MassQuote.NoQuoteSets grp = new quickfix.fix44.MassQuote.NoQuoteSets();
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MassQuoteMsg] message version [4.4].", ex.getMessage());
    }
}
