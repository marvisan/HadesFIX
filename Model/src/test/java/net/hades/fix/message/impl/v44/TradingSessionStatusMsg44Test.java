...
/*
 * TradingSessionStatusMsg44Test.java
 *
 * $Id: TradingSessionStatusMsg44Test.java,v 1.1 2011-04-23 00:19:05 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 TradingSessionStatusMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class TradingSessionStatusMsg44Test extends MsgTest  {

    public TradingSessionStatusMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (TradingSessionStatusMsg) FIXMsgBuilder.build(MsgType.TradingSessionStatus.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [TradingSessionStatusMsg] message version [4.4].", ex.getMessage());
    }
}
