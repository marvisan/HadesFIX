...
/*
 * QuoteEntryAckGroup42TestData.java
 *
 * $Id: QuoteEntryAckGroup43TestData.java,v 1.2 2011-10-29 09:42:16 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteEntryAckGroup42 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/04/2009, 10:08:38 AM
 */
public class QuoteEntryAckGroup43TestData extends MsgTest {

    private static final QuoteEntryAckGroup43TestData INSTANCE;

    static {
        INSTANCE = new QuoteEntryAckGroup43TestData();
    }

    public static QuoteEntryAckGroup43TestData getInstance() {
        return INSTANCE;
    }

    public void populate1(quickfix.fix43.MassQuoteAcknowledgement.NoQuoteSets.NoQuoteEntries msg) throws Exception {
        ...
        msg.setInt(quickfix.field.QuoteEntryRejectReason.FIELD, quickfix.field.QuoteEntryRejectReason.DUPLICATE_QUOTE);
    }

    public void populate2(quickfix.fix43.MassQuoteAcknowledgement.NoQuoteSets.NoQuoteEntries msg) throws Exception {
        ...
        msg.setInt(quickfix.field.QuoteEntryRejectReason.FIELD, quickfix.field.QuoteEntryRejectReason.EXCHANGE_CLOSED);
    }
    ...
    public void check(QuoteEntryAckGroup expected, quickfix.fix43.MassQuoteAcknowledgement.NoQuoteSets.NoQuoteEntries actual) throws Exception {
        ...
        assertEquals(expected.getQuoteEntryRejectReason().intValue(), actual.getInt(quickfix.field.QuoteEntryRejectReason.FIELD));
    }

    public void check(quickfix.fix43.MassQuoteAcknowledgement.NoQuoteSets.NoQuoteEntries expected, QuoteEntryAckGroup actual) throws Exception {
        ...
        assertEquals(expected.getInt(quickfix.field.QuoteEntryRejectReason.FIELD), actual.getQuoteEntryRejectReason().intValue());
    }
