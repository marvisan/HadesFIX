...
/*
 * ListExecuteMsg41Test.java
 *
 * $Id: ListExecuteMsg41Test.java,v 1.1 2011-02-05 08:52:45 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.1 ListExecuteMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ListExecuteMsg41Test extends MsgTest  {

    public ListExecuteMsg41Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListExecuteMsg msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_4_1);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
