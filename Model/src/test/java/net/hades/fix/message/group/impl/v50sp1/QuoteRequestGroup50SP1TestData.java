...
/*
 * QuoteRequestGroup50SP1TestData.java
 *
 * $Id: QuoteRequestGroup50SP1TestData.java,v 1.2 2011-10-29 09:42:24 vrotaru Exp $
 */
 ...
 */
public class QuoteRequestGroup50SP1TestData extends MsgTest {

    private static final QuoteRequestGroup50SP1TestData INSTANCE;

    static {
        INSTANCE = new QuoteRequestGroup50SP1TestData();
    }

    public static QuoteRequestGroup50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate1(QuoteRequestGroup msg) throws UnsupportedEncodingException {
        ...
        QuoteRequestLegGroup50SP1TestData.getInstance().populate1(msg.getLegQuoteSymbolGroups()[0]);
        QuoteRequestLegGroup50SP1TestData.getInstance().populate2(msg.getLegQuoteSymbolGroups()[1]);
        // QuoteQualifiers
...
//        assertUTCTimestampEquals(expected.getTransactTime(), actual.getTransactTime(), false);
        ...
        QuoteRequestLegGroup50SP1TestData.getInstance().check(expected.getLegQuoteSymbolGroups()[0], actual.getLegQuoteSymbolGroups()[0]);
        QuoteRequestLegGroup50SP1TestData.getInstance().check(expected.getLegQuoteSymbolGroups()[1], actual.getLegQuoteSymbolGroups()[1]);
        // QuoteQualifiers
