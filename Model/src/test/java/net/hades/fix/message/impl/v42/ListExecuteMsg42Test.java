...
/*
 * ListExecuteMsg42Test.java
 *
 * $Id: ListExecuteMsg42Test.java,v 1.1 2011-02-05 08:52:44 vrotaru Exp $
 */
 ...
 */
public class ListExecuteMsg42Test extends MsgTest  {

    public ListExecuteMsg42Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListExecuteMsg msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_4_2);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListExecuteMsg] message version [4.2].", ex.getMessage());
    }
}
