...
/*
 * AllocationInstructionMsg50Test.java
 *
 * $Id: AllocationInstructionMsg50Test.java,v 1.1 2011-02-16 11:24:36 vrotaru Exp $
 */
 ...
 */
public class AllocationInstructionMsg50Test extends MsgTest {

    public AllocationInstructionMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AllocationInstructionMsg) FIXMsgBuilder.build(MsgType.Allocation.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AllocationInstructionMsg] message version [5.0].", ex.getMessage());
    }
}
