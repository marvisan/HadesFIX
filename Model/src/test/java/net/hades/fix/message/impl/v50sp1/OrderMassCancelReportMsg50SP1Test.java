...
/*
 * OrderMassCancelReportMsg50SP1Test.java
 *
 * $Id: OrderMassCancelReportMsg50SP1Test.java,v 1.2 2011-05-07 07:05:31 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 OrderMassCancelReportMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 07/05/2011, 12:18:17 PM
 */
public class OrderMassCancelReportMsg50SP1Test extends MsgTest  {

    public OrderMassCancelReportMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderMassCancelReportMsg) FIXMsgBuilder.build(MsgType.OrderMassCancelReport.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderMassCancelReportMsg] message version [5.0SP1].", ex.getMessage());
    }
}
