...
/*
 * CollateralInquiryMsgFIXML44Test.java
 *
 * $Id: CollateralInquiryMsgFIXML44Test.java,v 1.1 2011-02-16 11:24:36 vrotaru Exp $
 */
...
/**
 * Test suite for CollateralInquiryMsg44 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 19/12/2011, 20:57:03
 */
public class CollateralInquiryMsgFIXML44Test extends MsgTest {

    public CollateralInquiryMsgFIXML44Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ...
            CollateralInquiryMsg dmsg = (CollateralInquiryMsg) FIXMsgBuilder.build(MsgType.CollateralInquiry.getValue(), BeginString.FIX_4_4);
