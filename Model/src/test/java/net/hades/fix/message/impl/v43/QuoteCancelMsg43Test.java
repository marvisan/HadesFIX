...
/*
 * QuoteCancelMsg43Test.java
 *
 * $Id: QuoteCancelMsg43Test.java,v 1.4 2010-03-21 11:25:17 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v43.data.QuoteCancelMsg43TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;
import net.hades.fix.message.type.QuoteCancelType;

/**
 * Test suite for FIX 4.3 QuoteCancelMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class QuoteCancelMsg43Test extends MsgTest  {

    private DataDictionary dictionary;

    public QuoteCancelMsg43Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        QuoteCancelMsg msg = (QuoteCancelMsg) FIXMsgBuilder.build(MsgType.QuoteCancel.getValue(), BeginString.FIX_4_3);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF43DataDictionary();
        QuoteCancelMsg msg = (QuoteCancelMsg) FIXMsgBuilder.build(MsgType.QuoteCancel.getValue(), BeginString.FIX_4_3);
        QuoteCancelMsg43TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix43.QuoteCancel qfMsg = new quickfix.fix43.QuoteCancel();
        qfMsg.fromString(encoded, dictionary, true);
        QuoteCancelMsg43TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF43DataDictionary();
        quickfix.fix43.QuoteCancel msg = new quickfix.fix43.QuoteCancel();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        QuoteCancelMsg dmsg = (QuoteCancelMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        QuoteCancelMsg43TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (QuoteCancelMsg) FIXMsgBuilder.build(MsgType.QuoteCancel.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteCancelMsg] message version [4.3].", ex.getMessage());
    }
}
