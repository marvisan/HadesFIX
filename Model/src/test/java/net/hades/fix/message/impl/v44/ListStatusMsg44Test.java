 ...
 *
 * $Id: ListStatusMsg44Test.java,v 1.1 2011-02-04 09:58:21 vrotaru Exp $
 */
 ...
 */
public class ListStatusMsg44Test extends MsgTest  {

    public ListStatusMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListStatusMsg) FIXMsgBuilder.build(MsgType.ListStatus.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListStatusMsg] message version [4.4].", ex.getMessage());
    }
}
