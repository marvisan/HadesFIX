...
/*
 * RequestForPositionsMsgFIXML50SP2Test.java
 *
...
import net.hades.fix.message.impl.v50sp2.data.RequestForPositionsMsg50SP2TestData;
 ...
 */
public class RequestForPositionsMsgFIXML50SP2Test extends MsgTest {

    public RequestForPositionsMsgFIXML50SP2Test() {
    }
    ...
    /**
     * Test of encode method, of class RequestForPositionsMsg for FIXML.
     * @throws Exception
     */
    @Test
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            RequestForPositionsMsg msg = (RequestForPositionsMsg) FIXMsgBuilder.build(MsgType.RequestForPositions.getValue(), BeginString.FIX_5_0SP2);
            ...
            RequestForPositionsMsg dmsg = (RequestForPositionsMsg) FIXMsgBuilder.build(MsgType.RequestForPositions.getValue(), BeginString.FIX_5_0SP2);
    ...
    public void testMarshallUnmarshallFixml() throws Exception {
        ...
        try {
            RequestForPositionsMsg msg = (RequestForPositionsMsg) FIXMsgBuilder.build(MsgType.RequestForPositions.getValue(), BeginString.FIX_5_0SP2);
            RequestForPositionsMsg50SP2TestData.getInstance().populate(msg);
            String fixml = msg.toFixml();
            System.out.println("fixml-->" + fixml);
            XMLValidationResult result = validateXMLAgainstXSD(fixml, FIXML_SCHEMA_V50SP2);
            if (result.hasErrors()) {
            ...
            RequestForPositionsMsg dmsg = (RequestForPositionsMsg) FIXMsgBuilder.build(MsgType.RequestForPositions.getValue(), BeginString.FIX_5_0SP2);
            dmsg.fromFixml(fixml);
            RequestForPositionsMsg50SP2TestData.getInstance().check(msg, dmsg);
        } finally {
            unsetPrintableFixml();
        }
    }
