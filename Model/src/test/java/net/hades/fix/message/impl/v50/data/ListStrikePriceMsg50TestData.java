...
/*
 * ListStrikePriceMsg50TestData.java
 *
 * $Id: ListStrikePriceMsg50TestData.java,v 1.1 2011-04-15 04:37:44 vrotaru Exp $
 */
 ...
 */
public class ListStrikePriceMsg50TestData extends MsgTest {

    private static final ListStrikePriceMsg50TestData INSTANCE;

    static {
        INSTANCE = new ListStrikePriceMsg50TestData();
    }

    public static ListStrikePriceMsg50TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(ListStrikePriceMsg msg) throws UnsupportedEncodingException {
        ...
        InstrmtStrikePriceGroup50TestData.getInstance().populate2(msg.getInstrmtStrikePriceGroups()[1]);
    }
    ...
    public void check(ListStrikePriceMsg expected, ListStrikePriceMsg actual) throws Exception {
        ...
        InstrmtStrikePriceGroup50TestData.getInstance().check(expected.getInstrmtStrikePriceGroups()[0], actual.getInstrmtStrikePriceGroups()[0]);
        InstrmtStrikePriceGroup50TestData.getInstance().check(expected.getInstrmtStrikePriceGroups()[1], actual.getInstrmtStrikePriceGroups()[1]);
    }
}
