...
/*
 * MassQuoteMsg50Test.java
 *
 * $Id: MassQuoteMsg50Test.java,v 1.3 2010-03-21 11:25:16 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 MassQuoteMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class MassQuoteMsg50Test extends MsgTest  {

    public MassQuoteMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (MassQuoteMsg) FIXMsgBuilder.build(MsgType.MassQuote.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MassQuoteMsg] message version [5.0].", ex.getMessage());
    }
}
