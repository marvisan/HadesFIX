...
/*
 * NewOrderCrossMsg50SP1TestData.java
 *
 * $Id: NewOrderCrossMsg50SP1TestData.java,v 1.2 2011-10-29 09:42:13 vrotaru Exp $
 */
...
/**
 * Test utility for NewOrderCrossMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 12/05/2011, 12:08:30 PM
 */
public class NewOrderCrossMsg50SP1TestData extends MsgTest {

    private static final NewOrderCrossMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new NewOrderCrossMsg50SP1TestData();
    }

    public static NewOrderCrossMsg50SP1TestData getInstance() {
        return INSTANCE;
    }

    public void populate(NewOrderCrossMsg msg) throws UnsupportedEncodingException {
        ...
        SideCrossOrdModGroup50SP1TestData.getInstance().populate2(msg.getSideCrossOrdModGroups()[1]);
    ...
    public void check(NewOrderCrossMsg expected, NewOrderCrossMsg actual) throws Exception {
        ...
        SideCrossOrdModGroup50SP1TestData.getInstance().check(expected.getSideCrossOrdModGroups()[0], actual.getSideCrossOrdModGroups()[0]);
        SideCrossOrdModGroup50SP1TestData.getInstance().check(expected.getSideCrossOrdModGroups()[1], actual.getSideCrossOrdModGroups()[1]);
