...
/*
 * DerivativeSecurityListMsgFIXML50Test.java
 *
 * $Id: DerivativeSecurityListMsgFIXML50Test.java,v 1.1 2011-09-28 08:10:22 vrotaru Exp $
 */
...
/**
 * Test suite for DerivativeSecurityListMsg50 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class DerivativeSecurityListMsgFIXML50Test extends MsgTest {

    public DerivativeSecurityListMsgFIXML50Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ...
            DerivativeSecurityListMsg dmsg = (DerivativeSecurityListMsg) FIXMsgBuilder.build(MsgType.DerivativeSecurityList.getValue(), BeginString.FIX_5_0);
