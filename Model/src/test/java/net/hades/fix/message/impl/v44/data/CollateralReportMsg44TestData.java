...
/*
 * CollateralReportMsg44TestData.java
 *
...
/**
 * Test utility for CollateralReportMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 19/12/2011, 12:08:30 PM
 */
public class CollateralReportMsg44TestData extends MsgTest {

    private static final CollateralReportMsg44TestData INSTANCE;

    static {
        INSTANCE = new CollateralReportMsg44TestData();
    }

    public static CollateralReportMsg44TestData getInstance() {
        return INSTANCE;
    }
