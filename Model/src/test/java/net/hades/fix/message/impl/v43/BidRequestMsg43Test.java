...
/*
 * BidRequestMsg43Test.java
 *
 * $Id: BidRequestMsg43Test.java,v 1.1 2011-04-13 10:13:44 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.3 BidRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class BidRequestMsg43Test extends MsgTest  {

    public BidRequestMsg43Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        BidRequestMsg msg = (BidRequestMsg) FIXMsgBuilder.build(MsgType.BidRequest.getValue(), BeginString.FIX_4_3);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (BidRequestMsg) FIXMsgBuilder.build(MsgType.BidRequest.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [BidRequestMsg] message version [4.3].", ex.getMessage());
    }
}
