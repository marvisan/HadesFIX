...
/*
 * PositionQtyGroup50TestData.java
 *
 ...
 */
public class PositionQtyGroup50TestData extends MsgTest {

    private static final PositionQtyGroup50TestData INSTANCE;

    static {
        INSTANCE = new PositionQtyGroup50TestData();
    }

    public static PositionQtyGroup50TestData getInstance() {
        return INSTANCE;
    }
