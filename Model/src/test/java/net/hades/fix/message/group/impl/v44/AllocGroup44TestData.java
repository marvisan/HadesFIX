...
/*
 * AllocGroup44TestData.java
 *
 * $Id: AllocGroup44TestData.java,v 1.2 2011-10-29 09:42:09 vrotaru Exp $
 */
...
/**
 * Test utility for AllocGroup44 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 31/03/2009, 9:12:46 AM
 */
public class AllocGroup44TestData extends MsgTest {

    private static final AllocGroup44TestData INSTANCE;

    static {
        INSTANCE = new AllocGroup44TestData();
    }

    public static AllocGroup44TestData getInstance() {
        return INSTANCE;
    }
