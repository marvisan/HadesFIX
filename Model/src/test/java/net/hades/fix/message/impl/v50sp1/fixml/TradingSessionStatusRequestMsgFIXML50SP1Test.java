...
/*
 * TradingSessionStatusRequestMsgFIXML50P1Test.java
 *
 * $Id: TradingSessionStatusRequestMsgFIXML50SP1Test.java,v 1.1 2011-04-22 01:59:23 vrotaru Exp $
 */
...
/**
 * Test suite for TradingSessionStatusRequestMsg50SP1 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class TradingSessionStatusRequestMsgFIXML50SP1Test extends MsgTest {

    public TradingSessionStatusRequestMsgFIXML50SP1Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            TradingSessionStatusRequestMsg msg = (TradingSessionStatusRequestMsg) FIXMsgBuilder.build(MsgType.TradingSessionStatusRequest.getValue(), BeginString.FIX_5_0SP1);
            ...
            TradingSessionStatusRequestMsg dmsg = (TradingSessionStatusRequestMsg) FIXMsgBuilder.build(MsgType.TradingSessionStatusRequest.getValue(), BeginString.FIX_5_0SP1);
