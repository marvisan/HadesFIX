...
/*
 * RequestForPositionsMsg50SP2Test.java
 *
 ...
 */
public class RequestForPositionsMsg50SP2Test extends MsgTest  {

    public RequestForPositionsMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (RequestForPositionsMsg) FIXMsgBuilder.build(MsgType.RequestForPositions.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [RequestForPositionsMsg] message version [5.0SP2].", ex.getMessage());
    }
}
