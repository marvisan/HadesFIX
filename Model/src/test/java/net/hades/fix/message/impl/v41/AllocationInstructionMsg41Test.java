...
/*
 * AllocationInstructionMsg41Test.java
 *
 * $Id: AllocationInstructionMsg41Test.java,v 1.1 2011-02-16 11:24:37 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v41.data.AllocationInstructionMsg41TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.0 AllocationInstructionMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class AllocationInstructionMsg41Test extends MsgTest  {

    public AllocationInstructionMsg41Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        AllocationInstructionMsg msg = (AllocationInstructionMsg) FIXMsgBuilder.build(MsgType.Allocation.getValue(), BeginString.FIX_4_1);
        AllocationInstructionMsg41TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        AllocationInstructionMsg41TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AllocationInstructionMsg) FIXMsgBuilder.build(MsgType.Allocation.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AllocationInstructionMsg] message version [4.1].", ex.getMessage());
    }
}
