...
/*
 * SettlInstGroup44TestData.java
 *
 * $Id: SettlInstGroup44TestData.java,v 1.1 2011-03-26 03:24:29 vrotaru Exp $
 */
...
/**
 * Test utility for SettlInstGroup44 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 31/03/2009, 9:12:46 AM
 */
public class SettlInstGroup44TestData extends MsgTest {

    private static final SettlInstGroup44TestData INSTANCE;

    static {
        INSTANCE = new SettlInstGroup44TestData();
    }

    public static SettlInstGroup44TestData getInstance() {
        return INSTANCE;
    }
