...
/*
 * NewOrderListMsg50SP2Test.java
 *
 * $Id: NewOrderListMsg50SP2Test.java,v 1.1 2011-02-02 10:03:16 vrotaru Exp $
 */
 ...
 */
public class NewOrderListMsg50SP2Test extends MsgTest  {

    public NewOrderListMsg50SP2Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        dmsg.decode();
        NewOrderListMsg50SP2TestData.getInstance().check(msg, dmsg, false);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (NewOrderListMsg) FIXMsgBuilder.build(MsgType.NewOrderList.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [NewOrderListMsg] message version [5.0SP2].", ex.getMessage());
    }
}
