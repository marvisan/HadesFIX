 ...
 *
 * $Id: YieldData44TestData.java,v 1.1 2009-07-06 03:19:12 vrotaru Exp $
 */
...
public class YieldData44TestData extends MsgTest {
    ...
    public void populate(quickfix.fix44.component.YieldData component) throws UnsupportedEncodingException {
        ...
        component.setUtcDateOnly(quickfix.field.YieldCalcDate.FIELD, new Date());
        component.setUtcDateOnly(quickfix.field.YieldRedemptionDate.FIELD, new Date());
        component.setDouble(quickfix.field.YieldRedemptionPrice.FIELD, 2.545);
        component.setInt(quickfix.field.YieldRedemptionPriceType.FIELD, 1);
    }
    ...
    public void populate(YieldData component) {
        ...
        component.setYieldRedemptionPrice(new Double(12.566));
