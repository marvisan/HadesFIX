...
/*
 * MarketDataIncrRefreshMsg50SP1Test.java
 *
 * $Id: MarketDataIncrRefreshMsg50SP1Test.java,v 1.3 2010-03-21 11:25:17 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 MarketDataIncrRefreshMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class MarketDataIncrRefreshMsg50SP1Test extends MsgTest  {

    public MarketDataIncrRefreshMsg50SP1Test() {
    }
    ...
    public void testSetNoRoutingIDs() throws Exception {
        MarketDataIncrRefreshMsg comp = (MarketDataIncrRefreshMsg) FIXMsgBuilder.build(MsgType.MarketDataIncrRefresh.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MarketDataIncrRefreshMsg] message version [5.0SP1].", ex.getMessage());
    }
}
