...
/*
 * DontKnowTradeMsg40Test.java
 *
 * $Id: DontKnowTradeMsg40Test.java,v 1.1 2011-01-16 00:47:41 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v40.data.DontKnowTradeMsg40TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.0 DontKnowTradeMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class DontKnowTradeMsg40Test extends MsgTest  {

    public DontKnowTradeMsg40Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        DontKnowTradeMsg msg = (DontKnowTradeMsg) FIXMsgBuilder.build(MsgType.DontKnowTrade.getValue(), BeginString.FIX_4_0);
        DontKnowTradeMsg40TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        DontKnowTradeMsg dmsg = (DontKnowTradeMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        DontKnowTradeMsg40TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (DontKnowTradeMsg) FIXMsgBuilder.build(MsgType.DontKnowTrade.getValue(), BeginString.FIX_4_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [DontKnowTradeMsg] message version [4.0].", ex.getMessage());
    }
}
