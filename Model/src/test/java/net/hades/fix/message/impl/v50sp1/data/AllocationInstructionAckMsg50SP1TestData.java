...
/*
 * AllocationInstructionAckMsg50SP1TestData.java
 *
 * $Id: AllocationInstructionAckMsg50SP1TestData.java,v 1.1 2011-02-17 09:21:28 vrotaru Exp $
 */
...
/**
 * Test utility for AllocationInstructionAckMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class AllocationInstructionAckMsg50SP1TestData extends MsgTest {

    private static final AllocationInstructionAckMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new AllocationInstructionAckMsg50SP1TestData();
    }

    public static AllocationInstructionAckMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
