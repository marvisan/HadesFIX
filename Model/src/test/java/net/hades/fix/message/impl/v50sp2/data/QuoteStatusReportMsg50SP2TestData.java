...
/*
 * QuoteStatusReportMsg50SP2TestData.java
 *
 * $Id: QuoteStatusReportMsg50SP2TestData.java,v 1.3 2011-10-29 09:42:20 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.LegQuoteStatusGroup50SP2TestData;
...
/**
 * Test utility for QuoteStatusReportMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class QuoteStatusReportMsg50SP2TestData extends MsgTest {

    private static final QuoteStatusReportMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new QuoteStatusReportMsg50SP2TestData();
    }

    public static QuoteStatusReportMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(QuoteStatusReportMsg msg) throws UnsupportedEncodingException {
        ...
        msg.setMinQty(new Double(23.765));
        ...
        LegQuoteStatusGroup50SP2TestData.getInstance().populate1(msg.getLegQuoteStatusGroups()[0]);
        LegQuoteStatusGroup50SP2TestData.getInstance().populate2(msg.getLegQuoteStatusGroups()[1]);
        // QuoteQualifierGroup
        ...
        msg.setOrderRestrictions(OrderRestrictions.ActingAsMarketMakerInSecurity.getValue());
        msg.setQuoteStatus(QuoteStatus.Accepted);
        msg.setQuoteRejectReason(QuoteRejectReason.InvalidBidAskSpread.getValue());
    ...
    public void check(QuoteStatusReportMsg expected, QuoteStatusReportMsg actual) throws Exception {
        ...
        LegQuoteStatusGroup50SP2TestData.getInstance().check(expected.getLegQuoteStatusGroups()[0], actual.getLegQuoteStatusGroups()[0]);
        LegQuoteStatusGroup50SP2TestData.getInstance().check(expected.getLegQuoteStatusGroups()[1], actual.getLegQuoteStatusGroups()[1]);
        // QuoteQualifierGroup
        ...
        assertEquals(expected.getQuoteRejectReason(), actual.getQuoteRejectReason());
