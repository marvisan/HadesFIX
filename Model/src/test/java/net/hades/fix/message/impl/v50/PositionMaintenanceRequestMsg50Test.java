...
/*
 * PositionMaintenanceRequestMsg50Test.java
 *
 ...
 */
public class PositionMaintenanceRequestMsg50Test extends MsgTest  {

    public PositionMaintenanceRequestMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [PositionMaintenanceRequestMsg] message version [5.0].", ex.getMessage());
    }
}
