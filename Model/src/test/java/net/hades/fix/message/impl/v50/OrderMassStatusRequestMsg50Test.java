...
/*
 * OrderMassStatusRequestMsg50Test.java
 *
 * $Id: OrderMassStatusRequestMsg50Test.java,v 1.1 2011-05-09 08:21:12 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 OrderMassStatusRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class OrderMassStatusRequestMsg50Test extends MsgTest  {

    public OrderMassStatusRequestMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderMassStatusRequestMsg) FIXMsgBuilder.build(MsgType.OrderMassStatusRequest.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderMassStatusRequestMsg] message version [5.0].", ex.getMessage());
    }
}
