...
/*
 * TradeCaptureReportMsg50SP1TestData.java
 *
 * $Id: TradeCaptureReportMsg50SP1TestData.java,v 1.2 2011-10-29 09:42:14 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.TrdCapRptSideGroup50SP1TestData;
...
/**
 * Test utility for TradeCaptureReportMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class TradeCaptureReportMsg50SP1TestData extends MsgTest {

    private static final TradeCaptureReportMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new TradeCaptureReportMsg50SP1TestData();
    }

    public static TradeCaptureReportMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(TradeCaptureReportMsg msg) throws UnsupportedEncodingException {
        ...
        msg.setNoSides(2);
        TrdCapRptSideGroup50SP1TestData.getInstance().populate1(msg.getTrdCapRptSideGroups()[0]);
        TrdCapRptSideGroup50SP1TestData.getInstance().populate2(msg.getTrdCapRptSideGroups()[1]);
    ...
    public void check(TradeCaptureReportMsg expected, TradeCaptureReportMsg actual) throws Exception {
        ...
        TrdCapRptSideGroup50SP1TestData.getInstance().check(expected.getTrdCapRptSideGroups()[0], actual.getTrdCapRptSideGroups()[0]);
        TrdCapRptSideGroup50SP1TestData.getInstance().check(expected.getTrdCapRptSideGroups()[1], actual.getTrdCapRptSideGroups()[1]);
