...
/*
 * CollateralAssignmentMsg44TestData.java
 *
 * $Id: CollateralAssignmentMsg44TestData.java,v 1.2 2011-10-29 09:42:17 vrotaru Exp $
 */
...
/**
 * Test utility for CollateralAssignmentMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 18/12/2011, 12:08:30 PM
 */
public class CollateralAssignmentMsg44TestData extends MsgTest {

    private static final CollateralAssignmentMsg44TestData INSTANCE;

    static {
        INSTANCE = new CollateralAssignmentMsg44TestData();
    }

    public static CollateralAssignmentMsg44TestData getInstance() {
        return INSTANCE;
    }
