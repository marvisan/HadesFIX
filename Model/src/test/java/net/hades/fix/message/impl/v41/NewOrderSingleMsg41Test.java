...
/*
 * NewOrderSingleMsg41Test.java
 *
 * $Id: NewOrderSingleMsg41Test.java,v 1.1 2010-12-12 09:13:10 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v41.data.NewOrderSingleMsg41TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.1 NewOrderSingleMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class NewOrderSingleMsg41Test extends MsgTest  {

    public NewOrderSingleMsg41Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        NewOrderSingleMsg msg = (NewOrderSingleMsg) FIXMsgBuilder.build(MsgType.NewOrderSingle.getValue(), BeginString.FIX_4_1);
        NewOrderSingleMsg41TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        NewOrderSingleMsg dmsg = (NewOrderSingleMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        NewOrderSingleMsg41TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (NewOrderSingleMsg) FIXMsgBuilder.build(MsgType.NewOrderSingle.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
    ...
    public void testEncodeMissingRequired() {
        ...
        try {
            ...
            assertEquals("Tag value(s) for [ClOrdID] [Symbol] [Side] [OrdType] is missing.", ex.getMessage());
        }
    }
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [NewOrderSingleMsg] message version [4.1].", ex.getMessage());
    }
}
