...
/*
 * DerivativeSecurityListMsg50SP2Test.java
 *
 * $Id: DerivativeSecurityListMsg50SP2Test.java,v 1.1 2011-09-28 08:10:22 vrotaru Exp $
 */
 ...
 */
public class DerivativeSecurityListMsg50SP2Test extends MsgTest  {

    public DerivativeSecurityListMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (DerivativeSecurityListMsg) FIXMsgBuilder.build(MsgType.DerivativeSecurityList.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [DerivativeSecurityListMsg] message version [5.0SP2].", ex.getMessage());
    }
}
