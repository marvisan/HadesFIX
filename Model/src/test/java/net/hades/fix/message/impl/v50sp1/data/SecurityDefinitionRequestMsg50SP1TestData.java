...
/*
 * SecurityDefinitionRequestMsg50SP1TestData.java
 *
 * $Id: SecurityDefinitionRequestMsg50SP1TestData.java,v 1.2 2011-10-29 09:42:13 vrotaru Exp $
 */
 ...
 */
public class SecurityDefinitionRequestMsg50SP1TestData extends MsgTest {

    private static final SecurityDefinitionRequestMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new SecurityDefinitionRequestMsg50SP1TestData();
    }

    public static SecurityDefinitionRequestMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
