...
/*
 * TradeCaptureReportRequestMsg50Test.java
 *
 * $Id: TradeCaptureReportRequestMsg50Test.java,v 1.1 2011-10-08 08:43:04 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 TradeCaptureReportRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class TradeCaptureReportRequestMsg50Test extends MsgTest  {

    public TradeCaptureReportRequestMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (TradeCaptureReportRequestMsg) FIXMsgBuilder.build(MsgType.TradeCaptureReportRequest.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [TradeCaptureReportRequestMsg] message version [5.0].", ex.getMessage());
    }
}
