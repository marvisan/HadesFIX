 ...
 * EmailMsg44Test.java
 *
 * $Id: EmailMsg44Test.java,v 1.4 2010-03-21 11:25:18 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 EmailMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 02/04/2009, 8:57:55 AM
 */
public class EmailMsg44Test extends MsgTest {

    private DataDictionary dictionary;

    public EmailMsg44Test() {
    }
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        quickfix.fix44.Email qfMsg = new quickfix.fix44.Email();
        qfMsg.fromString(encoded, dictionary, true);
        EmailMsg44TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF44DataDictionary();
        quickfix.fix44.Email msg = new quickfix.fix44.Email();
    ...
    public void testSetNoRoutingIDs() throws Exception {
        EmailMsg comp = (EmailMsg) FIXMsgBuilder.build(MsgType.Email.getValue(), BeginString.FIX_4_4);
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [EmailMsg] message version [4.4].", ex.getMessage());
    }
}
