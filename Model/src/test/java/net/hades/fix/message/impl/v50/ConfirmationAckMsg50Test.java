...
/**
 * Test suite for FIX 5.0 ConfirmationAckMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ConfirmationAckMsg50Test extends MsgTest  {

    public ConfirmationAckMsg50Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ConfirmationAckMsg msg = (ConfirmationAckMsg) FIXMsgBuilder.build(MsgType.ConfirmationAck.getValue(), BeginString.FIX_5_0);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ConfirmationAckMsg) FIXMsgBuilder.build(MsgType.ConfirmationAck.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ConfirmationAckMsg] message version [5.0].", ex.getMessage());
    }
}
