...
/*
 * CollateralInquiryAckMsg50Test.java
 *
...
/**
 * Test suite for FIX 5.0 CollateralInquiryAckMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 19/12/2011, 12:18:17 PM
 */
public class CollateralInquiryAckMsg50Test extends MsgTest  {

    public CollateralInquiryAckMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (CollateralInquiryAckMsg) FIXMsgBuilder.build(MsgType.CollateralInquiryAck.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [CollateralInquiryAckMsg] message version [5.0].", ex.getMessage());
    }
}
