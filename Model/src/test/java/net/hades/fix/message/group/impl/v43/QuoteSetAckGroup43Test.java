...
/*
 * QuoteSetAckGroup43Test.java
 *
 * $Id: QuoteSetAckGroup43Test.java,v 1.2 2009-11-21 09:57:16 vrotaru Exp $
 */
...
/**
 * Test suite for QuoteSetAckGroup43 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/04/2009, 11:30:15 AM
 */
public class QuoteSetAckGroup43Test {

    public QuoteSetAckGroup43Test() {
    }
    ...
    public void testQuoteEntries() {
        QuoteSetAckGroup group = new QuoteSetAckGroup43();
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteSetAckGroup] group version [4.3].", ex.getMessage());
    }
}
