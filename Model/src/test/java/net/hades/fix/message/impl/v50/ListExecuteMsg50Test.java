...
/*
 * ListExecuteMsg50Test.java
 *
 * $Id: ListExecuteMsg50Test.java,v 1.1 2011-02-05 08:52:44 vrotaru Exp $
 */
 ...
 */
public class ListExecuteMsg50Test extends MsgTest  {

    public ListExecuteMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListExecuteMsg] message version [5.0].", ex.getMessage());
    }
}
