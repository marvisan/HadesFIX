...
/*
 * DontKnowTradeMsg44Test.java
 *
 * $Id: DontKnowTradeMsg44Test.java,v 1.1 2011-01-16 00:47:41 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 DontKnowTradeMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class DontKnowTradeMsg44Test extends MsgTest  {

    public DontKnowTradeMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (DontKnowTradeMsg) FIXMsgBuilder.build(MsgType.DontKnowTrade.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [DontKnowTradeMsg] message version [4.4].", ex.getMessage());
    }
}
