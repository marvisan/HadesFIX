...
/*
 * QuoteMsg50SP1TestData.java
 *
 * $Id: QuoteMsg50SP1TestData.java,v 1.2 2011-10-29 09:42:15 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteMsgSP150 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class QuoteMsg50SP1TestData extends MsgTest {

    private static final QuoteMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new QuoteMsg50SP1TestData();
    }

    public static QuoteMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(QuoteMsg msg) throws UnsupportedEncodingException {
        ...
        LegQuoteGroup50SP1TestData.getInstance().populate1(msg.getLegQuoteSymbolGroups()[0]);
        LegQuoteGroup50SP1TestData.getInstance().populate2(msg.getLegQuoteSymbolGroups()[1]);
    ...
    public void check(QuoteMsg expected, QuoteMsg actual) throws Exception {
        ...
        LegQuoteGroup50SP1TestData.getInstance().check(expected.getLegQuoteSymbolGroups()[0], actual.getLegQuoteSymbolGroups()[0]);
        LegQuoteGroup50SP1TestData.getInstance().check(expected.getLegQuoteSymbolGroups()[1], actual.getLegQuoteSymbolGroups()[1]);
