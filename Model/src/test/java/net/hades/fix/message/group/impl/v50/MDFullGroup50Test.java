...
/*
 * MDFullGroup50Test.java
 *
 * $Id: MDFullGroup50Test.java,v 1.1 2009-12-03 11:19:12 vrotaru Exp $
 */
 ...
 */
public class MDFullGroup50Test {


    public MDFullGroup50Test() {
    }
    ...
    public void testGetUnsupportedTag() {
        ...
        MDFullGroup group = new MDFullGroup50();
        try {
            group.getYieldData();
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MDFullGroup] group version [5.0].", ex.getMessage());
    }
}
