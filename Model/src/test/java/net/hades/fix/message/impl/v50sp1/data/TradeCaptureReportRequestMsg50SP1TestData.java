 ...
 *
 * $Id: TradeCaptureReportRequestMsg50SP1TestData.java,v 1.1 2011-10-08 08:43:05 vrotaru Exp $
 */
 ...
 */
public class TradeCaptureReportRequestMsg50SP1TestData extends MsgTest {

    private static final TradeCaptureReportRequestMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new TradeCaptureReportRequestMsg50SP1TestData();
    }

    public static TradeCaptureReportRequestMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
