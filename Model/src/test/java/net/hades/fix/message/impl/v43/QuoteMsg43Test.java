 ...
 * QuoteMsg43Test.java
 *
 * $Id: QuoteMsg43Test.java,v 1.4 2010-03-21 11:25:17 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v43.data.QuoteMsg43TestData;
...
/**
 * Test suite for FIX 4.3 QuoteMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class QuoteMsg43Test extends MsgTest  {

    private DataDictionary dictionary;

    public QuoteMsg43Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        QuoteMsg msg = (QuoteMsg) FIXMsgBuilder.build(MsgType.Quote.getValue(), BeginString.FIX_4_3);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF43DataDictionary();
        QuoteMsg msg = (QuoteMsg) FIXMsgBuilder.build(MsgType.Quote.getValue(), BeginString.FIX_4_3);
        QuoteMsg43TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix43.Quote qfMsg = new quickfix.fix43.Quote();
        qfMsg.fromString(encoded, dictionary, true);
        QuoteMsg43TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        QuoteMsg dmsg = (QuoteMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        QuoteMsg43TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        QuoteMsg msg = null;
        try {
            msg = (QuoteMsg) FIXMsgBuilder.build(MsgType.Quote.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteMsg] message version [4.3].", ex.getMessage());
    }}
