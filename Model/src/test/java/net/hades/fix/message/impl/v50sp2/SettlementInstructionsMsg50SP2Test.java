...
/*
 * SettlementInstructionsMsg50SP2Test.java
 *
 * $Id: SettlementInstructionsMsg50SP2Test.java,v 1.1 2011-03-26 03:24:28 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP2 SettlementInstructionsMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SettlementInstructionsMsg50SP2Test extends MsgTest  {

    public SettlementInstructionsMsg50SP2Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        SettlementInstructionsMsg msg = (SettlementInstructionsMsg) FIXMsgBuilder.build(MsgType.SettlInstructions.getValue(), BeginString.FIX_5_0SP2);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SettlementInstructionsMsg) FIXMsgBuilder.build(MsgType.SettlInstructions.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SettlementInstructionsMsg] message version [5.0SP2].", ex.getMessage());
    }
}
