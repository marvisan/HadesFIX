...
/*
 * OrderMassCancelRequestMsg50Test.java
 *
 * $Id: OrderMassCancelRequestMsg50Test.java,v 1.1 2011-05-02 05:16:38 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 OrderMassCancelRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class OrderMassCancelRequestMsg50Test extends MsgTest  {

    public OrderMassCancelRequestMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderMassCancelRequestMsg) FIXMsgBuilder.build(MsgType.OrderMassCancelRequest.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderMassCancelRequestMsg] message version [5.0].", ex.getMessage());
    }
}
