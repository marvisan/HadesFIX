...
/*
 * QuoteEntryAckGroup42Test.java
 *
 * $Id: QuoteEntryAckGroup42Test.java,v 1.2 2009-11-21 09:57:22 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v42.QuoteEntryAckGroup42;

/**
 * Test suite for QuoteEntryAckGroup42 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/04/2009, 11:30:15 AM
 */
public class QuoteEntryAckGroup42Test {


    public QuoteEntryAckGroup42Test() {
    }
    ...
    public void testGetUnsupportedTag() {
        ...
        QuoteEntryAckGroup group = new QuoteEntryAckGroup42();
        try {
            group.getInstrument();
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteEntryAckGroup] group version [4.2].", ex.getMessage());
    }
