...
/*
 * NewOrderMultilegMsg50SP2TestData.java
 *
 * $Id: NewOrderMultilegMsg50SP2TestData.java,v 1.2 2011-10-29 09:42:21 vrotaru Exp $
 */
...
/**
 * Test utility for NewOrderMultilegMsg message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class NewOrderMultilegMsg50SP2TestData extends MsgTest {

    private static final NewOrderMultilegMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new NewOrderMultilegMsg50SP2TestData();
    }

    public static NewOrderMultilegMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(NewOrderMultilegMsg msg) throws UnsupportedEncodingException {
        ...
        LegOrdGroup50SP2TestData.getInstance().populate2(msg.getLegOrdGroups()[1]);
        ...
        msg.setMultilegModel(MultilegModel.PredefinedMultilegSecurity);
        msg.setMultilegPriceMethod(MultilegPriceMethod.MultipliedPrice);
    ...
    public void check(NewOrderMultilegMsg expected, NewOrderMultilegMsg actual) throws Exception {
        ...
        LegOrdGroup50SP2TestData.getInstance().check(expected.getLegOrdGroups()[0], actual.getLegOrdGroups()[0]);
        LegOrdGroup50SP2TestData.getInstance().check(expected.getLegOrdGroups()[1], actual.getLegOrdGroups()[1]);
