...
/*
 * SettlementInstructionRequestMsg44TestData.java
 *
...
/**
 * Test utility for SettlementInstructionRequestMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class SettlementInstructionRequestMsg44TestData extends MsgTest {

    private static final SettlementInstructionRequestMsg44TestData INSTANCE;

    static {
        INSTANCE = new SettlementInstructionRequestMsg44TestData();
    }

    public static SettlementInstructionRequestMsg44TestData getInstance() {
        return INSTANCE;
    }
