...
/*
 * InstrumentLeg50SP1Test.java
 *
 * $Id: InstrumentLeg50SP1Test.java,v 1.2 2009-11-21 09:57:23 vrotaru Exp $
 */
...
/**
 * Test suite for InstrumentLeg50SP1 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 08/01/2009, 9:08:45 PM
 */
public class InstrumentLeg50SP1Test {

    public InstrumentLeg50SP1Test() {
    }
    ...
    public void testSetNoLegSecurityAltID() {
        InstrumentLeg comp = new InstrumentLeg50SP1();
    ...
    private void checkUnsupportedInstrumentLegException(Exception ex) {
        assertEquals("This tag is not supported in [InstrumentLeg] component version [5.0SP1].", ex.getMessage());
    }
}