...
/*
 * NewOrderMultilegMsg44TestData.java
 *
 * $Id: NewOrderMultilegMsg44TestData.java,v 1.2 2011-10-29 09:42:17 vrotaru Exp $
 */
 ...
 */
public class NewOrderMultilegMsg44TestData extends MsgTest {

    private static final NewOrderMultilegMsg44TestData INSTANCE;

    static {
        INSTANCE = new NewOrderMultilegMsg44TestData();
    }

    public static NewOrderMultilegMsg44TestData getInstance() {
        return INSTANCE;
    }
