...
/*
 * OrderModificationRequestMsg43TestData.java
 *
 * $Id: OrderModificationRequestMsg43TestData.java,v 1.2 2011-10-29 09:42:28 vrotaru Exp $
 */
 ...
 */
public class OrderModificationRequestMsg43TestData extends MsgTest {

    private static final OrderModificationRequestMsg43TestData INSTANCE;

    static {
        INSTANCE = new OrderModificationRequestMsg43TestData();
    }

    public static OrderModificationRequestMsg43TestData getInstance() {
        return INSTANCE;
    }
