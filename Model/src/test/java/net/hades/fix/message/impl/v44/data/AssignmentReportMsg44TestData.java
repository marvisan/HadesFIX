...
/*
 * AssignmentReportMsg44TestData.java
 *
...
/**
 * Test utility for AssignmentReportMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 16/12/2011, 12:08:30 PM
 */
public class AssignmentReportMsg44TestData extends MsgTest {

    private static final AssignmentReportMsg44TestData INSTANCE;

    static {
        INSTANCE = new AssignmentReportMsg44TestData();
    }

    public static AssignmentReportMsg44TestData getInstance() {
        return INSTANCE;
    }
