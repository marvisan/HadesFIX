...
/*
 * SecurityDefinitionRequestMsg44TestData.java
 *
 * $Id: SecurityDefinitionRequestMsg44TestData.java,v 1.2 2011-10-29 09:42:18 vrotaru Exp $
 */
 ...
 */
public class SecurityDefinitionRequestMsg44TestData extends MsgTest {

    private static final SecurityDefinitionRequestMsg44TestData INSTANCE;

    static {
        INSTANCE = new SecurityDefinitionRequestMsg44TestData();
    }

    public static SecurityDefinitionRequestMsg44TestData getInstance() {
        return INSTANCE;
    }
