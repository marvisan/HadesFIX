...
/*
 * MarketDataRequestMsg50SP1Test.java
 *
 * $Id: MarketDataRequestMsg50SP1Test.java,v 1.5 2010-03-21 11:25:17 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v50sp1.data.MarketDataRequestMsg50SP1TestData;
...
/**
 * Test suite for FIX 5.0SP1 MarketDataRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.5 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class MarketDataRequestMsg50SP1Test extends MsgTest  {

    public MarketDataRequestMsg50SP1Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        MarketDataRequestMsg msg = (MarketDataRequestMsg) FIXMsgBuilder.build(MsgType.MarketDataRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
    ...
    public void b1_testEncodeDecodeAll() throws Exception {
        ...
        MarketDataRequestMsg msg = (MarketDataRequestMsg) FIXMsgBuilder.build(MsgType.MarketDataRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        MarketDataRequestMsg50SP1TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        MarketDataRequestMsg dmsg = (MarketDataRequestMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        MarketDataRequestMsg50SP1TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (MarketDataRequestMsg) FIXMsgBuilder.build(MsgType.MarketDataRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MarketDataRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
}
