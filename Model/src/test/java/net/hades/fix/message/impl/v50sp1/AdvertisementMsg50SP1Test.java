...
/*
 * AdvertisementMsg50SP1Test.java
 *
 * $Id: AdvertisementMsg50SP1Test.java,v 1.4 2010-03-21 11:25:17 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v50sp1.data.AdvertisementMsg50SP1TestData;
...
/**
 * Test suite for AdvertisementMsg 5.0 SP1 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 07/02/2009, 9:07:29 PM
 */
public class AdvertisementMsg50SP1Test extends MsgTest {

    public AdvertisementMsg50SP1Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        AdvertisementMsg msg = (AdvertisementMsg) FIXMsgBuilder.build(MsgType.Advertisement.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        ...
        assertEquals(AdvTransType.New, dmsg.getAdvTransType());
        assertEquals("MOT", dmsg.getInstrument().getSymbol());
        assertEquals(AdvSide.Buy, dmsg.getAdvSide());
    ...
    public void a2_testEncodeDecodeAll() throws Exception {
        ...
        AdvertisementMsg msg = (AdvertisementMsg) FIXMsgBuilder.build(MsgType.Advertisement.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        AdvertisementMsg50SP1TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        AdvertisementMsg dmsg = (AdvertisementMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        AdvertisementMsg50SP1TestData.getInstance().check(msg, dmsg);
    }
   ...
   /**
    ...
    public void testGetUnsupportedTag() {
        ...
        try {
            msg = (AdvertisementMsg) FIXMsgBuilder.build(MsgType.Advertisement.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AdvertismentMsg] message version [5.0SP1].", ex.getMessage());
    }
}
