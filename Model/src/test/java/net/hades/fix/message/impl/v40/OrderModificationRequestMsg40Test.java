...
/*
 * OrderModificationRequestMsg40Test.java
 *
 * $Id: OrderModificationRequestMsg40Test.java,v 1.1 2011-01-21 10:23:14 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v40.data.OrderModificationRequestMsg40TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.0 OrderModificationRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class OrderModificationRequestMsg40Test extends MsgTest  {

    public OrderModificationRequestMsg40Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        OrderModificationRequestMsg msg = (OrderModificationRequestMsg) FIXMsgBuilder.build(MsgType.OrderModificationRequest.getValue(), BeginString.FIX_4_0);
        OrderModificationRequestMsg40TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        OrderModificationRequestMsg40TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderModificationRequestMsg) FIXMsgBuilder.build(MsgType.OrderModificationRequest.getValue(), BeginString.FIX_4_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderModificationRequestMsg] message version [4.0].", ex.getMessage());
    }
}
