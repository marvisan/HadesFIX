...
/*
 * NewsMsg50SP1Test.java
 *
 * $Id: NewsMsg50SP1Test.java,v 1.3 2010-03-21 11:25:17 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 NewsMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 02/03/2009, 7:38:11 PM
 */
public class NewsMsg50SP1Test extends MsgTest {

    public NewsMsg50SP1Test() {
    }
    ...
    public void testSetNoRelatedSyms() throws Exception {
        NewsMsg comp = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        NewsMsg msg = null;
        try {
            msg = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [NewsMsg] message version [5.0SP1].", ex.getMessage());
    }
