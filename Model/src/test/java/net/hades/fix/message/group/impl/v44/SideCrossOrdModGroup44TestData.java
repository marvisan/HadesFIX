...
/*
 * SideCrossOrdModGroup44TestData.java
 *
 * $Id: SideCrossOrdModGroup44TestData.java,v 1.2 2011-10-29 09:42:11 vrotaru Exp $
 */
 ...
 */
public class SideCrossOrdModGroup44TestData extends MsgTest {

    private static final SideCrossOrdModGroup44TestData INSTANCE;

    static {
        INSTANCE = new SideCrossOrdModGroup44TestData();
    }

    public static SideCrossOrdModGroup44TestData getInstance() {
        return INSTANCE;
    }
