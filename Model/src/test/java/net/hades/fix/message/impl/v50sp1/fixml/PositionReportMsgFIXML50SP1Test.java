...
/*
 * PositionReportMsgFIXML50SP1Test.java
 *
...
import net.hades.fix.message.impl.v50sp1.data.PositionReportMsg50SP1TestData;
...
/**
 * Test suite for PositionReportMsg50SP1 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 14/12/2011, 20:57:03
 */
public class PositionReportMsgFIXML50SP1Test extends MsgTest {

    public PositionReportMsgFIXML50SP1Test() {
    }
    ...
    /**
     * Test of encode method, of class PositionReportMsg for FIXML.
     * @throws Exception
     */
    @Test
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            PositionReportMsg msg = (PositionReportMsg) FIXMsgBuilder.build(MsgType.PositionReport.getValue(), BeginString.FIX_5_0SP1);
            ...
            PositionReportMsg dmsg = (PositionReportMsg) FIXMsgBuilder.build(MsgType.PositionReport.getValue(), BeginString.FIX_5_0SP1);
    ...
    public void testMarshallUnmarshallFixml() throws Exception {
        ...
        try {
            PositionReportMsg msg = (PositionReportMsg) FIXMsgBuilder.build(MsgType.PositionReport.getValue(), BeginString.FIX_5_0SP1);
            PositionReportMsg50SP1TestData.getInstance().populate(msg);
            String fixml = msg.toFixml();
            System.out.println("fixml-->" + fixml);
            XMLValidationResult result = validateXMLAgainstXSD(fixml, FIXML_SCHEMA_V50SP1);
            if (result.hasErrors()) {
            ...
            PositionReportMsg dmsg = (PositionReportMsg) FIXMsgBuilder.build(MsgType.PositionReport.getValue(), BeginString.FIX_5_0SP1);
            dmsg.fromFixml(fixml);
            PositionReportMsg50SP1TestData.getInstance().check(msg, dmsg);
        } finally {
            unsetPrintableFixml();
        }
    }
