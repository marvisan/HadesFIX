 ...
 * IOIMsg50Test.java
 *
 * $Id: IOIMsg50Test.java,v 1.4 2010-03-21 11:25:16 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 IOIMsg class.
 *
 ...
 * @created 02/03/2009, 7:38:11 PM
 */
public class IOIMsg50Test extends MsgTest {
    ...
    public void testGetUnsupportedTag() {
        ...
        IOIMsg msg = null;
        try {
            msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [IOIMsg] message version [5.0].", ex.getMessage());
    }
}
