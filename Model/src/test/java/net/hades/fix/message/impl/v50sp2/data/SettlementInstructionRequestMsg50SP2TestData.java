...
/*
 * SettlementInstructionRequestMsg50SP2TestData.java
 *
...
/**
 * Test utility for SettlementInstructionRequestMsg50SP2 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class SettlementInstructionRequestMsg50SP2TestData extends MsgTest {

    private static final SettlementInstructionRequestMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new SettlementInstructionRequestMsg50SP2TestData();
    }

    public static SettlementInstructionRequestMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
