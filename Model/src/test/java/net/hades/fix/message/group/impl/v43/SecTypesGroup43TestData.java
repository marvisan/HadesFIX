...
/*
 * SecTypesGroup43TestData.java
 *
 * $Id: SecTypesGroup43TestData.java,v 1.1 2011-04-27 01:09:58 vrotaru Exp $
 */
...
/**
 * Test utility for SecTypesGroup43 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 31/03/2009, 9:12:46 AM
 */
public class SecTypesGroup43TestData extends MsgTest {

    private static final SecTypesGroup43TestData INSTANCE;

    static {
        INSTANCE = new SecTypesGroup43TestData();
    }

    public static SecTypesGroup43TestData getInstance() {
        return INSTANCE;
    }
