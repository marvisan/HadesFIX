...
/*
 * PosUndInstrmtGroup50TestData.java
 *
 ...
 */
public class PosUndInstrmtGroup50TestData extends MsgTest {

    private static final PosUndInstrmtGroup50TestData INSTANCE;

    static {
        INSTANCE = new PosUndInstrmtGroup50TestData();
    }

    public static PosUndInstrmtGroup50TestData getInstance() {
        return INSTANCE;
    }
