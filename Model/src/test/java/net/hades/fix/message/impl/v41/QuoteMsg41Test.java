 ...
 * QuoteMsg41Test.java
 *
 * $Id: QuoteMsg41Test.java,v 1.4 2010-03-21 11:25:18 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v41.data.QuoteMsg41TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;


/**
 * Test suite for FIX 4.1 QuoteMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class QuoteMsg41Test extends MsgTest  {

    private DataDictionary dictionary;

    public QuoteMsg41Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        QuoteMsg msg = (QuoteMsg) FIXMsgBuilder.build(MsgType.Quote.getValue(), BeginString.FIX_4_1);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF41DataDictionary();
        QuoteMsg msg = (QuoteMsg) FIXMsgBuilder.build(MsgType.Quote.getValue(), BeginString.FIX_4_1);
        QuoteMsg41TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix41.Quote qfMsg = new quickfix.fix41.Quote();
        qfMsg.fromString(encoded, dictionary, true);
        QuoteMsg41TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF41DataDictionary();
        quickfix.fix41.Quote msg = new quickfix.fix41.Quote();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        QuoteMsg dmsg = (QuoteMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        QuoteMsg41TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        QuoteMsg msg = null;
        try {
            msg = (QuoteMsg) FIXMsgBuilder.build(MsgType.Quote.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteMsg] message version [4.1].", ex.getMessage());
    }}
