...
/*
 * SecurityDefinitionRequestMsg44Test.java
 *
 * $Id: SecurityDefinitionRequestMsg44Test.java,v 1.1 2011-04-16 09:39:02 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 SecurityDefinitionRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SecurityDefinitionRequestMsg44Test extends MsgTest  {

    public SecurityDefinitionRequestMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SecurityDefinitionRequestMsg) FIXMsgBuilder.build(MsgType.SecurityDefinitionRequest.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SecurityDefinitionRequestMsg] message version [4.4].", ex.getMessage());
    }
}
