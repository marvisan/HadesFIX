...
/*
 * QuoteEntryGroup50SP1TestData.java
 *
 * $Id: QuoteEntryGroup50SP1TestData.java,v 1.3 2011-10-29 09:42:24 vrotaru Exp $
 */
 ...
 */
public class QuoteEntryGroup50SP1TestData extends MsgTest {

    private static final QuoteEntryGroup50SP1TestData INSTANCE;

    static {
        INSTANCE = new QuoteEntryGroup50SP1TestData();
    }

    public static QuoteEntryGroup50SP1TestData getInstance() {
        return INSTANCE;
    }
