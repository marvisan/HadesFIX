 ...
 *
 * $Id: RegistrationInstructionsMsg50SP2TestData.java,v 1.1 2011-10-29 01:31:21 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.RgstDtlsGroup50SP2TestData;
 ...
 */
public class RegistrationInstructionsMsg50SP2TestData extends MsgTest {

    private static final RegistrationInstructionsMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new RegistrationInstructionsMsg50SP2TestData();
    }

    public static RegistrationInstructionsMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(RegistrationInstructionsMsg msg) throws UnsupportedEncodingException {
        ...
        RgstDtlsGroup50SP2TestData.getInstance().populate1(msg.getRgstDtlsGroups()[0]);
        RgstDtlsGroup50SP2TestData.getInstance().populate2(msg.getRgstDtlsGroups()[1]);
    ...
    public void check(RegistrationInstructionsMsg expected, RegistrationInstructionsMsg actual) throws Exception {
        ...
        RgstDtlsGroup50SP2TestData.getInstance().check(expected.getRgstDtlsGroups()[0], actual.getRgstDtlsGroups()[0]);
        RgstDtlsGroup50SP2TestData.getInstance().check(expected.getRgstDtlsGroups()[1], actual.getRgstDtlsGroups()[1]);
