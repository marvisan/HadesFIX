...
/*
 * ListCancelRequestMsg41Test.java
 *
 * $Id: ListCancelRequestMsg41Test.java,v 1.1 2011-02-06 01:06:14 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.1 ListCancelRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ListCancelRequestMsg41Test extends MsgTest  {

    public ListCancelRequestMsg41Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListCancelRequestMsg msg = (ListCancelRequestMsg) FIXMsgBuilder.build(MsgType.ListCancelRequest.getValue(), BeginString.FIX_4_1);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListCancelRequestMsg) FIXMsgBuilder.build(MsgType.ListCancelRequest.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListCancelRequestMsg] message version [4.1].", ex.getMessage());
    }
}
