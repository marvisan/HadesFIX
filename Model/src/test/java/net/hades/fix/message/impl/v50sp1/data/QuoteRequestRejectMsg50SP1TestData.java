...
/*
 * QuoteRequestRejectMsg50SP1TestData.java
 *
 * $Id: QuoteRequestRejectMsg50SP1TestData.java,v 1.1 2009-07-06 03:19:18 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteRequestRejectMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 11:57:03 AM
 */
public class QuoteRequestRejectMsg50SP1TestData extends MsgTest {

    private static final QuoteRequestRejectMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new QuoteRequestRejectMsg50SP1TestData();
    }

    public static QuoteRequestRejectMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(QuoteRequestRejectMsg msg) throws UnsupportedEncodingException {
        ...
        QuoteRequestRejectGroup50SP1TestData.getInstance().populate2(msg.getQuoteRequestRejectGroups()[1]);
    ...
    public void check(QuoteRequestRejectMsg expected, QuoteRequestRejectMsg actual) throws Exception {
        ...
        QuoteRequestRejectGroup50SP1TestData.getInstance().check(expected.getQuoteRequestRejectGroups()[0],
            actual.getQuoteRequestRejectGroups()[0]);
        QuoteRequestRejectGroup50SP1TestData.getInstance().check(expected.getQuoteRequestRejectGroups()[1],
