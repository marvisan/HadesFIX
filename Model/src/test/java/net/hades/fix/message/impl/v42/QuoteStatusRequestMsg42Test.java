...
/*
 * QuoteStatusRequestMsg42Test.java
 *
 * $Id: QuoteStatusRequestMsg42Test.java,v 1.5 2010-03-21 11:25:18 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.QuoteStatusRequestMsg42TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.2 QuoteStatusRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.5 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class QuoteStatusRequestMsg42Test extends MsgTest  {

    private DataDictionary dictionary;

    public QuoteStatusRequestMsg42Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        QuoteStatusRequestMsg msg = (QuoteStatusRequestMsg) FIXMsgBuilder.build(MsgType.QuoteStatusRequest.getValue(), BeginString.FIX_4_2);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        QuoteStatusRequestMsg msg = (QuoteStatusRequestMsg) FIXMsgBuilder.build(MsgType.QuoteStatusRequest.getValue(), BeginString.FIX_4_2);
        QuoteStatusRequestMsg42TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix42.QuoteStatusRequest qfMsg = new quickfix.fix42.QuoteStatusRequest();
        qfMsg.fromString(encoded, dictionary, true);
        QuoteStatusRequestMsg42TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        quickfix.fix42.QuoteStatusRequest msg = new quickfix.fix42.QuoteStatusRequest();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        QuoteStatusRequestMsg dmsg = (QuoteStatusRequestMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        QuoteStatusRequestMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (QuoteStatusRequestMsg) FIXMsgBuilder.build(MsgType.QuoteStatusRequest.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteStatusRequestMsg] message version [4.2].", ex.getMessage());
    }}
