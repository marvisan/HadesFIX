...
/*
 * CollateralInquiryMsgFIXML50Test.java
 *
...
/**
 * Test suite for CollateralInquiryMsg50 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 19/12/2011, 20:57:03
 */
public class CollateralInquiryMsgFIXML50Test extends MsgTest {

    public CollateralInquiryMsgFIXML50Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ...
            CollateralInquiryMsg dmsg = (CollateralInquiryMsg) FIXMsgBuilder.build(MsgType.CollateralInquiry.getValue(), BeginString.FIX_5_0);
