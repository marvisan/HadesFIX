 ...
 * EmailMsg42Test.java
 *
 * $Id: EmailMsg42Test.java,v 1.3 2010-03-21 11:25:18 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.EmailMsg42TestData;
...
/**
 * Test suite for FIX 4.2 EmailMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 02/04/2009, 8:57:55 AM
 */
public class EmailMsg42Test extends MsgTest {

    private DataDictionary dictionary;

    public EmailMsg42Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        EmailMsg msg = (EmailMsg) FIXMsgBuilder.build(MsgType.Email.getValue(), BeginString.FIX_4_2);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        EmailMsg msg = (EmailMsg) FIXMsgBuilder.build(MsgType.Email.getValue(), BeginString.FIX_4_2);
        EmailMsg42TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix42.Email qfMsg = new quickfix.fix42.Email();
        qfMsg.fromString(encoded, dictionary, true);
        EmailMsg42TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        quickfix.fix42.Email msg = new quickfix.fix42.Email();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        EmailMsg dmsg = (EmailMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        EmailMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testSetNoRoutingIDs() throws Exception {
        EmailMsg comp = (EmailMsg) FIXMsgBuilder.build(MsgType.Email.getValue(), BeginString.FIX_4_2);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        EmailMsg msg = null;
        try {
            msg = (EmailMsg) FIXMsgBuilder.build(MsgType.Email.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [EmailMsg] message version [4.2].", ex.getMessage());
    }
}
