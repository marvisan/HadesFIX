...
/*
 * TrdCapRptSideGroup50SP1TestData.java
 *
 * $Id: TrdCapRptSideGroup50SP1TestData.java,v 1.1 2011-10-25 08:29:21 vrotaru Exp $
 */
 ...
 */
public class TrdCapRptSideGroup50SP1TestData extends MsgTest {

    private static final TrdCapRptSideGroup50SP1TestData INSTANCE;

    static {
        INSTANCE = new TrdCapRptSideGroup50SP1TestData();
    }

    public static TrdCapRptSideGroup50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate1(TrdCapRptSideGroup grp) throws UnsupportedEncodingException {
        ...
        grp.setExecRefID("EXEC_REF_0000");
    ...
    public void populate2(TrdCapRptSideGroup grp) throws UnsupportedEncodingException {
        ...
        grp.setExecRefID("EXEC_REF_1111");
        grp.setSecondaryClOrdID("SEC_CLI_ORD_7777");
        grp.setListID("LIST_2222");
