...
/*
 * CollateralAssignmentMsg50SP2TestData.java
 *
...
import net.hades.fix.message.group.impl.v50sp2.UndInstrmtCollGroup50SP2TestData;
...
/**
 * Test utility for CollateralAssignmentMsg50SP2 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 18/12/2011, 12:08:30 PM
 */
public class CollateralAssignmentMsg50SP2TestData extends MsgTest {

    private static final CollateralAssignmentMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new CollateralAssignmentMsg50SP2TestData();
    }

    public static CollateralAssignmentMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(CollateralAssignmentMsg msg) throws UnsupportedEncodingException {
        ...
        UndInstrmtCollGroup50SP2TestData.getInstance().populate1(msg.getUndInstrmtCollGroups()[0]);
        UndInstrmtCollGroup50SP2TestData.getInstance().populate2(msg.getUndInstrmtCollGroups()[1]);
    ...
    public void check(CollateralAssignmentMsg expected, CollateralAssignmentMsg actual) throws Exception {
        ...
        UndInstrmtCollGroup50SP2TestData.getInstance().check(expected.getUndInstrmtCollGroups()[0], actual.getUndInstrmtCollGroups()[0]);
        UndInstrmtCollGroup50SP2TestData.getInstance().check(expected.getUndInstrmtCollGroups()[1], actual.getUndInstrmtCollGroups()[1]);
