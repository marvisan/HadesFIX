 ...
 *
 * $Id: OrderMassCancelReportMsg50SP1TestData.java,v 1.1 2011-05-07 06:58:53 vrotaru Exp $
 */
 ...
 */
public class OrderMassCancelReportMsg50SP1TestData extends MsgTest {

    private static final OrderMassCancelReportMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new OrderMassCancelReportMsg50SP1TestData();
    }

    public static OrderMassCancelReportMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
