...
/*
 * MarketDataRequestMsg44Test.java
 *
 * $Id: MarketDataRequestMsg44Test.java,v 1.4 2010-03-21 11:25:18 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 MarketDataRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class MarketDataRequestMsg44Test extends MsgTest  {

    private DataDictionary dictionary;

    public MarketDataRequestMsg44Test() {
    }
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        quickfix.fix44.MarketDataRequest qfMsg = new quickfix.fix44.MarketDataRequest();
        qfMsg.fromString(encoded, dictionary, true);
        MarketDataRequestMsg44TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (MarketDataRequestMsg) FIXMsgBuilder.build(MsgType.MarketDataRequest.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MarketDataRequestMsg] message version [4.4].", ex.getMessage());
    }
}
