...
/*
 * SecurityTypeRequestMsg50TestData.java
 *
 * $Id: SecurityTypeRequestMsg50TestData.java,v 1.1 2011-04-26 02:16:04 vrotaru Exp $
 */
...
/**
 * Test utility for SecurityTypeRequestMsg50 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class SecurityTypeRequestMsg50TestData extends MsgTest {

    private static final SecurityTypeRequestMsg50TestData INSTANCE;

    static {
        INSTANCE = new SecurityTypeRequestMsg50TestData();
    }

    public static SecurityTypeRequestMsg50TestData getInstance() {
        return INSTANCE;
    }
