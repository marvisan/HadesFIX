 ...
 * IOIMsg42Test.java
 *
 * $Id: IOIMsg42Test.java,v 1.4 2010-03-21 11:25:18 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.IOIMsg42TestData;
...
/**
 * Test suite for FIX 4.2 IOIMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 02/03/2009, 7:38:11 PM
 */
public class IOIMsg42Test extends MsgTest {
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        IOIMsg msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIX_4_2);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        IOIMsg msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIX_4_2);
        IOIMsg42TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix42.IndicationofInterest qfMsg = new quickfix.fix42.IndicationofInterest();
        qfMsg.fromString(encoded, dictionary, true);
        IOIMsg42TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        quickfix.fix42.IndicationofInterest msg = new quickfix.fix42.IndicationofInterest();
...
//    @Test
    public void b2_testDecodeAll() throws Exception {
        ...
        IOIMsg dmsg = (IOIMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        IOIMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedTag() {
        ...
        IOIMsg msg = null;
        try {
            msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [IOIMsg] message version [4.2].", ex.getMessage());
    }
}
