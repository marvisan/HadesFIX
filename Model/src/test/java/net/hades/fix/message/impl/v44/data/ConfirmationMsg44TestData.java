...
/*
 * ConfirmationMsg44TestData.java
 *
...
/**
 * Test utility for ConfirmationMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class ConfirmationMsg44TestData extends MsgTest {

    private static final ConfirmationMsg44TestData INSTANCE;

    static {
        INSTANCE = new ConfirmationMsg44TestData();
    }

    public static ConfirmationMsg44TestData getInstance() {
        return INSTANCE;
    }
