...
/*
 * MarketDataRequestMsg42Test.java
 *
 * $Id: MarketDataRequestMsg42Test.java,v 1.5 2010-03-21 11:25:17 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.MarketDataRequestMsg42TestData;
...
/**
 * Test suite for FIX 4.2 MarketDataRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.5 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class MarketDataRequestMsg42Test extends MsgTest  {

    private DataDictionary dictionary;

    public MarketDataRequestMsg42Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        MarketDataRequestMsg msg = (MarketDataRequestMsg) FIXMsgBuilder.build(MsgType.MarketDataRequest.getValue(), BeginString.FIX_4_2);
        ...
        msg.getMdReqGroups()[0].setSymbol("IBM");
...
//    @Test
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        MarketDataRequestMsg msg = (MarketDataRequestMsg) FIXMsgBuilder.build(MsgType.MarketDataRequest.getValue(), BeginString.FIX_4_2);
        MarketDataRequestMsg42TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix42.MarketDataRequest qfMsg = new quickfix.fix42.MarketDataRequest();
        qfMsg.fromString(encoded, dictionary, true);
        MarketDataRequestMsg42TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        quickfix.fix42.MarketDataRequest msg = new quickfix.fix42.MarketDataRequest();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        MarketDataRequestMsg dmsg = (MarketDataRequestMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        MarketDataRequestMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (MarketDataRequestMsg) FIXMsgBuilder.build(MsgType.MarketDataRequest.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MarketDataRequestMsg] message version [4.2].", ex.getMessage());
    }
}
