...
/*
 * OrderCancelRequestMsg50TestData.java
 *
 * $Id: OrderCancelRequestMsg50TestData.java,v 1.1 2011-01-22 09:52:25 vrotaru Exp $
 */
 ...
 */
public class OrderCancelRequestMsg50TestData extends MsgTest {

    private static final OrderCancelRequestMsg50TestData INSTANCE;

    static {
        INSTANCE = new OrderCancelRequestMsg50TestData();
    }

    public static OrderCancelRequestMsg50TestData getInstance() {
        return INSTANCE;
    }
