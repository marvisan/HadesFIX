...
/*
 * NewOrderMultilegMsg50SP1TestData.java
 *
 * $Id: NewOrderMultilegMsg50SP1TestData.java,v 1.2 2011-10-29 09:42:14 vrotaru Exp $
 */
 ...
 */
public class NewOrderMultilegMsg50SP1TestData extends MsgTest {

    private static final NewOrderMultilegMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new NewOrderMultilegMsg50SP1TestData();
    }

    public static NewOrderMultilegMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(NewOrderMultilegMsg msg) throws UnsupportedEncodingException {
        ...
        LegOrdGroup50SP1TestData.getInstance().populate2(msg.getLegOrdGroups()[1]);
    ...
    public void check(NewOrderMultilegMsg expected, NewOrderMultilegMsg actual) throws Exception {
        ...
        LegOrdGroup50SP1TestData.getInstance().check(expected.getLegOrdGroups()[0], actual.getLegOrdGroups()[0]);
        LegOrdGroup50SP1TestData.getInstance().check(expected.getLegOrdGroups()[1], actual.getLegOrdGroups()[1]);
