...
/*
 * RequestForPositionsAckMsg50Test.java
 *
 ...
 */
public class RequestForPositionsAckMsg50Test extends MsgTest  {

    public RequestForPositionsAckMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (RequestForPositionsAckMsg) FIXMsgBuilder.build(MsgType.RequestForPositionsAck.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [RequestForPositionsAckMsg] message version [5.0].", ex.getMessage());
    }
}
