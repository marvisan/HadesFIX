...
/*
 * AssignmentReportMsg44Test.java
 *
...
/**
 * Test suite for FIX 4.4 AssignmentReportMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 16/12/2011, 12:18:17 PM
 */
public class AssignmentReportMsg44Test extends MsgTest  {

    public AssignmentReportMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AssignmentReportMsg) FIXMsgBuilder.build(MsgType.AssignmentReport.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    public void testEncodeMissingRequired() {
        ...
        try {
            ...
            assertEquals("Tag value(s) for [AsgnRptID] [Parties] [AccountType] [NoPositions] [NoPosAmt] [SettlPrice] [SettlPriceType] [UnderlyingSettlPrice] [AssignmentMethod] [OpenInterest] [ExerciseMethod] [SettlSessID] [SettlSessSubID] [ClearingBusinessDate] is missing.", ex.getMessage());
        }
    }
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AssignmentReportMsg] message version [4.4].", ex.getMessage());
    }
}
