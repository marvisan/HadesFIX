...
/*
 * RegistrationInstructionsResponseMsgFIXML50SP1Test.java
 *
 * $Id: RegistrationInstructionsResponseMsgFIXML50SP1Test.java,v 1.1 2011-10-29 02:54:35 vrotaru Exp $
 */
...
/**
 * Test suite for RegistrationInstructionsResponseMsg50SP1 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class RegistrationInstructionsResponseMsgFIXML50SP1Test extends MsgTest {

    public RegistrationInstructionsResponseMsgFIXML50SP1Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            RegistrationInstructionsResponseMsg msg = (RegistrationInstructionsResponseMsg) FIXMsgBuilder.build(MsgType.RegistrationInstructionsResponse.getValue(), BeginString.FIX_5_0SP1);
            ...
            RegistrationInstructionsResponseMsg dmsg = (RegistrationInstructionsResponseMsg) FIXMsgBuilder.build(MsgType.RegistrationInstructionsResponse.getValue(), BeginString.FIX_5_0SP1);
