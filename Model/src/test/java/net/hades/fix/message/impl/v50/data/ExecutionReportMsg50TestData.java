...
/*
 * ExecutionReportMsg50TestData.java
 *
 * $Id: ExecutionReportMsg50TestData.java,v 1.3 2011-10-29 09:42:06 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.InstrmtLegExecGroup50TestData;
 ...
 */
public class ExecutionReportMsg50TestData extends MsgTest {

    private static final ExecutionReportMsg50TestData INSTANCE;

    static {
        INSTANCE = new ExecutionReportMsg50TestData();
    }

    public static ExecutionReportMsg50TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(ExecutionReportMsg msg) throws UnsupportedEncodingException {
        ...
        msg.setNoLegs(2);
        InstrmtLegExecGroup50TestData.getInstance().populate1(msg.getInstrmtLegExecGroups()[0]);
        InstrmtLegExecGroup50TestData.getInstance().populate2(msg.getInstrmtLegExecGroups()[1]);
    ...
    public void check(ExecutionReportMsg expected, ExecutionReportMsg actual) throws Exception {
        ...
        InstrmtLegExecGroup50TestData.getInstance().check(expected.getInstrmtLegExecGroups()[0], actual.getInstrmtLegExecGroups()[0]);
        InstrmtLegExecGroup50TestData.getInstance().check(expected.getInstrmtLegExecGroups()[1], actual.getInstrmtLegExecGroups()[1]);
