...
/*
 * TradingSessionStatusMsg50SP1Test.java
 *
 * $Id: TradingSessionStatusMsg50SP1Test.java,v 1.1 2011-04-23 00:19:03 vrotaru Exp $
 */
 ...
 */
public class TradingSessionStatusMsg50SP1Test extends MsgTest  {

    public TradingSessionStatusMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (TradingSessionStatusMsg) FIXMsgBuilder.build(MsgType.TradingSessionStatus.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [TradingSessionStatusMsg] message version [5.0SP1].", ex.getMessage());
    }
}
