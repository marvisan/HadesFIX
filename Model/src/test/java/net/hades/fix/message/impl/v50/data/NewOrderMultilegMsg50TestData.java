...
/*
 * NewOrderMultilegMsg50TestData.java
 *
 * $Id: NewOrderMultilegMsg50TestData.java,v 1.2 2011-10-29 09:42:06 vrotaru Exp $
 */
 ...
 */
public class NewOrderMultilegMsg50TestData extends MsgTest {

    private static final NewOrderMultilegMsg50TestData INSTANCE;

    static {
        INSTANCE = new NewOrderMultilegMsg50TestData();
    }

    public static NewOrderMultilegMsg50TestData getInstance() {
        return INSTANCE;
    }
