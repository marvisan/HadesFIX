...
/*
 * AllocationReportAckMsg50Test.java
 *
 ...
 */
public class AllocationReportAckMsg50Test extends MsgTest  {

    public AllocationReportAckMsg50Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        AllocationReportAckMsg msg = (AllocationReportAckMsg) FIXMsgBuilder.build(MsgType.AllocationReportAck.getValue(), BeginString.FIX_5_0);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AllocationReportAckMsg) FIXMsgBuilder.build(MsgType.AllocationReportAck.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AllocationReportAckMsg] message version [5.0].", ex.getMessage());
    }
}
