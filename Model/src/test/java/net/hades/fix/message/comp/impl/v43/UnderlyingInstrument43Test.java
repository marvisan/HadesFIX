...
/*
 * UnderlyingInstrument43Test.java
 *
 * $Id: UnderlyingInstrument43Test.java,v 1.2 2009-11-21 09:57:28 vrotaru Exp $
 */
...
/**
 * Test suite for UnderlyingInstrument43 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/01/2009, 10:08:32 AM
 */
public class UnderlyingInstrument43Test {

    public UnderlyingInstrument43Test() {
    }
    ...
    public void testSetNoUnderlyingSecurityAltID() {
        UnderlyingInstrument comp = new UnderlyingInstrument43();
    ...
    public void testGetUnsupportedTag() {
        ...
        UnderlyingInstrument comp = new UnderlyingInstrument43();
        try {
            comp.getUnderlyingStipulations();
    ...
    private void checkUnsupportedUnderlyingInstrumentException(Exception ex) {
        assertEquals("This tag is not supported in [UnderlyingInstrument] component version [4.3].", ex.getMessage());
    }
