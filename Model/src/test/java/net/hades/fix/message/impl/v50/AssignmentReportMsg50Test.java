...
/*
 * AssignmentReportMsg50Test.java
 *
...
/**
 * Test suite for FIX 5.0 AssignmentReportMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 16/12/2011, 12:18:17 PM
 */
public class AssignmentReportMsg50Test extends MsgTest  {

    public AssignmentReportMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AssignmentReportMsg) FIXMsgBuilder.build(MsgType.AssignmentReport.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AssignmentReportMsg] message version [5.0].", ex.getMessage());
    }
}
