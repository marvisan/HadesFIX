...
/*
 * PositionMaintenanceRequestMsg44TestData.java
 *
...
/**
 * Test utility for PositionMaintenanceRequestMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 06/12/2011, 12:08:30 PM
 */
public class PositionMaintenanceRequestMsg44TestData extends MsgTest {

    private static final PositionMaintenanceRequestMsg44TestData INSTANCE;

    static {
        INSTANCE = new PositionMaintenanceRequestMsg44TestData();
    }

    public static PositionMaintenanceRequestMsg44TestData getInstance() {
        return INSTANCE;
    }
