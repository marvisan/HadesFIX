...
/*
 * QuoteRequestRejectGroup50SP1TestData.java
 *
 * $Id: QuoteRequestRejectGroup50SP1TestData.java,v 1.2 2011-10-29 09:42:24 vrotaru Exp $
 */
 ...
 */
public class QuoteRequestRejectGroup50SP1TestData extends MsgTest {

    private static final QuoteRequestRejectGroup50SP1TestData INSTANCE;

    static {
        INSTANCE = new QuoteRequestRejectGroup50SP1TestData();
    }

    public static QuoteRequestRejectGroup50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate1(QuoteRequestRejectGroup msg) throws UnsupportedEncodingException {
        ...
        QuoteRequestLegGroup50SP1TestData.getInstance().populate1(msg.getQuoteRequestLegGroups()[0]);
        QuoteRequestLegGroup50SP1TestData.getInstance().populate2(msg.getQuoteRequestLegGroups()[1]);
        // QuoteQualifiers
    ...
    public void check(QuoteRequestRejectGroup expected, QuoteRequestRejectGroup actual) throws Exception {
        ...
        QuoteRequestLegGroup50SP1TestData.getInstance().check(expected.getQuoteRequestLegGroups()[0], actual.getQuoteRequestLegGroups()[0]);
        QuoteRequestLegGroup50SP1TestData.getInstance().check(expected.getQuoteRequestLegGroups()[1], actual.getQuoteRequestLegGroups()[1]);
        // QuoteQualifiers
