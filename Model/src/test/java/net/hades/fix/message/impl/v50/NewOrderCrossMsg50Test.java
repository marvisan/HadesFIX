...
/*
 * NewOrderCrossMsg50Test.java
 *
 * $Id: NewOrderCrossMsg50Test.java,v 1.2 2011-05-17 09:28:23 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 NewOrderCrossMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class NewOrderCrossMsg50Test extends MsgTest  {

    public NewOrderCrossMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (NewOrderCrossMsg) FIXMsgBuilder.build(MsgType.NewOrderCross.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [NewOrderCrossMsg] message version [5.0].", ex.getMessage());
    }
}
