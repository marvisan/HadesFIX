...
/*
 * OrderMassCancelReportMsg44Test.java
 *
 * $Id: OrderMassCancelReportMsg44Test.java,v 1.1 2011-05-07 06:58:54 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 OrderMassCancelReportMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 07/05/2011, 12:18:17 PM
 */
public class OrderMassCancelReportMsg44Test extends MsgTest  {

    public OrderMassCancelReportMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderMassCancelReportMsg) FIXMsgBuilder.build(MsgType.OrderMassCancelReport.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderMassCancelReportMsg] message version [4.4].", ex.getMessage());
    }
}
