...
/*
 * NewOrderCrossMsg44TestData.java
 *
 * $Id: NewOrderCrossMsg44TestData.java,v 1.2 2011-10-29 09:42:18 vrotaru Exp $
 */
...
/**
 * Test utility for NewOrderCrossMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 12/05/2011, 12:08:30 PM
 */
public class NewOrderCrossMsg44TestData extends MsgTest {

    private static final NewOrderCrossMsg44TestData INSTANCE;

    static {
        INSTANCE = new NewOrderCrossMsg44TestData();
    }

    public static NewOrderCrossMsg44TestData getInstance() {
        return INSTANCE;
    }
