...
/*
 * SecurityStatusRequestMsg42Test.java
 *
 * $Id: SecurityStatusRequestMsg42Test.java,v 1.1 2011-04-20 06:57:50 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.SecurityStatusRequestMsg42TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.2 SecurityStatusRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SecurityStatusRequestMsg42Test extends MsgTest  {

    public SecurityStatusRequestMsg42Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        SecurityStatusRequestMsg msg = (SecurityStatusRequestMsg) FIXMsgBuilder.build(MsgType.SecurityStatusRequest.getValue(), BeginString.FIX_4_2);
        SecurityStatusRequestMsg42TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        SecurityStatusRequestMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SecurityStatusRequestMsg) FIXMsgBuilder.build(MsgType.SecurityStatusRequest.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SecurityStatusRequestMsg] message version [4.2].", ex.getMessage());
    }
}
