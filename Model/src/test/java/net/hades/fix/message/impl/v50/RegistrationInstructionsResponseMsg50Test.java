...
/*
 * RegistrationInstructionsResponseMsg50Test.java
 *
 * $Id: RegistrationInstructionsResponseMsg50Test.java,v 1.1 2011-10-29 02:54:35 vrotaru Exp $
 */
 ...
 */
public class RegistrationInstructionsResponseMsg50Test extends MsgTest  {

    public RegistrationInstructionsResponseMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (RegistrationInstructionsResponseMsg) FIXMsgBuilder.build(MsgType.RegistrationInstructionsResponse.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [RegistrationInstructionsResponseMsg] message version [5.0].", ex.getMessage());
    }
}
