...
/*
 * SettlementInstructionsMsg42TestData.java
 *
 * $Id: SettlementInstructionsMsg42TestData.java,v 1.1 2011-03-26 03:24:29 vrotaru Exp $
 */
...
/**
 * Test utility for SettlementInstructionsMsg42 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class SettlementInstructionsMsg42TestData extends MsgTest {

    private static final SettlementInstructionsMsg42TestData INSTANCE;

    static {
        INSTANCE = new SettlementInstructionsMsg42TestData();
    }

    public static SettlementInstructionsMsg42TestData getInstance() {
        return INSTANCE;
    }
