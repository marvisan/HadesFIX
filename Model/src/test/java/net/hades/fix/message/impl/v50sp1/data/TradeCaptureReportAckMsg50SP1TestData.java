...
/*
 * TradeCaptureReportAckMsg50SP1TestData.java
 *
...
import net.hades.fix.message.group.impl.v50sp1.TrdCapRptAckSideGroup50SP1TestData;
...
/**
 * Test utility for TradeCaptureReportAckMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class TradeCaptureReportAckMsg50SP1TestData extends MsgTest {

    private static final TradeCaptureReportAckMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new TradeCaptureReportAckMsg50SP1TestData();
    }

    public static TradeCaptureReportAckMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(TradeCaptureReportAckMsg msg) throws UnsupportedEncodingException {
        ...
        msg.setNoSides(2);
        TrdCapRptAckSideGroup50SP1TestData.getInstance().populate1(msg.getTrdCapRptAckSideGroups()[0]);
        TrdCapRptAckSideGroup50SP1TestData.getInstance().populate2(msg.getTrdCapRptAckSideGroups()[1]);
    ...
    public void check(TradeCaptureReportAckMsg expected, TradeCaptureReportAckMsg actual) throws Exception {
        ...
        TrdCapRptAckSideGroup50SP1TestData.getInstance().check(expected.getTrdCapRptAckSideGroups()[0], actual.getTrdCapRptAckSideGroups()[0]);
        TrdCapRptAckSideGroup50SP1TestData.getInstance().check(expected.getTrdCapRptAckSideGroups()[1], actual.getTrdCapRptAckSideGroups()[1]);
