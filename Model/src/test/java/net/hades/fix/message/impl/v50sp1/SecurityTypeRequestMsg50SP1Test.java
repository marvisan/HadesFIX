...
/*
 * SecurityTypeRequestMsg50SP1Test.java
 *
 * $Id: SecurityTypeRequestMsg50SP1Test.java,v 1.1 2011-04-26 02:16:03 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 SecurityTypeRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SecurityTypeRequestMsg50SP1Test extends MsgTest  {

    public SecurityTypeRequestMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SecurityTypeRequestMsg) FIXMsgBuilder.build(MsgType.SecurityTypeRequest.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SecurityTypeRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
}
