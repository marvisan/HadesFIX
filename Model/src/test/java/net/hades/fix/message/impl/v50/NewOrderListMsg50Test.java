...
/*
 * NewOrderListMsg50Test.java
 *
 * $Id: NewOrderListMsg50Test.java,v 1.1 2011-02-02 10:03:16 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 NewOrderListMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class NewOrderListMsg50Test extends MsgTest  {

    public NewOrderListMsg50Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        dmsg.decode();
        NewOrderListMsg50TestData.getInstance().check(msg, dmsg, false);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (NewOrderListMsg) FIXMsgBuilder.build(MsgType.NewOrderList.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [NewOrderListMsg] message version [4.4].", ex.getMessage());
    }
}
