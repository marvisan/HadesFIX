...
/*
 * IOIMsg50SP1Test.java
 *
 * $Id: IOIMsg50SP1Test.java,v 1.4 2010-03-21 11:25:17 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v50sp1.data.IOIMsg50SP1TestData;
 ...
 * @created 02/03/2009, 7:38:11 PM
 */
public class IOIMsg50SP1Test extends MsgTest {

    public IOIMsg50SP1Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        IOIMsg msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
    ...
    public void a2_testEncodeDecodeAll() throws Exception {
        ...
        IOIMsg msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        IOIMsg50SP1TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        IOIMsg dmsg = (IOIMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        IOIMsg50SP1TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedTag() {
        ...
        IOIMsg msg = null;
        try {
            msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [IOIMsg] message version [5.0SP1].", ex.getMessage());
    }
}
