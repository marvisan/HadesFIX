...
/*
 * CollateralAssignmentMsg50SP1TestData.java
 *
 * $Id: CollateralAssignmentMsg50TestData.java,v 1.2 2011-10-29 09:42:17 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.UndInstrmtCollGroup50SP1TestData;
...
/**
 * Test utility for CollateralAssignmentMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 18/12/2011, 12:08:30 PM
 */
public class CollateralAssignmentMsg50SP1TestData extends MsgTest {

    private static final CollateralAssignmentMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new CollateralAssignmentMsg50SP1TestData();
    }

    public static CollateralAssignmentMsg50SP1TestData getInstance() {
        return INSTANCE;
    }

    public void populate(CollateralAssignmentMsg msg) throws UnsupportedEncodingException {
        TestUtils.populate50HeaderAll(msg);
        Calendar cal = Calendar.getInstance();
        
        msg.setCollAsgnID("COLL_ASGN_9999");
        ...
        msg.setCollAsgnRefID("ASGN_REF_0000");
        ...
        UndInstrmtCollGroup50SP1TestData.getInstance().populate1(msg.getUndInstrmtCollGroups()[0]);
        UndInstrmtCollGroup50SP1TestData.getInstance().populate2(msg.getUndInstrmtCollGroups()[1]);
    ...
    public void check(CollateralAssignmentMsg expected, CollateralAssignmentMsg actual) throws Exception {
        ...
        assertEquals(expected.getCollAsgnRefID(), actual.getCollAsgnRefID());
        ...
        UndInstrmtCollGroup50SP1TestData.getInstance().check(expected.getUndInstrmtCollGroups()[0], actual.getUndInstrmtCollGroups()[0]);
        UndInstrmtCollGroup50SP1TestData.getInstance().check(expected.getUndInstrmtCollGroups()[1], actual.getUndInstrmtCollGroups()[1]);
