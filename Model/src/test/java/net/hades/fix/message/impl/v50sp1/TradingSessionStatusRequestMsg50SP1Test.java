...
/*
 * TradingSessionStatusRequestMsg50SP1Test.java
 *
 * $Id: TradingSessionStatusRequestMsg50SP1Test.java,v 1.1 2011-04-22 01:59:22 vrotaru Exp $
 */
 ...
 */
public class TradingSessionStatusRequestMsg50SP1Test extends MsgTest  {

    public TradingSessionStatusRequestMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (TradingSessionStatusRequestMsg) FIXMsgBuilder.build(MsgType.TradingSessionStatusRequest.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [TradingSessionStatusRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
}
