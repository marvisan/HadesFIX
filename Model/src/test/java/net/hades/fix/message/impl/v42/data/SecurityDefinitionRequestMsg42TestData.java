...
/*
 * SecurityDefinitionRequestMsg42TestData.java
 *
 * $Id: SecurityDefinitionRequestMsg42TestData.java,v 1.2 2011-10-29 09:42:09 vrotaru Exp $
 */
...
/**
 * Test utility for SecurityDefinitionRequestMsg42 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class SecurityDefinitionRequestMsg42TestData extends MsgTest {

    private static final SecurityDefinitionRequestMsg42TestData INSTANCE;

    static {
        INSTANCE = new SecurityDefinitionRequestMsg42TestData();
    }

    public static SecurityDefinitionRequestMsg42TestData getInstance() {
        return INSTANCE;
    }
