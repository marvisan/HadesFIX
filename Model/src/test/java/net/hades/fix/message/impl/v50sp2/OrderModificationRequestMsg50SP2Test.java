...
/*
 * OrderModificationRequestMsg50SP2Test.java
 *
 * $Id: OrderModificationRequestMsg50SP2Test.java,v 1.1 2011-01-21 10:23:14 vrotaru Exp $
 */
 ...
 */
public class OrderModificationRequestMsg50SP2Test extends MsgTest  {

    public OrderModificationRequestMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderModificationRequestMsg) FIXMsgBuilder.build(MsgType.OrderModificationRequest.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderModificationRequestMsg] message version [5.0SP2].", ex.getMessage());
    }
}
