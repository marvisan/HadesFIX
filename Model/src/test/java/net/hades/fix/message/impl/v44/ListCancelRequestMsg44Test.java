...
/*
 * ListCancelRequestMsg44Test.java
 *
 * $Id: ListCancelRequestMsg44Test.java,v 1.1 2011-02-06 01:06:13 vrotaru Exp $
 */
 ...
 */
public class ListCancelRequestMsg44Test extends MsgTest {

    public ListCancelRequestMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListCancelRequestMsg) FIXMsgBuilder.build(MsgType.ListCancelRequest.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListCancelRequestMsg] message version [4.4].", ex.getMessage());
    }
