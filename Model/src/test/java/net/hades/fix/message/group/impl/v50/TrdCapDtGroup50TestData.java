...
/*
 * TrdCapDtGroup50TestData.java
 *
 * $Id: TrdCapDtGroup50TestData.java,v 1.1 2011-10-08 08:43:04 vrotaru Exp $
 */
...
/**
 * Test utility for TrdCapDtGroup group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 31/03/2009, 9:12:46 AM
 */
public class TrdCapDtGroup50TestData extends MsgTest {

    private static final TrdCapDtGroup50TestData INSTANCE;

    static {
        INSTANCE = new TrdCapDtGroup50TestData();
    }

    public static TrdCapDtGroup50TestData getInstance() {
        return INSTANCE;
    }
