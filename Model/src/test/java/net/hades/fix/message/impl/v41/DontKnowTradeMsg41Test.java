...
/*
 * DontKnowTradeMsg41Test.java
 *
 * $Id: DontKnowTradeMsg41Test.java,v 1.1 2011-01-16 00:47:41 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v41.data.DontKnowTradeMsg41TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.1 DontKnowTradeMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class DontKnowTradeMsg41Test extends MsgTest  {

    public DontKnowTradeMsg41Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        DontKnowTradeMsg msg = (DontKnowTradeMsg) FIXMsgBuilder.build(MsgType.DontKnowTrade.getValue(), BeginString.FIX_4_1);
        DontKnowTradeMsg41TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        DontKnowTradeMsg dmsg = (DontKnowTradeMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        DontKnowTradeMsg41TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (DontKnowTradeMsg) FIXMsgBuilder.build(MsgType.DontKnowTrade.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [DontKnowTradeMsg] message version [4.1].", ex.getMessage());
    }
}
