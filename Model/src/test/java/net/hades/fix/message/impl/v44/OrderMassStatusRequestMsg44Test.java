...
/*
 * OrderMassStatusRequestMsg44Test.java
 *
 * $Id: OrderMassStatusRequestMsg44Test.java,v 1.1 2011-05-09 08:21:13 vrotaru Exp $
 */
 ...
 */
public class OrderMassStatusRequestMsg44Test extends MsgTest {

    public OrderMassStatusRequestMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderMassStatusRequestMsg) FIXMsgBuilder.build(MsgType.OrderMassStatusRequest.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderMassStatusRequestMsg] message version [4.4].", ex.getMessage());
    }
}
