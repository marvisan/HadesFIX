...
/*
 * SettlementInstructionRequestMsgFIXML50Test.java
 *
...
/**
 * Test suite for SettlementInstructionRequestMsg50 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class SettlementInstructionRequestMsgFIXML50Test extends MsgTest {

    public SettlementInstructionRequestMsgFIXML50Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            SettlementInstructionRequestMsg msg = (SettlementInstructionRequestMsg) FIXMsgBuilder.build(MsgType.SettlementInstructionRequest.getValue(), BeginString.FIX_5_0);
            ...
            SettlementInstructionRequestMsg dmsg = (SettlementInstructionRequestMsg) FIXMsgBuilder.build(MsgType.SettlementInstructionRequest.getValue(), BeginString.FIX_5_0);
