...
/*
 * NewsMsg44TestData.java
 *
 * $Id: NewsMsg44TestData.java,v 1.1 2009-07-06 03:19:08 vrotaru Exp $
 */
...
/**
 * Test utility for NewsMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 11:34:14 AM
 */
public class NewsMsg44TestData extends MsgTest {

    private static final NewsMsg44TestData INSTANCE;

    static {
        INSTANCE = new NewsMsg44TestData();
    }

    public static NewsMsg44TestData getInstance() {
        return INSTANCE;
    }

    public void populate(quickfix.fix44.News msg) throws Exception {
        ...
        // RoutingIDGroup
        quickfix.fix44.News.NoRoutingIDs grpr1 = new quickfix.fix44.News.NoRoutingIDs();
        ...
        msg.addGroup(grpr1);
        quickfix.fix44.News.NoRoutingIDs grpr2 = new quickfix.fix44.News.NoRoutingIDs();
        ...
        msg.addGroup(grpr2);
        // Instrument
        quickfix.fix44.News.NoRelatedSym grps1 = new quickfix.fix44.News.NoRelatedSym();
        ...
        grps1.set(instr1);
        msg.addGroup(grps1);
        quickfix.fix44.News.NoRelatedSym grps2 = new quickfix.fix44.News.NoRelatedSym();
        ...
        msg.addGroup(grps2);
        // InstrumentLeg
        quickfix.fix44.News.NoLegs grpi1 = new quickfix.fix44.News.NoLegs();
        ...
        grpi1.set(instrleg1);
        msg.addGroup(grpi1);
        quickfix.fix44.News.NoLegs grpi2 = new quickfix.fix44.News.NoLegs();
        ...
        quickfix.fix44.News.NoUnderlyings grpu1 = new quickfix.fix44.News.NoUnderlyings();
        ...
        msg.addGroup(grpu1);
        quickfix.fix44.News.NoUnderlyings grpu2 = new quickfix.fix44.News.NoUnderlyings();
    ...
    public void check(quickfix.fix44.News expected, NewsMsg actual) throws Exception {
    ...
    public void check(NewsMsg expected, quickfix.fix44.News actual) throws Exception {
