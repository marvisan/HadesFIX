...
/*
 * AllocationInstructionMsgFIXML44Test.java
 *
 * $Id: AllocationInstructionMsgFIXML44Test.java,v 1.1 2011-02-16 11:24:36 vrotaru Exp $
 */
...
/**
 * Test suite for AllocationInstructionMsg44 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class AllocationInstructionMsgFIXML44Test extends MsgTest {

    public AllocationInstructionMsgFIXML44Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ...
            AllocationInstructionMsg dmsg = (AllocationInstructionMsg) FIXMsgBuilder.build(MsgType.Allocation.getValue(), BeginString.FIX_4_4);
