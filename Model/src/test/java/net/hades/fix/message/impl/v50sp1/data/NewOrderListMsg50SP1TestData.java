...
/*
 * NewOrderListMsg50SP1TestData.java
 *
 * $Id: NewOrderListMsg50SP1TestData.java,v 1.2 2011-10-29 09:42:13 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.OrderListGroup50SP1TestData;
...
/**
 * Test utility for NewOrderListMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class NewOrderListMsg50SP1TestData extends MsgTest {

    private static final NewOrderListMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new NewOrderListMsg50SP1TestData();
    }

    public static NewOrderListMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(NewOrderListMsg msg) throws UnsupportedEncodingException {
        ...
        msg.setNoOrders(2);
        OrderListGroup50SP1TestData.getInstance().populate1(msg.getOrderListGroups()[0]);
        OrderListGroup50SP1TestData.getInstance().populate2(msg.getOrderListGroups()[1]);
    }
    ...
    public void check(NewOrderListMsg expected, NewOrderListMsg actual, boolean fixml) throws Exception {
        ...
        OrderListGroup50SP1TestData.getInstance().check(expected.getOrderListGroups()[0], actual.getOrderListGroups()[0], fixml);
        OrderListGroup50SP1TestData.getInstance().check(expected.getOrderListGroups()[1], actual.getOrderListGroups()[1], fixml);
     }
}
