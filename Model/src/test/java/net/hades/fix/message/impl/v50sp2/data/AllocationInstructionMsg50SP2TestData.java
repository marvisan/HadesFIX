...
/*
 * AllocationInstructionMsg50SP2TestData.java
 *
 * $Id: AllocationInstructionMsg50SP2TestData.java,v 1.2 2011-10-29 09:42:21 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.AllocGroup50SP2TestData;
...
/**
 * Test utility for AllocationInstructionMsg50SP2 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class AllocationInstructionMsg50SP2TestData extends MsgTest {

    private static final AllocationInstructionMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new AllocationInstructionMsg50SP2TestData();
    }

    public static AllocationInstructionMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(AllocationInstructionMsg msg) throws UnsupportedEncodingException {
        ...
        msg.setNoAllocs(2);
        AllocGroup50SP2TestData.getInstance().populate1(msg.getAllocGroups()[0]);
        AllocGroup50SP2TestData.getInstance().populate2(msg.getAllocGroups()[1]);

        msg.setAvgPxIndicator(AvgPxIndicator.NoAveragePricing);
        cal.set(2010, 3, 11, 33, 44, 12);
    ...
    public void check(AllocationInstructionMsg expected, AllocationInstructionMsg actual) throws Exception {
        ...
        AllocGroup50SP2TestData.getInstance().check(expected.getAllocGroups()[0], actual.getAllocGroups()[0]);
        AllocGroup50SP2TestData.getInstance().check(expected.getAllocGroups()[1], actual.getAllocGroups()[1]);
