...
/*
 * MarketDataSnapshotMsg50SP1Test.java
 *
 * $Id: MarketDataSnapshotMsg50SP1Test.java,v 1.3 2010-03-21 11:25:16 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 MarketDataSnapshotMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class MarketDataSnapshotMsg50SP1Test extends MsgTest  {

    public MarketDataSnapshotMsg50SP1Test() {
    }
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MarketDataSnapshotMsg] message version [5.0SP1].", ex.getMessage());
    }
}
