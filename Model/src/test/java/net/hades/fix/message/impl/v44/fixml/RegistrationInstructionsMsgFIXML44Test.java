...
/*
 * RegistrationInstructionsMsgFIXML44Test.java
 *
 * $Id: RegistrationInstructionsMsgFIXML44Test.java,v 1.1 2011-10-29 01:31:22 vrotaru Exp $
 */
...
/**
 * Test suite for RegistrationInstructionsMsg44 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class RegistrationInstructionsMsgFIXML44Test extends MsgTest {

    public RegistrationInstructionsMsgFIXML44Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ...
            RegistrationInstructionsMsg dmsg = (RegistrationInstructionsMsg) FIXMsgBuilder.build(MsgType.RegistrationInstructions.getValue(), BeginString.FIX_4_4);
