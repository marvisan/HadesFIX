 ...
 * IOIMsg43Test.java
 *
 * $Id: IOIMsg43Test.java,v 1.4 2010-03-21 11:25:17 vrotaru Exp $
 */
package net.hades.fix.message.impl.v43;


import net.hades.fix.message.impl.v43.data.IOIMsg43TestData;
...
/**
 * Test suite for FIX 4.3 IOIMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 02/03/2009, 7:38:11 PM
 */
public class IOIMsg43Test extends MsgTest {
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        IOIMsg msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIX_4_3);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF43DataDictionary();
        IOIMsg msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIX_4_3);
        IOIMsg43TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix43.IndicationOfInterest qfMsg = new quickfix.fix43.IndicationOfInterest();
        qfMsg.fromString(encoded, dictionary, true);
        IOIMsg43TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF43DataDictionary();
        quickfix.fix43.IndicationOfInterest msg = new quickfix.fix43.IndicationOfInterest();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        IOIMsg dmsg = (IOIMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        IOIMsg43TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedTag() {
        ...
        IOIMsg msg = null;
        try {
            msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [IOIMsg] message version [4.3].", ex.getMessage());
    }
}
