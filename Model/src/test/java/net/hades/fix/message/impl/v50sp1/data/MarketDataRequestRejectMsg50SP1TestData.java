 ...
 *
 * $Id: MarketDataRequestRejectMsg50SP1TestData.java,v 1.1 2010-02-03 11:15:21 vrotaru Exp $
 */
 ...
 */
public class MarketDataRequestRejectMsg50SP1TestData extends MsgTest {

    private static final MarketDataRequestRejectMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new MarketDataRequestRejectMsg50SP1TestData();
    }

    public static MarketDataRequestRejectMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
