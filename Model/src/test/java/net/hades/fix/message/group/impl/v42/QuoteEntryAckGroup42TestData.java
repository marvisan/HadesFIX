 ...
 *
 * $Id: QuoteEntryAckGroup42TestData.java,v 1.1 2009-07-22 10:38:12 vrotaru Exp $
 */
 ...
 */
public class QuoteEntryAckGroup42TestData extends MsgTest {

    private static final QuoteEntryAckGroup42TestData INSTANCE;

    static {
        INSTANCE = new QuoteEntryAckGroup42TestData();
    }

    public static QuoteEntryAckGroup42TestData getInstance() {
        return INSTANCE;
    }

    public void populate1(quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries msg) throws Exception {
    ...
    public void populate2(quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries msg) throws Exception {
    ...
    public void check(QuoteEntryAckGroup expected, quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries actual) throws Exception {
    ...
    public void check(quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries expected, QuoteEntryAckGroup actual) throws Exception {
