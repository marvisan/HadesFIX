...
/*
 * QuoteRequestMsg50TestData.java
 *
 * $Id: QuoteRequestMsg50TestData.java,v 1.2 2010-12-12 09:13:10 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteRequestMsg50 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 11:57:03 AM
 */
public class QuoteRequestMsg50TestData extends MsgTest {

    private static final QuoteRequestMsg50TestData INSTANCE;

    static {
        INSTANCE = new QuoteRequestMsg50TestData();
    }

    public static QuoteRequestMsg50TestData getInstance() {
        return INSTANCE;
    }

    public void populate(quickfix.fix50.QuoteRequest msg) throws Exception {
        ...
        quickfix.fix50.QuoteRequest.NoRelatedSym grprelsym2 = new quickfix.fix50.QuoteRequest.NoRelatedSym();
        QuoteRequestGroup50TestData.getInstance().populate2(grprelsym2);
    ...
    public void populate(QuoteRequestMsg msg) throws UnsupportedEncodingException {
        ...
        QuoteRequestGroup50TestData.getInstance().populate2(msg.getQuoteRelatedSymbols()[1]);
    ...
    public void check(quickfix.fix50.QuoteRequest expected, QuoteRequestMsg actual) throws Exception {
        ...
        QuoteRequestGroup50TestData.getInstance().check(grprelsym1, actual.getQuoteRelatedSymbols()[0]);
        quickfix.fix50.QuoteRequest.NoRelatedSym grprelsym2 = new quickfix.fix50.QuoteRequest.NoRelatedSym();
        expected.getGroup(2, grprelsym2);
        QuoteRequestGroup50TestData.getInstance().check(grprelsym2, actual.getQuoteRelatedSymbols()[1]);
    ...
    public void check(QuoteRequestMsg expected, quickfix.fix50.QuoteRequest actual) throws Exception {
        ...
        QuoteRequestGroup50TestData.getInstance().check(expected.getQuoteRelatedSymbols()[0], grprelsym1);
        quickfix.fix50.QuoteRequest.NoRelatedSym grprelsym2 = new quickfix.fix50.QuoteRequest.NoRelatedSym();
        actual.getGroup(2, grprelsym2);
        QuoteRequestGroup50TestData.getInstance().check(expected.getQuoteRelatedSymbols()[1], grprelsym2);
    ...
    public void check(QuoteRequestMsg expected, QuoteRequestMsg actual) throws Exception {
        ...
        QuoteRequestGroup50TestData.getInstance().check(expected.getQuoteRelatedSymbols()[0], actual.getQuoteRelatedSymbols()[0]);
        QuoteRequestGroup50TestData.getInstance().check(expected.getQuoteRelatedSymbols()[1], actual.getQuoteRelatedSymbols()[1]);
