...
/*
 * ListStatusRequestMsg44Test.java
 *
 * $Id: ListStatusRequestMsg44Test.java,v 1.1 2011-02-06 01:06:13 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 ListStatusRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ListStatusRequestMsg44Test extends MsgTest {

    public ListStatusRequestMsg44Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListStatusRequestMsg msg = (ListStatusRequestMsg) FIXMsgBuilder.build(MsgType.ListStatusRequest.getValue(), BeginString.FIX_4_4);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListStatusRequestMsg) FIXMsgBuilder.build(MsgType.ListStatusRequest.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListStatusRequestMsg] message version [4.4].", ex.getMessage());
    }
