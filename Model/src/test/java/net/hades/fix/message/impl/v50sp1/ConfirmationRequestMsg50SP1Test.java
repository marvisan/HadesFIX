...
/*
 * ConfirmationRequestMsg50SP1Test.java
 *
...
/**
 * Test suite for FIX 5.0SP1 ConfirmationRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ConfirmationRequestMsg50SP1Test extends MsgTest  {

    public ConfirmationRequestMsg50SP1Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ConfirmationRequestMsg msg = (ConfirmationRequestMsg) FIXMsgBuilder.build(MsgType.ConfirmationRequest.getValue(), BeginString.FIX_5_0SP1);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ConfirmationRequestMsg) FIXMsgBuilder.build(MsgType.ConfirmationRequest.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ConfirmationRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
}
