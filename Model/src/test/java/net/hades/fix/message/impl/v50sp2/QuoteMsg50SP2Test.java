...
/*
 * QuoteMsg50SP2Test.java
 *
 * $Id: QuoteMsg50SP2Test.java,v 1.5 2011-01-15 02:10:10 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP2 QuoteMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.5 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class QuoteMsg50SP2Test extends MsgTest  {

    public QuoteMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        QuoteMsg msg = null;
        try {
            msg = (QuoteMsg) FIXMsgBuilder.build(MsgType.Quote.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteMsg] message version [5.0SP2].", ex.getMessage());
    }}
