 ...
 */
public class ConfirmationMsg50Test extends MsgTest  {

    public ConfirmationMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ConfirmationMsg) FIXMsgBuilder.build(MsgType.Confirmation.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
