...
/*
 * SettlementInstructionsMsg44Test.java
 *
 * $Id: SettlementInstructionsMsg44Test.java,v 1.1 2011-03-26 03:24:27 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v44.data.SettlementInstructionsMsg44TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.4 SettlementInstructionsMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SettlementInstructionsMsg44Test extends MsgTest  {

    public SettlementInstructionsMsg44Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        SettlementInstructionsMsg msg = (SettlementInstructionsMsg) FIXMsgBuilder.build(MsgType.SettlInstructions.getValue(), BeginString.FIX_4_4);
        SettlementInstructionsMsg44TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        SettlementInstructionsMsg44TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SettlementInstructionsMsg) FIXMsgBuilder.build(MsgType.SettlInstructions.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SettlementInstructionsMsg] message version [4.4].", ex.getMessage());
    }
}
