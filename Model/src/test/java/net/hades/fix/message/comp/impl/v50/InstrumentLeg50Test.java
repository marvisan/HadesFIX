...
/*
 * InstrumentLeg50Test.java
 *
 * $Id: InstrumentLeg50Test.java,v 1.2 2009-11-21 09:57:27 vrotaru Exp $
 */
...
/**
 * Test suite for InstrumentLeg50 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 08/01/2009, 9:03:14 PM
 */
public class InstrumentLeg50Test {

    public InstrumentLeg50Test() {
    }
    ...
    public void testSetNoLegSecurityAltID() {
        InstrumentLeg comp = new InstrumentLeg50();
    ...
    private void checkUnsupportedInstrumentLegException(Exception ex) {
        assertEquals("This tag is not supported in [InstrumentLeg] component version [5.0].", ex.getMessage());
    }
