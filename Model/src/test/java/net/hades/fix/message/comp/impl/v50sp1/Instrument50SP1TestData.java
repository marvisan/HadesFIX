 ...
 *
 * $Id: Instrument50SP1TestData.java,v 1.4 2011-10-29 09:42:12 vrotaru Exp $
 */
...
import net.hades.fix.message.comp.impl.v50.InstrumentParties50TestData;
 ...
 */
public class Instrument50SP1TestData extends MsgTest {

    private static final Instrument50SP1TestData INSTANCE;

    static {
        INSTANCE = new Instrument50SP1TestData();
    }

    public static Instrument50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(Instrument comp) {
        ...
        // InstrumentParties
        InstrumentParties50TestData.getInstance().populate(comp.getInstrumentParties());
    }
...
//        assertTimeEquals(expected.getMaturityTime(), actual.getMaturityTime(), false);
