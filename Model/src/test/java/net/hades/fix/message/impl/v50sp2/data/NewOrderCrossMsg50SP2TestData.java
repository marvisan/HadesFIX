...
/*
 * NewOrderCrossMsg50SP2TestData.java
 *
 * $Id: NewOrderCrossMsg50SP2TestData.java,v 1.2 2011-10-29 09:42:20 vrotaru Exp $
 */
 ...
 */
public class NewOrderCrossMsg50SP2TestData extends MsgTest {

    private static final NewOrderCrossMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new NewOrderCrossMsg50SP2TestData();
    }

    public static NewOrderCrossMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(NewOrderCrossMsg msg) throws UnsupportedEncodingException {
        ...
        SideCrossOrdModGroup50SP2TestData.getInstance().populate2(msg.getSideCrossOrdModGroups()[1]);
    ...
    public void check(NewOrderCrossMsg expected, NewOrderCrossMsg actual) throws Exception {
        ...
        SideCrossOrdModGroup50SP2TestData.getInstance().check(expected.getSideCrossOrdModGroups()[0], actual.getSideCrossOrdModGroups()[0]);
        SideCrossOrdModGroup50SP2TestData.getInstance().check(expected.getSideCrossOrdModGroups()[1], actual.getSideCrossOrdModGroups()[1]);
