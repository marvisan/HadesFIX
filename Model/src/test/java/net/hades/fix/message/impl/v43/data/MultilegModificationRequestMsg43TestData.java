...
/*
 * MultilegModificationRequestMsg43TestData.java
 *
 * $Id: MultilegModificationRequestMsg43TestData.java,v 1.2 2011-10-29 09:42:28 vrotaru Exp $
 */
 ...
 */
public class MultilegModificationRequestMsg43TestData extends MsgTest {

    private static final MultilegModificationRequestMsg43TestData INSTANCE;

    static {
        INSTANCE = new MultilegModificationRequestMsg43TestData();
    }

    public static MultilegModificationRequestMsg43TestData getInstance() {
        return INSTANCE;
    }
