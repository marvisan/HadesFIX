...
/*
 * PosUndInstrmtGroup50SP2TestData.java
 *
...
/**
 * Test utility for PosUndInstrmtGroup50SP2 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 13/12/2011, 10:08:38 AM
 */
public class PosUndInstrmtGroup50SP2TestData extends MsgTest {

    private static final PosUndInstrmtGroup50SP2TestData INSTANCE;

    static {
        INSTANCE = new PosUndInstrmtGroup50SP2TestData();
    }

    public static PosUndInstrmtGroup50SP2TestData getInstance() {
        return INSTANCE;
    }
