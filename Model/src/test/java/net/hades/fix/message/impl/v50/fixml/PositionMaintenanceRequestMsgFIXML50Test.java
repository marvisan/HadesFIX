...
/*
 * PositionMaintenanceRequestMsgFIXML50Test.java
 *
...
import net.hades.fix.message.impl.v50.data.PositionMaintenanceRequestMsg50TestData;
 ...
 */
public class PositionMaintenanceRequestMsgFIXML50Test extends MsgTest {

    public PositionMaintenanceRequestMsgFIXML50Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            PositionMaintenanceRequestMsg msg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0);
            ...
            PositionMaintenanceRequestMsg dmsg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0);
    ...
    public void testMarshallUnmarshallFixml() throws Exception {
        ...
        try {
            PositionMaintenanceRequestMsg msg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0);
            PositionMaintenanceRequestMsg50TestData.getInstance().populate(msg);
            String fixml = msg.toFixml();
            System.out.println("fixml-->" + fixml);
            XMLValidationResult result = validateXMLAgainstXSD(fixml, FIXML_SCHEMA_V50);
            if (result.hasErrors()) {
            ...
            PositionMaintenanceRequestMsg dmsg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0);
            dmsg.fromFixml(fixml);
            PositionMaintenanceRequestMsg50TestData.getInstance().check(msg, dmsg);
        } finally {
            unsetPrintableFixml();
        }
    }
