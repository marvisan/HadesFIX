...
/*
 * ListCancelRequestMsg50SP2Test.java
 *
 * $Id: ListCancelRequestMsg50SP2Test.java,v 1.1 2011-02-06 01:06:13 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP2 ListCancelRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ListCancelRequestMsg50SP2Test extends MsgTest {

    public ListCancelRequestMsg50SP2Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListCancelRequestMsg msg = (ListCancelRequestMsg) FIXMsgBuilder.build(MsgType.ListCancelRequest.getValue(), BeginString.FIX_5_0SP2);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListCancelRequestMsg) FIXMsgBuilder.build(MsgType.ListCancelRequest.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
