...
/*
 * QuoteSetGroup44Test.java
 *
 * $Id: QuoteSetGroup44Test.java,v 1.2 2009-11-21 09:57:24 vrotaru Exp $
 */
...
/**
 * Test suite for QuoteSetGroup44 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/04/2009, 11:30:15 AM
 */
public class QuoteSetGroup44Test {


    public QuoteSetGroup44Test() {
    }
    ...
    public void testQuoteEntries() {
        QuoteSetGroup group = new QuoteSetGroup44();
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteSetGroup] group version [4.4].", ex.getMessage());
    }
}
