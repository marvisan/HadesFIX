...
/*
 * UndInstrmtCollGroup50TestData.java
 *
 * $Id: UndInstrmtCollGroup50TestData.java,v 1.2 2011-10-29 09:42:10 vrotaru Exp $
 */
...
/**
 * Test utility for UndInstrmtCollGroup50 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 17/12/2011, 10:08:38 AM
 */
public class UndInstrmtCollGroup50TestData extends MsgTest {

    private static final UndInstrmtCollGroup50TestData INSTANCE;

    static {
        INSTANCE = new UndInstrmtCollGroup50TestData();
    }

    public static UndInstrmtCollGroup50TestData getInstance() {
        return INSTANCE;
    }

    public void populate1(UndInstrmtCollGroup grp) throws UnsupportedEncodingException {
        grp.setUnderlyingInstrument();
        UnderlyingInstrument50TestData.getInstance().populate1(grp.getUnderlyingInstrument());
