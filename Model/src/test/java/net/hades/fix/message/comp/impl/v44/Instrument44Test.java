...
/*
 * Instrument44Test.java
 *
 * $Id: Instrument44Test.java,v 1.2 2009-11-21 09:57:29 vrotaru Exp $
 */
...
/**
 * Test suite for Instrument44 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 08/01/2009, 20:57:03
 */
public class Instrument44Test {

    public Instrument44Test() {
    }
    ...
    public void testSetNoSecurityAltID() {
        Instrument comp = new Instrument44();
    ...
    public void testGetUnsupportedInstrumentTag() {
        ...
        Instrument instrument = new Instrument44();
        try {
    ...
    private void checkUnsupportedInstrumentException(Exception ex) {
        assertEquals("This tag is not supported in [Instrument] component version [4.4].", ex.getMessage());
    }
