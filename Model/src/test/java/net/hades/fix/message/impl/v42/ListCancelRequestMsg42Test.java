...
/*
 * ListCancelRequestMsg42Test.java
 *
 * $Id: ListCancelRequestMsg42Test.java,v 1.1 2011-02-06 01:06:14 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.2 ListCancelRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ListCancelRequestMsg42Test extends MsgTest {

    public ListCancelRequestMsg42Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListCancelRequestMsg msg = (ListCancelRequestMsg) FIXMsgBuilder.build(MsgType.ListCancelRequest.getValue(), BeginString.FIX_4_2);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListCancelRequestMsg) FIXMsgBuilder.build(MsgType.ListCancelRequest.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListCancelRequestMsg] message version [4.2].", ex.getMessage());
    }
