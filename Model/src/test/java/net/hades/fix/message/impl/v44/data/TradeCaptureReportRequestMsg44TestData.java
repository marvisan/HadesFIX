...
/*
 * TradeCaptureReportRequestMsg44TestData.java
 *
 * $Id: TradeCaptureReportRequestMsg44TestData.java,v 1.1 2011-10-08 08:43:04 vrotaru Exp $
 */
...
/**
 * Test utility for TradeCaptureReportRequestMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class TradeCaptureReportRequestMsg44TestData extends MsgTest {

    private static final TradeCaptureReportRequestMsg44TestData INSTANCE;

    static {
        INSTANCE = new TradeCaptureReportRequestMsg44TestData();
    }

    public static TradeCaptureReportRequestMsg44TestData getInstance() {
        return INSTANCE;
    }
