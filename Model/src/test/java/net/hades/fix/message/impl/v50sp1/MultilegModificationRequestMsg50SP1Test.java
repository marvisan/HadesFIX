...
/*
 * MultilegModificationRequestMsg50SP1Test.java
 *
 * $Id: MultilegModificationRequestMsg50SP1Test.java,v 1.1 2011-09-10 05:41:13 vrotaru Exp $
 */
 ...
 */
public class MultilegModificationRequestMsg50SP1Test extends MsgTest  {

    public MultilegModificationRequestMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (MultilegModificationRequestMsg) FIXMsgBuilder.build(MsgType.MultilegModificationRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
        } catch (Exception ex) {
    ...
    public void testEncodeMissingRequired() {
        ...
        try {
            MultilegModificationRequestMsg msg = (MultilegModificationRequestMsg) FIXMsgBuilder.build(MsgType.MultilegModificationRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50SP1);
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MultilegModificationRequestMsg] message version [5.0].", ex.getMessage());
    }
}
