 ...
 *
 * $Id: MDIncGroup42Test.java,v 1.1 2009-12-15 09:59:23 vrotaru Exp $
 */
...
/**
 * Test suite for MDIncGroup42 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/04/2009, 11:30:15 AM
 */
public class MDIncGroup42Test {


    public MDIncGroup42Test() {
    }
    ...
    public void testGetUnsupportedTag() {
        ...
        MDIncGroup group = new MDIncGroup42();
        try {
            group.getInstrument();
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MDIncGroup] group version [4.2].", ex.getMessage());
    }
}
