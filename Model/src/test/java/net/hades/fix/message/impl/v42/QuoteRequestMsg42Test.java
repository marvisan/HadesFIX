...
/*
 * QuoteRequestMsg42Test.java
 *
 * $Id: QuoteRequestMsg42Test.java,v 1.4 2010-03-21 11:25:18 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.QuoteRequestMsg42TestData;
...
/**
 * Test suite for FIX 4.2 QuoteRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 09/04/2009, 3:12:30 PM
 */
public class QuoteRequestMsg42Test extends MsgTest {

    private DataDictionary dictionary;

    public QuoteRequestMsg42Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        QuoteRequestMsg msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_2);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        QuoteRequestMsg msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_2);
        QuoteRequestMsg42TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix42.QuoteRequest qfMsg = new quickfix.fix42.QuoteRequest();
        qfMsg.fromString(encoded, dictionary, true);
//        QuoteRequestMsg42TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        QuoteRelatedSymbolGroup42TestData.getInstance().check(grprelsym1, dmsg.getQuoteRelatedSymbols()[0]);
    }
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        QuoteRequestMsg dmsg = (QuoteRequestMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        QuoteRequestMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testSetNoRelatedSym() throws Exception {
        QuoteRequestMsg comp = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_2);
    ...
    public void testAddQuoteRelatedSymbolGroup() throws Exception {
        ...
        assertEquals(3, comp.getQuoteRelatedSymbols().length);
        comp.getQuoteRelatedSymbols()[2].setSymbol("SYM 2");
        int i = 0;
        for (QuoteRequestGroup group : comp.getQuoteRelatedSymbols()) {
            assertEquals("SYM " + i, group.getSymbol());
            i++;
    ...
    public void testDeleteQuoteRelatedSymbolGroup() throws Exception {
        ...
        assertEquals("SYM 2", comp.getQuoteRelatedSymbols()[1].getSymbol());
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteRequestMsg] message version [4.2].", ex.getMessage());
    }
}
