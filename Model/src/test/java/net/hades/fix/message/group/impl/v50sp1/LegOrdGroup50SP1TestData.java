...
/*
 * LegOrdGroup50SP1TestData.java
 *
 * $Id: LegOrdGroup50SP1TestData.java,v 1.2 2011-10-29 09:42:25 vrotaru Exp $
 */
 ...
 */
public class LegOrdGroup50SP1TestData extends MsgTest {

    private static final LegOrdGroup50SP1TestData INSTANCE;

    static {
        INSTANCE = new LegOrdGroup50SP1TestData();
    }

    public static LegOrdGroup50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate1(LegOrdGroup group) throws UnsupportedEncodingException {
        ...
        InstrumentLeg50SP1TestData.getInstance().populate1(group.getInstrumentLeg());
    ...
    public void populate2(LegOrdGroup group) throws UnsupportedEncodingException {
        ...
        group.setInstrumentLeg();
        InstrumentLeg50SP1TestData.getInstance().populate2(group.getInstrumentLeg());
