...
/*
 * CollateralInquiryMsg44TestData.java
 *
...
/**
 * Test utility for CollateralInquiryMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 18/12/2011, 12:08:30 PM
 */
public class CollateralInquiryMsg44TestData extends MsgTest {

    private static final CollateralInquiryMsg44TestData INSTANCE;

    static {
        INSTANCE = new CollateralInquiryMsg44TestData();
    }

    public static CollateralInquiryMsg44TestData getInstance() {
        return INSTANCE;
    }
