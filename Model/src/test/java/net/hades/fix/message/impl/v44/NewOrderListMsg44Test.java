...
/*
 * NewOrderListMsg44Test.java
 *
 * $Id: NewOrderListMsg44Test.java,v 1.1 2011-02-02 10:03:15 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 NewOrderListMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class NewOrderListMsg44Test extends MsgTest  {

    public NewOrderListMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (NewOrderListMsg) FIXMsgBuilder.build(MsgType.NewOrderList.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
