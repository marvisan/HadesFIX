...
/*
 * DerivSecListGroup43TestData.java
 *
 * $Id: DerivSecListGroup43TestData.java,v 1.2 2011-10-29 09:42:15 vrotaru Exp $
 */
 ...
 */
public class DerivSecListGroup43TestData extends MsgTest {

    private static final DerivSecListGroup43TestData INSTANCE;

    static {
        INSTANCE = new DerivSecListGroup43TestData();
    }

    public static DerivSecListGroup43TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate1(DerivSecListGroup grp) throws UnsupportedEncodingException {
        ...
        grp.setNoLegs(2);
        InstrmtLegDerivSecListGroup43TestData.getInstance().populate1(grp.getInstrmtLegDerivSecListGroups()[0]);
        InstrmtLegDerivSecListGroup43TestData.getInstance().populate2(grp.getInstrmtLegDerivSecListGroups()[1]);
    ...
    public void check(DerivSecListGroup expected, DerivSecListGroup actual) throws Exception {
        ...
        InstrmtLegDerivSecListGroup43TestData.getInstance().check(expected.getInstrmtLegDerivSecListGroups()[0], actual.getInstrmtLegDerivSecListGroups()[0]);
        InstrmtLegDerivSecListGroup43TestData.getInstance().check(expected.getInstrmtLegDerivSecListGroups()[1], actual.getInstrmtLegDerivSecListGroups()[1]);
