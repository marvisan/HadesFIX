...
/*
 * OrderCancelRejectMsg50SP2Test.java
 *
 * $Id: OrderCancelRejectMsg50SP2Test.java,v 1.1 2011-01-23 10:02:05 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP2 OrderCancelRejectMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class OrderCancelRejectMsg50SP2Test extends MsgTest  {

    public OrderCancelRejectMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderCancelRejectMsg) FIXMsgBuilder.build(MsgType.OrderCancelReject.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderCancelRejectMsg] message version [5.0SP2].", ex.getMessage());
    }
}
