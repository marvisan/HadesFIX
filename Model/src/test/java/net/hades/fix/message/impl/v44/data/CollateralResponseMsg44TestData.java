...
/*
 * CollateralResponseMsg44TestData.java
 *
...
/**
 * Test utility for CollateralResponseMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 19/12/2011, 12:08:30 PM
 */
public class CollateralResponseMsg44TestData extends MsgTest {

    private static final CollateralResponseMsg44TestData INSTANCE;

    static {
        INSTANCE = new CollateralResponseMsg44TestData();
    }

    public static CollateralResponseMsg44TestData getInstance() {
        return INSTANCE;
    }
