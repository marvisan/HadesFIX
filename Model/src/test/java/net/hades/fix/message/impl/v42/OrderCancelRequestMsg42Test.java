...
/*
 * OrderCancelRequestMsg42Test.java
 *
 * $Id: OrderCancelRequestMsg42Test.java,v 1.1 2011-01-22 09:52:25 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.OrderCancelRequestMsg42TestData;
 ...
 */
public class OrderCancelRequestMsg42Test extends MsgTest  {

    public OrderCancelRequestMsg42Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        OrderCancelRequestMsg msg = (OrderCancelRequestMsg) FIXMsgBuilder.build(MsgType.OrderCancelRequest.getValue(), BeginString.FIX_4_2);
        OrderCancelRequestMsg42TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        OrderCancelRequestMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderCancelRequestMsg) FIXMsgBuilder.build(MsgType.OrderCancelRequest.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderCancelRequestMsg] message version [4.2].", ex.getMessage());
    }
}
