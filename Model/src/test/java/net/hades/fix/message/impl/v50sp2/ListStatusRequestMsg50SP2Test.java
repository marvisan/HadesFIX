...
/*
 * ListStatusRequestMsg50SP2Test.java
 *
 * $Id: ListStatusRequestMsg50SP2Test.java,v 1.1 2011-02-06 01:06:14 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 ListStatusRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ListStatusRequestMsg50SP2Test extends MsgTest {

    public ListStatusRequestMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListStatusRequestMsg) FIXMsgBuilder.build(MsgType.ListStatusRequest.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListStatusRequestMsg] message version [5.0SP2].", ex.getMessage());
    }
