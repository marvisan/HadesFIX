...
/*
 * OrderCancelRejectMsg44TestData.java
 *
 * $Id: OrderCancelRejectMsg44TestData.java,v 1.1 2011-01-23 10:02:04 vrotaru Exp $
 */
...
/**
 * Test utility for OrderCancelRejectMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class OrderCancelRejectMsg44TestData extends MsgTest {

    private static final OrderCancelRejectMsg44TestData INSTANCE;

    static {
        INSTANCE = new OrderCancelRejectMsg44TestData();
    }

    public static OrderCancelRejectMsg44TestData getInstance() {
        return INSTANCE;
    }
