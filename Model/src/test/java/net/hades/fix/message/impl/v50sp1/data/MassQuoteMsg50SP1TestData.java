...
/*
 * MassQuoteMsg50SP1TestData.java
 *
 * $Id: MassQuoteMsg50SP1TestData.java,v 1.1 2009-07-21 08:58:46 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.QuoteSetGroup50SP1TestData;
...
/**
 * Test utility for MassQuoteMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class MassQuoteMsg50SP1TestData extends MsgTest {

    private static final MassQuoteMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new MassQuoteMsg50SP1TestData();
    }

    public static MassQuoteMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(MassQuoteMsg msg) throws UnsupportedEncodingException {
        ...
        QuoteSetGroup50SP1TestData.getInstance().populate1(msg.getQuoteSetGroups()[0]);
        QuoteSetGroup50SP1TestData.getInstance().populate2(msg.getQuoteSetGroups()[1]);
    }
    ...
    public void check(MassQuoteMsg expected, MassQuoteMsg actual) throws Exception {
        ...
        QuoteSetGroup50SP1TestData.getInstance().check(expected.getQuoteSetGroups()[0], actual.getQuoteSetGroups()[0]);
        QuoteSetGroup50SP1TestData.getInstance().check(expected.getQuoteSetGroups()[1], actual.getQuoteSetGroups()[1]);
    }
}
