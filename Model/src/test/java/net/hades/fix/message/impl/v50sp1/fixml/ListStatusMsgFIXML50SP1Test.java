...
/*
 * ListStatusMsgFIXML50SP1Test.java
 *
 * $Id: ListStatusMsgFIXML50SP1Test.java,v 1.1 2011-02-04 09:58:24 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v50sp1.data.ListStatusMsg50SP1TestData;
...
/**
 * Test suite for ListStatusMsg50SP1 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class ListStatusMsgFIXML50SP1Test extends MsgTest {

    public ListStatusMsgFIXML50SP1Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ListStatusMsg msg = (ListStatusMsg) FIXMsgBuilder.build(MsgType.ListStatus.getValue(), BeginString.FIX_5_0SP1);
            ...
            ListStatusMsg dmsg = (ListStatusMsg) FIXMsgBuilder.build(MsgType.ListStatus.getValue(), BeginString.FIX_5_0SP1);
    ...
    public void testMarshallUnmarshallFixml() throws Exception {
        ...
        try {
            ListStatusMsg msg = (ListStatusMsg) FIXMsgBuilder.build(MsgType.ListStatus.getValue(), BeginString.FIX_5_0SP1);
            TestUtils.populate50HeaderAll(msg);
            ListStatusMsg50SP1TestData.getInstance().populate(msg);
            String fixml = msg.toFixml();
            System.out.println("fixml-->" + fixml);
            XMLValidationResult result = validateXMLAgainstXSD(fixml, FIXML_SCHEMA_V50SP1);
            if (result.hasErrors()) {
            ...
            ListStatusMsg dmsg = (ListStatusMsg) FIXMsgBuilder.build(MsgType.ListStatus.getValue(), BeginString.FIX_5_0SP1);
            dmsg.fromFixml(fixml);
            ListStatusMsg50SP1TestData.getInstance().check(msg, dmsg);
        } finally {
            unsetPrintableFixml();
        }
    }
