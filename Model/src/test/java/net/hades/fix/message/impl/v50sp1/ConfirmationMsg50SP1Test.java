...
import net.hades.fix.message.impl.v50sp1.data.ConfirmationMsg50SP1TestData;
 ...
 */
public class ConfirmationMsg50SP1Test extends MsgTest  {

    public ConfirmationMsg50SP1Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ConfirmationMsg msg = (ConfirmationMsg) FIXMsgBuilder.build(MsgType.Confirmation.getValue(), BeginString.FIX_5_0SP1);
        ConfirmationMsg50SP1TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        ConfirmationMsg dmsg = (ConfirmationMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        ConfirmationMsg50SP1TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ConfirmationMsg) FIXMsgBuilder.build(MsgType.Confirmation.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ConfirmationMsg] message version [5.0SP1].", ex.getMessage());
    }
}
