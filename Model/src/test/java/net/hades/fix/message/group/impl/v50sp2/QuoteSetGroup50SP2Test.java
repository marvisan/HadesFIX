...
/*
 * QuoteSetGroup50SP2Test.java
 *
 * $Id: QuoteSetGroup50SP2Test.java,v 1.2 2009-11-21 09:57:26 vrotaru Exp $
 */
...
/**
 * Test suite for QuoteSetGroup50SP2 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/04/2009, 11:30:15 AM
 */
public class QuoteSetGroup50SP2Test {

    public QuoteSetGroup50SP2Test() {
    }
    ...
    public void testQuoteEntries() {
        QuoteSetGroup group = new QuoteSetGroup50SP2();
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteSetGroup] group version [5.0SP2].", ex.getMessage());
    }
}
