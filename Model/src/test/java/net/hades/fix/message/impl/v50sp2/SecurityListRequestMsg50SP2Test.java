...
/*
 * SecurityListRequestMsg50SP2Test.java
 *
 * $Id: SecurityListRequestMsg50SP2Test.java,v 1.1 2011-04-27 03:47:46 vrotaru Exp $
 */
 ...
 */
public class SecurityListRequestMsg50SP2Test extends MsgTest  {

    public SecurityListRequestMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SecurityListRequestMsg) FIXMsgBuilder.build(MsgType.SecurityListRequest.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SecurityListRequestMsg] message version [5.0SP2].", ex.getMessage());
    }
}
