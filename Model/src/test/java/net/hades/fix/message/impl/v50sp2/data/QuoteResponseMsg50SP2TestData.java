...
/*
 * QuoteResponseMsg50SP2TestData.java
 *
 * $Id: QuoteResponseMsg50SP2TestData.java,v 1.3 2011-10-29 09:42:21 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteResponseMsg50SP2 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class QuoteResponseMsg50SP2TestData extends MsgTest {

    private static final QuoteResponseMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new QuoteResponseMsg50SP2TestData();
    }

    public static QuoteResponseMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(QuoteResponseMsg msg) throws UnsupportedEncodingException {
        ...
        LegQuoteGroup50SP2TestData.getInstance().populate1(msg.getLegQuoteGroups()[0]);
        LegQuoteGroup50SP2TestData.getInstance().populate2(msg.getLegQuoteGroups()[1]);
    ...
    public void check(QuoteResponseMsg expected, QuoteResponseMsg actual) throws Exception {
        ...
        LegQuoteGroup50SP2TestData.getInstance().check(expected.getLegQuoteGroups()[0], actual.getLegQuoteGroups()[0]);
        LegQuoteGroup50SP2TestData.getInstance().check(expected.getLegQuoteGroups()[1], actual.getLegQuoteGroups()[1]);
