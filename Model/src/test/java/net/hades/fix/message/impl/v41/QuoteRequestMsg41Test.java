...
/*
 * QuoteRequestMsg41Test.java
 *
 * $Id: QuoteRequestMsg41Test.java,v 1.4 2010-03-21 11:25:18 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v41.data.QuoteRequestMsg41TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.1 QuoteRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 09/04/2009, 3:12:30 PM
 */
public class QuoteRequestMsg41Test extends MsgTest {

    private DataDictionary dictionary;

    public QuoteRequestMsg41Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        QuoteRequestMsg msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_1);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF41DataDictionary();
        QuoteRequestMsg msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_1);
        QuoteRequestMsg41TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix41.QuoteRequest qfMsg = new quickfix.fix41.QuoteRequest();
        qfMsg.fromString(encoded, dictionary, true);
        QuoteRequestMsg41TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF41DataDictionary();
        quickfix.fix41.QuoteRequest msg = new quickfix.fix41.QuoteRequest();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        QuoteRequestMsg dmsg = (QuoteRequestMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        QuoteRequestMsg41TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteRequestMsg] message version [4.1].", ex.getMessage());
    }
}
