...
/*
 * OrderCancelRequestMsg50SP2Test.java
 *
 * $Id: OrderCancelRequestMsg50SP2Test.java,v 1.1 2011-01-22 09:52:24 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP2 OrderCancelRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class OrderCancelRequestMsg50SP2Test extends MsgTest  {

    public OrderCancelRequestMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderCancelRequestMsg) FIXMsgBuilder.build(MsgType.OrderCancelRequest.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderCancelRequestMsg] message version [5.0SP2].", ex.getMessage());
    }
}
