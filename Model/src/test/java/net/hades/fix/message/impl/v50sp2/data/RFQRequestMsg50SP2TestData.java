...
/*
 * RFQRequestMsg50SP2TestData.java
 *
 * $Id: RFQRequestMsg50SP2TestData.java,v 1.1 2009-07-06 03:19:08 vrotaru Exp $
 */
...
/**
 * Test utility for RFQRequestMsg50SP2 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 11:57:03 AM
 */
public class RFQRequestMsg50SP2TestData extends MsgTest {

    private static final RFQRequestMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new RFQRequestMsg50SP2TestData();
    }

    public static RFQRequestMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(RFQRequestMsg msg) throws UnsupportedEncodingException {
        ...
        RFQRequestGroup50SP2TestData.getInstance().populate2(msg.getRFQRequestGroups()[1]);
    ...
    public void check(RFQRequestMsg expected, RFQRequestMsg actual) throws Exception {
        ...
        RFQRequestGroup50SP2TestData.getInstance().check(expected.getRFQRequestGroups()[0], actual.getRFQRequestGroups()[0]);
        RFQRequestGroup50SP2TestData.getInstance().check(expected.getRFQRequestGroups()[1], actual.getRFQRequestGroups()[1]);
