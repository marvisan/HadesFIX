...
/*
 * DerivativeSecurityListMsgFIXML44Test.java
 *
 * $Id: DerivativeSecurityListMsgFIXML44Test.java,v 1.1 2011-09-28 08:10:20 vrotaru Exp $
 */
...
/**
 * Test suite for DerivativeSecurityListMsg44 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class DerivativeSecurityListMsgFIXML44Test extends MsgTest {

    public DerivativeSecurityListMsgFIXML44Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ...
            DerivativeSecurityListMsg dmsg = (DerivativeSecurityListMsg) FIXMsgBuilder.build(MsgType.DerivativeSecurityList.getValue(), BeginString.FIX_4_4);
