...
/*
 * PositionMaintenanceReportMsg50SP1Test.java
 *
...
/**
 * Test suite for FIX 5.0SP1 PositionMaintenanceReportMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 08/12/2011, 12:18:17 PM
 */
public class PositionMaintenanceReportMsg50SP1Test extends MsgTest  {

    public PositionMaintenanceReportMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (PositionMaintenanceReportMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceReport.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [PositionMaintenanceReportMsg] message version [5.0SP1].", ex.getMessage());
    }
}
