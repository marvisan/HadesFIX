...
/*
 * ListExecuteMsg43Test.java
 *
 * $Id: ListExecuteMsg43Test.java,v 1.1 2011-02-05 08:52:44 vrotaru Exp $
 */
 ...
 */
public class ListExecuteMsg43Test extends MsgTest  {

    public ListExecuteMsg43Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListExecuteMsg msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_4_3);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListExecuteMsg] message version [4.3].", ex.getMessage());
    }
}
