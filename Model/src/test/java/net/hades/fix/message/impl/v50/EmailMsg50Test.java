 ...
 * EmailMsg50Test.java
 *
 * $Id: EmailMsg50Test.java,v 1.4 2011-01-15 02:10:11 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 EmailMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 02/04/2009, 8:57:55 AM
 */
public class EmailMsg50Test extends MsgTest {

    public EmailMsg50Test() {
    }
    ...
    /**
     * Test of decode method, of class AdvertismentMsg all fields.
     * @throws Exception
     */
    @Test
    public void b2_testDecodeAll() throws Exception {
        System.out.println("-->testDecodeAll");
        quickfix.fix50.Email msg = new quickfix.fix50.Email();
    ...
    public void testSetNoRoutingIDs() throws Exception {
        EmailMsg comp = (EmailMsg) FIXMsgBuilder.build(MsgType.Email.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        EmailMsg msg = null;
        try {
            msg = (EmailMsg) FIXMsgBuilder.build(MsgType.Email.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [EmailMsg] message version [5.0].", ex.getMessage());
    }
}
