...
/*
 * ListExecuteMsg50SP1Test.java
 *
 * $Id: ListExecuteMsg50SP1Test.java,v 1.1 2011-02-05 08:52:44 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 ListExecuteMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ListExecuteMsg50SP1Test extends MsgTest  {

    public ListExecuteMsg50SP1Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListExecuteMsg msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_5_0SP1);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListExecuteMsg] message version [5.0SP1].", ex.getMessage());
    }
}
