...
/*
 * OrderMassCancelRequestMsg50TestData.java
 *
 * $Id: OrderMassCancelRequestMsg50TestData.java,v 1.1 2011-05-02 05:16:38 vrotaru Exp $
 */
...
/**
 * Test utility for OrderMassCancelRequestMsg50 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class OrderMassCancelRequestMsg50TestData extends MsgTest {

    private static final OrderMassCancelRequestMsg50TestData INSTANCE;

    static {
        INSTANCE = new OrderMassCancelRequestMsg50TestData();
    }

    public static OrderMassCancelRequestMsg50TestData getInstance() {
        return INSTANCE;
    }
