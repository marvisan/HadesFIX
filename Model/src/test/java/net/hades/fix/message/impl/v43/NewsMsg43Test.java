 ...
 * NewsMsg43Test.java
 *
 * $Id: NewsMsg43Test.java,v 1.3 2010-03-21 11:25:17 vrotaru Exp $
 */
package net.hades.fix.message.impl.v43;


import net.hades.fix.message.impl.v43.data.NewsMsg43TestData;
...
/**
 * Test suite for FIX 4.3 NewsMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 02/03/2009, 7:38:11 PM
 */
public class NewsMsg43Test extends MsgTest {

    private DataDictionary dictionary;

    public NewsMsg43Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        NewsMsg msg = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIX_4_3);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF43DataDictionary();
        NewsMsg msg = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIX_4_3);
        NewsMsg43TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix43.News qfMsg = new quickfix.fix43.News();
        qfMsg.fromString(encoded, dictionary, true);
        NewsMsg43TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF43DataDictionary();
        quickfix.fix43.News msg = new quickfix.fix43.News();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        NewsMsg dmsg = (NewsMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        NewsMsg43TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testSetNoRelatedSyms() throws Exception {
        NewsMsg comp = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIX_4_3);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        NewsMsg msg = null;
        try {
            msg = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [NewsMsg] message version [4.3].", ex.getMessage());
    }
}
