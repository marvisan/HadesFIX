...
/*
 * HeadTrail44Test.java
 *
 * $Id: HeadTrail44Test.java,v 1.7 2011-04-04 09:37:11 vrotaru Exp $
 */
...
public class HeadTrail44Test extends MsgTest {
    
    private DataDictionary dictionary;

    public HeadTrail44Test() {
    }
    ...
    /**
     * Test of encode method, of a message class Header/Tailer for FIX 4.4.
     * @throws Exception 
     */
    @Test
    public void a1_testEncodeReqOnly() throws Exception {
        ...
        checkHeaderReq((quickfix.fix44.Message.Header) qfMsg.getHeader());
    }
    ...
    public void a4_testEncodeAll() throws Exception {
        ...
        quickfix.fix44.Message qfMsg = new quickfix.fix44.Message();
        qfMsg.fromString(encoded, dictionary, true);
        checkHeaderAll((quickfix.fix44.Message.Header) qfMsg.getHeader());
        checkTrailer(qfMsg.getTrailer());
    }
    
    /**
     * Test of encode method, of a message class Header/Tailer for FIX 4.4 with secure data.
     */
    @Test
...
//            quickfix.fix43.TestRequest qfMsg = (quickfix.fix43.TestRequest) new quickfix.Message(encoded);
    ...
    /**
     * Test of encode method, of a message class Header/Tailer for FIX 4.4 with custom fields.
     * @throws Exception 
     */
    @Ignore
    ...
    /**
     * Test of decode method, of a message class Header/Tailer for FIX 4.4.
     * @throws Exception 
     */
    @Test
    ...
    public void a14_testDecodeCustom() throws Exception {
        quickfix.fix44.TestRequest qfMsg = buildTestRequestAll();
    ...
    private quickfix.fix44.TestRequest buildTestRequestReq() {
        quickfix.fix44.TestRequest msg = new quickfix.fix44.TestRequest();
        TestUtils.populateQuickFIX44HeaderReq(msg);
        msg.setString(TestReqID.FIELD, ("Test field 4.4"));
        
        return msg;
    }
    
    private quickfix.fix44.TestRequest buildTestRequestAll() {
        quickfix.fix44.TestRequest msg = new quickfix.fix44.TestRequest();
    ...
    private void checkQuickFIXHeaderReq(FIXMsg msg) {
    ...
    private void checkQuickFIXHeaderAll(FIXMsg msg) throws UnsupportedEncodingException {
        assertEquals(BeginString.FIX_4_4, msg.getHeader().getBeginString());
        assertEquals(MsgType.TestRequest.getValue(), msg.getHeader().getMsgType());
        assertEquals("Teleton", msg.getHeader().getSenderCompID());
        assertEquals("BI", msg.getHeader().getTargetCompID());
    ...
    private void checkHeaderAll(quickfix.fix44.Message.Header header) {
        try {
            assertEquals("Marvisan", header.getString(SenderCompID.FIELD));
            assertEquals("IB", header.getString(TargetCompID.FIELD));
            ...
            cal.add(Calendar.HOUR_OF_DAY, -1);
            quickfix.fix44.Message.Header.NoHops grp2 = new quickfix.fix44.Message.Header.NoHops();
