...
/*
 * MarketDataSnapshotMsg42Test.java
 *
 * $Id: MarketDataSnapshotMsg42Test.java,v 1.4 2010-03-21 11:25:17 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.MarketDataSnapshotMsg42TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MDEntryType;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.2 MarketDataSnapshotMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class MarketDataSnapshotMsg42Test extends MsgTest  {

    public MarketDataSnapshotMsg42Test() {
    }
    ...
    public void a1_testEncodeDecodeReq() throws Exception {
        ...
        MarketDataSnapshotMsg msg = (MarketDataSnapshotMsg) FIXMsgBuilder.build(MsgType.MarketDataSnapshot.getValue(), BeginString.FIX_4_2);
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        MarketDataSnapshotMsg msg = (MarketDataSnapshotMsg) FIXMsgBuilder.build(MsgType.MarketDataSnapshot.getValue(), BeginString.FIX_4_2);
        MarketDataSnapshotMsg42TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        MarketDataSnapshotMsg dmsg = (MarketDataSnapshotMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        MarketDataSnapshotMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (MarketDataSnapshotMsg) FIXMsgBuilder.build(MsgType.MarketDataSnapshot.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MarketDataSnapshotMsg] message version [4.2].", ex.getMessage());
    }
}
