...
/*
 * QuoteSetAckGroup42TestData.java
 *
 * $Id: QuoteSetAckGroup42TestData.java,v 1.2 2009-11-21 09:57:22 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteSetAckGroup42 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/04/2009, 10:08:38 AM
 */
public class QuoteSetAckGroup42TestData extends MsgTest {

    private static final QuoteSetAckGroup42TestData INSTANCE;

    static {
        INSTANCE = new QuoteSetAckGroup42TestData();
    }

    public static QuoteSetAckGroup42TestData getInstance() {
        return INSTANCE;
    }

    public void populate1(quickfix.fix42.QuoteAcknowledgement.NoQuoteSets msg) throws Exception {
        ...
        quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries grp1 = new quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries();
        QuoteEntryAckGroup42TestData.getInstance().populate1(grp1);
        msg.addGroup(grp1);
        quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries grp2 = new quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries();
        QuoteEntryAckGroup42TestData.getInstance().populate2(grp2);
        msg.addGroup(grp2);
    }

    public void populate2(quickfix.fix42.QuoteAcknowledgement.NoQuoteSets msg) throws Exception {
    ...
    public void populate1(QuoteSetAckGroup msg) throws UnsupportedEncodingException {
        ...
        QuoteEntryAckGroup42TestData.getInstance().populate1(msg.getQuoteEntryAckGroups()[0]);
        QuoteEntryAckGroup42TestData.getInstance().populate2(msg.getQuoteEntryAckGroups()[1]);
    }
    ...
    public void check(QuoteSetAckGroup expected, quickfix.fix42.QuoteAcknowledgement.NoQuoteSets actual) throws Exception {
        ...
        QuoteEntryAckGroup42TestData.getInstance().check(expected.getQuoteEntryAckGroups()[0], grp1);
        quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries grp2 = new quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries();
        actual.getGroup(2, grp2);
        QuoteEntryAckGroup42TestData.getInstance().check(expected.getQuoteEntryAckGroups()[1], grp2);
    }

    public void check(quickfix.fix42.QuoteAcknowledgement.NoQuoteSets expected, QuoteSetAckGroup actual) throws Exception {
        ...
        QuoteEntryAckGroup42TestData.getInstance().check(grp1, actual.getQuoteEntryAckGroups()[0]);
        quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries grp2 = new quickfix.fix42.QuoteAcknowledgement.NoQuoteSets.NoQuoteEntries();
        expected.getGroup(2, grp2);
        QuoteEntryAckGroup42TestData.getInstance().check(grp2, actual.getQuoteEntryAckGroups()[1]);
    }
    ...
    public void check(QuoteSetAckGroup expected, QuoteSetAckGroup actual) throws Exception {
        ...
        // QuoteEntryGroup check
        QuoteEntryAckGroup42TestData.getInstance().check(expected.getQuoteEntryAckGroups()[0], actual.getQuoteEntryAckGroups()[0]);
        QuoteEntryAckGroup42TestData.getInstance().check(expected.getQuoteEntryAckGroups()[1], actual.getQuoteEntryAckGroups()[1]);
    }
}
