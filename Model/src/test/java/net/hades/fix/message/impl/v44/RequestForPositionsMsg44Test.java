...
/*
 * RequestForPositionsMsg44Test.java
 *
 ...
 */
public class RequestForPositionsMsg44Test extends MsgTest  {

    public RequestForPositionsMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (RequestForPositionsMsg) FIXMsgBuilder.build(MsgType.RequestForPositions.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    public void testEncodeMissingRequired() {
        ...
        try {
            ...
            assertEquals("Tag value(s) for [PosReqID] [PosReqType] [Parties] [Account] [AccountType] [ClearingBusinessDate] [TransactTime] is missing.", ex.getMessage());
        }
    }
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [RequestForPositionsMsg] message version [4.4].", ex.getMessage());
    }
}
