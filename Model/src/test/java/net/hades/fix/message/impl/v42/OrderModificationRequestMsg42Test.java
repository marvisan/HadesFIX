...
/*
 * OrderModificationRequestMsg42Test.java
 *
 * $Id: OrderModificationRequestMsg42Test.java,v 1.1 2011-01-21 10:23:14 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.OrderModificationRequestMsg42TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.2 OrderModificationRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class OrderModificationRequestMsg42Test extends MsgTest  {

    public OrderModificationRequestMsg42Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        OrderModificationRequestMsg msg = (OrderModificationRequestMsg) FIXMsgBuilder.build(MsgType.OrderModificationRequest.getValue(), BeginString.FIX_4_2);
        OrderModificationRequestMsg42TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        OrderModificationRequestMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderModificationRequestMsg) FIXMsgBuilder.build(MsgType.OrderModificationRequest.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderModificationRequestMsg] message version [4.2].", ex.getMessage());
    }
}
