...
/*
 * SecurityStatusMsg43Test.java
 *
 * $Id: SecurityStatusMsg43Test.java,v 1.1 2011-04-21 09:45:44 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v43.data.SecurityStatusMsg43TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.3 SecurityStatusMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SecurityStatusMsg43Test extends MsgTest  {

    public SecurityStatusMsg43Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        SecurityStatusMsg msg = (SecurityStatusMsg) FIXMsgBuilder.build(MsgType.SecurityStatus.getValue(), BeginString.FIX_4_3);
        SecurityStatusMsg43TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        SecurityStatusMsg dmsg = (SecurityStatusMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        SecurityStatusMsg43TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SecurityStatusMsg) FIXMsgBuilder.build(MsgType.SecurityStatus.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SecurityStatusMsg] message version [4.3].", ex.getMessage());
    }
}
