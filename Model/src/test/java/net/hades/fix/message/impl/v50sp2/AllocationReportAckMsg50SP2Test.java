 ...
 */
public class AllocationReportAckMsg50SP2Test extends MsgTest  {

    public AllocationReportAckMsg50SP2Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        AllocationReportAckMsg msg = (AllocationReportAckMsg) FIXMsgBuilder.build(MsgType.AllocationReportAck.getValue(), BeginString.FIX_5_0SP2);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AllocationReportAckMsg) FIXMsgBuilder.build(MsgType.AllocationReportAck.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    public void testEncodeMissingRequired() {
        ...
        try {
            ...
            assertEquals("Tag value(s) for [AllocReportID] is missing.", ex.getMessage());
        }
    }
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AllocationReportAckMsg] message version [5.0SP2].", ex.getMessage());
    }
}
