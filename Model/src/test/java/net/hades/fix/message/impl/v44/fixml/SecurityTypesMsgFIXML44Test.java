...
/*
 * SecurityTypesMsgFIXML44Test.java
 *
 * $Id: SecurityTypesMsgFIXML44Test.java,v 1.1 2011-04-27 01:09:59 vrotaru Exp $
 */
...
/**
 * Test suite for SecurityTypesMsg44 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class SecurityTypesMsgFIXML44Test extends MsgTest {

    public SecurityTypesMsgFIXML44Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ...
            SecurityTypesMsg dmsg = (SecurityTypesMsg) FIXMsgBuilder.build(MsgType.SecurityTypes.getValue(), BeginString.FIX_4_4);
