...
/*
 * BidRequestMsg50SP1Test.java
 *
 * $Id: BidRequestMsg50SP1Test.java,v 1.1 2011-04-13 10:13:46 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 BidRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class BidRequestMsg50SP1Test extends MsgTest  {

    public BidRequestMsg50SP1Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        BidRequestMsg msg = (BidRequestMsg) FIXMsgBuilder.build(MsgType.BidRequest.getValue(), BeginString.FIX_5_0SP1);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (BidRequestMsg) FIXMsgBuilder.build(MsgType.BidRequest.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
