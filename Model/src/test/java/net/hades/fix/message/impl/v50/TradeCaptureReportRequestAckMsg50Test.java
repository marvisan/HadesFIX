...
/*
 * TradeCaptureReportRequestAckMsg50Test.java
 *
...
/**
 * Test suite for FIX 5.0 TradeCaptureReportRequestAckMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class TradeCaptureReportRequestAckMsg50Test extends MsgTest  {

    public TradeCaptureReportRequestAckMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (TradeCaptureReportRequestAckMsg) FIXMsgBuilder.build(MsgType.TradeCaptureReportRequestAck.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [TradeCaptureReportRequestAckMsg] message version [5.0].", ex.getMessage());
    }
}
