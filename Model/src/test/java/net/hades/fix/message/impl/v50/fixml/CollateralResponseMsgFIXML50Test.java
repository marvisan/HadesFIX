 ...
 */
public class CollateralResponseMsgFIXML50Test extends MsgTest {

    public CollateralResponseMsgFIXML50Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ...
            CollateralResponseMsg dmsg = (CollateralResponseMsg) FIXMsgBuilder.build(MsgType.CollateralResponse.getValue(), BeginString.FIX_5_0);
