...
/*
 * DerivativeSecurityListMsg50TestData.java
 *
 * $Id: DerivativeSecurityListMsg50TestData.java,v 1.1 2011-09-28 08:10:22 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50.DerivSecListGroup50TestData;
import net.hades.fix.message.type.SecurityRequestResult;

/**
 * Test utility for DerivativeSecurityListMsg50 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class DerivativeSecurityListMsg50TestData extends MsgTest {

    private static final DerivativeSecurityListMsg50TestData INSTANCE;

    static {
        INSTANCE = new DerivativeSecurityListMsg50TestData();
    }

    public static DerivativeSecurityListMsg50TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(DerivativeSecurityListMsg msg) throws UnsupportedEncodingException {
        ...
        DerivSecListGroup50TestData.getInstance().populate1(msg.getDerivSecListGroups()[0]);
        DerivSecListGroup50TestData.getInstance().populate2(msg.getDerivSecListGroups()[1]);
    }
    ...
    public void check(DerivativeSecurityListMsg expected, DerivativeSecurityListMsg actual) throws Exception {
        ...
        DerivSecListGroup50TestData.getInstance().check(expected.getDerivSecListGroups()[0], actual.getDerivSecListGroups()[0]);
        DerivSecListGroup50TestData.getInstance().check(expected.getDerivSecListGroups()[1], actual.getDerivSecListGroups()[1]);
    }
}
