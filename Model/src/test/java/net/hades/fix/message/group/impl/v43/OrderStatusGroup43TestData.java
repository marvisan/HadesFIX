...
/*
 * OrderStatusGroup43TestData.java
 *
 * $Id: OrderStatusGroup43TestData.java,v 1.1 2011-02-04 09:58:23 vrotaru Exp $
 */
 ...
 */
public class OrderStatusGroup43TestData extends MsgTest {

    private static final OrderStatusGroup43TestData INSTANCE;

    static {
        INSTANCE = new OrderStatusGroup43TestData();
    }

    public static OrderStatusGroup43TestData getInstance() {
        return INSTANCE;
    }
