...
/*
 * QuoteRequestRejectGroup50TestData.java
 *
 * $Id: QuoteRequestRejectGroup50TestData.java,v 1.2 2011-10-29 09:42:30 vrotaru Exp $
 */
 ...
 */
public class QuoteRequestRejectGroup50TestData extends MsgTest {

    private static final QuoteRequestRejectGroup50TestData INSTANCE;

    static {
        INSTANCE = new QuoteRequestRejectGroup50TestData();
    }

    public static QuoteRequestRejectGroup50TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate1(QuoteRequestRejectGroup msg) throws UnsupportedEncodingException {
        ...
        QuoteRequestLegGroup50TestData.getInstance().populate1(msg.getQuoteRequestLegGroups()[0]);
        QuoteRequestLegGroup50TestData.getInstance().populate2(msg.getQuoteRequestLegGroups()[1]);
        // QuoteQualifiers
    ...
    public void check(QuoteRequestRejectGroup expected, QuoteRequestRejectGroup actual) throws Exception {
        ...
        QuoteRequestLegGroup50TestData.getInstance().check(expected.getQuoteRequestLegGroups()[0], actual.getQuoteRequestLegGroups()[0]);
        QuoteRequestLegGroup50TestData.getInstance().check(expected.getQuoteRequestLegGroups()[1], actual.getQuoteRequestLegGroups()[1]);
        // QuoteQualifiers
