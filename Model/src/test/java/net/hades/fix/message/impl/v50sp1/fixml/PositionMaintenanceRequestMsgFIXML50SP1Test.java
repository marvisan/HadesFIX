...
/*
 * PositionMaintenanceRequestMsgFIXML50SP1Test.java
 *
...
import net.hades.fix.message.impl.v50sp1.data.PositionMaintenanceRequestMsg50SP1TestData;
...
/**
 * Test suite for PositionMaintenanceRequestMsg50 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class PositionMaintenanceRequestMsgFIXML50SP1Test extends MsgTest {

    public PositionMaintenanceRequestMsgFIXML50SP1Test() {
    }
    ...
    /**
     * Test of encode method, of class PositionMaintenanceRequestMsg for FIXML 4.4.
     * @throws Exception
     */
    @Test
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            PositionMaintenanceRequestMsg msg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0SP1);
            ...
            PositionMaintenanceRequestMsg dmsg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0SP1);
    ...
    public void testMarshallUnmarshallFixml() throws Exception {
        ...
        try {
            PositionMaintenanceRequestMsg msg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0SP1);
            PositionMaintenanceRequestMsg50SP1TestData.getInstance().populate(msg);
            String fixml = msg.toFixml();
            System.out.println("fixml-->" + fixml);
            XMLValidationResult result = validateXMLAgainstXSD(fixml, FIXML_SCHEMA_V50SP1);
            if (result.hasErrors()) {
            ...
            PositionMaintenanceRequestMsg dmsg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0SP1);
            dmsg.fromFixml(fixml);
            PositionMaintenanceRequestMsg50SP1TestData.getInstance().check(msg, dmsg);
        } finally {
            unsetPrintableFixml();
        }
    }
