...
/*
 * QuoteRequestRejectMsg44TestData.java
 *
 * $Id: QuoteRequestRejectMsg44TestData.java,v 1.1 2009-07-06 03:19:08 vrotaru Exp $
 */
 ...
 */
public class QuoteRequestRejectMsg44TestData extends MsgTest {

    private static final QuoteRequestRejectMsg44TestData INSTANCE;

    static {
        INSTANCE = new QuoteRequestRejectMsg44TestData();
    }

    public static QuoteRequestRejectMsg44TestData getInstance() {
        return INSTANCE;
    }

    public void populate(quickfix.fix44.QuoteRequestReject msg) throws Exception {
        ...
        quickfix.fix44.QuoteRequestReject.NoRelatedSym grprelsym1 = new quickfix.fix44.QuoteRequestReject.NoRelatedSym();
        QuoteRequestRejectGroup44TestData.getInstance().populate1(grprelsym1);
        msg.addGroup(grprelsym1);
        quickfix.fix44.QuoteRequestReject.NoRelatedSym grprelsym2 = new quickfix.fix44.QuoteRequestReject.NoRelatedSym();
        QuoteRequestRejectGroup44TestData.getInstance().populate2(grprelsym2);
    ...
    public void populate(QuoteRequestRejectMsg msg) throws UnsupportedEncodingException {
        ...
        QuoteRequestRejectGroup44TestData.getInstance().populate2(msg.getQuoteRequestRejectGroups()[1]);
...
//    public void check(quickfix.fix44.QuoteRequestReject expected, QuoteRequestRejectMsg actual) throws Exception {
...
//    }
//
//    public void check(QuoteRequestRejectMsg expected, quickfix.fix44.QuoteRequestReject actual) throws Exception {
...
//    }
    ...
    public void check(QuoteRequestRejectMsg expected, QuoteRequestRejectMsg actual) throws Exception {
        ...
        // QuoteRelatedSymbolGroup check
        QuoteRequestRejectGroup44TestData.getInstance().check(expected.getQuoteRequestRejectGroups()[0],
            actual.getQuoteRequestRejectGroups()[0]);
        QuoteRequestRejectGroup44TestData.getInstance().check(expected.getQuoteRequestRejectGroups()[1],
