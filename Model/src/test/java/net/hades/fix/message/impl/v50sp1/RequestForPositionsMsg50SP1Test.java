...
/*
 * RequestForPositionsMsg50SP1Test.java
 *
 ...
 */
public class RequestForPositionsMsg50SP1Test extends MsgTest  {

    public RequestForPositionsMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (RequestForPositionsMsg) FIXMsgBuilder.build(MsgType.RequestForPositions.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
