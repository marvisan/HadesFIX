...
/*
 * AllocationInstructionAckMsg50SP2TestData.java
 *
 * $Id: AllocationInstructionAckMsg50SP2TestData.java,v 1.1 2011-02-17 09:21:28 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp2.AllocAckGroup50SP2TestData;
...
/**
 * Test utility for AllocationInstructionAckMsg50SP2 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class AllocationInstructionAckMsg50SP2TestData extends MsgTest {

    private static final AllocationInstructionAckMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new AllocationInstructionAckMsg50SP2TestData();
    }

    public static AllocationInstructionAckMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(AllocationInstructionAckMsg msg) throws UnsupportedEncodingException {
        ...
        msg.setNoAllocs(2);
        AllocAckGroup50SP2TestData.getInstance().populate1(msg.getAllocAckGroups()[0]);
        AllocAckGroup50SP2TestData.getInstance().populate2(msg.getAllocAckGroups()[1]);
    }
    ...
    public void check(AllocationInstructionAckMsg expected, AllocationInstructionAckMsg actual) throws Exception {
        ...
        AllocAckGroup50SP2TestData.getInstance().check(expected.getAllocAckGroups()[0], actual.getAllocAckGroups()[0]);
        AllocAckGroup50SP2TestData.getInstance().check(expected.getAllocAckGroups()[1], actual.getAllocAckGroups()[1]);
    }
}
