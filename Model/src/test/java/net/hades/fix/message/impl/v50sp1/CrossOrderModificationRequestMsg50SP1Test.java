...
/*
 * CrossOrderModificationRequestMsg50SP1Test.java
 *
 * $Id: CrossOrderModificationRequestMsg50SP1Test.java,v 1.1 2011-05-17 09:28:24 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0SP1 CrossOrderModificationRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class CrossOrderModificationRequestMsg50SP1Test extends MsgTest  {

    public CrossOrderModificationRequestMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (CrossOrderModificationRequestMsg) FIXMsgBuilder.build(MsgType.CrossOrderModificationRequest.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [CrossOrderModificationRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
}
