...
/*
 * AllocationInstructionAckMsg44Test.java
 *
 * $Id: AllocationInstructionAckMsg44Test.java,v 1.1 2011-02-17 09:21:28 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 AllocationInstructionAckMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class AllocationInstructionAckMsg44Test extends MsgTest  {

    public AllocationInstructionAckMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AllocationInstructionAckMsg) FIXMsgBuilder.build(MsgType.AllocationAck.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AllocationInstructionAckMsg] message version [4.4].", ex.getMessage());
    }
}
