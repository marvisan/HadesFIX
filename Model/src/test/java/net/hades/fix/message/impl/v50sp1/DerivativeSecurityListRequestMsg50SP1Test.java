...
/*
 * DerivativeSecurityListRequestMsg50SP1Test.java
 *
 * $Id: DerivativeSecurityListRequestMsg50SP1Test.java,v 1.1 2011-09-22 08:54:32 vrotaru Exp $
 */
 ...
 */
public class DerivativeSecurityListRequestMsg50SP1Test extends MsgTest  {

    public DerivativeSecurityListRequestMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (DerivativeSecurityListRequestMsg) FIXMsgBuilder.build(MsgType.DerivativeSecurityListRequest.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [DerivativeSecurityListRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
}
