...
/*
 * SideCrossOrdCxlGroup44TestData.java
 *
 * $Id: SideCrossOrdCxlGroup44TestData.java,v 1.1 2011-05-21 23:53:23 vrotaru Exp $
 */
...
/**
 * Test utility for SideCrossOrdCxlGroup44 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/05/2011, 10:08:38 AM
 */
public class SideCrossOrdCxlGroup44TestData extends MsgTest {

    private static final SideCrossOrdCxlGroup44TestData INSTANCE;

    static {
        INSTANCE = new SideCrossOrdCxlGroup44TestData();
    }

    public static SideCrossOrdCxlGroup44TestData getInstance() {
        return INSTANCE;
    }
