...
/*
 * QuoteRequestMsg43Test.java
 *
 * $Id: QuoteRequestMsg43Test.java,v 1.4 2010-03-21 11:25:17 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v43.data.QuoteRequestMsg43TestData;
...
/**
 * Test suite for FIX 4.3 QuoteRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 09/04/2009, 3:12:30 PM
 */
public class QuoteRequestMsg43Test extends MsgTest {

    private DataDictionary dictionary;

    public QuoteRequestMsg43Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        QuoteRequestMsg msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_3);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF43DataDictionary();
        QuoteRequestMsg msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_3);
        QuoteRequestMsg43TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix43.QuoteRequest qfMsg = new quickfix.fix43.QuoteRequest();
        qfMsg.fromString(encoded, dictionary, true);
//        QuoteRequestMsg43TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF43DataDictionary();
        quickfix.fix43.QuoteRequest msg = new quickfix.fix43.QuoteRequest();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        QuoteRequestMsg dmsg = (QuoteRequestMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        QuoteRequestMsg43TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testSetNoRelatedSym() throws Exception {
        QuoteRequestMsg comp = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_3);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (QuoteRequestMsg) FIXMsgBuilder.build(MsgType.QuoteRequest.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [QuoteRequestMsg] message version [4.3].", ex.getMessage());
    }
}
