...
/*
 * SettlementInstructionRequestMsg50Test.java
 *
 ...
 */
public class SettlementInstructionRequestMsg50Test extends MsgTest  {

    public SettlementInstructionRequestMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SettlementInstructionRequestMsg) FIXMsgBuilder.build(MsgType.SettlementInstructionRequest.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SettlementInstructionRequestMsg] message version [5.0].", ex.getMessage());
    }
}
