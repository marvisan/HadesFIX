 ...
 * IOIMsg41Test.java
 *
 * $Id: IOIMsg41Test.java,v 1.4 2010-03-21 11:25:18 vrotaru Exp $
 */
package net.hades.fix.message.impl.v41;

import net.hades.fix.message.impl.v41.data.IOIMsg41TestData;
...
/**
 * Test suite for FIX 4.1 IOIMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 02/03/2009, 7:38:11 PM
 */
public class IOIMsg41Test extends MsgTest {
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        IOIMsg msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIX_4_1);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF41DataDictionary();
        IOIMsg msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIX_4_1);
        IOIMsg41TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix41.IndicationofInterest qfMsg = new quickfix.fix41.IndicationofInterest();
        qfMsg.fromString(encoded, dictionary, true);
        IOIMsg41TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b1_testDecodeReq() throws Exception {
        ...
        dictionary = getQF41DataDictionary();
        quickfix.fix41.IndicationofInterest msg = new quickfix.fix41.IndicationofInterest();
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        IOIMsg dmsg = (IOIMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        IOIMsg41TestData.getInstance().check(msg, dmsg);
    }
     ...
     */
    @Test
    public void testGetUnsupportedIOIMsgTag() {
        System.out.println("-->testGetUnsupportedIOIMsgTag");
        IOIMsg msg = null;
        try {
            msg = (IOIMsg) FIXMsgBuilder.build(MsgType.IndicationOfInterest.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
     ...
     */
    @Test
    public void testSetUnsupportedIOIMsgTag() {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [IOIMsg] message version [4.1].", ex.getMessage());
    }
}
