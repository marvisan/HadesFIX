...
/*
 * ListStrikePriceMsg50Test.java
 *
 * $Id: ListStrikePriceMsg50Test.java,v 1.1 2011-04-15 04:37:43 vrotaru Exp $
 */
 ...
 */
public class ListStrikePriceMsg50Test extends MsgTest  {

    public ListStrikePriceMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListStrikePriceMsg) FIXMsgBuilder.build(MsgType.ListStrikePrice.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListStrikePriceMsg] message version [5.0].", ex.getMessage());
    }
}
