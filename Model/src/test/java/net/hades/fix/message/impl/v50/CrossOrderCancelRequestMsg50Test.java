...
/*
 * CrossOrderCancelRequestMsg50Test.java
 *
 * $Id: CrossOrderCancelRequestMsg50Test.java,v 1.1 2011-05-21 23:53:24 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 CrossOrderCancelRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 22/05/2009, 12:18:17 PM
 */
public class CrossOrderCancelRequestMsg50Test extends MsgTest  {

    public CrossOrderCancelRequestMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (CrossOrderCancelRequestMsg) FIXMsgBuilder.build(MsgType.CrossOrderCancelRequest.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [CrossOrderCancelRequestMsg] message version [5.0].", ex.getMessage());
    }
}
