...
/*
 * MDFullGroup42Test.java
 *
 * $Id: MDFullGroup42Test.java,v 1.1 2009-11-10 11:10:40 vrotaru Exp $
 */
 ...
 */
public class MDFullGroup42Test {


    public MDFullGroup42Test() {
    }
    ...
    public void testGetUnsupportedTag() {
        ...
        MDFullGroup group = new MDFullGroup42();
        try {
            group.getYieldData();
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MDFullGroup] group version [4.2].", ex.getMessage());
    }
}
