...
/*
 * ListExecuteMsg44Test.java
 *
 * $Id: ListExecuteMsg44Test.java,v 1.1 2011-02-05 08:52:45 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.2 ListExecuteMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ListExecuteMsg44Test extends MsgTest  {

    public ListExecuteMsg44Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListExecuteMsg msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_4_4);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListExecuteMsg) FIXMsgBuilder.build(MsgType.ListExecute.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListExecuteMsg] message version [4.4].", ex.getMessage());
    }
}
