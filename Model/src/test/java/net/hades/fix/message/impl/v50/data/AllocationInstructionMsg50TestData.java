...
/*
 * AllocationInstructionMsg50TestData.java
 *
 * $Id: AllocationInstructionMsg50TestData.java,v 1.2 2011-10-29 09:42:05 vrotaru Exp $
 */
...
/**
 * Test utility for AllocationInstructionMsg50 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class AllocationInstructionMsg50TestData extends MsgTest {

    private static final AllocationInstructionMsg50TestData INSTANCE;

    static {
        INSTANCE = new AllocationInstructionMsg50TestData();
    }

    public static AllocationInstructionMsg50TestData getInstance() {
        return INSTANCE;
    }
