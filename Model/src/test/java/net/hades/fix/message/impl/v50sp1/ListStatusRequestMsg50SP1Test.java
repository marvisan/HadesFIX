...
/*
 * ListStatusRequestMsg50SP1Test.java
 *
 * $Id: ListStatusRequestMsg50SP1Test.java,v 1.1 2011-02-06 01:06:14 vrotaru Exp $
 */
 ...
 */
public class ListStatusRequestMsg50SP1Test extends MsgTest {

    public ListStatusRequestMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListStatusRequestMsg) FIXMsgBuilder.build(MsgType.ListStatusRequest.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListStatusRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
