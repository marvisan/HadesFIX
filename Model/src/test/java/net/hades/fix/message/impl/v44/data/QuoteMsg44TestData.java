...
/*
 * QuoteMsg44TestData.java
 *
 * $Id: QuoteMsg44TestData.java,v 1.2 2011-10-29 09:42:18 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteMsg44 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class QuoteMsg44TestData extends MsgTest {

    private static final QuoteMsg44TestData INSTANCE;

    static {
        INSTANCE = new QuoteMsg44TestData();
    }

    public static QuoteMsg44TestData getInstance() {
        return INSTANCE;
    }

    public void populate(quickfix.fix44.Quote msg) throws Exception {
        ...
        quickfix.fix44.Quote.NoLegs grpl1 = new quickfix.fix44.Quote.NoLegs();
        LegQuoteGroup44TestData.getInstance().populate1(grpl1);
        msg.addGroup(grpl1);
        quickfix.fix44.Quote.NoLegs grpl2 = new quickfix.fix44.Quote.NoLegs();
    ...
    public void populate(QuoteMsg msg) throws UnsupportedEncodingException {
        ...
        LegQuoteGroup44TestData.getInstance().populate1(msg.getLegQuoteSymbolGroups()[0]);
        LegQuoteGroup44TestData.getInstance().populate2(msg.getLegQuoteSymbolGroups()[1]);
    ...
    public void check(quickfix.fix44.Quote expected, QuoteMsg actual) throws Exception {
        ...
        LegQuoteGroup44TestData.getInstance().check(grpl1, actual.getLegQuoteSymbolGroups()[0]);
        quickfix.fix44.Quote.NoLegs grpl2 = new quickfix.fix44.Quote.NoLegs();
        expected.getGroup(2, grpl2);
        LegQuoteGroup44TestData.getInstance().check(grpl2, actual.getLegQuoteSymbolGroups()[1]);
    ...
    public void check(QuoteMsg expected, quickfix.fix44.Quote actual) throws Exception {
        ...
        LegQuoteGroup44TestData.getInstance().check(expected.getLegQuoteSymbolGroups()[0], grpl1);
        quickfix.fix44.Quote.NoLegs grpl2 = new quickfix.fix44.Quote.NoLegs();
        actual.getGroup(2, grpl2);
        LegQuoteGroup44TestData.getInstance().check(expected.getLegQuoteSymbolGroups()[1], grpl2);
    ...
    public void check(QuoteMsg expected, QuoteMsg actual) throws Exception {
        ...
        LegQuoteGroup44TestData.getInstance().check(expected.getLegQuoteSymbolGroups()[0], actual.getLegQuoteSymbolGroups()[0]);
        LegQuoteGroup44TestData.getInstance().check(expected.getLegQuoteSymbolGroups()[1], actual.getLegQuoteSymbolGroups()[1]);
