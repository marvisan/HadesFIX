...
/*
 * OrderCancelRejectMsg44Test.java
 *
 * $Id: OrderCancelRejectMsg44Test.java,v 1.1 2011-01-23 10:02:05 vrotaru Exp $
 */
 ...
 */
public class OrderCancelRejectMsg44Test extends MsgTest  {

    public OrderCancelRejectMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (OrderCancelRejectMsg) FIXMsgBuilder.build(MsgType.OrderCancelReject.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [OrderCancelRejectMsg] message version [4.4].", ex.getMessage());
    }
}
