...
/*
 * SecurityTypesMsg50Test.java
 *
 * $Id: SecurityTypesMsg50Test.java,v 1.1 2011-04-27 01:09:59 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 SecurityTypesMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SecurityTypesMsg50Test extends MsgTest  {

    public SecurityTypesMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SecurityTypesMsg) FIXMsgBuilder.build(MsgType.SecurityTypes.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SecurityTypesMsg] message version [5.0].", ex.getMessage());
    }
}
