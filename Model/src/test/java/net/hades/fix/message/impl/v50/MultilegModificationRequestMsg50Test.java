...
/*
 * MultilegModificationRequestMsg50Test.java
 *
 * $Id: MultilegModificationRequestMsg50Test.java,v 1.1 2011-09-10 05:41:13 vrotaru Exp $
 */
 ...
 */
public class MultilegModificationRequestMsg50Test extends MsgTest  {

    public MultilegModificationRequestMsg50Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (MultilegModificationRequestMsg) FIXMsgBuilder.build(MsgType.MultilegModificationRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50);
        } catch (Exception ex) {
    ...
    public void testEncodeMissingRequired() {
        ...
        try {
            MultilegModificationRequestMsg msg = (MultilegModificationRequestMsg) FIXMsgBuilder.build(MsgType.MultilegModificationRequest.getValue(), BeginString.FIXT_1_1, ApplVerID.FIX50);
