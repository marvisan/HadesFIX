...
/*
 * ConfirmationAckMsg50SP1Test.java
 *
...
/**
 * Test suite for FIX 5.0SP1 ConfirmationAckMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ConfirmationAckMsg50SP1Test extends MsgTest  {

    public ConfirmationAckMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ConfirmationAckMsg) FIXMsgBuilder.build(MsgType.ConfirmationAck.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ConfirmationAckMsg] message version [5.0SP1].", ex.getMessage());
    }
}
