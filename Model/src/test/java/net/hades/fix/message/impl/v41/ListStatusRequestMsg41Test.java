...
/*
 * ListStatusRequestMsg41Test.java
 *
 * $Id: ListStatusRequestMsg41Test.java,v 1.1 2011-02-06 01:06:14 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.1 ListStatusRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ListStatusRequestMsg41Test extends MsgTest  {

    public ListStatusRequestMsg41Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ListStatusRequestMsg msg = (ListStatusRequestMsg) FIXMsgBuilder.build(MsgType.ListStatusRequest.getValue(), BeginString.FIX_4_1);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ListStatusRequestMsg) FIXMsgBuilder.build(MsgType.ListStatusRequest.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ListStatusRequestMsg] message version [4.1].", ex.getMessage());
    }
}
