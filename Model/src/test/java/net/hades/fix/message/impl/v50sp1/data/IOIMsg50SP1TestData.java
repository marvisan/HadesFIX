...
/*
 * IOIMsg50SP1TestData.java
 *
 * $Id: IOIMsg50SP1TestData.java,v 1.2 2011-10-29 09:42:15 vrotaru Exp $
 */
...
import net.hades.fix.message.group.impl.v50sp1.LegIOIGroup50SP1TestData;
...
/**
 * Test utility for IOIMsg50SP1 message class.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 11:01:10 AM
 */
public class IOIMsg50SP1TestData extends MsgTest {

    private static final IOIMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new IOIMsg50SP1TestData();
    }

    public static IOIMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(IOIMsg msg) throws UnsupportedEncodingException {
        ...
        LegIOIGroup50SP1TestData.getInstance().populate1(msg.getLegIOIGroups()[0]);
        LegIOIGroup50SP1TestData.getInstance().populate2(msg.getLegIOIGroups()[1]);
    ...
    public void check(IOIMsg expected, IOIMsg actual) throws Exception {
        ...
        LegIOIGroup50SP1TestData.getInstance().check(expected.getLegIOIGroups()[0], actual.getLegIOIGroups()[0]);
        LegIOIGroup50SP1TestData.getInstance().check(expected.getLegIOIGroups()[1], actual.getLegIOIGroups()[1]);
