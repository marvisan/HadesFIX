...
/*
 * MarketDataRequestRejectMsg50Test.java
 *
 * $Id: MarketDataRequestRejectMsg50Test.java,v 1.2 2010-03-21 11:25:16 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 MarketDataRequestRejectMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class MarketDataRequestRejectMsg50Test extends MsgTest  {

    public MarketDataRequestRejectMsg50Test() {
    }
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MarketDataRequestRejectMsg] message version [5.0].", ex.getMessage());
    }
}
