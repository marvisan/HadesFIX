 ...
 *
 * $Id: MDreqGroup42TestData.java,v 1.2 2009-11-10 11:10:40 vrotaru Exp $
 */
 ...
 */
public class MDReqGroup42TestData extends MsgTest {

    private static final MDReqGroup42TestData INSTANCE;

    static {
        INSTANCE = new MDReqGroup42TestData();
    }

    public static MDReqGroup42TestData getInstance() {
        return INSTANCE;
    }

    public void populate1(quickfix.fix42.MarketDataRequest.NoRelatedSym msg) throws Exception {
    ...
    public void populate2(quickfix.fix42.MarketDataRequest.NoRelatedSym msg) throws Exception {
    ...
    public void check(MDReqGroup expected, quickfix.fix42.MarketDataRequest.NoRelatedSym actual) throws Exception {
    ...
    public void check(quickfix.fix42.MarketDataRequest.NoRelatedSym expected, MDReqGroup actual) throws Exception {
