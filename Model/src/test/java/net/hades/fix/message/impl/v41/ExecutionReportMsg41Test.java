...
/*
 * ExecutionReportMsg41Test.java
 *
 * $Id: ExecutionReportMsg41Test.java,v 1.2 2011-01-12 11:33:59 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v41.data.ExecutionReportMsg41TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.1 ExecutionReportMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class ExecutionReportMsg41Test extends MsgTest  {

    public ExecutionReportMsg41Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        ExecutionReportMsg msg = (ExecutionReportMsg) FIXMsgBuilder.build(MsgType.ExecutionReport.getValue(), BeginString.FIX_4_1);
        ExecutionReportMsg41TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        ExecutionReportMsg dmsg = (ExecutionReportMsg) FIXMsgBuilder.build(encoded.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        ExecutionReportMsg41TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (ExecutionReportMsg) FIXMsgBuilder.build(MsgType.ExecutionReport.getValue(), BeginString.FIX_4_1);
        } catch (Exception ex) {
        ...
        try {
            msg.getNoContraBrokers();
            fail("Expect exception thrown.");
        } catch (Exception ex) {
            checkUnsupportedException(ex);
        }
        try {
            msg.getContraBrokers();
            fail("Expect exception thrown.");
        } catch (Exception ex) {
            checkUnsupportedException(ex);
        }
    ...
    public void testSetUnsupportedMsgTag() {
        ...
        try {
            msg.deleteContraBroker(1);
            fail("Expect exception thrown.");
        } catch (Exception ex) {
            checkUnsupportedException(ex);
        }
        try {
            msg.clearContraBrokers();
            fail("Expect exception thrown.");
        } catch (Exception ex) {
            checkUnsupportedException(ex);
        }
    ...
    public void testEncodeMissingRequired() {
        ...
        try {
            ...
            assertEquals("Tag value(s) for [OrderID] [ExecID] [ExecTransType] [ExecType] [OrdStatus] [Symbol] [Side] [OrderQty] [LastQty] [LastPx] [LeavesQty] [CumQty] [AvgPx] is missing.", ex.getMessage());
        }
    }
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [ExecutionReportMsg] message version [4.1].", ex.getMessage());
    }
}
