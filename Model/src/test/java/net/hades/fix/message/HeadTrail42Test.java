...
/*
 * HeadTrail42Test.java
 *
 * $Id: HeadTrail42Test.java,v 1.6 2011-04-04 09:37:10 vrotaru Exp $
 */
...
public class HeadTrail42Test extends MsgTest {

    public HeadTrail42Test() {
    }
    ...
    /**
     * Test of encode method, of a message class Header/Tailer for FIX 4.2.
     * @throws Exception 
     */
    @Test
    public void a1_testEncodeReqOnly() throws Exception {
        ...
        msg.setTestReqID("Test header/trailer 4.2");
    ...
    /**
     * Test of encode method, of a message class Header/Tailer for FIX 4.2 with secure data.
     */
    @Test
...
//            quickfix.fix40.TestRequest qfMsg = (quickfix.fix40.TestRequest) new quickfix.Message(encoded);
    ...
    /**
     * Test of encode method, of a message class Header/Tailer for FIX 4.2 with custom fields.
     * @throws Exception 
     */
    @Test
    ...
    /**
     * Test of decode method, of a message class Header/Tailer for FIX 4.2.
     * @throws Exception 
     */
    @Test
    ...
    public void a14_testDecodeCustom() throws Exception {
        quickfix.fix42.TestRequest qfMsg =  buildTestRequestAll();
    ...
    /**
     * Test of encode method, of class Header 4.2 with missing required header data.
     */
    @Test
    ...
    public void x4_testGetUnsupportedHeaderTag() {
        try {
            TestRequestMsg msg = (TestRequestMsg) FIXMsgBuilder.build(MsgType.TestRequest.getValue(), BeginString.FIX_4_2);
            msg.getHeader().getNoHops();
            fail("Expect exception thrown.");
        } catch (Exception ex) {
            assertEquals("This tag is not supported in release [" + BeginString.FIX_4_2.getValue() + "].",
                    ex.getMessage());
        }
    }
    ...
    private quickfix.fix42.TestRequest buildTestRequestReq() {
        quickfix.fix42.TestRequest msg = new quickfix.fix42.TestRequest();
        TestUtils.populateQuicFIX42HeaderReq(msg);
        msg.setString(TestReqID.FIELD, ("Test field 4.2"));
        
        return msg;
    }
    
    private quickfix.fix42.TestRequest buildTestRequestAll() {
        quickfix.fix42.TestRequest msg = new quickfix.fix42.TestRequest();
    ...
    private void checkQuickFIXHeaderReq(TestRequestMsg msg) {
        assertEquals(BeginString.FIX_4_2, msg.getHeader().getBeginString());
