 ...
 *
 * $Id: MarketDataRequestRejectMsg44Test.java,v 1.2 2010-03-21 11:25:18 vrotaru Exp $
 */
 ...
 */
public class MarketDataRequestRejectMsg44Test extends MsgTest {

    public MarketDataRequestRejectMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (MarketDataRequestRejectMsg) FIXMsgBuilder.build(MsgType.MarketDataRequestReject.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [MarketDataRequestRejectMsg] message version [4.4].", ex.getMessage());
    }
}
