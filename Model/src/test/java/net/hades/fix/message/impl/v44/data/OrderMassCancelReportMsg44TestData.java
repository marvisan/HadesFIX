...
/*
 * OrderMassCancelReportMsg44TestData.java
 *
 * $Id: OrderMassCancelReportMsg44TestData.java,v 1.1 2011-05-07 06:58:53 vrotaru Exp $
 */
 ...
 */
public class OrderMassCancelReportMsg44TestData extends MsgTest {

    private static final OrderMassCancelReportMsg44TestData INSTANCE;

    static {
        INSTANCE = new OrderMassCancelReportMsg44TestData();
    }

    public static OrderMassCancelReportMsg44TestData getInstance() {
        return INSTANCE;
    }
