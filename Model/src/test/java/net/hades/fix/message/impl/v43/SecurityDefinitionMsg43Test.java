...
/*
 * SecurityDefinitionMsg43Test.java
 *
 * $Id: SecurityDefinitionMsg43Test.java,v 1.1 2011-04-19 12:13:37 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v43.data.SecurityDefinitionMsg43TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.3 SecurityDefinitionMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SecurityDefinitionMsg43Test extends MsgTest  {

    public SecurityDefinitionMsg43Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        SecurityDefinitionMsg msg = (SecurityDefinitionMsg) FIXMsgBuilder.build(MsgType.SecurityDefinition.getValue(), BeginString.FIX_4_3);
        SecurityDefinitionMsg43TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        SecurityDefinitionMsg43TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SecurityDefinitionMsg) FIXMsgBuilder.build(MsgType.SecurityDefinition.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SecurityDefinitionMsg] message version [4.3].", ex.getMessage());
    }
}
