...
/*
 * QuoteRequestLegGroup50SP2TestData.java
 *
 * $Id: QuoteRequestLegGroup50SP2TestData.java,v 1.1 2009-07-06 03:18:49 vrotaru Exp $
 */
...
/**
 * Test utility for LegQuoteRequestSymbolGroup50SP2 component class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 14/03/2009, 4:17:02 PM
 */
public class QuoteRequestLegGroup50SP2TestData extends MsgTest {

    private static final QuoteRequestLegGroup50SP2TestData INSTANCE;

    static {
        INSTANCE = new QuoteRequestLegGroup50SP2TestData();
    }

    public static QuoteRequestLegGroup50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate2(QuoteRequestLegGroup comp) {
        // InstrumentLeg
        comp.setInstrumentLeg();
        InstrumentLeg50SP2TestData.getInstance().populate2(comp.getInstrumentLeg());
        // LegStipulations
        comp.setLegStipulations();
        LegStipulations50TestData.getInstance().populate(comp.getLegStipulations());
        // NestedParties
