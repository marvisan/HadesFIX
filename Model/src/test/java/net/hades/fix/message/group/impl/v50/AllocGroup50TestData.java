...
/*
 * AllocGroup50TestData.java
 *
 * $Id: AllocGroup50TestData.java,v 1.2 2011-10-29 09:42:29 vrotaru Exp $
 */
...
/**
 * Test utility for AllocGroup50 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 31/03/2009, 9:12:46 AM
 */
public class AllocGroup50TestData extends MsgTest {

    private static final AllocGroup50TestData INSTANCE;

    static {
        INSTANCE = new AllocGroup50TestData();
    }

    public static AllocGroup50TestData getInstance() {
        return INSTANCE;
    }
