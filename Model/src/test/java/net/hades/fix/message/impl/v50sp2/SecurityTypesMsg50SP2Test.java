...
/*
 * SecurityTypesMsg50SP2Test.java
 *
 * $Id: SecurityTypesMsg50SP2Test.java,v 1.1 2011-04-27 01:09:57 vrotaru Exp $
 */
 ...
 */
public class SecurityTypesMsg50SP2Test extends MsgTest  {

    public SecurityTypesMsg50SP2Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SecurityTypesMsg) FIXMsgBuilder.build(MsgType.SecurityTypes.getValue(), BeginString.FIX_5_0SP2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SecurityTypesMsg] message version [5.0SP2].", ex.getMessage());
    }
}
