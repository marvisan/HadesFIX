...
/*
 * NewOrderListMsg50SP2TestData.java
 *
 * $Id: NewOrderListMsg50SP2TestData.java,v 1.2 2011-10-29 09:42:19 vrotaru Exp $
 */
...
/**
 * Test utility for NewOrderListMsg50SP2 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class NewOrderListMsg50SP2TestData extends MsgTest {

    private static final NewOrderListMsg50SP2TestData INSTANCE;

    static {
        INSTANCE = new NewOrderListMsg50SP2TestData();
    }

    public static NewOrderListMsg50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(NewOrderListMsg msg) throws UnsupportedEncodingException {
        ...
        OrderListGroup50SP2TestData.getInstance().populate2(msg.getOrderListGroups()[1]);
    }
    ...
    public void check(NewOrderListMsg expected, NewOrderListMsg actual, boolean fixml) throws Exception {
        ...
        OrderListGroup50SP2TestData.getInstance().check(expected.getOrderListGroups()[0], actual.getOrderListGroups()[0], fixml);
        OrderListGroup50SP2TestData.getInstance().check(expected.getOrderListGroups()[1], actual.getOrderListGroups()[1], fixml);
     }
}
