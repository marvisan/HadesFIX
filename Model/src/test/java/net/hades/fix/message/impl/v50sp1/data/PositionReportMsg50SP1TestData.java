...
/*
 * PositionReportMsg50SP1TestData.java
 *
...
import net.hades.fix.message.group.impl.v50sp1.PosUndInstrmtGroup50SP1TestData;
...
/**
 * Test utility for PositionReportMsg50SP1 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 13/12/2011, 12:08:30 PM
 */
public class PositionReportMsg50SP1TestData extends MsgTest {

    private static final PositionReportMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new PositionReportMsg50SP1TestData();
    }

    public static PositionReportMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(PositionReportMsg msg) throws UnsupportedEncodingException {
        ...
        PosUndInstrmtGroup50SP1TestData.getInstance().populate1(msg.getPosUndInstrmtGroups()[0]);
        PosUndInstrmtGroup50SP1TestData.getInstance().populate2(msg.getPosUndInstrmtGroups()[1]);
    ...
    public void check(PositionReportMsg expected, PositionReportMsg actual) throws Exception {
        ...
        PosUndInstrmtGroup50SP1TestData.getInstance().check(expected.getPosUndInstrmtGroups()[0], actual.getPosUndInstrmtGroups()[0]);
        PosUndInstrmtGroup50SP1TestData.getInstance().check(expected.getPosUndInstrmtGroups()[1], actual.getPosUndInstrmtGroups()[1]);
