 ...
 *
 * $Id: NewOrderSingleMsg50TestData.java,v 1.3 2011-10-29 09:42:07 vrotaru Exp $
 */
 ...
 */
public class NewOrderSingleMsg50TestData extends MsgTest {

    private static final NewOrderSingleMsg50TestData INSTANCE;

    static {
        INSTANCE = new NewOrderSingleMsg50TestData();
    }

    public static NewOrderSingleMsg50TestData getInstance() {
        return INSTANCE;
    }
