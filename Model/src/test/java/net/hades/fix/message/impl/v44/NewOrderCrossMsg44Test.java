...
/*
 * NewOrderCrossMsg44Test.java
 *
 * $Id: NewOrderCrossMsg44Test.java,v 1.2 2011-05-17 09:28:22 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 4.4 NewOrderCrossMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class NewOrderCrossMsg44Test extends MsgTest  {

    public NewOrderCrossMsg44Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (NewOrderCrossMsg) FIXMsgBuilder.build(MsgType.NewOrderCross.getValue(), BeginString.FIX_4_4);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [NewOrderCrossMsg] message version [4.4].", ex.getMessage());
    }
}
