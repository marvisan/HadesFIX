...
/*
 * QuoteEntryAckGroup50SP2TestData.java
 *
 * $Id: QuoteEntryAckGroup50SP2TestData.java,v 1.3 2011-10-29 09:42:22 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteEntryAckGroup50SP2 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 11/04/2009, 10:08:38 AM
 */
public class QuoteEntryAckGroup50SP2TestData extends MsgTest {

    private static final QuoteEntryAckGroup50SP2TestData INSTANCE;

    static {
        INSTANCE = new QuoteEntryAckGroup50SP2TestData();
    }

    public static QuoteEntryAckGroup50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate1(QuoteEntryAckGroup msg) throws UnsupportedEncodingException {
        ...
        msg.setOrderRestrictions(OrderRestrictions.RisklessArbitrage.getValue());
        msg.setQuoteEntryStatus(QuoteEntryStatus.Accepted);
    ...
    public void populate2(QuoteEntryAckGroup msg) throws UnsupportedEncodingException {
        ...
        msg.setQuoteEntryStatus(QuoteEntryStatus.Active);
    ...
    public void check(QuoteEntryAckGroup expected, QuoteEntryAckGroup actual) throws Exception {
        ...
        assertEquals(expected.getQuoteEntryStatus().getValue(), actual.getQuoteEntryStatus().getValue());
