 ...
 *
 * $Id: MDFullGroup44TestData.java,v 1.2 2011-10-29 09:42:11 vrotaru Exp $
 */
 ...
 */
public class MDFullGroup44TestData extends MsgTest {

    private static final MDFullGroup44TestData INSTANCE;

    static {
        INSTANCE = new MDFullGroup44TestData();
    }

    public static MDFullGroup44TestData getInstance() {
        return INSTANCE;
    }
