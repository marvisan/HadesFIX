 ...
 * NewsMsg42Test.java
 *
 * $Id: NewsMsg42Test.java,v 1.3 2010-03-21 11:25:17 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v42.data.NewsMsg42TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;
import net.hades.fix.message.type.RoutingType;

/**
 * Test suite for FIX 4.2 NewsMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.3 $
 * @created 02/03/2009, 7:38:11 PM
 */
public class NewsMsg42Test extends MsgTest {

    private DataDictionary dictionary;

    public NewsMsg42Test() {
    }
    ...
    public void a1_testEncodeReq() throws Exception {
        ...
        NewsMsg msg = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIX_4_2);
    ...
    public void a2_testEncodeAll() throws Exception {
        ...
        dictionary = getQF42DataDictionary();
        NewsMsg msg = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIX_4_2);
        NewsMsg42TestData.getInstance().populate(msg);
        String encoded = new String(msg.encode(), DEFAULT_CHARACTER_SET);
        System.out.println("encoded-->" + encoded);

        quickfix.fix42.News qfMsg = new quickfix.fix42.News();
        qfMsg.fromString(encoded, dictionary, true);
        NewsMsg42TestData.getInstance().check(msg, qfMsg);
    }
    ...
    public void b2_testDecodeAll() throws Exception {
        ...
        NewsMsg dmsg = (NewsMsg) FIXMsgBuilder.build(strMsg.getBytes(DEFAULT_CHARACTER_SET));
        dmsg.decode();
        NewsMsg42TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testSetNoRelatedSyms() throws Exception {
        NewsMsg comp = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIX_4_2);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        NewsMsg msg = null;
        try {
            msg = (NewsMsg) FIXMsgBuilder.build(MsgType.News.getValue(), BeginString.FIX_4_2);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [NewsMsg] message version [4.2].", ex.getMessage());
    }
}
