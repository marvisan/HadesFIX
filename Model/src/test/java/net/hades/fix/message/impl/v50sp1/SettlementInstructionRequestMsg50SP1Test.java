...
/*
 * SettlementInstructionRequestMsg50SP1Test.java
 *
...
/**
 * Test suite for FIX 5.0SP1 SettlementInstructionRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class SettlementInstructionRequestMsg50SP1Test extends MsgTest {

    public SettlementInstructionRequestMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (SettlementInstructionRequestMsg) FIXMsgBuilder.build(MsgType.SettlementInstructionRequest.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [SettlementInstructionRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
}
