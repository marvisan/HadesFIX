...
/*
 * BidRequestMsg50Test.java
 *
 * $Id: BidRequestMsg50Test.java,v 1.1 2011-04-13 10:13:46 vrotaru Exp $
 */
...
/**
 * Test suite for FIX 5.0 BidRequestMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class BidRequestMsg50Test extends MsgTest  {

    public BidRequestMsg50Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        BidRequestMsg msg = (BidRequestMsg) FIXMsgBuilder.build(MsgType.BidRequest.getValue(), BeginString.FIX_5_0);
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (BidRequestMsg) FIXMsgBuilder.build(MsgType.BidRequest.getValue(), BeginString.FIX_5_0);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [BidRequestMsg] message version [5.0].", ex.getMessage());
    }
}
