...
/*
 * QuoteResponseMsg50TestData.java
 *
 * $Id: QuoteResponseMsg50TestData.java,v 1.3 2011-10-29 09:42:06 vrotaru Exp $
 */
 ...
 */
public class QuoteResponseMsg50TestData extends MsgTest {

    private static final QuoteResponseMsg50TestData INSTANCE;

    static {
        INSTANCE = new QuoteResponseMsg50TestData();
    }

    public static QuoteResponseMsg50TestData getInstance() {
        return INSTANCE;
    }

    public void populate(quickfix.fix50.QuoteResponse msg) throws Exception {
        ...
        quickfix.fix50.QuoteResponse.NoQuoteQualifiers grpqq1 = new quickfix.fix50.QuoteResponse.NoQuoteQualifiers();
        grpqq1.setChar(quickfix.field.QuoteQualifier.FIELD, 'B');
        msg.addGroup(grpqq1);
        quickfix.fix50.QuoteResponse.NoQuoteQualifiers grpqq2 = new quickfix.fix50.QuoteResponse.NoQuoteQualifiers();
        ...
        quickfix.fix50.QuoteResponse.NoUnderlyings grpu1 = new quickfix.fix50.QuoteResponse.NoUnderlyings();
        grpu1.set(ui1);
        ...
        quickfix.fix50.QuoteResponse.NoUnderlyings grpu2 = new quickfix.fix50.QuoteResponse.NoUnderlyings();
        grpu2.set(ui2);
        ...
        quickfix.fix50.QuoteResponse.NoLegs grpl1 = new quickfix.fix50.QuoteResponse.NoLegs();
        LegQuoteGroup50TestData.getInstance().populate1(grpl1);
        msg.addGroup(grpl1);
        quickfix.fix50.QuoteResponse.NoLegs grpl2 = new quickfix.fix50.QuoteResponse.NoLegs();
    ...
    public void populate(QuoteResponseMsg msg) throws UnsupportedEncodingException {
        ...
        LegQuoteGroup50TestData.getInstance().populate1(msg.getLegQuoteGroups()[0]);
        LegQuoteGroup50TestData.getInstance().populate2(msg.getLegQuoteGroups()[1]);
    ...
    public void check(quickfix.fix50.QuoteResponse expected, QuoteResponseMsg actual) throws Exception {
        ...
        LegQuoteGroup50TestData.getInstance().check(grpl1, actual.getLegQuoteGroups()[0]);
        quickfix.fix50.QuoteResponse.NoLegs grpl2 = new quickfix.fix50.QuoteResponse.NoLegs();
        expected.getGroup(2, grpl2);
        LegQuoteGroup50TestData.getInstance().check(grpl2, actual.getLegQuoteGroups()[1]);
    ...
    public void check(QuoteResponseMsg expected, QuoteResponseMsg actual) throws Exception {
        ...
        LegQuoteGroup50TestData.getInstance().check(expected.getLegQuoteGroups()[0], actual.getLegQuoteGroups()[0]);
        LegQuoteGroup50TestData.getInstance().check(expected.getLegQuoteGroups()[1], actual.getLegQuoteGroups()[1]);
