...
/*
 * QuoteEntryGroup50TestData.java
 *
 * $Id: QuoteEntryGroup50TestData.java,v 1.2 2011-10-29 09:42:31 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteEntryGroup50 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/04/2009, 10:08:38 AM
 */
public class QuoteEntryGroup50TestData extends MsgTest {

    private static final QuoteEntryGroup50TestData INSTANCE;

    static {
        INSTANCE = new QuoteEntryGroup50TestData();
    }

    public static QuoteEntryGroup50TestData getInstance() {
        return INSTANCE;
    }
