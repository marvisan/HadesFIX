...
/*
 * AllocationReportMsg50SP1Test.java
 *
 ...
 */
public class AllocationReportMsg50SP1Test extends MsgTest  {

    public AllocationReportMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AllocationReportMsg) FIXMsgBuilder.build(MsgType.AllocationReport.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AllocationReportMsg] message version [5.0SP1].", ex.getMessage());
    }
}
