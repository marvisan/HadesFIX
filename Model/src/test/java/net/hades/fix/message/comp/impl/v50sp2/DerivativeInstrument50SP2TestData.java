...
/*
 * DerivativeInstrument50SP2TestData.java
 *
 * $Id: DerivativeInstrument50SP2TestData.java,v 1.2 2011-10-29 09:42:32 vrotaru Exp $
 */
...
import net.hades.fix.message.comp.impl.v50sp1.DerivativeInstrumentParties50SP1TestData;
 ...
 */
public class DerivativeInstrument50SP2TestData extends MsgTest {

    private static final DerivativeInstrument50SP2TestData INSTANCE;

    static {
        INSTANCE = new DerivativeInstrument50SP2TestData();
    }

    public static DerivativeInstrument50SP2TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(DerivativeInstrument comp) {
        ...
        comp.setDerivativeContractMultiplierUnit(ContractMultiplierUnit.Shares);
        comp.setDerivativeFlowScheduleType(2);
...
//        assertTimeEquals(expected.getDerivativeMaturityTime(), actual.getDerivativeMaturityTime(), false);
        ...
        assertEquals(expected.getDerivativeContractMultiplierUnit(), actual.getDerivativeContractMultiplierUnit());
        assertEquals(expected.getDerivativeFlowScheduleType(), actual.getDerivativeFlowScheduleType());
