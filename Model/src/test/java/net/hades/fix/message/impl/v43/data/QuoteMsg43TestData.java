...
/*
 * QuoteMsg43TestData.java
 *
 * $Id: QuoteMsg43TestData.java,v 1.2 2011-10-29 09:42:29 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteMsg43 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class QuoteMsg43TestData extends MsgTest {

    private static final QuoteMsg43TestData INSTANCE;

    static {
        INSTANCE = new QuoteMsg43TestData();
    }

    public static QuoteMsg43TestData getInstance() {
        return INSTANCE;
    }

    public void populate(quickfix.fix43.Quote msg) throws Exception {
    ...
    public void check(quickfix.fix43.Quote expected, QuoteMsg actual) throws Exception {
    ...
    public void check(QuoteMsg expected, quickfix.fix43.Quote actual) throws Exception {
