...
/*
 * UnderlyingInstrument50SP1Test.java
 *
 * $Id: UnderlyingInstrument50SP1Test.java,v 1.2 2009-11-21 09:57:22 vrotaru Exp $
 */
...
/**
 * Test suite for UnderlyingInstrument50SP1 class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/01/2009, 10:41:25 AM
 */
public class UnderlyingInstrument50SP1Test {

    public UnderlyingInstrument50SP1Test() {
    }
    ...
    public void testSetNoUnderlyingSecurityAltID() {
        UnderlyingInstrument comp = new UnderlyingInstrument50SP1();
    ...
    private void checkUnsupportedUnderlyingInstrumentException(Exception ex) {
        assertEquals("This tag is not supported in [UnderlyingInstrument] component version [5.0SP1].", ex.getMessage());
    }
}