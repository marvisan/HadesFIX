...
/*
 * OrderCancelRejectMsg43TestData.java
 *
 * $Id: OrderCancelRejectMsg43TestData.java,v 1.1 2011-01-23 10:02:04 vrotaru Exp $
 */
...
/**
 * Test utility for OrderCancelRejectMsg43 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class OrderCancelRejectMsg43TestData extends MsgTest {

    private static final OrderCancelRejectMsg43TestData INSTANCE;

    static {
        INSTANCE = new OrderCancelRejectMsg43TestData();
    }

    public static OrderCancelRejectMsg43TestData getInstance() {
        return INSTANCE;
    }
