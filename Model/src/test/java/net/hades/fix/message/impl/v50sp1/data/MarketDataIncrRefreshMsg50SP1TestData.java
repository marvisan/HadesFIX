...
/*
 * MarketDataIncrRefreshMsg50SP1TestData.java
 *
 * $Id: MarketDataIncrRefreshMsg50SP1TestData.java,v 1.1 2010-01-14 09:07:10 vrotaru Exp $
 */
 ...
 */
public class MarketDataIncrRefreshMsg50SP1TestData extends MsgTest {

    private static final MarketDataIncrRefreshMsg50SP1TestData INSTANCE;

    static {
        INSTANCE = new MarketDataIncrRefreshMsg50SP1TestData();
    }

    public static MarketDataIncrRefreshMsg50SP1TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(MarketDataIncrRefreshMsg msg) throws UnsupportedEncodingException {
        ...
        MDIncGroup50SP1TestData.getInstance().populate2(msg.getMDIncGroups()[1]);
    ...
    public void check(MarketDataIncrRefreshMsg expected, MarketDataIncrRefreshMsg actual) throws Exception {
        ...
        MDIncGroup50SP1TestData.getInstance().check(expected.getMDIncGroups()[0], actual.getMDIncGroups()[0]);
        MDIncGroup50SP1TestData.getInstance().check(expected.getMDIncGroups()[1], actual.getMDIncGroups()[1]);
