...
/*
 * RequestForPositionsAckMsgFIXML50SP1Test.java
 *
...
/**
 * Test suite for RequestForPositionsAckMsg50SP1 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 10/12/2011, 20:57:03
 */
public class RequestForPositionsAckMsgFIXML50SP1Test extends MsgTest {

    public RequestForPositionsAckMsgFIXML50SP1Test() {
    }
    ...
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ...
            RequestForPositionsAckMsg dmsg = (RequestForPositionsAckMsg) FIXMsgBuilder.build(MsgType.RequestForPositionsAck.getValue(), BeginString.FIX_5_0SP1);
