...
/*
 * AllocationInstructionMsg43Test.java
 *
 * $Id: AllocationInstructionMsg43Test.java,v 1.1 2011-02-16 11:24:35 vrotaru Exp $
 */
...
import net.hades.fix.message.impl.v43.data.AllocationInstructionMsg43TestData;
import net.hades.fix.message.type.BeginString;
import net.hades.fix.message.type.MsgType;

/**
 * Test suite for FIX 4.3 AllocationInstructionMsg class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 01/05/2009, 12:18:17 PM
 */
public class AllocationInstructionMsg43Test extends MsgTest  {

    public AllocationInstructionMsg43Test() {
    }
    ...
    public void b3_testEncodeDecodeAll() throws Exception {
        ...
        AllocationInstructionMsg msg = (AllocationInstructionMsg) FIXMsgBuilder.build(MsgType.Allocation.getValue(), BeginString.FIX_4_3);
        AllocationInstructionMsg43TestData.getInstance().populate(msg);
        ...
        dmsg.decode();
        AllocationInstructionMsg43TestData.getInstance().check(msg, dmsg);
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (AllocationInstructionMsg) FIXMsgBuilder.build(MsgType.Allocation.getValue(), BeginString.FIX_4_3);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [AllocationInstructionMsg] message version [4.3].", ex.getMessage());
    }
}
