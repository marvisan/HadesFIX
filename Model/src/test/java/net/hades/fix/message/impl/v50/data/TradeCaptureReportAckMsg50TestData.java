...
/*
 * TradeCaptureReportAckMsg50TestData.java
 *
...
import net.hades.fix.message.group.impl.v50.TrdCapRptAckSideGroup50TestData;
...
/**
 * Test utility for TradeCaptureReportAckMsg50 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class TradeCaptureReportAckMsg50TestData extends MsgTest {

    private static final TradeCaptureReportAckMsg50TestData INSTANCE;

    static {
        INSTANCE = new TradeCaptureReportAckMsg50TestData();
    }

    public static TradeCaptureReportAckMsg50TestData getInstance() {
        return INSTANCE;
    }
    ...
    public void populate(TradeCaptureReportAckMsg msg) throws UnsupportedEncodingException {
        ...
        msg.setNoSides(2);
        TrdCapRptAckSideGroup50TestData.getInstance().populate1(msg.getTrdCapRptAckSideGroups()[0]);
        TrdCapRptAckSideGroup50TestData.getInstance().populate2(msg.getTrdCapRptAckSideGroups()[1]);
    ...
    public void check(TradeCaptureReportAckMsg expected, TradeCaptureReportAckMsg actual) throws Exception {
        ...
        TrdCapRptAckSideGroup50TestData.getInstance().check(expected.getTrdCapRptAckSideGroups()[0], actual.getTrdCapRptAckSideGroups()[0]);
        TrdCapRptAckSideGroup50TestData.getInstance().check(expected.getTrdCapRptAckSideGroups()[1], actual.getTrdCapRptAckSideGroups()[1]);
