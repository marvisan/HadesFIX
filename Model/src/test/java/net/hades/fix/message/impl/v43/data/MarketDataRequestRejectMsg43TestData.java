 ...
 *
 * $Id: MarketDataRequestRejectMsg43TestData.java,v 1.1 2010-02-03 11:15:21 vrotaru Exp $
 */
...
/**
 * Test utility for MarketDataRequestRejectMsg43 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class MarketDataRequestRejectMsg43TestData extends MsgTest {

    private static final MarketDataRequestRejectMsg43TestData INSTANCE;

    static {
        INSTANCE = new MarketDataRequestRejectMsg43TestData();
    }

    public static MarketDataRequestRejectMsg43TestData getInstance() {
        return INSTANCE;
    }
