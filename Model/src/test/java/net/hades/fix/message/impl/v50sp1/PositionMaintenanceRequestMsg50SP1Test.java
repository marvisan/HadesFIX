...
/*
 * PositionMaintenanceRequestMsg50SP1Test.java
 *
 ...
 */
public class PositionMaintenanceRequestMsg50SP1Test extends MsgTest  {

    public PositionMaintenanceRequestMsg50SP1Test() {
    }
    ...
    public void testGetUnsupportedMsgTag() {
        ...
        try {
            msg = (PositionMaintenanceRequestMsg) FIXMsgBuilder.build(MsgType.PositionMaintenanceRequest.getValue(), BeginString.FIX_5_0SP1);
        } catch (Exception ex) {
    ...
    private void checkUnsupportedException(Exception ex) {
        assertEquals("This tag is not supported in [PositionMaintenanceRequestMsg] message version [5.0SP1].", ex.getMessage());
    }
}
