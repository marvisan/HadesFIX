 ...
 *
 * $Id: MDFullGroup43TestData.java,v 1.2 2011-10-29 09:42:16 vrotaru Exp $
 */
...
/**
 * Test utility for MDFullGroup43 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/04/2009, 10:08:38 AM
 */
public class MDFullGroup43TestData extends MsgTest {

    private static final MDFullGroup43TestData INSTANCE;

    static {
        INSTANCE = new MDFullGroup43TestData();
    }

    public static MDFullGroup43TestData getInstance() {
        return INSTANCE;
    }
