...
/*
 * RegistrationInstructionsMsg50TestData.java
 *
 * $Id: RegistrationInstructionsMsg50TestData.java,v 1.1 2011-10-29 01:31:23 vrotaru Exp $
 */
 ...
 */
public class RegistrationInstructionsMsg50TestData extends MsgTest {

    private static final RegistrationInstructionsMsg50TestData INSTANCE;

    static {
        INSTANCE = new RegistrationInstructionsMsg50TestData();
    }

    public static RegistrationInstructionsMsg50TestData getInstance() {
        return INSTANCE;
    }
