...
/*
 * ConfirmationRequestMsgFIXML50SP2Test.java
 *
...
/**
 * Test suite for ConfirmationRequestMsg50SP2 class FIXML implementation.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 20/10/2008, 20:57:03
 */
public class ConfirmationRequestMsgFIXML50SP2Test extends MsgTest {

    public ConfirmationRequestMsgFIXML50SP2Test() {
    }
    ...
    /**
     * Test of encode method, of class ConfirmationRequestMsg for FIXML.
     * @throws Exception
     */
    @Test
    public void testMarshallUnmarshallFixmlReq() throws Exception {
        ...
        try {
            ConfirmationRequestMsg msg = (ConfirmationRequestMsg) FIXMsgBuilder.build(MsgType.ConfirmationRequest.getValue(), BeginString.FIX_5_0SP2);
            ...
            ConfirmationRequestMsg dmsg = (ConfirmationRequestMsg) FIXMsgBuilder.build(MsgType.ConfirmationRequest.getValue(), BeginString.FIX_5_0SP2);
