 ...
 *
 * $Id: AllocGroup42TestData.java,v 1.2 2011-10-29 09:42:27 vrotaru Exp $
 */
 ...
 */
public class AllocGroup42TestData extends MsgTest {

    private static final AllocGroup42TestData INSTANCE;

    static {
        INSTANCE = new AllocGroup42TestData();
    }

    public static AllocGroup42TestData getInstance() {
        return INSTANCE;
    }
