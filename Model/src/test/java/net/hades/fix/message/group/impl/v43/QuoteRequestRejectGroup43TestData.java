 ...
 *
 * $Id: QuoteRequestRejectGroup43TestData.java,v 1.2 2011-10-29 09:42:16 vrotaru Exp $
 */
 ...
 */
public class QuoteRequestRejectGroup43TestData extends MsgTest {

    private static final QuoteRequestRejectGroup43TestData INSTANCE;

    static {
        INSTANCE = new QuoteRequestRejectGroup43TestData();
    }

    public static QuoteRequestRejectGroup43TestData getInstance() {
        return INSTANCE;
    }

    public void populate1(quickfix.fix43.QuoteRequestReject.NoRelatedSym msg) throws Exception {
        // Instrument
    ...
    public void populate2(quickfix.fix43.QuoteRequestReject.NoRelatedSym msg) throws Exception {
        // Instrument
        quickfix.fix43.component.Instrument instr = new quickfix.fix43.component.Instrument();
        Instrument43TestData.getInstance().populate(instr);
        msg.set(instr);
    ...
    public void check(QuoteRequestRejectGroup expected, quickfix.fix43.QuoteRequestReject.NoRelatedSym actual) throws Exception {
        // Instrument check
    ...
    public void check(quickfix.fix43.QuoteRequestReject.NoRelatedSym expected, QuoteRequestRejectGroup actual) throws Exception {
        // Instrument check
        Instrument43TestData.getInstance().check(expected.getInstrument(), actual.getInstrument());
