...
/*
 * QuoteEntryAckGroup44TestData.java
 *
 * $Id: QuoteEntryAckGroup44TestData.java,v 1.2 2011-10-29 09:42:09 vrotaru Exp $
 */
...
/**
 * Test utility for QuoteEntryAckGroup44 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 11/04/2009, 10:08:38 AM
 */
public class QuoteEntryAckGroup44TestData extends MsgTest {

    private static final QuoteEntryAckGroup44TestData INSTANCE;

    static {
        INSTANCE = new QuoteEntryAckGroup44TestData();
    }

    public static QuoteEntryAckGroup44TestData getInstance() {
        return INSTANCE;
    }

    public void populate1(quickfix.fix44.MassQuoteAcknowledgement.NoQuoteSets.NoQuoteEntries msg) throws Exception {
    ...
    public void populate2(quickfix.fix44.MassQuoteAcknowledgement.NoQuoteSets.NoQuoteEntries msg) throws Exception {
    ...
    public void check(QuoteEntryAckGroup expected, quickfix.fix44.MassQuoteAcknowledgement.NoQuoteSets.NoQuoteEntries actual) throws Exception {
    ...
    public void check(quickfix.fix44.MassQuoteAcknowledgement.NoQuoteSets.NoQuoteEntries expected, QuoteEntryAckGroup actual) throws Exception {
