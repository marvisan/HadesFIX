...
/*
 * DerivativeSecurityDefinition50SP1TestData.java
 *
 * $Id: DerivativeSecurityDefinition50SP1TestData.java,v 1.1 2011-09-28 08:10:20 vrotaru Exp $
 */
 ...
 */
public class DerivativeSecurityDefinition50SP1TestData extends MsgTest {

    private static final DerivativeSecurityDefinition50SP1TestData INSTANCE;

    static {
        INSTANCE = new DerivativeSecurityDefinition50SP1TestData();
    }

    public static DerivativeSecurityDefinition50SP1TestData getInstance() {
        return INSTANCE;
    }

    public void populate(DerivativeSecurityDefinition comp) {
        comp.setDerivativeInstrument();
        DerivativeInstrument50SP1TestData.getInstance().populate(comp.getDerivativeInstrument());
