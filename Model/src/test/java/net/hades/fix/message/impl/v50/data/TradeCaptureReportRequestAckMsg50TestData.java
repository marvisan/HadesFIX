...
/*
 * TradeCaptureReportRequestAckMsg50TestData.java
 *
...
/**
 * Test utility for TradeCaptureReportRequestAckMsg50 message class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 11/05/2009, 12:08:30 PM
 */
public class TradeCaptureReportRequestAckMsg50TestData extends MsgTest {

    private static final TradeCaptureReportRequestAckMsg50TestData INSTANCE;

    static {
        INSTANCE = new TradeCaptureReportRequestAckMsg50TestData();
    }

    public static TradeCaptureReportRequestAckMsg50TestData getInstance() {
        return INSTANCE;
    }
