...
/*
 * SideCrossOrdCxlGroup50TestData.java
 *
 * $Id: SideCrossOrdCxlGroup50TestData.java,v 1.1 2011-05-21 23:53:23 vrotaru Exp $
 */
...
/**
 * Test utility for SideCrossOrdCxlGroup50 group class.
 *
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.1 $
 * @created 21/05/2011, 10:08:38 AM
 */
public class SideCrossOrdCxlGroup50TestData extends MsgTest {

    private static final SideCrossOrdCxlGroup50TestData INSTANCE;

    static {
        INSTANCE = new SideCrossOrdCxlGroup50TestData();
    }

    public static SideCrossOrdCxlGroup50TestData getInstance() {
        return INSTANCE;
    }
