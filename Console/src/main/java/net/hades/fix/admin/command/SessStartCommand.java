...
/*
 * SessStartCommand.java
 *
 * $Id: SessStartCommand.java,v 1.4 2011-04-01 05:04:23 vrotaru Exp $
 */
...
/**
 * Starts the given server session.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.4 $
 * @created 08/05/2010
 */
public class SessStartCommand extends Command {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final String MBEAN_OPERATION_NAME = "startSession";
    ...
    public SessStartCommand(String[] args) throws SessionException {
        super(args);
    }
    public SessStartCommand(String[] args, MBeanServerConnection conn) throws SessionException {
        super(args, conn);
    }
    // </editor-fold>
    ...
    public String getHelpText() {
        ...
        formatter.format("%1$s <session_id> %n", CommandName.SESS_START.getValue());
