 ...
 *
 * $Id: ResetSeqCommand.java,v 1.4 2011-04-01 05:04:23 vrotaru Exp $
 */
 ...
 * @created 08/05/2010
 */
public class ResetSeqCommand extends Command {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final String MBEAN_OPERATION_NAME = "resetSequences";
    ...
    public ResetSeqCommand(String[] args) throws SessionException {
        super(args);
    }
    
    public ResetSeqCommand(String[] args, MBeanServerConnection conn) throws SessionException {
        super(args, conn);
    }
    ...
    public String getHelpText() {
        ...
        formatter.format("%1$s <session_id> <new_seq_num> %n", CommandName.SEQ_RESET.getValue());
