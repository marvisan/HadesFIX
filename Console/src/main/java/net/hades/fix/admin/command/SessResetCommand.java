...
/*
 * SessResetCommand.java
 *
 * $Id: SessResetCommand.java,v 1.2 2011-04-01 05:04:23 vrotaru Exp $
 */
...
/**
 * Attempts to reset session sequence numbers to 1.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.2 $
 * @created 08/05/2010
 */
public class SessResetCommand extends Command {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final String MBEAN_OPERATION_NAME = "sessionReset";
    ...
    public SessResetCommand(String[] args) throws SessionException {
        super(args);
    }
    public SessResetCommand(String[] args, MBeanServerConnection conn) throws SessionException {
        super(args, conn);
    }
    // </editor-fold>
    ...
    public String getHelpText() {
        ...
        formatter.format("%1$s <session_id> %n", CommandName.SESS_RESET.getValue());
