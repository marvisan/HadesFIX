 ...
 *
 * $Id: SessDisconnectCommand.java,v 1.2 2011-04-01 05:04:23 vrotaru Exp $
 */
 ...
 * @created 08/05/2010
 */
public class SessDisconnectCommand extends Command {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final String MBEAN_OPERATION_NAME = "disconnectSession";
    ...
    public SessDisconnectCommand(String[] args) throws SessionException {
        super(args);
    }
    public SessDisconnectCommand(String[] args, MBeanServerConnection conn) throws SessionException {
        super(args, conn);
    }
    // </editor-fold>
    ...
    public String getHelpText() {
        ...
        formatter.format("%1$s <session_id> %n", CommandName.SESS_DISC.getValue());
