...
/*
 * SessThawCommand.java
 *
 * $Id: SessThawCommand.java,v 1.6 2011-04-01 05:04:23 vrotaru Exp $
 */
...
/**
 * Unblocks the given server session.
 * 
 * @author <a href="mailto:support@marvisan.com">Support Team</a>
 * @version $Revision: 1.6 $
 * @created 08/05/2010
 */
public class SessThawCommand extends Command {

    // <editor-fold defaultstate="collapsed" desc="Constants">

    private static final String MBEAN_OPERATION_NAME = "thawSess";
    ...
    public SessThawCommand(String[] args) throws SessionException {
        super(args);
    }
    public SessThawCommand(String[] args, MBeanServerConnection conn) throws SessionException {
        super(args, conn);
    }
    // </editor-fold>
        ...
        if (args.length == 1 && HELP_OPTION.equalsIgnoreCase(args[0])) {
            ...
            if (args.length != 1) {
                ...
                if (cmdResult.getOutcome()) {
                    cmdLineResult.addRow("Session [" + sessionAddress.getCptyAddress() + ":" + sessionAddress.getSessAdrress() + "] successfully thawed.");
