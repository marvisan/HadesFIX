    ...
    static {
        try {
            ...
            COMPOSITE_DATA_ITEMS = new String[]{"compID", "subID", "locationID", "disabled",
                    ...
                    "description", "enableResendTimeout", "testMessageIndicator", "resendTimeout", "enableRejectResponse", "fillLastMsgSeqNum",
            ...
            COMPOSITE_DATA_ITEMS_DESCRIPTION = new String[]{"CompID", "SubID", "LocationID", "Is Disabled?",
                    ...
                    "Description", "Enable Resend Timeout", "Test Message Indicator", "Resend Timeout", "Enable Reject Response", "Fill Last Msg SeqNum",
            ...
            COMPOSITE_DATA_OPEN_TYPES = new OpenType<?>[]{SimpleType.STRING, SimpleType.STRING, SimpleType.STRING, SimpleType.BOOLEAN,
                    ...
                    SimpleType.STRING, SimpleType.BOOLEAN, SimpleType.BOOLEAN, SimpleType.INTEGER, SimpleType.BOOLEAN, SimpleType.BOOLEAN,
