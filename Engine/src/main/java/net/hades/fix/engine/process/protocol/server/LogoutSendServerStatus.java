...
/*
 * LogoutSendServerStatus.java
 *
 * $Id: LogoutSendServerStatus.java,v 1.14 2011-04-03 08:00:05 vrotaru Exp $
 */
 ...
 */
public class LogoutSendServerStatus extends Status {

    private static final Logger LOGGER = Logger.getLogger(LogoutSendServerStatus.class.getName());
    ...
    public LogoutSendServerStatus(StateProcessor stateProcessor) {
    ...
    public LifeCycleCode getLifeCycleCode() {
