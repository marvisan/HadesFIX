...
public class ClientTcpConnectionInfo extends TcpConnectionInfo implements CompositeDataView, Serializable {
    ...
    static {
        try {
            ...
            COMPOSITE_DATA_ITEMS = new String[]{"host", "port", "txBufferSize", "soLinger", "tcpNodelay",
    ...
    public CompositeData toCompositeData(CompositeType ct) {
		...
		itemTypes.add(ct.getType(item));
            ...
            CompositeData cd = new CompositeDataSupport(xct, COMPOSITE_DATA_ITEMS, new Object[]{host, port, txBufferSize,
